...
@Singleton
public class ResizePluginPanel extends PluginPanel
{
	...
	static
	{
		final BufferedImage addIcon = ImageUtil.getResourceStreamFromClass(ResizePlugin.class, "add_icon.png");
	...
	public void updateProfiles()
	{
		...
		for (final ResizeProfile marker : plugin.getResizeProfiles())
		{
			markerView.add(new ResizeProfilePanel(plugin, marker), constraints);
			constraints.gridy++;
