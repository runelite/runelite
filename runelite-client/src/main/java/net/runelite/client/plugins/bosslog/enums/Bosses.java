...
public enum Bosses
{
	...
	BANDOS("General Graardor", new int[]{ItemID.BANDOS_CHESTPLATE, ItemID.BANDOS_TASSETS, ItemID.BANDOS_BOOTS,
			ItemID.BANDOS_HILT},
			new int[]{NpcID.GENERAL_GRAARDOR, NpcID.GENERAL_GRAARDOR_6494},
		Tab.BANDOS),

	ZAMORAK("K'ril Tsutsaroth", new int[]{ItemID.ZAMORAKIAN_SPEAR, ItemID.ZAMORAK_HILT, ItemID.STAFF_OF_THE_DEAD,
			ItemID.STEAM_BATTLESTAFF},
			new int[]{NpcID.KRIL_TSUTSAROTH, NpcID.KRIL_TSUTSAROTH_6495},
			Tab.ZAMORAK),

	SARADOMIN("Commander Zilyana", new int[]{ItemID.SARADOMIN_SWORD, ItemID.SARADOMIN_HILT, ItemID.ARMADYL_CROSSBOW,
			ItemID.SARADOMINS_LIGHT},
			new int[]{NpcID.COMMANDER_ZILYANA, NpcID.COMMANDER_ZILYANA_6493},
			Tab.SARADOMIN),

	ARMADYL("Kree'arra", new int[]{ItemID.ARMADYL_HELMET, ItemID.ARMADYL_CHESTPLATE, ItemID.ARMADYL_CHAINSKIRT,
			ItemID.ARMADYL_HILT},
	...
	SKOTIZO("Skotizo", new int[]{ItemID.UNCUT_ONYX, ItemID.DARK_CLAW},
