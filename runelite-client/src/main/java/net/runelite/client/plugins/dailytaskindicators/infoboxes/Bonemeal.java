...
public class Bonemeal extends DailyInfoBox
{
	public Bonemeal(final int itemId, final String tooltip, final ItemManager itemManager, final DailyTasksConfig config, final DailyTasksPlugin plugin)
	{
	...
	{
		return config.showInfoBoxes() && plugin.bonemealAvailable();
	}
}
