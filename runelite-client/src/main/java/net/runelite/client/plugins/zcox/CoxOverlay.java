    ...
    public Dimension render(Graphics2D graphics)
    {
        ...
        if (plugin.getRunGuard() > 0)
        {
            if (config.Guardians())
            {
                ...
                if (G1 != null)
                {
                    if (plugin.getGuardTick() == 1)
                    {
                        Polygon objectClickbox = G1.getConvexHull();
                        renderPoly(graphics, Color.GREEN, objectClickbox);
                    }
                ...
                if (G2 != null)
                {
                    if (plugin.getGuardTick() == 1)
                    {
                        Polygon objectClickbox = G2.getConvexHull();
                        renderPoly(graphics, Color.GREEN, objectClickbox);
                    }
