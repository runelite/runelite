...
public class Runes extends DailyInfoBox
{
	public Runes(final int itemId, final String tooltip, final ItemManager itemManager, final DailyTasksConfig config, final DailyTasksPlugin plugin)
	{
