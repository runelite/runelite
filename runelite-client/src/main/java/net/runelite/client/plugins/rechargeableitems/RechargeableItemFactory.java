...
{
	public static RechargeableItem createRechargeableItem(int itemEnum, Client client)
	{
	...
	private static RechargeableItem handleBarrows(int itemEnum, Client client)
	{
		RechargeableItem result;
