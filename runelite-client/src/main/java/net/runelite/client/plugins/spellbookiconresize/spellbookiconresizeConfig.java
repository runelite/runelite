...
@ConfigGroup("!Spell Book Icon Resize")
public interface spellbookiconresizeConfig extends Config
{
    ...
    //Fire Surge
    @ConfigItem(position = 21, keyName = "shouldModifyFireSurge", name = "Fire Surge", description = "Toggle on to enable Fire Surge modifications.")
    default boolean shouldModifyFireSurge() { return false; }
    @ConfigItem(position = 22, keyName = "getFireSurgePositionX", name = "Fire Surge Pos X", description = "Modifies the X-axis position of Fire Surge.")
    default int getFireSurgePositionX()
    {
        return 0;
    }
    @ConfigItem(position = 23, keyName = "getFireSurgePositionY", name = "Fire Surge Pos X", description = "Modifies the X-axis position of Fire Surge.")
    default int getFireSurgePositionY()
    {
        return 118;
    }
    @ConfigItem(position = 24, keyName = "getFireSurgeSize", name = "Fire Surge Size", description = "Modifies the width position of Fire Surge.")
