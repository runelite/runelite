...
public final class VarPlayerID
{
	...
	public static final int PAGEPOS = 334;
	...
	public static final int FOLLOWER_OBJ = 448;
	...
	public static final int FARMGUILD_CONTRACT = 2094;
	...
	public static final int SLAYER_STORED_VARP = 3113;
	...
	public static final int MUSIC_LAST_TRACK = 3885;
	public static final int MUSIC_OVERRIDE_TRACK = 3886;
	...
	public static final int MUSIC_OVERRIDE_AREA = 5400;
	...
	public static final int TRACKING_PLAYTIME_LEAGUES_LAST_LOGIN = 5482;
	public static final int UNIQUE_SNELM_WORN_COUNT = 5483;
	public static final int TALENT_POINTS_EARNED = 5484;
	public static final int TALENT_PERM_1 = 5485;
	public static final int TALENT_POINTS_SPENT = 5486;
	public static final int TALENT_ACTIVE_TEMP_0 = 5487;
	public static final int TALENT_ACTIVE_TEMP_1 = 5488;
	public static final int TALENT_ACTIVE_TEMP_2 = 5489;
	public static final int TALENT_ACTIVE_TEMP_3 = 5490;
	public static final int TALENT_ACTIVE_TEMP_4 = 5491;
	public static final int TALENT_ACTIVE_TEMP_5 = 5492;
	public static final int TALENT_ACTIVE_TEMP_6 = 5493;
	public static final int TALENT_ACTIVE_TEMP_7 = 5494;
	public static final int TALENT_ACTIVE_TEMP_8 = 5495;
	public static final int TALENT_HOTFIX_LATEST = 5497;
	public static final int COMBAT_MASTERY_PERM_0 = 5498;
	public static final int COMBAT_MASTERY_PERM_1 = 5499;
	public static final int COMBAT_MASTERY_PERM_2 = 5500;
	public static final int COMBAT_MASTERY_PERM_3 = 5501;
	public static final int COMBAT_MASTERY_PERM_4 = 5502;
	public static final int COMBAT_MASTERY_PERM_5 = 5503;
	public static final int COMBAT_MASTERY_TEMP_1 = 5504;
	public static final int COMBAT_MASTERY_TEMP_2 = 5505;
	public static final int LEAGUE_DEBUG = 5506;
	public static final int LEAGUE_6_POINTS = 5507;
	public static final int LEAGUE_GUARDIAN_PICKUP_VALUE = 5508;
	public static final int ENDLESS_HARVEST_LAST_CATEGORY = 5509;
	public static final int ENDLESS_HARVEST_LAST_LOC = 5510;
	public static final int BUTLER_COLLECTION_MINUTE = 5512;
	public static final int LEAGUE_RELIC_EFFECT_TOGGLE_1 = 5514;
	public static final int LEAGUE_RELIC_GENERAL_PERM = 5515;
	public static final int LEAGUE_DEFAULT_TELEPORT_LAST_DESTINATION = 5517;
	public static final int LEAGUE_REUSABLE_ITEM_VARP1 = 5523;
	public static final int LEAGUE_REUSABLE_ITEM_VARP2 = 5524;
	public static final int LEAGUE_REUSABLE_ITEM_VARP3 = 5525;
	public static final int LEAGUE_REUSABLE_ITEM_VARP4 = 5526;
	public static final int LEAGUE_REUSABLE_ITEM_VARP5 = 5527;
	public static final int LEAGUE_RELIC_FLASK_OF_FERVOUR_COOLDOWN = 5528;
	public static final int SLAYER_LEAGUE_RELIC_CULLING_SPREE = 5529;
	public static final int LEAGUE_6_TASKS_VARP1 = 5530;
	public static final int LEAGUE_6_TASKS_VARP2 = 5531;
	public static final int LEAGUE_6_TASKS_VARP3 = 5532;
	public static final int LEAGUE_6_TEMP_VARP1 = 5533;
	public static final int LAST_NPC_TARGET_DISTANCE = 5535;
	public static final int LAST_NPC_ELEMENTAL_WEAKNESS = 5536;
	public static final int LEAGUE_RELIC_GENERAL_TEMP = 5545;
	public static final int SAILING_SIDEPANEL_FACILITY_STATES_7 = 5554;
	public static final int SAILING_SIDEPANEL_FACILITY_STATES_8 = 5555;
	public static final int SAILING_SIDEPANEL_FACILITY_STATES_9 = 5556;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_A = 5557;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_B = 5558;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_C = 5559;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_D = 5560;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_E = 5561;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_F = 5562;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_G = 5563;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_H = 5564;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_I = 5565;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_J = 5566;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_K = 5567;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_L = 5568;
	public static final int SAILING_SIDEPANEL_FACILITY_ORDERS_M = 5569;
	public static final int SAILING_BOAT_TELEPORT_BOAT_TO_ME_LAST = 5570;
	public static final int SAILING_BOAT_TELEPORT_ME_TO_BOAT_LAST = 5571;
	public static final int SAILING_SIDEPANEL_FACILITY_STATES_10 = 5572;
	public static final int SAILING_SIDEPANEL_FACILITY_STATES_11 = 5573;
	public static final int SAILING_SIDEPANEL_FACILITY_STATES_12 = 5574;
	public static final int DEADMAN_ALLSTAR_DATA = 5575;
	public static final int DEADMAN_ALLSTAR_DATA_2 = 5576;
	public static final int DEADMAN_ALLSTAR_DATA_3 = 5577;
	public static final int RESURRECTION_COSMETIC_TOGGLES = 5581;
	public static final int LEAGUE_6_REWARDS = 5582;
	public static final int AUTO_BANK_LOOT = 5583;
	public static final int POH_BUTLER_COSMETICS = 5584;
	public static final int PORT_TASKS_BOUNTY_ITEM_COUNTER = 5586;
	public static final int SLAYER_REWARDS_UNLOCKS2 = 5587;
	public static final int AREASOUNDS_OVERRIDE = 5588;
	public static final int OPTION_AREASOUNDS_OVERRIDE = 5589;
	public static final int VAMPYRIUM_SKILLING = 5590;
	public static final int VAMPYRIUM_SKILLING2 = 5591;
	public static final int VAMPYRIUM_SKILLING3 = 5592;
	public static final int VAMPYRIUM_SKILLING4 = 5593;
	public static final int VAMPYRIUM_SKILLING5 = 5594;
	public static final int VAMPYRIUM_SKILLING6 = 5595;
	public static final int ZAROSIAN_MEDAL_MAGIC_TIMER_START = 5605;
	public static final int ZAROSIAN_MEDAL_PRAYER_TIMER_START = 5606;
	public static final int ZAROSIAN_MEDAL_BUFF_BAR = 5607;
	public static final int HUNTING_STYMPHIKE_TRAP_STATUS = 5608;
	public static final int VAMPYRIUM_GENERAL = 5610;
	public static final int FOLLOWER_NPC_SECONDARY = 5612;
	public static final int TOTAL_MAGGOT_KING_KILLS = 5614;
	public static final int MYQ6_PRIMARY = 5618;
	public static final int MYQ6_SECONDARY = 5619;
	public static final int MYQ6_NOPROTECT = 5620;
	public static final int MYQ6_IVANDIS_WRITINGS = 5621;
	public static final int DRAKAN_SUCCESSFUL_DODGE_TRACKER = 5623;
	public static final int CASTLE_DRAKAN_GENERAL_1 = 5624;
	public static final int CASTLE_DRAKAN_GENERAL_2 = 5625;
	public static final int CASTLE_DRAKAN_GENERAL_3 = 5626;
	public static final int CASTLE_DRAKAN_GENERAL_4 = 5627;
	public static final int CASTLE_DRAKAN_GENERAL_5 = 5628;
	public static final int CASTLE_DRAKAN_ROOM_STATUS_1 = 5632;
	public static final int CASTLE_DRAKAN_ROOM_STATUS_2 = 5633;
	public static final int CASTLE_DRAKAN_ROOM_STATUS_3 = 5634;
	public static final int CASTLE_DRAKAN_ROOM_STATUS_4 = 5635;
	public static final int CASTLE_DRAKAN_DOOR_STATUS_1 = 5636;
	public static final int CASTLE_DRAKAN_DOOR_STATUS_2 = 5637;
	public static final int CASTLE_DRAKAN_DOOR_STATUS_3 = 5638;
	public static final int CASTLE_DRAKAN_DOOR_STATUS_4 = 5639;
	public static final int CASTLE_DRAKAN_ENEMY_STATUS_1 = 5640;
	public static final int CASTLE_DRAKAN_ENEMY_STATUS_2 = 5641;
	public static final int CASTLE_DRAKAN_CONSUMABLE_STATUS_1 = 5642;
	public static final int CASTLE_DRAKAN_CONSUMABLE_STATUS_2 = 5643;
	public static final int SANGVESTI_GENERAL = 5644;
	public static final int SANGVESTI_GENERAL_2 = 5645;
	public static final int SOTFA_FOREST_GENERAL = 5661;
	public static final int VAMPIRE_SECONDARY = 5662;
	public static final int AGILITY_SLIDE_XP_COOLDOWN = 5663;
	public static final int MAGGOT_KING_ATTEMPTS = 5665;
	public static final int DRAKAN_ENCOUNTER_ATTEMPTS = 5666;
	public static final int DRAKAN_FINAL_MIN_HP = 5667;
	public static final int SANGVESTI_GENERAL_3 = 5668;
	public static final int SANGVESTI_PLAYER_POS = 5669;
	public static final int SANGVESTI_PLAYER_LAST_DEATH_POS = 5670;
	public static final int AFK_BLOODWOOD_TREE = 5671;
	public static final int CA_TASK_COMPLETED_20 = 5673;
	public static final int WYRMSCRAIG_VARP = 5705;
	public static final int GOAT_PIT_VARP = 5706;
	public static final int GOLEM_CRAFTING_CORE = 5709;
	public static final int GOLEM_CRAFTING_SIDE = 5710;
	public static final int TOTAL_MAD_ANGEL_KILLS = 5712;
	public static final int FFG_PRIMARY = 5715;
	public static final int SLAYER_MODIFIERS = 5719;
	public static final int SLAYER_MORTIMER_TASKS_COMPLETED = 5720;
	public static final int SLAYER_REWARDS_BLOCKED_14 = 5721;
	public static final int SLAYER_MISC_PERM = 5722;
	public static final int SLAYER_MISC_PERM_2 = 5723;
	public static final int SLAYER_MISC_PERM_3 = 5724;
	public static final int SKILLPET_RUNECRAFTING_TRACKING = 5725;
	public static final int TELETAB_LAST_CRAFTED = 5730;
	public static final int TELETAB_LAST_CRAFTED_AMOUNT = 5731;
	public static final int DOG_SELECTION_BREED = 5732;
	public static final int DOG_SELECTION_COLOUR = 5733;
	public static final int DOG_UNLOCKS = 5734;
	public static final int CRAB = 5739;
	public static final int CRAB_SECONDARY = 5740;
	public static final int CRAB_TEMP = 5741;
	public static final int DOGQUEST_MAIN = 5742;
	public static final int SETTINGS_FARMING_PATCH_OVERLAY_COLOUR = 5745;
	public static final int FARMING_COMPOST_TRANSMIT_1 = 5746;
	public static final int FARMING_COMPOST_TRANSMIT_2 = 5747;
	public static final int FARMING_COMPOST_TRANSMIT_3 = 5748;
	public static final int FARMING_COMPOST_TRANSMIT_4 = 5749;
	public static final int FARMING_COMPOST_TRANSMIT_5 = 5750;
	public static final int FARMING_COMPOST_TRANSMIT_6 = 5751;
/* This file is automatically generated. Do not edit. */
}
