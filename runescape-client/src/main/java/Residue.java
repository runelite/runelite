...
public class Residue {
   ...
   Residue() {
      ...
      this.field1665 = new int[this.classification * 8];

      for(var2 = 0; var2 < this.classification * 8; ++var2) {
         this.field1665[var2] = (var1[var2 >> 3] & 1 << (var2 & 7)) != 0?class107.getInt(8):-1;
      }
