...
public abstract class class131 {
   ...
   static void method2833(class224 var0, class224 var1) {
      ...
      if(null != class158.field2604) {
         ...
         var0.method4002("World", var4 + 32, 17, 16777215, -1);
         int var5 = class31.field748 + 390;
         ...
         if(class25.field631[0] == 1 && class25.field627[0] == 1) {
            ...
            class158.field2604[1].method1841(15 + var5, 4);
         }

         var0.method4002("Players", 32 + var5, 17, 16777215, -1);
         var2 = class31.field748 + 500;
         ...
         var0.method4002("Location", var2 + 32, 17, 16777215, -1);
         var3 = class31.field748 + 610;
         ...
         if(class25.field631[0] == 3 && 1 == class25.field627[0]) {
            ...
            class158.field2604[1].method1841(var3 + 15, 4);
         }

         var0.method4002("Type", 32 + var3, 17, 16777215, -1);
      }
      ...
      if(class31.field745 != null) {
         ...
         do {
            var6 = var3;
            var7 = var2;
            if((var2 - 1) * var3 >= class25.field628) {
               --var2;
            }

            if(var2 * (var3 - 1) >= class25.field628) {
               --var3;
            }

            if((var3 - 1) * var2 >= class25.field628) {
               --var3;
            }
         } while(var6 != var3 || var2 != var7);

         var6 = (765 - var2 * var21) / (1 + var2);
         if(var6 > 5) {
            var6 = 5;
         }

         var7 = (480 - var23 * var3) / (var3 + 1);
         if(var7 > 5) {
            var7 = 5;
         }

         int var8 = (765 - var2 * var21 - (var2 - 1) * var6) / 2;
         int var9 = (480 - var3 * var23 - var7 * (var3 - 1)) / 2;
         int var10 = var9 + 23;
         ...
         for(var14 = 0; var14 < class25.field628; ++var14) {
            ...
            if(class140.field2162 >= var11 && class140.field2163 >= var10 && class140.field2162 < var21 + var11 && class140.field2163 < var10 + var23 && var16) {
               ...
               class31.field745[var19].method1725(var11, var10, 128, 16777215);
               var13 = true;
            } else {
               class31.field745[var19].method1674(var11, var10);
            }
            ...
            var0.method4004(Integer.toString(var15.field632), var11 + 15, var10 + var23 / 2 + 5, var18, -1);
         ...
         if(var13) {
            ...
            var1.method4004(class25.field636[class31.field747].field641, class140.field2162, 24 + class140.field2163 + 5 + var1.field3189, 0, -1);
         }
      }
