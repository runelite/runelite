...
public class class234 {
   @ObfuscatedName("b")
   public static final short[] field2762;
   @ObfuscatedName("q")
   public static final short[][] field2756;
   @ObfuscatedName("o")
   public static final short[] field2757;
   @ObfuscatedName("p")
   public static final short[][] field2761;
   @ObfuscatedName("h")
   @ObfuscatedSignature(
      signature = "Llm;"
   )
   static SpritePixels field2759;
   @ObfuscatedName("bj")
   @ObfuscatedSignature(
      signature = "Lld;"
   )
