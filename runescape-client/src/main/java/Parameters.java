...
public class Parameters {
   ...
   static {
      ...
      field3724 = new Parameters("14", "14");
      field3721 = new Parameters("6", "6");
      field3722 = new Parameters("12", "12");
      field3723 = new Parameters("3", "3");
      field3729 = new Parameters("2", "2");
      field3725 = new Parameters("15", "15");
      field3734 = new Parameters("11", "11");
      field3720 = new Parameters("1", "1");
      field3728 = new Parameters("13", "13");
      field3727 = new Parameters("7", "7");
