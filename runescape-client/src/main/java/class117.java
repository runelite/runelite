...
public class class117 extends class119 {
   ...
   public synchronized void method2139(int var1, int var2, int var3) {
      if(var1 == 0) {
         ...
         if(var4 == this.field1703 && var5 == this.field1704) {
            this.field1709 = 0;
         } else {
               ...
               label152: {
                  ...
                  if(this.field1707 < 0) {
                     ...
                     if(var7 >= this.field1705) {
                        this.field1710 += var6 * this.field1705;
                        this.field1705 = 0;
                        break label152;
                     }

                     this.field1710 += var6 * var7;
                     this.field1705 -= var7;
                  } else {
                     if(this.field1710 < var4) {
                        return;
   ...
   int vmethod2291() {
      ...
      if(this.field1705 == 0) {
         var1 -= var1 * this.field1710 / (((class107)super.field1726).field1630.length << 8);
      } else if(this.field1705 >= 0) {
         var1 -= var1 * this.field1706 / ((class107)super.field1726).field1630.length;
      }
   ...
   boolean method2152() {
      ...
      if(var1 == this.field1698 && var2 == this.field1703 && var3 == this.field1704) {
         if(this.field1700 == Integer.MIN_VALUE) {
            this.field1700 = 0;
            this.field1704 = 0;
            this.field1703 = 0;
