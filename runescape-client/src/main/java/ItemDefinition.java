...
public class ItemDefinition extends DualNode {
   ...
   public final ModelData method143(int var1) {
      ...
      if (this.field436 != null && var1 > 1) {
         ...
         if (var3 != -1) {
            return Skills.getItemDefinition(var3).method143(1);
         }
      }
      ...
      if (var4 == null) {
         ...
         if (this.resizeX != 128 || this.resizeY != 128 || this.resizeZ != 128) {
            var4.method215(this.resizeX, this.resizeY, this.resizeZ);
         }
   ...
   public final Model getModel(int var1) {
      ...
      if (var5 != null) {
         ...
         if (var6 == null) {
            ...
            if (this.resizeX != 128 || this.resizeY != 128 || this.resizeZ != 128) {
               var6.method215(this.resizeX, this.resizeY, this.resizeZ);
            }
   ...
   public final boolean method145(boolean var1) {
   ...
   public final ModelData method146(boolean var1) {
      int var2 = this.maleModel;
      int var3 = this.maleModel1;
      int var4 = this.maleModel2;
      if (var1) {
      ...
      if (var2 == -1) {
         ...
         if (!var1 && this.maleOffset != 0) {
            var5.method213(0, this.maleOffset, 0);
         }

         if (var1 && this.femaleOffset != 0) {
            var5.method213(0, this.femaleOffset, 0);
         }
   ...
   public final boolean method147(boolean var1) {
   ...
   public final ModelData method148(boolean var1) {
      int var2 = this.maleHeadModel;
      int var3 = this.maleHeadModel2;
      if (var1) {
         var2 = this.femaleHeadModel;
