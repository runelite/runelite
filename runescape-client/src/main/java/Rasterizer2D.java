...
public class Rasterizer2D extends CacheableNode {
   ...
   public static void method4080(int var0, int var1, int var2, int var3) {
      if(var0 >= field3208 && var0 < field3214) {
         if(var1 < field3211) {
            var2 -= field3211 - var1;
            var1 = field3211;
         }

         if(var1 + var2 > field3213) {
            var2 = field3213 - var1;
         }
   ...
   public static void method4082() {
      field3208 = 0;
      field3211 = 0;
      field3214 = graphicsPixelsWidth;
      field3213 = graphicsPixelsHeight;
   }

   @ObfuscatedName("dk")
   public static void method4083(int var0, int var1, int var2, int var3) {
      if(var0 < 0) {
         var0 = 0;
      }
   ...
   @ObfuscatedName("do")
   public static void method4084(int var0, int var1, int var2, int var3) {
      if(field3208 < var0) {
         field3208 = var0;
      }
   ...
   @ObfuscatedName("dx")
   public static void method4086(int[] var0) {
      field3208 = var0[0];
      field3211 = var0[1];
      field3214 = var0[2];
      field3213 = var0[3];
   ...
   @ObfuscatedName("dr")
   public static void method4087(int var0, int var1, int var2, int var3, int var4) {
      var2 -= var0;
      var3 -= var1;
      if(var3 == 0) {
         if(var2 >= 0) {
            method4097(var0, var1, var2 + 1, var4);
         } else {
            method4097(var0 + var2, var1, -var2 + 1, var4);
         }

      } else if(var2 == 0) {
         if(var3 >= 0) {
            method4080(var0, var1, var3 + 1, var4);
         } else {
            method4080(var0, var1 + var3, -var3 + 1, var4);
         }
         ...
         if(var2 > var3) {
            ...
            while(var0 <= var2) {
               var6 = var1 >> 16;
               if(var6 >= field3211 && var6 < field3213) {
            ...
            while(var1 <= var3) {
               var6 = var0 >> 16;
               if(var6 >= field3208 && var6 < field3214) {
   ...
   @ObfuscatedName("df")
   public static void method4089(int var0, int var1, int var2, int var3, int var4) {
      if(var0 < field3208) {
         var2 -= field3208 - var0;
         var0 = field3208;
      }
      ...
      if(var0 + var2 > field3214) {
         var2 = field3214 - var0;
      }

      if(var1 + var3 > field3213) {
         var3 = field3213 - var1;
      }
   ...
   @ObfuscatedName("dw")
   public static void method4090(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
   ...
   @ObfuscatedName("dh")
   public static void method4091(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = var4 == var5 && var6 == var7?-1:65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   @ObfuscatedName("ds")
   public static void method4092(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = 65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   @ObfuscatedName("dj")
   public static void method4093(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = 65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   public static void method4094(int var0, int var1, int var2, int var3, int var4, int var5) {
      int var6 = 0;
      int var7 = 65536 / var3;
      if(var0 < field3208) {
         var2 -= field3208 - var0;
   ...
   @ObfuscatedName("da")
   public static void method4095(int var0, int var1, int var2, int var3, int var4) {
      method4097(var0, var1, var2, var4);
      method4097(var0, var1 + var3 - 1, var2, var4);
      method4080(var0, var1, var3, var4);
      method4080(var0 + var2 - 1, var1, var3, var4);
   }

   @ObfuscatedName("dv")
   public static void method4096(int var0, int var1, int var2, int var3, int var4, int var5) {
      method4098(var0, var1, var2, var4, var5);
      method4098(var0, var1 + var3 - 1, var2, var4, var5);
      if(var3 >= 3) {
         method4100(var0, var1 + 1, var3 - 2, var4, var5);
         method4100(var0 + var2 - 1, var1 + 1, var3 - 2, var4, var5);
      }

   }

   @ObfuscatedName("dc")
   public static void method4097(int var0, int var1, int var2, int var3) {
      if(var1 >= field3211 && var1 < field3213) {
         if(var0 < field3208) {
            var2 -= field3208 - var0;
            var0 = field3208;
         }
   ...
   @ObfuscatedName("de")
   static void method4098(int var0, int var1, int var2, int var3, int var4) {
      if(var1 >= field3211 && var1 < field3213) {
         if(var0 < field3208) {
            var2 -= field3208 - var0;
            var0 = field3208;
   ...
   @ObfuscatedName("dm")
   static void method4100(int var0, int var1, int var2, int var3, int var4) {
      if(var0 >= field3208 && var0 < field3214) {
         if(var1 < field3211) {
            var2 -= field3211 - var1;
            var1 = field3211;
   ...
   @ObfuscatedName("dp")
   public static void method4101(int var0, int var1, int var2, int var3, int var4, int var5) {
      if(var0 < field3208) {
         var2 -= field3208 - var0;
         var0 = field3208;
      }
   ...
   @ObfuscatedName("dy")
   public static void method4125(int[] var0) {
      var0[0] = field3208;
      var0[1] = field3211;
      var0[2] = field3214;
      var0[3] = field3213;
   ...
   @ObfuscatedName("dz")
   public static void method4126(int var0, int var1, int var2, int[] var3, int[] var4) {
