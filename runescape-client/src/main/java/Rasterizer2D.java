...
public class Rasterizer2D extends CacheableNode {
   ...
   @ObfuscatedName("db")
   public static void method5055(int var0, int var1, int var2, int var3) {
   ...
   @ObfuscatedName("dd")
   public static void method5045(int var0, int var1, int var2, int var3, int var4) {
   ...
   @ObfuscatedName("dg")
   public static void method5053(int var0, int var1, int var2, int var3) {
   ...
   @ObfuscatedName("dy")
   public static void method5039(int var0, int var1, int var2, int var3, int var4) {
      if(var4 != 0) {
         if(var4 == 256) {
            method5047(var0, var1, var2, var3);
         } else {
            if(var2 < 0) {
               var2 = -var2;
            }
   ...
   public static void drawRectangle(int var0, int var1, int var2, int var3, int var4) {
      method5053(var0, var1, var2, var4);
      method5053(var0, var3 + var1 - 1, var2, var4);
      method5055(var0, var1, var3, var4);
      method5055(var0 + var2 - 1, var1, var3, var4);
   }
   ...
   public static void method5050(int var0, int var1, int var2, int var3, int var4, int var5, byte[] var6, int var7) {
   ...
   @ObfuscatedName("dl")
   static void method5047(int var0, int var1, int var2, int var3) {
      if(var2 == 0) {
         method5034(var0, var1, var3);
      } else {
         if(var2 < 0) {
            var2 = -var2;
         }
   ...
   public static void drawLine(int var0, int var1, int var2, int var3, int var4) {
      ...
      if(var3 == 0) {
         if(var2 >= 0) {
            method5053(var0, var1, var2 + 1, var4);
         } else {
            method5053(var0 + var2, var1, -var2 + 1, var4);
         }

      } else if(var2 == 0) {
         if(var3 >= 0) {
            method5055(var0, var1, var3 + 1, var4);
         } else {
            method5055(var0, var3 + var1, -var3 + 1, var4);
         }
   ...
   @ObfuscatedName("ea")
   static void method5034(int var0, int var1, int var2) {
   ...
   @ObfuscatedName("dc")
   public static void method5052(int var0, int var1, int var2, int var3, int var4, int var5) {
      int var6 = 0;
      int var7 = 65536 / var3;
      if(var0 < draw_region_x) {
         var2 -= draw_region_x - var0;
   ...
   @ObfuscatedName("es")
   public static void method5059(int var0, int var1, int var2, int[] var3, int[] var4) {
   ...
   @ObfuscatedName("dz")
   public static void method5038(int var0, int var1, int var2, int var3, int var4, int var5) {
      method5054(var0, var1, var2, var4, var5);
      method5054(var0, var3 + var1 - 1, var2, var4, var5);
      if(var3 >= 3) {
         method5042(var0, var1 + 1, var3 - 2, var4, var5);
         method5042(var0 + var2 - 1, var1 + 1, var3 - 2, var4, var5);
      }
   ...
   @ObfuscatedName("dw")
   public static void method5048(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = 65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   @ObfuscatedName("ds")
   public static void method5075(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
   ...
   @ObfuscatedName("dv")
   public static void method5076(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = 65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   @ObfuscatedName("dq")
   public static void method5111(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = var5 == var4 && var7 == var6?-1:65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   @ObfuscatedName("du")
   static void method5054(int var0, int var1, int var2, int var3, int var4) {
      if(var1 >= drawingAreaTop && var1 < drawingAreaRight) {
         if(var0 < draw_region_x) {
            var2 -= draw_region_x - var0;
            var0 = draw_region_x;
   ...
   @ObfuscatedName("ev")
   static void method5042(int var0, int var1, int var2, int var3, int var4) {
      if(var0 >= draw_region_x && var0 < drawingAreaBottom) {
         if(var1 < drawingAreaTop) {
            var2 -= drawingAreaTop - var1;
            var1 = drawingAreaTop;
