...
public class class64 {
   ...
   static final void method1094(ModIcon var0) {
      ...
      int var2;
      for(var2 = 0; var2 < class30.field437.length; ++var2) {
         class30.field437[var2] = 0;
      }

      int var8;
      for(var2 = 0; var2 < 5000; ++var2) {
         var8 = (int)(Math.random() * 128.0D * (double)var1);
         class30.field437[var8] = (int)(Math.random() * 256.0D);
      }
      ...
      for(var2 = 0; var2 < 20; ++var2) {
         for(var8 = 1; var8 < var1 - 1; ++var8) {
            for(var4 = 1; var4 < 127; ++var4) {
               var5 = (var8 << 7) + var4;
               Preferences.field1289[var5] = (class30.field437[var5 + 128] + class30.field437[var5 - 128] + class30.field437[var5 - 1] + class30.field437[var5 + 1]) / 4;
            }
         }

         int[] var3 = class30.field437;
         class30.field437 = Preferences.field1289;
