...
public final class Client extends GameEngine {
   ...
   final void method1239() {
      ...
      try {
         ...
         if(loginState == 2) {
            field952.method1949();
            PacketNode var4 = class11.method60();
            var4.clientPacket = null;
            var4.field2427 = 0;
            var4.packetBuffer = new PacketBuffer(5000);
            var4.packetBuffer.putByte(class168.field2407.field2408);
         ...
         if(loginState == 5) {
            ...
            PacketNode var6 = class11.method60();
            var6.clientPacket = null;
            var6.field2427 = 0;
            var6.packetBuffer = new PacketBuffer(5000);
            var6.packetBuffer.offset = 0;
            if(gameState == 40) {
               var6.packetBuffer.putByte(class168.field2404.field2408);
            } else {
               var6.packetBuffer.putByte(class168.field2406.field2408);
            }

            var6.packetBuffer.putShort(0);
            int var7 = var6.packetBuffer.offset;
            var6.packetBuffer.putInt(157);
            var6.packetBuffer.putBytes(var3.payload, 0, var3.offset);
            int var8 = var6.packetBuffer.offset;
            var6.packetBuffer.putString(class91.username);
            var6.packetBuffer.putByte((isResized?1:0) << 1 | (lowMemory?1:0));
            var6.packetBuffer.putShort(Tile.canvasWidth);
            var6.packetBuffer.putShort(class89.canvasHeight);
            class214.method4045(var6.packetBuffer);
            var6.packetBuffer.putString(class40.sessionToken);
            var6.packetBuffer.putInt(class36.field480);
            ...
            var6.packetBuffer.putByte(class175.field2443);
            var6.packetBuffer.putInt(0);
            var6.packetBuffer.putInt(Varcs.indexInterfaces.crc);
            var6.packetBuffer.putInt(class31.indexSoundEffects.crc);
            var6.packetBuffer.putInt(GrandExchangeOffer.configsIndex.crc);
            var6.packetBuffer.putInt(class149.field2115.crc);
            var6.packetBuffer.putInt(Tile.field1838.crc);
            var6.packetBuffer.putInt(class56.indexMaps.crc);
            var6.packetBuffer.putInt(class21.indexTrack1.crc);
            var6.packetBuffer.putInt(class48.indexModels.crc);
            var6.packetBuffer.putInt(class96.indexSprites.crc);
            var6.packetBuffer.putInt(class12.indexTextures.crc);
            var6.packetBuffer.putInt(AbstractSoundSystem.field1563.crc);
            var6.packetBuffer.putInt(class236.indexTrack2.crc);
            var6.packetBuffer.putInt(class43.indexScripts.crc);
            var6.packetBuffer.putInt(class27.field382.crc);
            var6.packetBuffer.putInt(WorldMapType2.vorbisIndex.crc);
            var6.packetBuffer.putInt(class177.field2452.crc);
            var6.packetBuffer.putInt(RSCanvas.indexWorldMap.crc);
            var6.packetBuffer.encryptXtea(var20, var8, var6.packetBuffer.offset);
            var6.packetBuffer.method3410(var6.packetBuffer.offset - var7);
         ...
         if(loginState == 8) {
            ...
            if(loginState == 9 && var1.available() >= 13) {
               ...
               var2.offset = 0;
               ServerPacket[] var5 = DecorativeObject.method3001();
               ...
               field952.packetId = field952.field1470.packetType;
               var1.read(var2.payload, 0, 2);
               var2.offset = 0;
               field952.packetId = var2.readUnsignedShort();
            ...
            if(loginState == 10) {
               if(var1.available() >= field952.packetId) {
                  var2.offset = 0;
            ...
            while(true) {
               ...
               if(!var27) {
                  ...
                  if(field970.field3776) {
                     ...
                     field970.method5105(var12.packetBuffer);
                     var12.packetBuffer.method3287(var12.packetBuffer.offset - var13);
                  ...
                  synchronized(class5.field31.field804) {
                     if(!field1080) {
                        ...
                        for(var5 = 0; var5 < class5.field31.field811 && var28.packetBuffer.offset - var3 < 240; ++var5) {
                           ++var4;
                           ...
                           if(var7 == field1090 && var6 == field1054) {
                              ...
                              if(field882 < 8 && var9 >= -32 && var9 <= 31 && var10 >= -32 && var10 <= 31) {
                                 var9 += 32;
                                 var10 += 32;
                                 var28.packetBuffer.putShort(var10 + (field882 << 12) + (var9 << 6));
                                 field882 = 0;
                              } else if(field882 < 8) {
                                 var28.packetBuffer.put24bitInt((field882 << 19) + var8 + 8388608);
                                 field882 = 0;
                              } else {
                                 var28.packetBuffer.putInt((field882 << 19) + var8 + -1073741824);
                                 field882 = 0;
                              }
                           }
                        }

                        var28.packetBuffer.method3287(var28.packetBuffer.offset - var3);
                  ...
                  if(MouseInput.field713 == 1 || !Item.field1399 && MouseInput.field713 == 4 || MouseInput.field713 == 2) {
                     ...
                     var16.packetBuffer.putShort((MouseInput.field713 == 2?1:0) + (var5 << 1));
                  ...
                  if(KeyFocusListener.field605 > 0) {
                     ...
                     for(var5 = 0; var5 < KeyFocusListener.field605; ++var5) {
                        ...
                        field1052 = var17;
                        var12.packetBuffer.method3327((int)var19);
                        var12.packetBuffer.method3311(KeyFocusListener.field614[var5]);
                     }

                     var12.packetBuffer.method3410(var12.packetBuffer.offset - var13);
                     field952.method1951(var12);
                  }
                  ...
                  if(field983 && field939 <= 0) {
                     ...
                     var12.packetBuffer.method3319(field932);
                     var12.packetBuffer.method3340(mapAngle);
                     field952.method1951(var12);
                  }
                  ...
                  if(class44.method687() && KeyFocusListener.field618[82] && KeyFocusListener.field618[81] && field1047 != 0) {
                     ...
                     if(var3 != class48.localPlayer.field852) {
                        ...
                        var16.packetBuffer.putShort(var5);
                        var16.packetBuffer.method3340(var4);
                        var16.packetBuffer.putByte(var3);
                        field952.method1951(var16);
                     }
                                       ...
                                       do {
                                          ...
                                          if(var38 == null) {
                                                ...
                                                if(MouseInput.field706 == 0) {
                                                   if(field966) {
                                                      if(ClanMember.field864 == class111.field1586 && field894 != field965) {
                                                         ...
                                                         PacketNode var24 = Actor.method1628(ClientPacket.field2390, field952.field1478);
                                                         var24.packetBuffer.method3289(ClanMember.field864.id);
                                                         var24.packetBuffer.method3403(var30);
                                                         var24.packetBuffer.method3319(field965);
                                                         var24.packetBuffer.method3340(field894);
                                             ...
                                             if(Region.method2780()) {
                                                ...
                                                PacketNode var44 = Actor.method1628(ClientPacket.field2400, field952.field1478);
                                                var44.packetBuffer.putByte(5);
                                                var44.packetBuffer.method3340(var4 + ItemLayer.baseY);
                                                var44.packetBuffer.method3340(var3 + ItemLayer.baseX);
                                                var44.packetBuffer.method3374(KeyFocusListener.field618[82]?(KeyFocusListener.field618[81]?2:1):0);
               ...
               var28.packetBuffer.putByte(0);
               var3 = var28.packetBuffer.offset;
               World.encodeClassVerifier(var28.packetBuffer);
               var28.packetBuffer.method3287(var28.packetBuffer.offset - var3);
               field952.method1951(var28);
            }
         }
      ...
      if(var2 == null) {
         ...
         try {
            ...
            if(var1.field1470 == null) {
               ...
               var1.field1474 = true;
               ServerPacket[] var4 = DecorativeObject.method3001();
               ...
               var1.packetId = var1.field1470.packetType;
            }
            ...
            if(var1.packetId == -1) {
               ...
               var1.packetId = var3.payload[0] & 255;
            }
            ...
            if(var1.packetId == -2) {
               ...
               var3.offset = 0;
               var1.packetId = var3.readUnsignedShort();
            }

            if(!var2.method3101(var1.packetId)) {
               return false;
            }

            var3.offset = 0;
            var2.read(var3.payload, 0, var1.packetId);
            var1.field1475 = 0;
            field970.method5106();
            ...
            int var23;
            Widget var63;
            if(ServerPacket.field2251 == var1.field1470) {
            ...
            int var62;
            if(ServerPacket.field2281 == var1.field1470) {
            ...
            if(ServerPacket.field2289 == var1.field1470) {
            ...
            if(ServerPacket.field2284 == var1.field1470) {
               class35.method542();
            ...
            if(ServerPacket.field2239 == var1.field1470) {
            ...
            if(ServerPacket.field2230 == var1.field1470) {
               ScriptVarType.method18(class169.field2410);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2283 == var1.field1470) {
            ...
            if(ServerPacket.field2279 == var1.field1470) {
            ...
            WidgetNode var80;
            if(ServerPacket.field2244 == var1.field1470) {
            ...
            if(ServerPacket.field2261 == var1.field1470) {
               ScriptVarType.method18(class169.field2415);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2276 == var1.field1470) {
            ...
            if(ServerPacket.field2277 == var1.field1470) {
            ...
            boolean var81;
            if(ServerPacket.field2282 == var1.field1470) {
            ...
            if(ServerPacket.field2299 == var1.field1470) {
               class35.method542();
            ...
            if(ServerPacket.field2294 == var1.field1470) {
            ...
            int var10;
            int var64;
            if(ServerPacket.field2266 == var1.field1470) {
               field1097 = true;
            ...
            Widget var91;
            if(ServerPacket.field2253 == var1.field1470) {
               var23 = var3.readInt();
            ...
            int var68;
            boolean var76;
            if(ServerPacket.field2300 == var1.field1470) {
               while(var3.offset < var1.packetId) {
            ...
            if(ServerPacket.field2267 == var1.field1470) {
               if(widgetRoot != -1) {
                  var23 = widgetRoot;
            ...
            String var58;
            if(ServerPacket.field2236 == var1.field1470) {
            ...
            boolean var61;
            if(ServerPacket.field2287 == var1.field1470) {
               while(var3.offset < var1.packetId) {
                  var23 = var3.readUnsignedByte();
                  var61 = (var23 & 1) == 1;
                  var6 = var3.readString();
            ...
            if(ServerPacket.field2302 == var1.field1470) {
               class82.method1744(var3, var1.packetId);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2297 == var1.field1470) {
               var23 = var3.readInt();
               ...
               for(; var3.offset < var1.packetId; class10.setItemTableSlot(var5, var62, var64 - 1, var9)) {
            ...
            Widget var25;
            if(ServerPacket.field2252 == var1.field1470) {
            ...
            if(ServerPacket.field2274 == var1.field1470) {
            ...
            if(ServerPacket.field2248 == var1.field1470) {
               class94.playerIndexesCount = 0;
            ...
            int var11;
            long var31;
            if(ServerPacket.field2242 == var1.field1470) {
               var23 = var3.offset + var1.packetId;
               var5 = var3.readUnsignedShort();
               var24 = var3.readUnsignedShort();
               if(var5 != widgetRoot) {
                  widgetRoot = var5;
            ...
            if(ServerPacket.field2241 == var1.field1470) {
               ScriptVarType.method18(class169.field2412);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2254 == var1.field1470) {
               var23 = var3.readInt();
               var5 = var3.method3322();
               if(var5 == 65535) {
                  var5 = -1;
            ...
            if(ServerPacket.field2280 == var1.field1470) {
               var23 = var3.readUnsignedByte();
            ...
            if(ServerPacket.field2259 == var1.field1470) {
            ...
            if(ServerPacket.field2298 == var1.field1470) {
               class41.method599(true, var3);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2296 == var1.field1470) {
               var23 = var3.readInt();
               var5 = var3.readUnsignedShort();
               if(var23 < -70000) {
                  var5 += 32768;
            ...
            if(ServerPacket.field2295 == var1.field1470) {
            ...
            if(ServerPacket.field2292 == var1.field1470) {
               var23 = var3.readUnsignedShort();
               if(var23 == 65535) {
                  var23 = -1;
               }
            ...
            if(ServerPacket.field2291 == var1.field1470) {
            ...
            if(ServerPacket.field2233 == var1.field1470) {
               ScriptVarType.method18(class169.field2413);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2246 == var1.field1470) {
               var58 = var3.readString();
            ...
            if(ServerPacket.field2257 == var1.field1470) {
               var23 = var3.method3322();
            ...
            Widget var89;
            if(ServerPacket.field2285 == var1.field1470) {
            ...
            if(ServerPacket.field2220 == var1.field1470) {
            ...
            if(ServerPacket.field2288 == var1.field1470) {
            ...
            if(ServerPacket.field2243 == var1.field1470) {
               var23 = var3.readInt();
            ...
            if(ServerPacket.field2275 == var1.field1470) {
               WallObject.xteaChanged(false, var1.field1469);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2245 == var1.field1470) {
               var23 = var3.readUnsignedShortOb1();
               widgetRoot = var23;
               this.method1248(false);
            ...
            if(ServerPacket.field2286 == var1.field1470) {
               class35.method542();
            ...
            if(ServerPacket.field2293 == var1.field1470) {
               var23 = var3.readUnsignedShortOb1();
               var5 = var3.method3292();
            ...
            if(ServerPacket.field2227 == var1.field1470) {
               ScriptVarType.method18(class169.field2418);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2223 == var1.field1470) {
               class181.method3514();
               var1.field1470 = null;
               return false;
            }

            if(ServerPacket.field2225 == var1.field1470) {
               var23 = var3.readInt();
            ...
            if(ServerPacket.field2269 == var1.field1470) {
               var23 = var3.readInt();
               var5 = var3.readInt();
               var24 = Renderable.method2972();
               PacketNode var79 = Actor.method1628(ClientPacket.field2357, field952.field1478);
               var79.packetBuffer.method3311(GameEngine.FPS);
               var79.packetBuffer.method3403(var24);
               var79.packetBuffer.method3289(var23);
               var79.packetBuffer.method3295(var5);
               field952.method1951(var79);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2250 == var1.field1470) {
               var23 = var3.method3292();
            ...
            long var37;
            int var40;
            if(ServerPacket.field2272 == var1.field1470) {
               var58 = var3.readString();
               var33 = var3.readLong();
            ...
            if(ServerPacket.field2235 == var1.field1470) {
            ...
            if(ServerPacket.field2234 == var1.field1470) {
               ScriptVarType.method18(class169.field2414);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2232 == var1.field1470) {
               class13.method81(var3.readString());
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2222 == var1.field1470) {
            ...
            if(ServerPacket.field2260 == var1.field1470) {
               var23 = var3.method3322();
            ...
            if(ServerPacket.field2255 == var1.field1470) {
               field1097 = true;
            ...
            if(ServerPacket.field2247 == var1.field1470) {
               var23 = var3.readUnsignedShortOb1();
               if(var23 == 65535) {
                  var23 = -1;
               }
            ...
            if(ServerPacket.field2262 == var1.field1470) {
               var23 = var3.method3324();
               var5 = var3.method3331();
               var63 = PendingSpawn.method1612(var5);
            ...
            if(ServerPacket.field2249 == var1.field1470) {
               class41.method599(false, var3);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2290 == var1.field1470) {
               ScriptVarType.method18(class169.field2417);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2265 == var1.field1470) {
               field1097 = false;
            ...
            if(ServerPacket.field2238 == var1.field1470) {
               class56.field655 = var3.method3407();
               GameObject.field2105 = var3.method3407();
            ...
            if(ServerPacket.field2240 == var1.field1470) {
               field1021 = 1;
               field1042 = cycleCntr;
               var1.field1470 = null;
               return true;
            ...
            if(ServerPacket.field2258 == var1.field1470) {
               var81 = var3.readUnsignedByte() == 1;
               if(var81) {
            ...
            if(ServerPacket.field2256 == var1.field1470) {
            ...
            String var85;
            if(ServerPacket.field2301 == var1.field1470) {
            ...
            if(ServerPacket.field2264 == var1.field1470) {
               var3.offset += 28;
               if(var3.checkCrc()) {
            ...
            int var73;
            if(ServerPacket.field2278 == var1.field1470) {
               var23 = var1.packetId;
            ...
            if(ServerPacket.field2228 == var1.field1470) {
               ScriptVarType.method18(class169.field2416);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2263 == var1.field1470) {
               var23 = var3.method3292();
               var26 = var3.readString();
               var63 = PendingSpawn.method1612(var23);
            ...
            if(ServerPacket.field2226 == var1.field1470) {
               var23 = var3.method3324();
               var5 = var3.method3331();
               var63 = PendingSpawn.method1612(var5);
            ...
            if(ServerPacket.field2231 == var1.field1470) {
            ...
            long var45;
            int var47;
            if(ServerPacket.field2271 == var1.field1470) {
               field1043 = cycleCntr;
               if(var1.packetId == 0) {
                  clanChatOwner = null;
                  clanChatName = null;
            ...
            if(ServerPacket.field2270 == var1.field1470) {
               var58 = var3.readString();
               var5 = var3.readUnsignedShort();
            ...
            if(ServerPacket.field2221 == var1.field1470) {
               WallObject.xteaChanged(true, var1.field1469);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2229 == var1.field1470) {
               ScriptVarType.method18(class169.field2411);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2268 == var1.field1470) {
               Huffman.field2432 = VarPlayerType.method4465(var3.readUnsignedByte());
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2273 == var1.field1470) {
               var58 = var3.readString();
            ...
            if(ServerPacket.field2237 == var1.field1470) {
               ScriptVarType.method18(class169.field2419);
               var1.field1470 = null;
               return true;
            }

            if(ServerPacket.field2224 == var1.field1470) {
            ...
            class33.method396("" + (var1.field1470 != null?var1.field1470.packetId:-1) + "," + (var1.field1476 != null?var1.field1476.packetId:-1) + "," + (var1.field1477 != null?var1.field1477.packetId:-1) + "," + var1.packetId, (Throwable)null);
            class181.method3514();
         } catch (IOException var56) {
            WidgetNode.method1156();
         } catch (Exception var57) {
            var26 = "" + (var1.field1470 != null?var1.field1470.packetId:-1) + "," + (var1.field1476 != null?var1.field1476.packetId:-1) + "," + (var1.field1477 != null?var1.field1477.packetId:-1) + "," + var1.packetId + "," + (class48.localPlayer.pathX[0] + ItemLayer.baseX) + "," + (class48.localPlayer.pathY[0] + ItemLayer.baseY) + ",";

            for(var24 = 0; var24 < var1.packetId && var24 < 50; ++var24) {
         ...
         if(MouseInput.field706 == 0) {
            if(field1063) {
               ...
               if(field1041 != null) {
                  ...
                  if(var17 != null) {
                     PacketNode var18 = Actor.method1628(ClientPacket.field2330, field952.field1478);
                     var18.packetBuffer.method3319(field1041.itemId);
                     var18.packetBuffer.method3295(field1041.id);
                     var18.packetBuffer.putShortLE(field1022.itemId);
                     var18.packetBuffer.method3319(field1041.index);
                     var18.packetBuffer.putInt(field1022.id);
                     var18.packetBuffer.putShortLE(field1022.index);
