      ...
      if(var0 == 3600) {
         ...
         if(var0 == 3601) {
            ...
            if(var0 == 3604) {
               ...
               Client.secretCipherBuffer1.putByte(class36.method753(var10) + 1);
               Client.secretCipherBuffer1.method2504(var10);
               Client.secretCipherBuffer1.method2499(var4);
               return 1;
            } else if(var0 == 3605) {
               var10 = class32.scriptStringStack[--class32.scriptStringStackSize];
                     ...
                     if(var14 != null) {
                        for(var5 = 0; var5 < Client.friendCount; ++var5) {
                           ...
                           if(TextureProvider.method1474(var10, var14, var7, var8)) {
                              ...
                              Client.secretCipherBuffer1.putByte(class36.method753(var10));
                              Client.secretCipherBuffer1.method2504(var10);
                              break;
                           }
                        }
