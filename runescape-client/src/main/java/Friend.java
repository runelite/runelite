...
public class Friend {
   ...
   public static void method1118(File var0, File var1) {
      try {
         ...
         var3.method3139(var0.getPath());
         if(var1 != null) {
            var3.method3139("");
         }

         var2.method2363(var3.payload, 0, var3.offset);
         var2.method2381();
   ...
   static final void method1119(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      if(var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
         if(Client.field930 && var0 != WallObject.plane) {
            return;
         }
         ...
         if(var7 != 0) {
            ...
            if(var1 == 0) {
               ...
               if(var12.field3463 != 0) {
                  Client.collisionMaps[var0].method3013(var2, var3, var35, var36, var12.field3456);
               }
            }
            ...
            if(var1 == 2) {
               ...
               if(var12.field3463 != 0) {
                  Client.collisionMaps[var0].method3014(var2, var3, var12.sizeX, var12.sizeY, var36, var12.field3456);
               }
            }
            ...
            if(var1 == 3) {
               ...
               var12 = class251.getObjectDefinition(var34);
               if(var12.field3463 == 1) {
                  Client.collisionMaps[var0].method3024(var2, var3);
               }
            }
         }
         ...
         if(var4 >= 0) {
            ...
            if(var6 == 22) {
               ...
               if(var14.field3463 == 1) {
                  var13.method3019(var2, var3);
               }
               ...
               if(var6 >= 12) {
                  ...
                  if(var14.field3463 != 0) {
                     var13.method3008(var2, var3, var15, var16, var14.field3456);
                  }
               } else if(var6 == 0) {
                  if(var14.animationId == -1 && var14.impostorIds == null) {
                  ...
                  var37.method2675(var0, var2, var3, var22, (Renderable)var27, (Renderable)null, class61.field775[var5], 0, var25, var26);
                  if(var14.field3463 != 0) {
                     var13.method3023(var2, var3, var6, var5, var14.field3456);
                  }
               } else if(var6 == 1) {
                  if(var14.animationId == -1 && var14.impostorIds == null) {
                  ...
                  var37.method2675(var0, var2, var3, var22, (Renderable)var27, (Renderable)null, class61.field776[var5], 0, var25, var26);
                  if(var14.field3463 != 0) {
                     var13.method3023(var2, var3, var6, var5, var14.field3456);
                  }
               } else {
                  ...
                  if(var6 == 2) {
                     ...
                     var37.method2675(var0, var2, var3, var22, (Renderable)var28, (Renderable)var29, class61.field775[var5], class61.field775[var32], var25, var26);
                     if(var14.field3463 != 0) {
                        var13.method3023(var2, var3, var6, var5, var14.field3456);
                     }
                  } else if(var6 == 3) {
                     ...
                     var37.method2676(var0, var2, var3, var22, (Renderable)var27, (Renderable)null, class61.field775[var5], 0, 0, 0, var25, var26);
                  } else {
                     int var33;
                     if(var6 == 5) {
                        var32 = 16;
                        ...
                        var37.method2676(var0, var2, var3, var22, (Renderable)var29, (Renderable)null, class61.field775[var5], 0, class61.field777[var5] * var32, class61.field778[var5] * var32, var25, var26);
                     } else if(var6 == 6) {
                        var32 = 8;
                        var33 = var37.method2692(var0, var2, var3);
                        if(var33 != 0) {
                        ...
                        var37.method2676(var0, var2, var3, var22, (Renderable)var29, (Renderable)null, 256, var5, class61.field772[var5] * var32, class61.field786[var5] * var32, var25, var26);
                     } else if(var6 == 7) {
                        var33 = var5 + 2 & 3;
                        if(var14.animationId == -1 && var14.impostorIds == null) {
                        ...
                        var37.method2676(var0, var2, var3, var22, (Renderable)var27, (Renderable)null, 256, var33, 0, 0, var25, var26);
                     } else if(var6 == 8) {
                        var32 = 8;
                        var33 = var37.method2692(var0, var2, var3);
                        if(var33 != 0) {
                        ...
                        var37.method2676(var0, var2, var3, var22, (Renderable)var29, (Renderable)var30, 256, var5, class61.field772[var5] * var32, class61.field786[var5] * var32, var25, var26);
                     }
                  }
               }
            } else {
