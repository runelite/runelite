...
public class class145 {
   ...
   public int method2647(byte[] var1, int var2, int var3, byte[] var4, int var5) {
      int var6 = 0;
      int var7 = var5 << 3;
      ...
      for(var3 += var2; var2 < var3; ++var2) {
         ...
         byte var10 = this.field2022[var8];
         if(var10 == 0) {
   ...
   @ObfuscatedSignature(
      signature = "([BI[BIII)I",
      garbageValue = "1079068960"
   )
   public int method2648(byte[] var1, int var2, byte[] var3, int var4, int var5) {
      if(var5 == 0) {
         return 0;
      } else {
         int var6 = 0;
