...
public class PlayerComposition {
      ...
      if(this.transformedNpcId != -1) {
         ...
         if(var15 == null) {
            ...
            for(int var10 = 0; var10 < 12; ++var10) {
               ...
               if(var11 >= 512 && !AbstractByteBuffer.getItemDefinition(var11 - 512).readyWorn(this.isFemale)) {
                  var9 = true;
               }
            }
            ...
            if(var15 == null) {
               ...
               for(int var12 = 0; var12 < 12; ++var12) {
                  ...
                  if(var13 >= 512) {
                     var14 = AbstractByteBuffer.getItemDefinition(var13 - 512).getWornModelData(this.isFemale);
                     if(var14 != null) {
                        var16[var11++] = var14;
                     }
                  }
               ...
               for(var13 = 0; var13 < 5; ++var13) {
                  if(this.bodyPartColours[var13] < colorsToReplace[var13].length) {
                     var18.recolor(class18.colorsToFind[var13], colorsToReplace[var13][this.bodyPartColours[var13]]);
                  }

                  if(this.bodyPartColours[var13] < field2620[var13].length) {
                     var18.recolor(NPC.field1398[var13], field2620[var13][this.bodyPartColours[var13]]);
                  }
               }
   ...
   ModelData method3959() {
      if(this.transformedNpcId != -1) {
         ...
         for(int var2 = 0; var2 < 12; ++var2) {
            ...
            if(var3 >= 512 && !AbstractByteBuffer.getItemDefinition(var3 - 512).method4587(this.isFemale)) {
               var1 = true;
            }
         }
         ...
         if(var1) {
            ...
            for(int var4 = 0; var4 < 12; ++var4) {
               ...
               if(var5 >= 512) {
                  var6 = AbstractByteBuffer.getItemDefinition(var5 - 512).method4588(this.isFemale);
                  if(var6 != null) {
                     var7[var3++] = var6;
                  }
               }
            ...
            for(var5 = 0; var5 < 5; ++var5) {
               if(this.bodyPartColours[var5] < colorsToReplace[var5].length) {
                  var8.recolor(class18.colorsToFind[var5], colorsToReplace[var5][this.bodyPartColours[var5]]);
               }

               if(this.bodyPartColours[var5] < field2620[var5].length) {
                  var8.recolor(NPC.field1398[var5], field2620[var5][this.bodyPartColours[var5]]);
               }
            }
   ...
   public int method3938() {
      return this.transformedNpcId == -1?this.equipmentIds[1] + (this.equipmentIds[0] << 15) + (this.bodyPartColours[4] << 20) + (this.bodyPartColours[0] << 25) + (this.equipmentIds[8] << 10) + (this.equipmentIds[11] << 5):305419896 + class35.getNpcDefinition(this.transformedNpcId).id;
   }
      ...
      if(var1 > Client.field937) {
         ...
         for(var1 = 0; var1 < Client.pendingNpcFlagsCount; ++var1) {
            ...
            if((var14 & 32) != 0) {
               ...
               var7 = var13.x - (var5 - KeyFocusListener.baseX - KeyFocusListener.baseX) * 64;
