...
public class VorbisFloor {
	...
	static {
		field1358 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field1365 = new int[var5];
			this.field1365[0] = 0;
			this.field1365[1] = 1 << var4;
			var5 = 2;
			...
			for (var9 = 0; var9 < var2; ++var9) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field1365[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field1359 == null || field1359.length < var5) {
				field1359 = new int[var5];
				field1366 = new int[var5];
				field1367 = new boolean[var5];
			}
	...
	@ObfuscatedName("w")
	void method2403(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field1359[var1];
			int var5 = field1366[var1];
			boolean var6 = field1367[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field1359[var7];
				if (var8 < var4) {
					field1359[var3] = var8;
					field1366[var3] = field1366[var7];
					field1367[var3] = field1367[var7];
					++var3;
					field1359[var7] = field1359[var3];
					field1366[var7] = field1366[var3];
					field1367[var7] = field1367[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			for (var3 = 0; var3 < var2; ++var3) {
				field1359[var3] = this.field1365[var3];
			}

			var3 = field1358[this.multiplier - 1];
			int var4 = Frames.iLog(var3 - 1);
			field1366[0] = VorbisSample.readBits(var4);
			field1366[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method2342();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field1366[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method2342() : 0;
				}
			}
	...
	@ObfuscatedName("e")
	void method2405(float[] var1, int var2) {
		int var3 = this.field1365.length;
		int var4 = field1358[this.multiplier - 1];
		boolean[] var5 = field1367;
		field1367[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method2419(field1359, var6);
			var8 = method2401(field1359, var6);
			var9 = this.method2402(field1359[var7], field1366[var7], field1359[var8], field1366[var8], field1359[var6]);
			var10 = field1366[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field1367;
				field1367[var8] = true;
				var14[var7] = true;
				field1367[var6] = true;
				if (var10 >= var13) {
					field1366[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field1366[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field1367[var6] = false;
				field1366[var6] = var9;
			}
		}
		...
		var6 = 0;
		var7 = field1366[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field1367[var8]) {
				var9 = field1359[var8];
				var10 = field1366[var8] * this.multiplier;
				this.method2403(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
