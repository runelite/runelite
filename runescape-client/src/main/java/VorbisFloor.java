...
public class VorbisFloor {
	...
	static {
		field1384 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field1385 = new int[var5];
			this.field1385[0] = 0;
			this.field1385[1] = 1 << var4;
			var5 = 2;
			...
			for (var9 = 0; var9 < var2; ++var9) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field1385[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field1387 == null || field1387.length < var5) {
				field1387 = new int[var5];
				field1390 = new int[var5];
				field1389 = new boolean[var5];
			}
	...
	@ObfuscatedName("o")
	int method2472(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	@ObfuscatedName("e")
	void method2481(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field1387[var1];
			int var5 = field1390[var1];
			boolean var6 = field1389[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field1387[var7];
				if (var8 < var4) {
					field1387[var3] = var8;
					field1390[var3] = field1390[var7];
					field1389[var3] = field1389[var7];
					++var3;
					field1387[var7] = field1387[var3];
					field1390[var7] = field1390[var3];
					field1389[var7] = field1389[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field1385.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field1387[var3] = this.field1385[var3];
			}

			var3 = field1384[this.multiplier - 1];
			int var4 = CollisionMap.iLog(var3 - 1);
			field1390[0] = VorbisSample.readBits(var4);
			field1390[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method2398();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field1390[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method2398() : 0;
				}
			}
	...
	@ObfuscatedName("d")
	void method2464(float[] var1, int var2) {
		int var3 = this.field1385.length;
		int var4 = field1384[this.multiplier - 1];
		boolean[] var5 = field1389;
		field1389[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method2465(field1387, var6);
			var8 = method2462(field1387, var6);
			var9 = this.method2472(field1387[var7], field1390[var7], field1387[var8], field1390[var8], field1387[var6]);
			var10 = field1390[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field1389;
				field1389[var8] = true;
				var14[var7] = true;
				field1389[var6] = true;
				if (var10 >= var13) {
					field1390[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field1390[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field1389[var6] = false;
				field1390[var6] = var9;
			}
		}
		...
		var6 = 0;
		var7 = field1390[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field1389[var8]) {
				var9 = field1387[var8];
				var10 = field1390[var8] * this.multiplier;
				this.method2481(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("c")
	static int method2465(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
