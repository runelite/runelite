...
public class VorbisFloor {
		...
		if (var1 != 1) {
			...
			for (var9 = 0; var9 < var2; ++var9) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field1408[var5++] = VorbisSample.readBits(var4);
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var4 = PacketBufferNode.iLog(var3 - 1);
			field1412[0] = VorbisSample.readBits(var4);
			field1412[1] = VorbisSample.readBits(var4);
			int var5 = 2;
