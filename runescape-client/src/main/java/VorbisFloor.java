...
public class VorbisFloor {
	...
	static {
		field1381 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field1388 = new int[var5];
			this.field1388[0] = 0;
			this.field1388[1] = 1 << var4;
			var5 = 2;
			...
			for (var9 = 0; var9 < var2; ++var9) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field1388[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field1380 == null || field1380.length < var5) {
				field1380 = new int[var5];
				field1389 = new int[var5];
				field1390 = new boolean[var5];
			}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field1380[var1];
			int var5 = field1389[var1];
			boolean var6 = field1390[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field1380[var7];
				if (var8 < var4) {
					field1380[var3] = var8;
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field1388.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field1380[var3] = this.field1388[var3];
			}

			var3 = field1381[this.multiplier - 1];
			int var4 = class160.iLog(var3 - 1);
			field1389[0] = VorbisSample.readBits(var4);
			field1389[1] = VorbisSample.readBits(var4);
			int var5 = 2;
	...
	void method2436(float[] var1, int var2) {
		...
		for (var6 = 2; var6 < var3; ++var6) {
			...
			if (var10 != 0) {
				boolean[] var14 = field1390;
				field1390[var8] = true;
				var14[var7] = true;
				field1390[var6] = true;
				if (var10 >= var13) {
					field1389[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field1389[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field1390[var6] = false;
				field1389[var6] = var9;
			}
		}
		...
		var6 = 0;
		var7 = field1389[0] * this.multiplier;
