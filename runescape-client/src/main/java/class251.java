...
public class class251 extends CacheableNode {
   ...
   public static ObjectComposition getObjectDefinition(int var0) {
      ObjectComposition var1 = (ObjectComposition)ObjectComposition.field3471.get((long)var0);
      if(var1 != null) {
         return var1;
      } else {
         byte[] var2 = ObjectComposition.field3446.getConfigData(6, var0);
         var1 = new ObjectComposition();
         var1.field3445 = var0;
         if(var2 != null) {
            var1.method4547(new Buffer(var2));
         }
         ...
         ObjectComposition.field3471.put(var1, (long)var0);
         return var1;
      }
   }
