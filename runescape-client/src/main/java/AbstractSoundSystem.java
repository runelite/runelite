   ...
   public final synchronized void method2025() {
      if(class157.task != null) {
         ...
         for(int var2 = 0; var2 < 2; ++var2) {
            if(class157.task.systems[var2] == this) {
         ...
         for(var6 = 7; var5 != 0; --var6) {
            ...
            for(int var10 = var5 >>> var8 & 286331153; var10 != 0; var10 >>>= 4) {
               if((var10 & 1) != 0) {
                  var5 &= ~(1 << var8);
                  var7 = null;
                  class119 var11 = this.field1663[var8];
                  ...
                  while(true) {
                     while(true) {
                        ...
                        if(var12 != null && var12.field1759 > var9) {
                           var5 |= 1 << var8;
                           var7 = var11;
                           ...
                           if(var7 == null) {
                              this.field1663[var8] = var18;
                           } else {
                              var7.field1727 = var18;
                           }

                           if(var18 == null) {
                              this.field1662[var8] = var7;
                           }
