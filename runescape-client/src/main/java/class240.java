...
public class class240 {
   ...
   @ObfuscatedName("k")
   public static final short[][] field2800;
   @ObfuscatedName("t")
   ...
   public static void method4410(IndexDataBase var0) {
