...
public final class class77 {
   ...
   int field1295;
   @ObfuscatedName("r")
   static int[] field1296 = new int[6];
   @ObfuscatedName("m")
   ...
   int[] field1300;
   @ObfuscatedName("t")
   static final int[][] field1301 = new int[][]{{1, 3, 5, 7}, {1, 3, 5, 7}, {1, 3, 5, 7}, {1, 3, 5, 7, 6}, {1, 3, 5, 7, 6}, {1, 3, 5, 7, 6}, {1, 3, 5, 7, 6}, {1, 3, 5, 7, 2, 6}, {1, 3, 5, 7, 2, 8}, {1, 3, 5, 7, 2, 8}, {1, 3, 5, 7, 11, 12}, {1, 3, 5, 7, 11, 12}, {1, 3, 5, 7, 13, 14}};
   @ObfuscatedName("l")
   int field1302;
   ...
   class77(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18, int var19) {
      ...
      this.field1288 = var1;
      this.field1293 = var2;
      this.field1302 = var18;
      this.field1295 = var19;
      short var20 = 128;
      int var21 = var20 / 2;
      int var22 = var20 / 4;
      int var23 = var20 * 3 / 4;
      int[] var24 = field1301[var1];
      int var25 = var24.length;
      this.field1285 = new int[var25];
      ...
      for(int var30 = 0; var30 < var25; ++var30) {
         ...
         this.field1285[var30] = var32;
         this.field1282[var30] = var34;
      ...
      for(var33 = 0; var33 < var31; ++var33) {
         ...
         this.field1287[var33] = var35;
         this.field1298[var33] = var36;
         this.field1289[var33] = var37;
         if(var34 == 0) {
            this.field1284[var33] = var26[var35];
            this.field1300[var33] = var26[var36];
            this.field1286[var33] = var26[var37];
            if(this.field1290 != null) {
               this.field1290[var33] = -1;
            }
         } else {
            this.field1284[var33] = var27[var35];
            this.field1300[var33] = var27[var36];
            this.field1286[var33] = var27[var37];
            if(this.field1290 != null) {
               this.field1290[var33] = var3;
            }
         }
      }
