                     ...
                     if((Client.field549 == 0 || Client.field549 == 3) && (class115.field1813 == 1 || !class202.field3076 && class115.field1813 == 4)) {
                        ...
                        if(null != var37) {
                           ...
                           if(var37.method3155(var19, var35)) {
                              ...
                              Client.secretCipherBuffer1.method2909(var27 + class3.baseY);
                              Client.secretCipherBuffer1.method2909(var26 + CombatInfoListHolder.baseX);
                              Client.secretCipherBuffer1.putByte(var19);
                              Client.secretCipherBuffer1.putByte(var35);
