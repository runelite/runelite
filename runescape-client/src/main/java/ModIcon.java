...
public final class ModIcon extends class82 {
   ...
   @ObfuscatedName("v")
   public void method1900(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var6 > 0 && var5 > 0) {
         method1903(class82.graphicsPixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8);
      }
   }
   ...
   @ObfuscatedName("d")
   public void method1902(int var1, int var2, int var3) {
   ...
   @ObfuscatedName("r")
   static void method1903(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
