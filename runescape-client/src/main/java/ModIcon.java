...
public final class ModIcon extends Rasterizer2D {
   ...
   public void method5017(int var1, int var2) {
      ...
      if(var6 > 0 && var5 > 0) {
         method5018(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("v")
   static void method5018(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("b")
   public void method5019(int var1, int var2, int var3, int var4) {
      ...
      method5020(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var7, var8, var13, var14, var3, var4, var11, var12, var5);
   }

   @ObfuscatedName("y")
   static void method5020(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
   ...
   @ObfuscatedName("c")
   public void method5032(int var1, int var2, int var3) {
