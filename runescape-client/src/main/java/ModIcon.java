...
public final class ModIcon extends Rasterizer2D {
   ...
   @ObfuscatedName("r")
   static void method4062(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("y")
   public void method4063(int var1, int var2, int var3) {
   ...
   @ObfuscatedName("o")
   public void method4064(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var6 > 0 && var5 > 0) {
         method4062(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8);
      }
   }
