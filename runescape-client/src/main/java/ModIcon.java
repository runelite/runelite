...
public final class ModIcon extends class219 {
   ...
   @ObfuscatedName("i")
   public void method4066(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
   ...
   @ObfuscatedName("a")
   static void method4067(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("x")
   public void method4068(int var1, int var2, int var3) {
