...
public final class ModIcon extends Rasterizer2D {
   ...
   @ObfuscatedName("d")
   public void method4109(int var1, int var2, int var3) {
   ...
   @ObfuscatedName("p")
   static void method4110(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   public void method4122(int var1, int var2) {
      ...
      if(var6 > 0 && var5 > 0) {
         method4110(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8);
      }
   }
}
