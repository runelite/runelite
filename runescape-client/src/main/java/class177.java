...
public class class177 {
   ...
   @ObfuscatedSignature(
      ...
      garbageValue = "-1964204890"
   )
   static final int method3365(Widget var0, int var1) {
      if(var0.dynamicValues != null && var1 < var0.dynamicValues.length) {
         try {
            ...
            while(true) {
               ...
               if(var6 == 6) {
                  var7 = class222.field2845[Client.realSkillLevels[var2[var4++]] - 1];
               }
               ...
               if(var6 == 8) {
                  var7 = XItemContainer.localPlayer.combatLevel;
               }

               if(var6 == 9) {
                  for(var9 = 0; var9 < 25; ++var9) {
                     if(class222.field2844[var9]) {
               ...
               if(var6 == 14) {
                  var9 = var2[var4++];
                  var7 = WorldMapType1.method264(var9);
               }
               ...
               if(var6 == 19) {
                  var7 = (XItemContainer.localPlayer.y >> 7) + class266.baseY;
               }
