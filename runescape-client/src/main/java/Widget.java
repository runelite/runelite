...
public class Widget extends Node {
   ...
   @ObfuscatedName("z")
   @ObfuscatedSignature(
      signature = "(Lgc;I)[Ljava/lang/Object;",
      garbageValue = "156982302"
   )
   ...
   @ObfuscatedName("v")
   @ObfuscatedSignature(
      signature = "(Lke;IZLic;I)Lei;",
      garbageValue = "-1439500467"
   )
   @Export("getModel")
