...
public class Floor1 {
   ...
   Floor1() {
      ...
      if(var1 != 1) {
         ...
         this.field1518 = new int[var5];
         this.field1518[0] = 0;
         this.field1518[1] = 1 << var4;
         var5 = 2;
   ...
   @ObfuscatedName("e")
   int method1986(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var4 - var2;
      int var7 = var3 - var1;
   ...
   void method1995(int var1, int var2, int var3, int var4, float[] var5, int var6) {
      ...
      for(int var14 = var1 + 1; var14 < var3; ++var14) {
         ...
         var5[var14] *= field1514[var11];
      }

   }

   @ObfuscatedName("u")
   void method1989(int var1, int var2) {
      if(var1 < var2) {
         int var3 = var1;
         int var4 = xList[var1];
         int var5 = yList[var1];
         boolean var6 = field1521[var1];
         ...
         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            ...
            if(var8 < var4) {
               ...
               field1521[var3] = field1521[var7];
               ++var3;
               xList[var7] = xList[var3];
               yList[var7] = yList[var3];
               field1521[var7] = field1521[var3];
            }
         }
         ...
         yList[var3] = var5;
         field1521[var3] = var6;
         this.method1989(var1, var3 - 1);
         this.method1989(var3 + 1, var2);
      }
   }
   ...
   boolean decodedFloor() {
      ...
      if(!var1) {
         ...
         int var2 = this.field1518.length;

         int var3;
         for(var3 = 0; var3 < var2; ++var3) {
            xList[var3] = this.field1518[var3];
         }
   ...
   void computeFloor(float[] var1, int var2) {
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method1988(xList, var6);
         var8 = method1985(xList, var6);
         var9 = this.method1986(xList[var7], yList[var7], xList[var8], yList[var8], xList[var6]);
         var10 = yList[var6];
         int var11 = var4 - var9;
         int var13 = (var11 < var9?var11:var9) << 1;
         if(var10 != 0) {
            boolean[] var14 = field1521;
            field1521[var8] = true;
            var14[var7] = true;
            field1521[var6] = true;
            if(var10 >= var13) {
            ...
            field1521[var6] = false;
            yList[var6] = var9;
         }
      }

      this.method1989(0, var3 - 1);
      var6 = 0;
   ...
   @ObfuscatedName("w")
   static int method1985(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
