...
public class Floor1 {
   ...
   Floor1() {
      ...
      if(var1 != 1) {
         ...
         this.field1622 = new int[var5];
         this.field1622[0] = 0;
         this.field1622[1] = 1 << var4;
         var5 = 2;
         ...
         for(var9 = 0; var9 < var2; ++var9) {
            ...
            for(int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
               this.field1622[var5++] = class105.getInt(var4);
            }
         }
   ...
   @ObfuscatedName("o")
   void method1991(int var1, int var2) {
      if(var1 < var2) {
         int var3 = var1;
         int var4 = xList[var1];
         int var5 = yList[var1];
         boolean var6 = field1631[var1];
         ...
         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            ...
            if(var8 < var4) {
               ...
               field1631[var3] = field1631[var7];
               ++var3;
               xList[var7] = xList[var3];
               yList[var7] = yList[var3];
               field1631[var7] = field1631[var3];
            }
         }
         ...
         yList[var3] = var5;
         field1631[var3] = var6;
         this.method1991(var1, var3 - 1);
         this.method1991(var3 + 1, var2);
      }
   }

   @ObfuscatedName("r")
   void method1990(int var1, int var2, int var3, int var4, float[] var5, int var6) {
      int var7 = var4 - var2;
      int var8 = var3 - var1;
      ...
      for(int var14 = var1 + 1; var14 < var3; ++var14) {
         ...
         var5[var14] *= field1621[var11];
      }

   }

   @ObfuscatedName("a")
   int method1993(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var4 - var2;
      int var7 = var3 - var1;
   ...
   boolean decodedFloor() {
      ...
      if(!var1) {
         ...
         int var2 = this.field1622.length;

         int var3;
         for(var3 = 0; var3 < var2; ++var3) {
            xList[var3] = this.field1622[var3];
         }

         var3 = RANGES[this.multiplier - 1];
         int var4 = class15.ilog(var3 - 1);
   ...
   void computeFloor(float[] var1, int var2) {
      int var3 = this.field1622.length;
      int var4 = RANGES[this.multiplier - 1];
      boolean[] var5 = field1631;
      field1631[1] = true;
      var5[0] = true;
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method1989(xList, var6);
         var8 = method1987(xList, var6);
         var9 = this.method1993(xList[var7], yList[var7], xList[var8], yList[var8], xList[var6]);
         var10 = yList[var6];
         int var11 = var4 - var9;
         int var13 = (var11 < var9?var11:var9) << 1;
         if(var10 != 0) {
            boolean[] var14 = field1631;
            field1631[var8] = true;
            var14[var7] = true;
            field1631[var6] = true;
            if(var10 >= var13) {
            ...
            field1631[var6] = false;
            yList[var6] = var9;
         }
      }

      this.method1991(0, var3 - 1);
      var6 = 0;
      ...
      for(var8 = 1; var8 < var3; ++var8) {
         if(field1631[var8]) {
            ...
            this.method1990(var6, var7, var9, var10, var1, var2);
            if(var9 >= var2) {
               return;
            }
   ...
   @ObfuscatedName("i")
   static int method1989(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
   ...
   @ObfuscatedName("j")
   static int method1987(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
