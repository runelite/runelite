      ...
      if(var1 < var2) {
         ...
         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            ...
            if(var8 < var4) {
               ...
               field1549[var3] = field1549[var7];
               ++var3;
               xList[var7] = xList[var3];
               yList[var7] = yList[var3];
               field1549[var7] = field1549[var3];
            }
         }
   ...
   boolean decodedFloor() {
      ...
      if(!var1) {
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            xList[var3] = this.field1551[var3];
         }
   ...
   void computeFloor(float[] var1, int var2) {
      ...
      for(var8 = 1; var8 < var3; ++var8) {
         if(field1549[var8]) {
            ...
            this.method2173(var6, var7, var9, var10, var1, var2);
            if(var9 >= var2) {
               return;
            }
