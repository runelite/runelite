...
public class Floor1 {
      ...
      if(var1 != 1) {
         ...
         for(var9 = 0; var9 < var2; ++var9) {
            ...
            for(int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
               this.field1534[var5++] = class105.getInt(var4);
            }
         }
   ...
   @ObfuscatedName("k")
   int method2070(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var4 - var2;
      int var7 = var3 - var1;
   ...
   @ObfuscatedName("z")
   void method2071(int var1, int var2, int var3, int var4, float[] var5, int var6) {
      int var7 = var4 - var2;
      int var8 = var3 - var1;
   ...
   void method2072(int var1, int var2) {
      if(var1 < var2) {
         ...
         yList[var3] = var5;
         field1543[var3] = var6;
         this.method2072(var1, var3 - 1);
         this.method2072(var3 + 1, var2);
      }
   }
   ...
   void computeFloor(float[] var1, int var2) {
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method2076(xList, var6);
         var8 = method2069(xList, var6);
         var9 = this.method2070(xList[var7], yList[var7], xList[var8], yList[var8], xList[var6]);
         var10 = yList[var6];
         int var11 = var4 - var9;
      ...
      for(var8 = 1; var8 < var3; ++var8) {
         if(field1543[var8]) {
            ...
            this.method2071(var6, var7, var9, var10, var1, var2);
            if(var9 >= var2) {
               return;
            }
   ...
   @ObfuscatedName("d")
   static int method2076(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
   ...
   @ObfuscatedName("x")
   static int method2069(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
