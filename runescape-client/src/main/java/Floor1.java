...
public class Floor1 {
      ...
      if(var1 != 1) {
         ...
         for(var9 = 0; var9 < var2; ++var9) {
            ...
            for(int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
               this.field1606[var5++] = class104.getInt(var4);
            }
         }
   ...
   @ObfuscatedName("o")
   void method2032(int var1, int var2, int var3, int var4, float[] var5, int var6) {
      int var7 = var4 - var2;
      int var8 = var3 - var1;
   ...
   void computeFloor(float[] var1, int var2) {
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method2045(xList, var6);
         var8 = method2030(xList, var6);
         var9 = this.method2036(xList[var7], yList[var7], xList[var8], yList[var8], xList[var6]);
         var10 = yList[var6];
         int var11 = var4 - var9;
         int var13 = (var11 < var9?var11:var9) << 1;
         if(var10 != 0) {
            boolean[] var14 = field1609;
            field1609[var8] = true;
            var14[var7] = true;
            field1609[var6] = true;
            if(var10 >= var13) {
            ...
            field1609[var6] = false;
            yList[var6] = var9;
         }
      }

      this.method2033(0, var3 - 1);
      var6 = 0;
      ...
      for(var8 = 1; var8 < var3; ++var8) {
         if(field1609[var8]) {
            ...
            this.method2032(var6, var7, var9, var10, var1, var2);
            if(var9 >= var2) {
               return;
            }
   ...
   @ObfuscatedName("w")
   static int method2045(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
   ...
   @ObfuscatedName("s")
   static int method2030(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
