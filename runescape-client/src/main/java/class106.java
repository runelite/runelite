...
public class class106 extends Node {
   ...
   class107 method1926(int[] var1) {
      if(var1 != null && var1[0] <= 0) {
         ...
         if(this.field1598 == null) {
            this.field1591 = 0;
            this.field1587 = new float[blockSize1];
            this.field1598 = new byte[this.field1571];
            this.field1601 = 0;
            this.field1580 = 0;
         }

         for(; this.field1580 < this.field1590.length; ++this.field1580) {
            if(var1 != null && var1[0] <= 0) {
               return null;
            }

            float[] var2 = this.method1923(this.field1580);
            if(var2 != null) {
               ...
               for(int var5 = 0; var5 < var4; ++var5) {
                  ...
                  this.field1598[var3++] = (byte)(var6 - 128);
               }

               if(var1 != null) {
                  var1[0] -= var3 - this.field1601;
               }
         ...
         this.field1587 = null;
         byte[] var7 = this.field1598;
         this.field1598 = null;
         return new class107(this.field1570, var7, this.field1588, this.field1573, this.field1574);
      }
   }

   @ObfuscatedName("l")
   float[] method1923(int var1) {
      setBytes(this.field1590[var1], 0);
      getBit();
      int var2 = getInt(class220.ilog(modeMappings.length - 1));
      ...
      for(var17 = 0; var17 < var14.field1711; ++var17) {
         Residue var18 = residues[var14.field1708[var17]];
         float[] var19 = field1597;
      ...
      if(!var15) {
         ...
         floors[var40].computeFloor(field1597, var4 >> 1);
      }

      int var41;
      if(var15) {
         for(var17 = var4 >> 1; var17 < var4; ++var17) {
            field1597[var17] = 0.0F;
         }
      } else {
         var17 = var4 >> 1;
         var40 = var4 >> 2;
         var41 = var4 >> 3;
         float[] var20 = field1597;
         ...
         float[] var44 = var3?field1595:field1592;
         float[] var22 = var3?field1596:field1593;
         float[] var23 = var3?field1572:field1594;
         ...
         for(var47 = var8; var47 < var9; ++var47) {
            ...
            field1597[var47] *= (float)Math.sin(1.5707963267948966D * (double)var27 * (double)var27);
         }
      ...
      float[] var42 = null;
      if(this.field1591 > 0) {
         var40 = var4 + this.field1591 >> 2;
         var42 = new float[var40];
         int var43;
         if(!this.field1575) {
            for(var41 = 0; var41 < this.field1579; ++var41) {
               var43 = var41 + (this.field1591 >> 1);
         ...
         if(!var15) {
            for(var41 = var8; var41 < var4 >> 1; ++var41) {
               ...
               var42[var43] += field1597[var41];
            }
         }
      }

      float[] var46 = this.field1587;
      this.field1587 = field1597;
      field1597 = var46;
      this.field1591 = var4;
      this.field1579 = var12 - (var4 >> 1);
      this.field1575 = var15;
      return var42;
   }
   ...
   @ObfuscatedName("e")
   static void method1922(byte[] var0) {
      setBytes(var0, 0);
      blockSize0 = 1 << getInt(4);
      blockSize1 = 1 << getInt(4);
      field1597 = new float[blockSize1];
      ...
      for(var1 = 0; var1 < 2; ++var1) {
         ...
         int var10 = class220.ilog(var5 - 1);

         for(int var11 = 0; var11 < var5; ++var11) {
            var14[var11] = class34.method482(var11, var10);
         }
