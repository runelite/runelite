				...
				if (var4 != 0 && var4 != 1 && var4 != 2) {
					if (var4 == 3 || var4 == 4) {
						...
						for (var12 = 0; var12 < var7; ++var12) {
							var21[var12] = class223.loadClassFromDescriptor(var8[var12]);
						}

						Class var22 = class223.loadClassFromDescriptor(var20);
						if (class223.loadClassFromDescriptor(var5).getClassLoader() == null) {
							throw new SecurityException();
						}

						Method[] var13 = class223.loadClassFromDescriptor(var5).getDeclaredMethods();
						Method[] var14 = var13;
