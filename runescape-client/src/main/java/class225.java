...
public class class225 {
   @ObfuscatedName("s")
   public static final short[] field2735;
   @ObfuscatedName("g")
   public static final short[][] field2732;
   @ObfuscatedName("m")
   public static final short[] field2737;
   @ObfuscatedName("h")
   public static final short[][] field2734;
   @ObfuscatedName("z")
   static byte[][][] field2731;
   @ObfuscatedName("jp")
   @ObfuscatedGetter(
      intValue = -895987465
   )
