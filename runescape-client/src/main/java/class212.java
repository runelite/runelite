...
public class class212 {
   ...
   @ObfuscatedSignature(
      ...
      garbageValue = "1210359995"
   )
   public static String method3983(CharSequence var0) {
      return class165.method3197('*', var0.length());
   }
}
