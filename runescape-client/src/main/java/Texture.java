...
public class Texture extends Node {
   ...
   Texture(Buffer var1) {
      ...
      this.field1865 = var1.readUnsignedByte() == 1;
      ...
      if(var2 >= 1 && var2 <= 4) {
         ...
         this.field1866 = var1.readUnsignedByte();
   ...
   boolean method2544(double var1, int var3, IndexDataBase var4) {
      int var5;
      for(var5 = 0; var5 < this.fileIds.length; ++var5) {
         if(var4.method4242(this.fileIds[var5]) == null) {
            return false;
         }
      }
      ...
      for(int var6 = 0; var6 < this.fileIds.length; ++var6) {
         IndexedSprite var7 = class39.method530(var4, this.fileIds[var6]);
         var7.method5157();
         byte[] var8 = var7.pixels;
         int[] var9 = var7.palette;
         int var10 = this.field1869[var6];
   ...
   void method2547(int var1) {
      if(this.pixels != null) {
         ...
         int var7;
         int[] var10;
         if(this.field1866 == 1 || this.field1866 == 3) {
         ...
         if(this.field1866 == 2 || this.field1866 == 4) {
            if(field1874 == null || field1874.length < this.pixels.length) {
               field1874 = new int[this.pixels.length];
            }
