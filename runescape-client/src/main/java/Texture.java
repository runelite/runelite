...
public class Texture extends Node {
		...
		if (var2 >= 1 && var2 <= 4) {
			...
			if (var2 > 1) {
				...
				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field1640[var3] = var1.readUnsignedByte();
				}
			}
			...
			if (var2 > 1) {
				...
				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field1633[var3] = var1.readUnsignedByte();
				}
			}
			...
			for (var3 = 0; var3 < var2; ++var3) {
				this.field1634[var3] = var1.readInt();
			}
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) {
			IndexedSprite var7 = class322.method5972(var4, this.fileIds[var6]);
			var7.normalize();
