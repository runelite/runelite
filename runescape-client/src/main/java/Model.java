...
public class Model extends Renderable {
   ...
   public void method2594() {
      if(this.field1939 != 1) {
         ...
         this.field1943 = (int)(Math.sqrt((double)(super.modelHeight * super.modelHeight + this.XYZMag * this.XYZMag)) + 0.99D);
         this.field1942 = this.field1943 + (int)(Math.sqrt((double)(this.field1940 * this.field1940 + this.XYZMag * this.XYZMag)) + 0.99D);
      }
   }
      ...
      if(this.field1936 != null) {
         if(var2 != -1) {
            ...
            for(int var5 = 0; var5 < var3.field1881; ++var5) {
               ...
               this.method2600(var4.types[var6], var4.list[var6], var3.translator_x[var5], var3.translator_y[var5], var3.translator_z[var5]);
            }
   ...
   final void method2612(int var1) {
      ...
      if(var8 >= 50) {
         ...
         if(var10 >= 50) {
            ...
            field1967[var4] = var2 + Graphics3D.field2009 * (var11 + ((yViewportBuffer[var7] - var11) * var14 >> 16)) / 50;
            field1968[var4] = var3 + Graphics3D.field2009 * (var12 + ((field1957[var7] - var12) * var14 >> 16)) / 50;
            xViewportBuffer[var4++] = var13 + ((this.field1935[var1] - var13) * var14 >> 16);
         }

         if(var9 >= 50) {
            var14 = field1970[var9 - var8] * (50 - var8);
            field1967[var4] = var2 + (var11 + ((yViewportBuffer[var6] - var11) * var14 >> 16)) * Graphics3D.field2009 / 50;
            field1968[var4] = var3 + (var12 + ((field1957[var6] - var12) * var14 >> 16)) * Graphics3D.field2009 / 50;
      ...
      if(var9 >= 50) {
         ...
         if(var8 >= 50) {
            ...
            field1967[var4] = var2 + (var11 + ((yViewportBuffer[var5] - var11) * var14 >> 16)) * Graphics3D.field2009 / 50;
            field1968[var4] = var3 + (var12 + ((field1957[var5] - var12) * var14 >> 16)) * Graphics3D.field2009 / 50;
         ...
         if(var10 >= 50) {
            ...
            field1967[var4] = var2 + Graphics3D.field2009 * (var11 + ((yViewportBuffer[var7] - var11) * var14 >> 16)) / 50;
            field1968[var4] = var3 + (var12 + ((field1957[var7] - var12) * var14 >> 16)) * Graphics3D.field2009 / 50;
            xViewportBuffer[var4++] = var13 + ((this.field1935[var1] - var13) * var14 >> 16);
         }
      }
      ...
      if(var10 >= 50) {
         ...
         if(var8 >= 50) {
            ...
            field1967[var4] = var2 + Graphics3D.field2009 * (var11 + ((yViewportBuffer[var5] - var11) * var14 >> 16)) / 50;
            field1968[var4] = var3 + Graphics3D.field2009 * (var12 + ((field1957[var5] - var12) * var14 >> 16)) / 50;
            xViewportBuffer[var4++] = var13 + ((this.field1978[var1] - var13) * var14 >> 16);
         }
      }
      ...
      if(var4 == 3) {
         ...
         if(this.field1975 != null && this.field1975[var1] != -1) {
            ...
            if(this.field1935[var1] == -1) {
               Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, this.field1978[var1], this.field1978[var1], this.field1978[var1], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1957[var17], field1957[var18], field1957[var19], field1958[var17], field1958[var18], field1958[var19], this.field1975[var1]);
            } else {
               Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, xViewportBuffer[0], xViewportBuffer[1], xViewportBuffer[2], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1957[var17], field1957[var18], field1957[var19], field1958[var17], field1958[var18], field1958[var19], this.field1975[var1]);
            }
      ...
      if(var4 == 4) {
         ...
         if(this.field1975 != null && this.field1975[var1] != -1) {
            ...
            if(this.field1935[var1] == -1) {
               Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, this.field1978[var1], this.field1978[var1], this.field1978[var1], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1957[var17], field1957[var18], field1957[var19], field1958[var17], field1958[var18], field1958[var19], var21);
               Graphics3D.rasterTextureAffine(var14, var16, field1968[3], var11, var13, field1967[3], this.field1978[var1], this.field1978[var1], this.field1978[var1], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1957[var17], field1957[var18], field1957[var19], field1958[var17], field1958[var18], field1958[var19], var21);
            } else {
               Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, xViewportBuffer[0], xViewportBuffer[1], xViewportBuffer[2], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1957[var17], field1957[var18], field1957[var19], field1958[var17], field1958[var18], field1958[var19], var21);
               Graphics3D.rasterTextureAffine(var14, var16, field1968[3], var11, var13, field1967[3], xViewportBuffer[0], xViewportBuffer[2], xViewportBuffer[3], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1957[var17], field1957[var18], field1957[var19], field1958[var17], field1958[var18], field1958[var19], var21);
            }
         } else if(this.field1935[var1] == -1) {
               ...
               if(var19 / var13 > Graphics3D.field2014) {
                  ...
                  if(var21 / var13 < Graphics3D.field2007) {
                     ...
                     if(class7.field242 && var9 > 0) {
                        ...
                        ScriptVarType.method19(var30 + Graphics3D.centerX, var32 + Graphics3D.centerY, var31 + Graphics3D.centerX, var33 + Graphics3D.centerY, var34);
                     }
                     ...
                     for(var34 = 0; var34 < this.field1949; ++var34) {
                        ...
                        int var38;
                        if(var1 != 0) {
                           var38 = var35 * var33 + var37 * var32 >> 16;
         ...
         if(var5 != null && var4 != -1) {
            ...
            for(var11 = 0; var11 < var6.field1881; ++var11) {
               ...
               if(var12 != var10 || var8.types[var12] == 0) {
                  this.method2600(var8.types[var12], var8.list[var12], var6.translator_x[var11], var6.translator_y[var11], var6.translator_z[var11]);
               }
            }
            ...
            for(var11 = 0; var11 < var7.field1881; ++var11) {
               ...
               if(var12 == var10 || var8.types[var12] == 0) {
                  this.method2600(var8.types[var12], var8.list[var12], var7.translator_x[var11], var7.translator_y[var11], var7.translator_z[var11]);
               }
            }
   ...
   final void method2611(int var1) {
      if(field1918[var1]) {
         ...
         if(this.field1975 != null && this.field1975[var1] != -1) {
            ...
            if(this.field1935[var1] == -1) {
               Graphics3D.rasterTextureAffine(field1954[var2], field1954[var3], field1954[var4], field1953[var2], field1953[var3], field1953[var4], this.field1978[var1], this.field1978[var1], this.field1978[var1], yViewportBuffer[var5], yViewportBuffer[var6], yViewportBuffer[var7], field1957[var5], field1957[var6], field1957[var7], field1958[var5], field1958[var6], field1958[var7], this.field1975[var1]);
            } else {
               Graphics3D.rasterTextureAffine(field1954[var2], field1954[var3], field1954[var4], field1953[var2], field1953[var3], field1953[var4], this.field1978[var1], this.field1926[var1], this.field1935[var1], yViewportBuffer[var5], yViewportBuffer[var6], yViewportBuffer[var7], field1957[var5], field1957[var6], field1957[var7], field1958[var5], field1958[var6], field1958[var7], this.field1975[var1]);
            }
         } else if(this.field1935[var1] == -1) {
            Graphics3D.rasterFlat(field1954[var2], field1954[var3], field1954[var4], field1953[var2], field1953[var3], field1953[var4], field1912[this.field1978[var1]]);
         } else {
            Graphics3D.rasterGouraud(field1954[var2], field1954[var3], field1954[var4], field1953[var2], field1953[var3], field1953[var4], this.field1978[var1], this.field1926[var1], this.field1935[var1]);
         }
               ...
               if(var8 < this.field1936.length) {
                  ...
                  for(var19 = 0; var19 < var18.length; ++var19) {
                     ...
                     if(var14 != 0) {
                        ...
                        var17 = var16 * this.verticesX[var11] + var15 * this.verticesY[var11] >> 16;
                     ...
                     if(var12 != 0) {
                        ...
                        this.verticesZ[var11] = var16 * this.verticesZ[var11] + var15 * this.verticesY[var11] >> 16;
                     ...
                     if(var13 != 0) {
                        ...
                        var17 = var16 * this.verticesX[var11] + var15 * this.verticesZ[var11] >> 16;
         ...
         for(var6 = 0; var6 < this.field1961; ++var6) {
            if(this.field1935[var6] != -2) {
               ...
               if(!var1 || var10 != -5000 && var11 != -5000 && var12 != -5000) {
                  ...
                  if((var10 - var11) * (field1954[var9] - field1954[var26]) - (var12 - var11) * (field1954[var7] - field1954[var26]) > 0) {
                  ...
                  if(var20 * var24 + var17 * var23 + var14 * var22 > 0) {
                     field1918[var6] = true;
   ...
   public final void method2607(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      for(int var19 = 0; var19 < this.field1949; ++var19) {
         ...
         if(var1 != 0) {
            ...
            var22 = var22 * var11 + var21 * var10 >> 16;
            var21 = var23;
         }

         if(var2 != 0) {
            var23 = var20 * var13 + var22 * var12 >> 16;
         ...
         var22 = var22 * var17 + var21 * var16 >> 16;
         field1955[var19] = var22 - var18;
         field1953[var19] = var20 * Graphics3D.field2009 / var22 + var8;
   ...
   public final void method2608(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      ...
      for(int var20 = 0; var20 < this.field1949; ++var20) {
         ...
         if(var1 != 0) {
            ...
            var23 = var23 * var12 + var22 * var11 >> 16;
            var22 = var24;
         }

         if(var2 != 0) {
            var24 = var21 * var14 + var23 * var13 >> 16;
         ...
         var23 = var23 * var18 + var22 * var17 >> 16;
