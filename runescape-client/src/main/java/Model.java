...
public class Model extends Renderable {
   ...
   static Model field1801;
   @ObfuscatedName("s")
   static byte[] field1802;
   @ObfuscatedName("ag")
   static boolean[] field1849;
   @ObfuscatedName("av")
   static boolean[] field1839;
   @ObfuscatedName("aw")
   ...
   static {
      ...
      field1839 = new boolean[4700];
      modelViewportYs = new int[4700];
      modelViewportXs = new int[4700];
      field1842 = new int[4700];
      yViewportBuffer = new int[4700];
      field1853 = new int[4700];
      field1845 = new int[4700];
      field1838 = new int[1600];
      field1848 = new int[1600][512];
      field1864 = new int[12];
      field1835 = new int[12][2000];
      field1851 = new int[2000];
      field1852 = new int[2000];
      field1812 = new int[12];
      field1854 = new int[10];
      ...
      field1865 = Graphics3D.colorPalette;
      field1860 = Graphics3D.field1908;
   }
   ...
   public Model(Model[] var1, int var2) {
      ...
      for(var7 = 0; var7 < var2; ++var7) {
         ...
         if(var8 != null) {
            ...
            if(var8.field1799 != null) {
               ...
               if(this.field1811 != var8.field1811) {
                  var3 = true;
               }
            }
      ...
      this.field1844 = new int[this.indicesCount];
      this.field1813 = new int[this.indicesCount];
      if(var3) {
         this.field1799 = new byte[this.indicesCount];
      }

      if(var4) {
         this.field1815 = new byte[this.indicesCount];
      }

      if(var5) {
         this.field1817 = new short[this.indicesCount];
      }
      ...
      if(this.field1819 > 0) {
         ...
         this.field1821 = new int[this.field1819];
         this.field1822 = new int[this.field1819];
      }
      ...
      for(var7 = 0; var7 < var2; ++var7) {
         ...
         if(var8 != null) {
            ...
            for(var9 = 0; var9 < var8.indicesCount; ++var9) {
               ...
               this.field1813[this.indicesCount] = var8.field1813[var9];
               if(var3) {
                  if(var8.field1799 != null) {
                     this.field1799[this.indicesCount] = var8.field1799[var9];
                  } else {
                     this.field1799[this.indicesCount] = var8.field1811;
                  }
               }

               if(var4 && var8.field1815 != null) {
                  this.field1815[this.indicesCount] = var8.field1815[var9];
               }
               ...
               if(var5) {
                  if(var8.field1817 != null) {
                     ...
                     this.field1817[this.indicesCount] = -1;
                  }
               }

               if(var6) {
                  if(var8.field1816 != null && var8.field1816[var9] != -1) {
                     this.field1816[this.indicesCount] = (byte)(this.field1819 + var8.field1816[var9]);
                  } else {
                     this.field1816[this.indicesCount] = -1;
                  }
               }
            ...
            for(var9 = 0; var9 < var8.field1819; ++var9) {
               this.field1820[this.field1819] = this.verticesCount + var8.field1820[var9];
               this.field1821[this.field1819] = this.verticesCount + var8.field1821[var9];
               this.field1822[this.field1819] = this.verticesCount + var8.field1822[var9];
               ++this.field1819;
            }
   ...
   public Model method2666(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
   ...
   public Model method2657(boolean var1) {
      if(!var1 && field1831.length < this.indicesCount) {
         field1831 = new byte[this.indicesCount + 100];
      }

      return this.method2716(var1, field1840, field1831);
   }
   ...
   public Model method2681(boolean var1) {
      if(!var1 && field1802.length < this.indicesCount) {
         field1802 = new byte[this.indicesCount + 100];
      }

      return this.method2716(var1, field1801, field1802);
   }
   ...
   Model method2716(boolean var1, Model var2, byte[] var3) {
   ...
   void method2659(int var1) {
      if(this.extremeX == -1) {
         ...
         for(int var10 = 0; var10 < this.verticesCount; ++var10) {
            int var11 = Graphics3D.method2777(this.verticesX[var10], this.verticesZ[var10], var8, var9);
            int var12 = this.verticesY[var10];
            int var13 = Graphics3D.method2760(this.verticesX[var10], this.verticesZ[var10], var8, var9);
            if(var11 < var2) {
               var2 = var11;
            }
   ...
   public void method2664(Frames var1, int var2) {
      if(this.field1823 != null) {
         if(var2 != -1) {
            ...
            for(int var5 = 0; var5 < var3.field1773; ++var5) {
               int var6 = var3.field1769[var5];
               this.method2699(var4.types[var6], var4.list[var6], var3.translator_x[var5], var3.translator_y[var5], var3.translator_z[var5]);
            }
   ...
   public void method2717(Frames var1, int var2, Frames var3, int var4, int[] var5) {
      if(var2 != -1) {
         if(var5 != null && var4 != -1) {
            ...
            int var11;
            int var12;
            for(var11 = 0; var11 < var6.field1773; ++var11) {
               for(var12 = var6.field1769[var11]; var12 > var10; var10 = var5[var13++]) {
                  ;
               }

               if(var12 != var10 || var8.types[var12] == 0) {
                  this.method2699(var8.types[var12], var8.list[var12], var6.translator_x[var11], var6.translator_y[var11], var6.translator_z[var11]);
               }
            }
            ...
            for(var11 = 0; var11 < var7.field1773; ++var11) {
               for(var12 = var7.field1769[var11]; var12 > var10; var10 = var5[var13++]) {
                  ;
               }

               if(var12 == var10 || var8.types[var12] == 0) {
                  this.method2699(var8.types[var12], var8.list[var12], var7.translator_x[var11], var7.translator_y[var11], var7.translator_z[var11]);
               }
            }

            this.resetBounds();
         } else {
            this.method2664(var1, var2);
         }
      }
   }

   @ObfuscatedName("q")
   void method2699(int var1, int[] var2, int var3, int var4, int var5) {
      ...
      if(var1 == 0) {
         ...
         for(var8 = 0; var8 < var6; ++var8) {
            ...
            if(var9 < this.field1823.length) {
               ...
               for(var11 = 0; var11 < var10.length; ++var11) {
                  var12 = var10[var11];
                  field1857 += this.verticesX[var12];
                  field1858 += this.verticesY[var12];
                  field1809 += this.verticesZ[var12];
                  ++var7;
               }
            }
         }
         ...
         if(var7 > 0) {
            field1857 = var3 + field1857 / var7;
            field1858 = var4 + field1858 / var7;
            field1809 = var5 + field1809 / var7;
         } else {
            field1857 = var3;
            field1858 = var4;
            field1809 = var5;
         ...
         if(var1 == 1) {
            for(var7 = 0; var7 < var6; ++var7) {
               var8 = var2[var7];
               if(var8 < this.field1823.length) {
                  var18 = this.field1823[var8];
            ...
            for(var7 = 0; var7 < var6; ++var7) {
               ...
               if(var8 < this.field1823.length) {
                  ...
                  for(var19 = 0; var19 < var18.length; ++var19) {
                     var11 = var18[var19];
                     this.verticesX[var11] -= field1857;
                     this.verticesY[var11] -= field1858;
                     this.verticesZ[var11] -= field1809;
                     var12 = (var3 & 255) * 8;
            ...
            if(this.field1824 != null && this.field1815 != null) {
               for(var7 = 0; var7 < var6; ++var7) {
                  var8 = var2[var7];
                  if(var8 < this.field1824.length) {
                     var18 = this.field1824[var8];

                     for(var19 = 0; var19 < var18.length; ++var19) {
                        var11 = var18[var19];
                        var12 = (this.field1815[var11] & 255) + var3 * 8;
                        if(var12 < 0) {
                           var12 = 0;
                        } else if(var12 > 255) {
                           var12 = 255;
                        ...
                        this.field1815[var11] = (byte)var12;
                     }
                  }
               }
            }
   ...
   @ObfuscatedName("z")
   public final void method2672(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      field1838[0] = -1;
      ...
      for(int var19 = 0; var19 < this.verticesCount; ++var19) {
         ...
         if(this.field1819 > 0) {
            ...
            field1853[var19] = var23;
            field1845[var19] = var22;
         }
      }
   ...
   @ObfuscatedName("b")
   public final void method2673(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      field1838[0] = -1;
      if(this.boundsType != 2 && this.boundsType != 1) {
         this.method2661();
      }
      ...
      for(int var20 = 0; var20 < this.verticesCount; ++var20) {
         ...
         if(this.field1819 > 0) {
            ...
            field1853[var20] = var24;
            field1845[var20] = var23;
         }
      }
   ...
   final void method0(boolean var1, boolean var2, boolean var3, int var4) {
      if(this.diameter < 1600) {
         ...
         if(class7.drawObjectGeometry2D && var2) {
            WorldMapType2.method532(this, var5);
         }
         ...
         for(var6 = 0; var6 < this.indicesCount; ++var6) {
            if(this.field1813[var6] != -2) {
               ...
               if(var1 && (var10 == -5000 || var11 == -5000 || var12 == -5000)) {
                  ...
                  var16 = field1853[var7];
                  var17 = field1853[var26];
                  int var18 = field1853[var9];
                  int var19 = field1845[var7];
                  int var20 = field1845[var26];
                  int var21 = field1845[var9];
                  var31 -= var14;
                  var15 -= var14;
                  var16 -= var17;
                  var18 -= var17;
                  ...
                  if(var14 * var22 + var17 * var23 + var20 * var24 > 0) {
                     field1839[var6] = true;
                     int var25 = (field1842[var7] + field1842[var26] + field1842[var9]) / 3 + this.radius;
                     field1848[var25][field1838[var25]++] = var6;
                  }
               } else {
                  if(var2) {
                     var14 = modelViewportXs[var7];
                     var15 = modelViewportXs[var26];
         ...
         if(this.field1799 == null) {
            ...
            for(var6 = this.diameter - 1; var6 >= 0; --var6) {
               ...
               if(var7 > 0) {
                  ...
                  for(var9 = 0; var9 < var7; ++var9) {
                     var10 = var8[var9];
                     byte var30 = this.field1799[var10];
                     var12 = field1864[var30]++;
                     field1835[var30][var12] = var10;
                     if(var30 < 10) {
                        field1812[var30] += var6;
                     } else if(var30 == 10) {
                        field1851[var12] = var6;
                     } else {
            ...
            if(field1864[1] > 0 || field1864[2] > 0) {
               var6 = (field1812[1] + field1812[2]) / (field1864[1] + field1864[2]);
            }

            var7 = 0;
            if(field1864[3] > 0 || field1864[4] > 0) {
               var7 = (field1812[3] + field1812[4]) / (field1864[3] + field1864[4]);
            }

            var26 = 0;
            if(field1864[6] > 0 || field1864[8] > 0) {
               var26 = (field1812[8] + field1812[6]) / (field1864[8] + field1864[6]);
            }

            var10 = 0;
            var11 = field1864[10];
            int[] var27 = field1835[10];
            int[] var28 = field1851;
            if(var10 == var11) {
               var10 = 0;
               var11 = field1864[11];
            ...
            for(var14 = 0; var14 < 10; ++var14) {
               while(var14 == 0 && var9 > var6) {
                  this.method2676(var27[var10++]);
                  if(var10 == var11 && var27 != field1835[11]) {
                     var10 = 0;
                     var11 = field1864[11];
                     var27 = field1835[11];
                     var28 = field1852;
               ...
               var15 = field1864[var14];
               int[] var29 = field1835[var14];

               for(var17 = 0; var17 < var15; ++var17) {
                  this.method2676(var29[var17]);
               }
            }
   ...
   @ObfuscatedName("aa")
   final void method2676(int var1) {
      if(field1839[var1]) {
         this.method2655(var1);
      } else {
         ...
         if(this.field1815 == null) {
            ...
            Graphics3D.rasterAlpha = this.field1815[var1] & 255;
         }

         if(this.field1817 != null && this.field1817[var1] != -1) {
            int var5;
            int var6;
            int var7;
            if(this.field1816 != null && this.field1816[var1] != -1) {
               int var8 = this.field1816[var1] & 255;
               var5 = this.field1820[var8];
               var6 = this.field1821[var8];
               var7 = this.field1822[var8];
            } else {
               var5 = var2;
               var6 = var3;
               var7 = var4;
            ...
            if(this.field1813[var1] == -1) {
               Graphics3D.rasterTextureAffine(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], this.field1847[var1], this.field1847[var1], this.field1847[var1], yViewportBuffer[var5], yViewportBuffer[var6], yViewportBuffer[var7], field1853[var5], field1853[var6], field1853[var7], field1845[var5], field1845[var6], field1845[var7], this.field1817[var1]);
            } else {
               Graphics3D.rasterTextureAffine(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], this.field1847[var1], this.field1844[var1], this.field1813[var1], yViewportBuffer[var5], yViewportBuffer[var6], yViewportBuffer[var7], field1853[var5], field1853[var6], field1853[var7], field1845[var5], field1845[var6], field1845[var7], this.field1817[var1]);
            }
         } else if(this.field1813[var1] == -1) {
            Graphics3D.rasterFlat(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], field1865[this.field1847[var1]]);
         } else {
            Graphics3D.rasterGouraud(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], this.field1847[var1], this.field1844[var1], this.field1813[var1]);
         }
   ...
   @ObfuscatedName("ap")
   final void method2655(int var1) {
      ...
      int var14;
      if(var8 >= 50) {
         field1854[var4] = modelViewportYs[var5];
         field1855[var4] = modelViewportXs[var5];
         xViewportBuffer[var4++] = this.field1847[var1];
      } else {
         var11 = yViewportBuffer[var5];
         var12 = field1853[var5];
         var13 = this.field1847[var1];
         if(var10 >= 50) {
            var14 = field1860[var10 - var8] * (50 - var8);
            field1854[var4] = var2 + Graphics3D.Rasterizer3D_zoom * (var11 + ((yViewportBuffer[var7] - var11) * var14 >> 16)) / 50;
            field1855[var4] = var3 + Graphics3D.Rasterizer3D_zoom * (var12 + ((field1853[var7] - var12) * var14 >> 16)) / 50;
            xViewportBuffer[var4++] = var13 + ((this.field1813[var1] - var13) * var14 >> 16);
         }

         if(var9 >= 50) {
            var14 = field1860[var9 - var8] * (50 - var8);
            field1854[var4] = var2 + Graphics3D.Rasterizer3D_zoom * (var11 + ((yViewportBuffer[var6] - var11) * var14 >> 16)) / 50;
            field1855[var4] = var3 + Graphics3D.Rasterizer3D_zoom * (var12 + ((field1853[var6] - var12) * var14 >> 16)) / 50;
            xViewportBuffer[var4++] = var13 + ((this.field1844[var1] - var13) * var14 >> 16);
         }
      }

      if(var9 >= 50) {
         field1854[var4] = modelViewportYs[var6];
         field1855[var4] = modelViewportXs[var6];
         xViewportBuffer[var4++] = this.field1844[var1];
      } else {
         var11 = yViewportBuffer[var6];
         var12 = field1853[var6];
         var13 = this.field1844[var1];
         if(var8 >= 50) {
            var14 = field1860[var8 - var9] * (50 - var9);
            field1854[var4] = var2 + Graphics3D.Rasterizer3D_zoom * (var11 + ((yViewportBuffer[var5] - var11) * var14 >> 16)) / 50;
            field1855[var4] = var3 + Graphics3D.Rasterizer3D_zoom * (var12 + ((field1853[var5] - var12) * var14 >> 16)) / 50;
            xViewportBuffer[var4++] = var13 + ((this.field1847[var1] - var13) * var14 >> 16);
         }

         if(var10 >= 50) {
            var14 = field1860[var10 - var9] * (50 - var9);
            field1854[var4] = var2 + Graphics3D.Rasterizer3D_zoom * (var11 + ((yViewportBuffer[var7] - var11) * var14 >> 16)) / 50;
            field1855[var4] = var3 + Graphics3D.Rasterizer3D_zoom * (var12 + ((field1853[var7] - var12) * var14 >> 16)) / 50;
            xViewportBuffer[var4++] = var13 + ((this.field1813[var1] - var13) * var14 >> 16);
         }
      ...
      if(var10 >= 50) {
         field1854[var4] = modelViewportYs[var7];
         field1855[var4] = modelViewportXs[var7];
         xViewportBuffer[var4++] = this.field1813[var1];
      } else {
         var11 = yViewportBuffer[var7];
         var12 = field1853[var7];
         var13 = this.field1813[var1];
         if(var9 >= 50) {
            var14 = field1860[var9 - var10] * (50 - var10);
            field1854[var4] = var2 + Graphics3D.Rasterizer3D_zoom * (var11 + ((yViewportBuffer[var6] - var11) * var14 >> 16)) / 50;
            field1855[var4] = var3 + Graphics3D.Rasterizer3D_zoom * (var12 + ((field1853[var6] - var12) * var14 >> 16)) / 50;
            xViewportBuffer[var4++] = var13 + ((this.field1844[var1] - var13) * var14 >> 16);
         }
         ...
         if(var8 >= 50) {
            var14 = field1860[var8 - var10] * (50 - var10);
            field1854[var4] = var2 + Graphics3D.Rasterizer3D_zoom * (var11 + ((yViewportBuffer[var5] - var11) * var14 >> 16)) / 50;
            field1855[var4] = var3 + Graphics3D.Rasterizer3D_zoom * (var12 + ((field1853[var5] - var12) * var14 >> 16)) / 50;
            xViewportBuffer[var4++] = var13 + ((this.field1847[var1] - var13) * var14 >> 16);
         }
      ...
      if(var4 == 3) {
         ...
         if(this.field1817 != null && this.field1817[var1] != -1) {
            if(this.field1816 != null && this.field1816[var1] != -1) {
               var20 = this.field1816[var1] & 255;
               var17 = this.field1820[var20];
               var18 = this.field1821[var20];
               var19 = this.field1822[var20];
            } else {
               var17 = var5;
               var18 = var6;
               var19 = var7;
            ...
            if(this.field1813[var1] == -1) {
               Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, this.field1847[var1], this.field1847[var1], this.field1847[var1], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1853[var17], field1853[var18], field1853[var19], field1845[var17], field1845[var18], field1845[var19], this.field1817[var1]);
            } else {
               Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, xViewportBuffer[0], xViewportBuffer[1], xViewportBuffer[2], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1853[var17], field1853[var18], field1853[var19], field1845[var17], field1845[var18], field1845[var19], this.field1817[var1]);
            }
         } else if(this.field1813[var1] == -1) {
            Graphics3D.rasterFlat(var14, var15, var16, var11, var12, var13, field1865[this.field1847[var1]]);
         } else {
      ...
      if(var4 == 4) {
         if(var11 < 0 || var12 < 0 || var13 < 0 || var11 > Graphics3D.rasterClipX || var12 > Graphics3D.rasterClipX || var13 > Graphics3D.rasterClipX || field1854[3] < 0 || field1854[3] > Graphics3D.rasterClipX) {
            Graphics3D.rasterClipEnable = true;
         }
         ...
         if(this.field1817 != null && this.field1817[var1] != -1) {
            ...
            short var21 = this.field1817[var1];
            if(this.field1813[var1] == -1) {
               Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, this.field1847[var1], this.field1847[var1], this.field1847[var1], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1853[var17], field1853[var18], field1853[var19], field1845[var17], field1845[var18], field1845[var19], var21);
               Graphics3D.rasterTextureAffine(var14, var16, field1855[3], var11, var13, field1854[3], this.field1847[var1], this.field1847[var1], this.field1847[var1], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1853[var17], field1853[var18], field1853[var19], field1845[var17], field1845[var18], field1845[var19], var21);
            } else {
               Graphics3D.rasterTextureAffine(var14, var15, var16, var11, var12, var13, xViewportBuffer[0], xViewportBuffer[1], xViewportBuffer[2], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1853[var17], field1853[var18], field1853[var19], field1845[var17], field1845[var18], field1845[var19], var21);
               Graphics3D.rasterTextureAffine(var14, var16, field1855[3], var11, var13, field1854[3], xViewportBuffer[0], xViewportBuffer[2], xViewportBuffer[3], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1853[var17], field1853[var18], field1853[var19], field1845[var17], field1845[var18], field1845[var19], var21);
            }
         } else if(this.field1813[var1] == -1) {
            var17 = field1865[this.field1847[var1]];
            Graphics3D.rasterFlat(var14, var15, var16, var11, var12, var13, var17);
            Graphics3D.rasterFlat(var14, var16, field1855[3], var11, var13, field1854[3], var17);
         } else {
            Graphics3D.rasterGouraud(var14, var15, var16, var11, var12, var13, xViewportBuffer[0], xViewportBuffer[1], xViewportBuffer[2]);
            Graphics3D.rasterGouraud(var14, var16, field1855[3], var11, var13, field1854[3], xViewportBuffer[0], xViewportBuffer[2], xViewportBuffer[3]);
         }
      }
            ...
            if(var16 / var13 > Graphics3D.Rasterizer3D_clipNegativeMidX) {
               ...
               if(var19 / var13 > Graphics3D.Rasterizer3D_clipNegativeMidY) {
                  ...
                  if(var21 / var13 < Graphics3D.Rasterizer3D_clipMidY2) {
                     ...
                     boolean var25 = var24 || this.field1819 > 0;
                     int var26 = class46.method694();
                     int var27 = BoundingBox3D.method69();
                     boolean var28 = class131.Viewport_containsMouse;
                     if(class7.drawBoundingBoxes3D && var9 > 0) {
                        if(UnitPriceComparator.boundingBox3DContainsMouse(this, var6, var7, var8)) {
                     ...
                     if(var9 > 0 && var28) {
                        ...
                        if(useBoundingBoxes3D) {
                           var45 = UnitPriceComparator.boundingBox3DContainsMouse(this, var6, var7, var8);
                        } else {
                           var32 = var11 - var12;
                           if(var32 <= 50) {
                              var32 = 50;
                        ...
                        if(var45) {
                           if(this.field1825) {
                              class131.Viewport_entityIdsAtMouse[++class131.Viewport_entityCountAtMouse - 1] = var9;
                           } else {
                              var46 = true;
                           }
                        }
                     ...
                     for(var35 = 0; var35 < this.verticesCount; ++var35) {
                        ...
                        if(var25) {
                           ...
                           field1853[var35] = var39;
                           field1845[var35] = var38;
                        }
                     }

                     try {
                        this.method0(var23, var46, this.field1825, var9);
