...
public abstract class IndexDataBase {
   ...
   public int getFile(String var1) {
      ...
      return this.identifiers.getFile(SceneMapObj.djb2Hash(var1));
   }
   ...
   public int getChild(int var1, String var2) {
      ...
      return this.childIdentifiers[var1].getFile(SceneMapObj.djb2Hash(var2));
   }
   ...
   public boolean method4273(String var1, String var2) {
      var1 = var1.toLowerCase();
      var2 = var2.toLowerCase();
      int var3 = this.identifiers.getFile(SceneMapObj.djb2Hash(var1));
      if(var3 < 0) {
         return false;
      } else {
         int var4 = this.childIdentifiers[var3].getFile(SceneMapObj.djb2Hash(var2));
         return var4 >= 0;
      }
   }
   ...
   public boolean tryLoadArchiveByName(String var1) {
      var1 = var1.toLowerCase();
      int var2 = this.identifiers.getFile(SceneMapObj.djb2Hash(var1));
