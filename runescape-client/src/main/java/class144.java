...
public class class144 extends Node {
   ...
   class144(Buffer var1) {
      ...
      var1.offset += var5 * 3;
      this.field2022 = new byte[var4];
      Buffer var51 = new Buffer(this.field2022);
      var51.method2714(1297377380);
      var51.method2714(6);
      var51.method2712(var2 > 1?1:0);
      var51.method2712(var2);
      var51.method2712(var3);
      var1.offset = var13;
      int var52 = 0;
      int var53 = 0;
      int var54 = 0;
      ...
      for(int var60 = 0; var60 < var2; ++var60) {
         ...
         while(true) {
            while(true) {
               int var63 = var1.method2878();
               var51.method2794(var63);
               int var64 = var1.payload[var29++] & 255;
               boolean var65 = var64 != var62;
               var62 = var64 & 15;
               if(var64 == 7) {
                  if(var65) {
                     var51.method2815(255);
                  }

                  var51.method2815(47);
                  var51.method2815(0);
                  var51.method2802(var51.offset - var61);
                  continue label369;
               }
               ...
               if(var64 == 23) {
                  ...
                  var51.method2815(81);
                  var51.method2815(3);
                  var51.method2815(var1.payload[var50++]);
                  var51.method2815(var1.payload[var50++]);
                  var51.method2815(var1.payload[var50++]);
               } else {
                  var52 ^= var64 >> 4;
                  if(var62 == 0) {
                     if(var65) {
                        var51.method2815(144 + var52);
                     }

                     var53 += var1.payload[var37++];
                     var54 += var1.payload[var38++];
                     var51.method2815(var53 & 127);
                     var51.method2815(var54 & 127);
                  } else if(var62 == 1) {
                     if(var65) {
                        var51.method2815(128 + var52);
                     }

                     var53 += var1.payload[var37++];
                     var55 += var1.payload[var40++];
                     var51.method2815(var53 & 127);
                     var51.method2815(var55 & 127);
                  } else if(var62 == 2) {
                     if(var65) {
                        var51.method2815(176 + var52);
                     }

                     var28 = var28 + var1.payload[var15++] & 127;
                     var51.method2815(var28);
                     byte var66;
                     if(var28 != 0 && var28 != 32) {
                        if(var28 == 1) {
                     ...
                     var59[var28] = var67;
                     var51.method2815(var67 & 127);
                  } else if(var62 == 3) {
                     if(var65) {
                        var51.method2815(224 + var52);
                     }

                     var56 += var1.payload[var45++];
                     var56 += var1.payload[var33++] << 7;
                     var51.method2815(var56 & 127);
                     var51.method2815(var56 >> 7 & 127);
                  } else if(var62 == 4) {
                     if(var65) {
                        var51.method2815(208 + var52);
                     }

                     var57 += var1.payload[var32++];
                     var51.method2815(var57 & 127);
                  } else if(var62 == 5) {
                     if(var65) {
                        var51.method2815(160 + var52);
                     }

                     var53 += var1.payload[var37++];
                     var58 += var1.payload[var31++];
                     var51.method2815(var53 & 127);
                     var51.method2815(var58 & 127);
                  } else {
                     if(var62 != 6) {
                        throw new RuntimeException();
                     }
                     ...
                     if(var65) {
                        var51.method2815(192 + var52);
                     }

                     var51.method2815(var1.payload[var44++]);
                  }
               }
            }
         }
   ...
   @ObfuscatedName("o")
   public static class144 method2646(class182 var0, int var1, int var2) {
   ...
   void method2652() {
      if(this.field2023 == null) {
         this.field2023 = new XHashTable(16);
         int[] var1 = new int[16];
         int[] var2 = new int[16];
         var2[9] = 128;
         var1[9] = 128;
         class141 var4 = new class141(this.field2022);
         int var5 = var4.method2574();

         int var6;
         for(var6 = 0; var6 < var5; ++var6) {
            var4.method2575(var6);
            var4.method2571(var6);
            var4.method2576(var6);
         }

         label82:
         do {
            while(true) {
               var6 = var4.method2582();
               int var7 = var4.field1996[var6];

               while(var4.field1996[var6] == var7) {
                  var4.method2575(var6);
                  int var8 = var4.method2578(var6);
                  if(var8 == 1) {
                     var4.method2577();
                     var4.method2576(var6);
                     continue label82;
                  ...
                  if(var9 == 144) {
                     ...
                     if(var12 > 0) {
                        ...
                        class134 var14 = (class134)this.field2023.method2299((long)var13);
                        if(var14 == null) {
                           var14 = new class134(new byte[128]);
                           this.field2023.method2291(var14, (long)var13);
                        }

                        var14.field1909[var11] = 1;
                     }
                  }
