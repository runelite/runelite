...
public class class82 extends CacheableNode {
   ...
   @ObfuscatedName("o")
   protected static int field1455 = 0;
   @ObfuscatedName("q")
   protected static int field1456 = 0;
   @ObfuscatedName("u")
   ...
   public static void method1794() {
      field1456 = 0;
      field1452 = 0;
      field1455 = graphicsPixelsWidth;
      field1454 = graphicsPixelsHeight;
   }

   @ObfuscatedName("ck")
   public static void method1795(int var0, int var1, int var2, int var3) {
      if(var0 < 0) {
         var0 = 0;
      }
   ...
   public static void setRasterBuffer(int[] var0, int var1, int var2) {
      ...
      method1795(0, 0, var1, var2);
   }

   @ObfuscatedName("cz")
   public static void method1800(int var0, int var1, int var2, int var3, int var4, int var5) {
      if(var0 < field1456) {
         var2 -= field1456 - var0;
         var0 = field1456;
      }
      ...
      if(var0 + var2 > field1455) {
         var2 = field1455 - var0;
      }

      if(var1 + var3 > field1454) {
         var3 = field1454 - var1;
      }
   ...
   @ObfuscatedName("db")
   public static void method1804(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = 65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   @ObfuscatedName("do")
   public static void method1805(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = 65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   public static void method1808(int var0, int var1, int var2, int var3, int var4, int var5) {
      method1810(var0, var1, var2, var4, var5);
      method1810(var0, var1 + var3 - 1, var2, var4, var5);
      if(var3 >= 3) {
         method1812(var0, var1 + 1, var3 - 2, var4, var5);
         method1812(var0 + var2 - 1, var1 + 1, var3 - 2, var4, var5);
      }
   ...
   public static void method1809(int var0, int var1, int var2, int var3) {
      if(var1 >= field1452 && var1 < field1454) {
         if(var0 < field1456) {
            var2 -= field1456 - var0;
            var0 = field1456;
         }
   ...
   @ObfuscatedName("da")
   static void method1812(int var0, int var1, int var2, int var3, int var4) {
      if(var0 >= field1456 && var0 < field1455) {
         if(var1 < field1452) {
            var2 -= field1452 - var1;
            var1 = field1452;
         }

         if(var1 + var2 > field1454) {
            var2 = field1454 - var1;
         }
   ...
   public static void method1813(int var0, int var1, int var2, int var3, int var4) {
      ...
      if(var3 == 0) {
         if(var2 >= 0) {
            method1809(var0, var1, var2 + 1, var4);
         } else {
            method1809(var0 + var2, var1, -var2 + 1, var4);
         }

      } else if(var2 == 0) {
         if(var3 >= 0) {
            method1833(var0, var1, var3 + 1, var4);
         } else {
            method1833(var0, var1 + var3, -var3 + 1, var4);
         }
         ...
         if(var2 > var3) {
            ...
            while(var0 <= var2) {
               var6 = var1 >> 16;
               if(var6 >= field1452 && var6 < field1454) {
            ...
            while(var1 <= var3) {
               var6 = var0 >> 16;
               if(var6 >= field1456 && var6 < field1455) {
   ...
   @ObfuscatedName("dn")
   public static void method1814(int var0, int var1, int var2, int[] var3, int[] var4) {
   ...
   public static void method1815(int var0, int var1, int var2, int var3, int var4) {
      method1809(var0, var1, var2, var4);
      method1809(var0, var1 + var3 - 1, var2, var4);
      method1833(var0, var1, var3, var4);
      method1833(var0 + var2 - 1, var1, var3, var4);
   }

   @ObfuscatedName("dx")
   public static void method1833(int var0, int var1, int var2, int var3) {
      if(var0 >= field1456 && var0 < field1455) {
         if(var1 < field1452) {
            var2 -= field1452 - var1;
            var1 = field1452;
