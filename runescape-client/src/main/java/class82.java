...
public class class82 {
   ...
   static int method1715(int var0, Script var1, boolean var2) {
      if(var0 < 1000) {
         ...
         return BoundingBox3D.method63(var0, var1, var2);
      } else if(var0 < 1300) {
         ...
         return UrlRequester.method3021(var0, var1, var2);
      } else {
         byte var3;
         Widget var29;
         if(var0 < 1700) {
            ...
            if(var0 == 1600) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.scrollX;
               var3 = 1;
            } else if(var0 == 1601) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.scrollY;
               var3 = 1;
            } else if(var0 == 1602) {
               scriptStringStack[++scriptStringStackSize - 1] = var29.text;
               var3 = 1;
            } else if(var0 == 1603) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.scrollWidth;
               var3 = 1;
            } else if(var0 == 1604) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.scrollHeight;
               var3 = 1;
            } else if(var0 == 1605) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.modelZoom;
               var3 = 1;
            } else if(var0 == 1606) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.rotationX;
               var3 = 1;
            } else if(var0 == 1607) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.rotationY;
               var3 = 1;
            } else if(var0 == 1608) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.rotationZ;
               var3 = 1;
            } else if(var0 == 1609) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.opacity;
               var3 = 1;
            } else if(var0 == 1610) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.field2729;
               var3 = 1;
            } else if(var0 == 1611) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.textColor;
               var3 = 1;
            } else if(var0 == 1612) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.field2750;
               var3 = 1;
            } else if(var0 == 1613) {
               intStack[++GrandExchangeEvents.intStackSize - 1] = var29.field2754.rsOrdinal();
               var3 = 1;
            } else {
               var3 = 2;
            }
            ...
            if(var0 < 1800) {
               ...
               if(var0 == 1700) {
                  intStack[++GrandExchangeEvents.intStackSize - 1] = var25.itemId;
                  var3 = 1;
               } else if(var0 == 1701) {
                  if(var25.itemId != -1) {
                     intStack[++GrandExchangeEvents.intStackSize - 1] = var25.itemQuantity;
                  } else {
                     intStack[++GrandExchangeEvents.intStackSize - 1] = 0;
                  }

                  var3 = 1;
               } else if(var0 == 1702) {
                  intStack[++GrandExchangeEvents.intStackSize - 1] = var25.index;
                  var3 = 1;
               } else {
                  var3 = 2;
               }
               ...
               if(var0 < 2000) {
                  ...
                  if(var0 >= 2000) {
                     var12 = var0 - 1000;
                     var31 = class87.getWidget(intStack[--GrandExchangeEvents.intStackSize]);
                  } else {
                  ...
                  var29 = class87.getWidget(intStack[--GrandExchangeEvents.intStackSize]);
                  if(var0 == 2500) {
                     intStack[++GrandExchangeEvents.intStackSize - 1] = var29.relativeX;
                     var3 = 1;
                  } else if(var0 == 2501) {
                     intStack[++GrandExchangeEvents.intStackSize - 1] = var29.relativeY;
                     var3 = 1;
                  } else if(var0 == 2502) {
                     intStack[++GrandExchangeEvents.intStackSize - 1] = var29.width;
                     var3 = 1;
                  } else if(var0 == 2503) {
                     intStack[++GrandExchangeEvents.intStackSize - 1] = var29.height;
                     var3 = 1;
                  } else if(var0 == 2504) {
                     intStack[++GrandExchangeEvents.intStackSize - 1] = var29.isHidden?1:0;
                     var3 = 1;
                  } else if(var0 == 2505) {
                     intStack[++GrandExchangeEvents.intStackSize - 1] = var29.parentId;
                     var3 = 1;
                  } else {
                     var3 = 2;
                  }
                  ...
                  if(var0 == 2700) {
                     var29 = class87.getWidget(intStack[--GrandExchangeEvents.intStackSize]);
                     intStack[++GrandExchangeEvents.intStackSize - 1] = var29.itemId;
                     var3 = 1;
                  } else if(var0 == 2701) {
                     var29 = class87.getWidget(intStack[--GrandExchangeEvents.intStackSize]);
                     if(var29.itemId != -1) {
                        intStack[++GrandExchangeEvents.intStackSize - 1] = var29.itemQuantity;
                     } else {
                        intStack[++GrandExchangeEvents.intStackSize - 1] = 0;
                     }
                     ...
                     var12 = intStack[--GrandExchangeEvents.intStackSize];
                     WidgetNode var33 = (WidgetNode)Client.componentTable.get((long)var12);
                     if(var33 != null) {
                        intStack[++GrandExchangeEvents.intStackSize - 1] = 1;
                     } else {
                        intStack[++GrandExchangeEvents.intStackSize - 1] = 0;
                     }
                     ...
                     intStack[++GrandExchangeEvents.intStackSize - 1] = Client.widgetRoot;
                     var3 = 1;
                  } else {
                     var3 = 2;
                  }
                  ...
                  if(var0 < 2900) {
                     ...
                     if(var0 == 2800) {
                        ...
                        var15 = intStack[--GrandExchangeEvents.intStackSize];
                        --var15;
                     ...
                     if(var0 < 3200) {
                        if(var0 == 3100) {
                           ...
                           MouseRecorder.method1130(class181.localPlayer, intStack[GrandExchangeEvents.intStackSize], intStack[GrandExchangeEvents.intStackSize + 1]);
                           var3 = 1;
                        } else if(var0 == 3103) {
                           ...
                           var12 = intStack[GrandExchangeEvents.intStackSize];
                           var15 = intStack[GrandExchangeEvents.intStackSize + 1];
                           var6 = intStack[GrandExchangeEvents.intStackSize + 2];
                           var25 = class87.getWidget(var6);
                           AttackOption.method1767(var25, var12, var15);
                           var3 = 1;
                        } else if(var0 == 3109) {
                           GrandExchangeEvents.intStackSize -= 2;
                           var12 = intStack[GrandExchangeEvents.intStackSize];
                           ...
                           AttackOption.method1767(var35, var12, var15);
                           var3 = 1;
                        } else if(var0 == 3110) {
                           Client.field956 = intStack[--GrandExchangeEvents.intStackSize] == 1;
                           var3 = 1;
                        } else if(var0 == 3111) {
                           intStack[++GrandExchangeEvents.intStackSize - 1] = RSCanvas.preferences.hideRoofs?1:0;
                           var3 = 1;
                        } else if(var0 == 3112) {
                           RSCanvas.preferences.hideRoofs = intStack[--GrandExchangeEvents.intStackSize] == 1;
                           class64.method1103();
                           var3 = 1;
                        } else if(var0 == 3113) {
                           var4 = scriptStringStack[--scriptStringStackSize];
                           var38 = intStack[--GrandExchangeEvents.intStackSize] == 1;
                           ...
                           Client.field1002 = intStack[--GrandExchangeEvents.intStackSize] == 1;
                           var3 = 1;
                        } else {
                           var3 = 2;
                        }
                        ...
                        return BoundingBox.method55(var0, var1, var2);
                     } else if(var0 < 3400) {
                        ...
                        if(var0 == 3600) {
                           if(Client.field1022 == 0) {
                              intStack[++GrandExchangeEvents.intStackSize - 1] = -2;
                           } else if(Client.field1022 == 1) {
                              intStack[++GrandExchangeEvents.intStackSize - 1] = -1;
                           } else {
                              intStack[++GrandExchangeEvents.intStackSize - 1] = Client.friendCount;
                           }
                           ...
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           if(Client.field1022 == 2 && var12 < Client.friendCount) {
                              intStack[++GrandExchangeEvents.intStackSize - 1] = Client.friends[var12].world;
                           } else {
                              intStack[++GrandExchangeEvents.intStackSize - 1] = 0;
                           }
                           ...
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           if(Client.field1022 == 2 && var12 < Client.friendCount) {
                              intStack[++GrandExchangeEvents.intStackSize - 1] = Client.friends[var12].rank;
                           } else {
                              intStack[++GrandExchangeEvents.intStackSize - 1] = 0;
                           }
                           ...
                           if(var0 == 3605) {
                              ...
                              if(var4 != null) {
                                 if((Client.friendCount < 200 || Client.field976 == 1) && Client.friendCount < 400) {
                                    var27 = GraphicsObject.cleanUsername(var4, class236.jagexLoginType);
                                    if(var27 != null) {
                                       var6 = 0;
                                       ...
                                       while(true) {
                                          if(var6 >= Client.friendCount) {
                                             for(var6 = 0; var6 < Client.ignoreCount; ++var6) {
                                                ...
                                                var16 = GraphicsObject.cleanUsername(var23.name, class236.jagexLoginType);
                                                ...
                                                if(var23.previousName != null) {
                                                   var9 = GraphicsObject.cleanUsername(var23.previousName, class236.jagexLoginType);
                                             ...
                                             if(GraphicsObject.cleanUsername(class181.localPlayer.name, class236.jagexLoginType).equals(var27)) {
                                          ...
                                          var16 = GraphicsObject.cleanUsername(var7.name, class236.jagexLoginType);
                                          if(var16 != null && var16.equals(var27)) {
                                          ...
                                          if(var7.previousName != null) {
                                             var9 = GraphicsObject.cleanUsername(var7.previousName, class236.jagexLoginType);
                                             if(var9 != null && var9.equals(var27)) {
                                                class54.sendGameMessage(30, "", var4 + " is already on your friend list");
                                                break;
                                             }
                              ...
                              if(var4 != null) {
                                 ...
                                 if(var27 != null) {
                                    for(var6 = 0; var6 < Client.ignoreCount; ++var6) {
                                       var23 = Client.ignores[var6];
                                       var16 = var23.name;
                                       var9 = GraphicsObject.cleanUsername(var16, class236.jagexLoginType);
                                       boolean var30;
                              ...
                              intStack[++GrandExchangeEvents.intStackSize - 1] = IntegerToken.isFriended(var4, false)?1:0;
                              var3 = 1;
                           } else if(var0 == 3611) {
                              ...
                              if(Client.clanChatOwner != null) {
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = class61.clanChatCount;
                              } else {
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = 0;
                              }
                              ...
                              var12 = intStack[--GrandExchangeEvents.intStackSize];
                              if(Client.clanChatOwner != null && var12 < class61.clanChatCount) {
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = class188.clanMembers[var12].world;
                              } else {
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = 0;
                              }
                              ...
                              var12 = intStack[--GrandExchangeEvents.intStackSize];
                              if(Client.clanChatOwner != null && var12 < class61.clanChatCount) {
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = class188.clanMembers[var12].rank;
                              } else {
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = 0;
                              }
                              ...
                              intStack[++GrandExchangeEvents.intStackSize - 1] = class60.field720;
                              var3 = 1;
                           } else if(var0 == 3617) {
                              var4 = scriptStringStack[--scriptStringStackSize];
                              ...
                              intStack[++GrandExchangeEvents.intStackSize - 1] = GrandExchangeEvent.clanChatRank;
                              var3 = 1;
                           } else if(var0 == 3619) {
                              var4 = scriptStringStack[--scriptStringStackSize];
                              ...
                              if(Client.field1022 == 0) {
                                 ...
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = Client.ignoreCount;
                              }
                              ...
                              intStack[++GrandExchangeEvents.intStackSize - 1] = class29.isIgnored(var4)?1:0;
                              var3 = 1;
                           } else if(var0 == 3624) {
                              var12 = intStack[--GrandExchangeEvents.intStackSize];
                        ...
                        if(var0 == 3903) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           intStack[++GrandExchangeEvents.intStackSize - 1] = Client.grandExchangeOffers[var12].type();
                           var3 = 1;
                        } else if(var0 == 3904) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           intStack[++GrandExchangeEvents.intStackSize - 1] = Client.grandExchangeOffers[var12].itemId;
                           var3 = 1;
                        } else if(var0 == 3905) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           intStack[++GrandExchangeEvents.intStackSize - 1] = Client.grandExchangeOffers[var12].price;
                           var3 = 1;
                        } else if(var0 == 3906) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           intStack[++GrandExchangeEvents.intStackSize - 1] = Client.grandExchangeOffers[var12].totalQuantity;
                           var3 = 1;
                        } else if(var0 == 3907) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           intStack[++GrandExchangeEvents.intStackSize - 1] = Client.grandExchangeOffers[var12].quantitySold;
                           var3 = 1;
                        } else if(var0 == 3908) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           intStack[++GrandExchangeEvents.intStackSize - 1] = Client.grandExchangeOffers[var12].spent;
                           var3 = 1;
                        } else if(var0 == 3910) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           var15 = Client.grandExchangeOffers[var12].status();
                           intStack[++GrandExchangeEvents.intStackSize - 1] = var15 == 0?1:0;
                           var3 = 1;
                        } else if(var0 == 3911) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           var15 = Client.grandExchangeOffers[var12].status();
                           intStack[++GrandExchangeEvents.intStackSize - 1] = var15 == 2?1:0;
                           var3 = 1;
                        } else if(var0 == 3912) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           var15 = Client.grandExchangeOffers[var12].status();
                           intStack[++GrandExchangeEvents.intStackSize - 1] = var15 == 5?1:0;
                           var3 = 1;
                        } else if(var0 == 3913) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           var15 = Client.grandExchangeOffers[var12].status();
                           intStack[++GrandExchangeEvents.intStackSize - 1] = var15 == 1?1:0;
                           var3 = 1;
                        } else {
                           boolean var40;
                           if(var0 == 3914) {
                              var40 = intStack[--GrandExchangeEvents.intStackSize] == 1;
                              if(BaseVarType.grandExchangeEvents != null) {
                                 BaseVarType.grandExchangeEvents.sort(GrandExchangeEvents.field264, var40);
                              }
                              ...
                              var40 = intStack[--GrandExchangeEvents.intStackSize] == 1;
                              if(BaseVarType.grandExchangeEvents != null) {
                                 BaseVarType.grandExchangeEvents.sort(GrandExchangeEvents.field271, var40);
                              }
                              ...
                              GrandExchangeEvents.intStackSize -= 2;
                              var40 = intStack[GrandExchangeEvents.intStackSize] == 1;
                              var38 = intStack[GrandExchangeEvents.intStackSize + 1] == 1;
                              if(BaseVarType.grandExchangeEvents != null) {
                                 Client.field1129.field863 = var38;
                                 BaseVarType.grandExchangeEvents.sort(Client.field1129, var40);
                              }
                              ...
                              var40 = intStack[--GrandExchangeEvents.intStackSize] == 1;
                              if(BaseVarType.grandExchangeEvents != null) {
                                 BaseVarType.grandExchangeEvents.sort(GrandExchangeEvents.field266, var40);
                              }
                              ...
                              var40 = intStack[--GrandExchangeEvents.intStackSize] == 1;
                              if(BaseVarType.grandExchangeEvents != null) {
                                 BaseVarType.grandExchangeEvents.sort(GrandExchangeEvents.field263, var40);
                              }

                              var3 = 1;
                           } else if(var0 == 3919) {
                              intStack[++GrandExchangeEvents.intStackSize - 1] = BaseVarType.grandExchangeEvents == null?0:BaseVarType.grandExchangeEvents.events.size();
                              var3 = 1;
                           } else {
                              GrandExchangeEvent var22;
                              if(var0 == 3920) {
                                 var12 = intStack[--GrandExchangeEvents.intStackSize];
                                 var22 = (GrandExchangeEvent)BaseVarType.grandExchangeEvents.events.get(var12);
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = var22.world;
                                 var3 = 1;
                              } else if(var0 == 3921) {
                                 var12 = intStack[--GrandExchangeEvents.intStackSize];
                                 var22 = (GrandExchangeEvent)BaseVarType.grandExchangeEvents.events.get(var12);
                                 ...
                                 var12 = intStack[--GrandExchangeEvents.intStackSize];
                                 var22 = (GrandExchangeEvent)BaseVarType.grandExchangeEvents.events.get(var12);
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = var22.grandExchangeOffer.totalQuantity;
                                 var3 = 1;
                              } else if(var0 == 3925) {
                                 var12 = intStack[--GrandExchangeEvents.intStackSize];
                                 var22 = (GrandExchangeEvent)BaseVarType.grandExchangeEvents.events.get(var12);
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = var22.grandExchangeOffer.price;
                                 var3 = 1;
                              } else if(var0 == 3926) {
                                 var12 = intStack[--GrandExchangeEvents.intStackSize];
                                 var22 = (GrandExchangeEvent)BaseVarType.grandExchangeEvents.events.get(var12);
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = var22.grandExchangeOffer.itemId;
                                 var3 = 1;
                              } else {
                                 var3 = 2;
                              }
                        ...
                        if(var0 == 4200) {
                           ...
                           if(var0 == 4201) {
                              ...
                              var12 = intStack[--GrandExchangeEvents.intStackSize];
                              intStack[++GrandExchangeEvents.intStackSize - 1] = WorldMapType2.getItemDefinition(var12).price;
                              var3 = 1;
                           } else if(var0 == 4204) {
                              var12 = intStack[--GrandExchangeEvents.intStackSize];
                              intStack[++GrandExchangeEvents.intStackSize - 1] = WorldMapType2.getItemDefinition(var12).isStackable == 1?1:0;
                              var3 = 1;
                           } else {
                              ...
                              if(var0 == 4205) {
                                 ...
                                 if(var21.notedTemplate == -1 && var21.note >= 0) {
                                    intStack[++GrandExchangeEvents.intStackSize - 1] = var21.note;
                                 } else {
                                    intStack[++GrandExchangeEvents.intStackSize - 1] = var12;
                                 }
                                 ...
                                 var12 = intStack[--GrandExchangeEvents.intStackSize];
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = WorldMapType2.getItemDefinition(var12).isMembers?1:0;
                                 var3 = 1;
                              } else if(var0 == 4208) {
                                 var12 = intStack[--GrandExchangeEvents.intStackSize];
                                 var21 = WorldMapType2.getItemDefinition(var12);
                                 if(var21.int3 == -1 && var21.int2 >= 0) {
                                    intStack[++GrandExchangeEvents.intStackSize - 1] = var21.int2;
                                 } else {
                                    intStack[++GrandExchangeEvents.intStackSize - 1] = var12;
                                 }
                                 ...
                                 intStack[++GrandExchangeEvents.intStackSize - 1] = class229.field2911;
                                 var3 = 1;
                              } else if(var0 == 4211) {
                                 if(SoundTaskDataProvider.field626 != null && class20.field321 < class229.field2911) {
                                    intStack[++GrandExchangeEvents.intStackSize - 1] = SoundTaskDataProvider.field626[++class20.field321 - 1] & '\uffff';
                                 } else {
                                    intStack[++GrandExchangeEvents.intStackSize - 1] = -1;
                                 }
                        ...
                        if(var0 < 5600) {
                           if(var0 == 5504) {
                              GrandExchangeEvents.intStackSize -= 2;
                              var14 = intStack[GrandExchangeEvents.intStackSize];
                              var8 = intStack[GrandExchangeEvents.intStackSize + 1];
                              if(!Client.field1100) {
                              ...
                              intStack[++GrandExchangeEvents.intStackSize - 1] = Client.field997;
                              var3 = 1;
                           } else if(var0 == 5506) {
                              intStack[++GrandExchangeEvents.intStackSize - 1] = Client.mapAngle;
                              var3 = 1;
                           } else if(var0 == 5530) {
                              var14 = intStack[--GrandExchangeEvents.intStackSize];
                              if(var14 < 0) {
                              ...
                              intStack[++GrandExchangeEvents.intStackSize - 1] = Client.field943;
                              var3 = 1;
                           } else {
                              var3 = 2;
                           }
                        ...
                        if(var0 == 5306) {
                           intStack[++GrandExchangeEvents.intStackSize - 1] = ISAACCipher.method3604();
                           var3 = 1;
                        } else if(var0 == 5307) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           if(var12 == 1 || var12 == 2) {
                           ...
                           intStack[++GrandExchangeEvents.intStackSize - 1] = RSCanvas.preferences.screenType;
                           var3 = 1;
                        } else if(var0 == 5309) {
                           var12 = intStack[--GrandExchangeEvents.intStackSize];
                           if(var12 == 1 || var12 == 2) {
   ...
   static void method1683(World var0) {
      ...
      class48.port1 = Client.socketType == 0?43594:var0.id + 40000;
      Client.port2 = Client.socketType == 0?443:var0.id + 50000;
