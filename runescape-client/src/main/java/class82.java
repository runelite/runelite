...
public class class82 extends CacheableNode {
   ...
   @ObfuscatedName("u")
   protected static int field1452 = 0;
   @ObfuscatedName("a")
   protected static int field1453 = 0;
   ...
   public static void method1824() {
      field1452 = 0;
      field1450 = 0;
      field1453 = graphicsPixelsWidth;
      field1451 = graphicsPixelsHeight;
   }
   ...
   @ObfuscatedName("cv")
   public static void method1826(int var0, int var1, int var2, int var3) {
      if(field1452 < var0) {
         field1452 = var0;
      }
   ...
   public static void method1827(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      if(var1 < field1450) {
         var8 += (field1450 - var1) * var9;
         var3 -= field1450 - var1;
         var1 = field1450;
      }

      if(var0 + var2 > field1453) {
         var2 = field1453 - var0;
      }

      if(var1 + var3 > field1451) {
         var3 = field1451 - var1;
      }
   ...
   @ObfuscatedName("da")
   public static void method1831(int var0, int var1, int var2, int var3, int var4) {
      if(var0 < field1452) {
         var2 -= field1452 - var0;
         var0 = field1452;
      }
   ...
   @ObfuscatedName("dd")
   static void method1832(int var0, int var1, int var2, int var3, int var4) {
      if(var0 >= field1452 && var0 < field1453) {
         if(var1 < field1450) {
            var2 -= field1450 - var1;
            var1 = field1450;
         }

         if(var1 + var2 > field1451) {
            var2 = field1451 - var1;
         }
   ...
   public static void method1834(int var0, int var1, int var2, int var3) {
      if(var1 >= field1450 && var1 < field1451) {
         if(var0 < field1452) {
            var2 -= field1452 - var0;
            var0 = field1452;
         }
   ...
   @ObfuscatedName("dj")
   public static void method1835(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = 65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   @ObfuscatedName("dw")
   public static void method1837(int var0, int var1, int var2, int var3, int var4) {
      method1834(var0, var1, var2, var4);
      method1834(var0, var1 + var3 - 1, var2, var4);
      method1841(var0, var1, var3, var4);
      method1841(var0 + var2 - 1, var1, var3, var4);
   }

   @ObfuscatedName("dq")
   static void method1840(int var0, int var1, int var2, int var3, int var4) {
      if(var1 >= field1450 && var1 < field1451) {
         if(var0 < field1452) {
            var2 -= field1452 - var0;
            var0 = field1452;
   ...
   @ObfuscatedName("db")
   public static void method1841(int var0, int var1, int var2, int var3) {
      if(var0 >= field1452 && var0 < field1453) {
         if(var1 < field1450) {
            var2 -= field1450 - var1;
            var1 = field1450;
   ...
   @ObfuscatedName("dt")
   public static void method1843(int var0, int var1, int var2, int var3, int var4) {
      var2 -= var0;
      var3 -= var1;
      if(var3 == 0) {
         if(var2 >= 0) {
            method1834(var0, var1, var2 + 1, var4);
         } else {
            method1834(var0 + var2, var1, -var2 + 1, var4);
         }

      } else if(var2 == 0) {
         if(var3 >= 0) {
            method1841(var0, var1, var3 + 1, var4);
         } else {
            method1841(var0, var1 + var3, -var3 + 1, var4);
         }
         ...
         if(var2 > var3) {
            ...
            while(var0 <= var2) {
               var6 = var1 >> 16;
               if(var6 >= field1450 && var6 < field1451) {
            ...
            while(var1 <= var3) {
               var6 = var0 >> 16;
               if(var6 >= field1452 && var6 < field1453) {
   ...
   @ObfuscatedName("dc")
   public static void method1844(int var0, int var1, int var2, int[] var3, int[] var4) {
   ...
   @ObfuscatedName("cy")
   public static void method1856(int var0, int var1, int var2, int var3, int var4, int var5) {
      if(var0 < field1452) {
         var2 -= field1452 - var0;
         var0 = field1452;
      }
   ...
   public static void method1892(int var0, int var1, int var2, int var3, int var4, int var5) {
      method1840(var0, var1, var2, var4, var5);
      method1840(var0, var1 + var3 - 1, var2, var4, var5);
      if(var3 >= 3) {
         method1832(var0, var1 + 1, var3 - 2, var4, var5);
         method1832(var0 + var2 - 1, var1 + 1, var3 - 2, var4, var5);
      }
