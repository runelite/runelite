...
public class class82 extends CacheableNode {
   @ObfuscatedName("x")
   protected static int field1465 = 0;
   @ObfuscatedName("c")
   ...
   @ObfuscatedName("k")
   protected static int field1471 = 0;
   ...
   public static void method1830() {
      field1465 = 0;
      field1466 = 0;
      field1471 = graphicsPixelsWidth;
      field1469 = graphicsPixelsHeight;
   }
   ...
   @ObfuscatedName("cg")
   public static void method1833(int[] var0) {
      var0[0] = field1465;
      var0[1] = field1466;
      var0[2] = field1471;
      var0[3] = field1469;
   ...
   @ObfuscatedName("cz")
   public static void method1834(int[] var0) {
      field1465 = var0[0];
      field1466 = var0[1];
      field1471 = var0[2];
      field1469 = var0[3];
   ...
   @ObfuscatedName("ce")
   public static void method1836(int var0, int var1, int var2, int var3, int var4, int var5) {
      if(var0 < field1465) {
         var2 -= field1465 - var0;
         var0 = field1465;
      }
      ...
      if(var0 + var2 > field1471) {
         var2 = field1471 - var0;
      }

      if(var1 + var3 > field1469) {
         var3 = field1469 - var1;
      }
   ...
   public static void method1842(int var0, int var1, int var2, int var3, int var4, int var5) {
      int var6 = 0;
      int var7 = 65536 / var3;
      if(var0 < field1465) {
         var2 -= field1465 - var0;
   ...
   @ObfuscatedName("dq")
   public static void method1845(int var0, int var1, int var2, int var3) {
      if(var0 >= field1465 && var0 < field1471) {
         if(var1 < field1466) {
            var2 -= field1466 - var1;
            var1 = field1466;
         }

         if(var1 + var2 > field1469) {
            var2 = field1469 - var1;
         }
   ...
   public static void setRasterBuffer(int[] var0, int var1, int var2) {
      ...
      method1831(0, 0, var1, var2);
   }

   @ObfuscatedName("da")
   static void method1848(int var0, int var1, int var2, int var3, int var4) {
      if(var0 >= field1465 && var0 < field1471) {
         if(var1 < field1466) {
            var2 -= field1466 - var1;
            var1 = field1466;
   ...
   @ObfuscatedName("dz")
   public static void method1849(int var0, int var1, int var2, int var3, int var4) {
      var2 -= var0;
      var3 -= var1;
      if(var3 == 0) {
         if(var2 >= 0) {
            method1879(var0, var1, var2 + 1, var4);
         } else {
            method1879(var0 + var2, var1, -var2 + 1, var4);
         }

      } else if(var2 == 0) {
         if(var3 >= 0) {
            method1845(var0, var1, var3 + 1, var4);
         } else {
            method1845(var0, var1 + var3, -var3 + 1, var4);
         }
         ...
         if(var2 > var3) {
            ...
            while(var0 <= var2) {
               var6 = var1 >> 16;
               if(var6 >= field1466 && var6 < field1469) {
            ...
            while(var1 <= var3) {
               var6 = var0 >> 16;
               if(var6 >= field1465 && var6 < field1471) {
   ...
   @ObfuscatedName("dg")
   public static void method1850(int var0, int var1, int var2, int[] var3, int[] var4) {
   ...
   @ObfuscatedName("dd")
   public static void method1856(int var0, int var1, int var2, int var3, int var4) {
      method1879(var0, var1, var2, var4);
      method1879(var0, var1 + var3 - 1, var2, var4);
      method1845(var0, var1, var3, var4);
      method1845(var0 + var2 - 1, var1, var3, var4);
   }

   @ObfuscatedName("do")
   public static void method1879(int var0, int var1, int var2, int var3) {
      if(var1 >= field1466 && var1 < field1469) {
         if(var0 < field1465) {
            var2 -= field1465 - var0;
            var0 = field1465;
         }
   ...
   @ObfuscatedName("dj")
   public static void method1884(int var0, int var1, int var2, int var3, int var4, int var5) {
      method1892(var0, var1, var2, var4, var5);
      method1892(var0, var1 + var3 - 1, var2, var4, var5);
      if(var3 >= 3) {
         method1848(var0, var1 + 1, var3 - 2, var4, var5);
         method1848(var0 + var2 - 1, var1 + 1, var3 - 2, var4, var5);
      }

   }

   @ObfuscatedName("ck")
   public static void method1886(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = var4 == var5 && var6 == var7?-1:65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   @ObfuscatedName("dp")
   static void method1892(int var0, int var1, int var2, int var3, int var4) {
      if(var1 >= field1466 && var1 < field1469) {
         if(var0 < field1465) {
            var2 -= field1465 - var0;
            var0 = field1465;
