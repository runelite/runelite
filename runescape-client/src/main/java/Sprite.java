...
public final class Sprite extends Rasterizer2D {
   ...
   @ObfuscatedName("j")
   public void method309(int var1, int var2, int var3, int var4) {
      if (var3 > 0 && var4 > 0) {
   ...
   @ObfuscatedName("h")
   public void method310(int var1, int var2, int var3) {
      var1 += this.yOffset;
      var2 += this.xOffset;
   ...
   @ObfuscatedName("c")
   public void method311(int var1, int var2, int var3, int var4, int var5) {
      if (var3 > 0 && var4 > 0) {
         int var6 = this.subWidth;
         int var7 = this.subHeight;
         int var8 = 0;
   ...
   @ObfuscatedName("v")
   public void method312(int var1, int var2, int var3) {
      var1 += this.yOffset;
      var2 += this.xOffset;
      int var4 = var1 + var2 * Rasterizer2D.Rasterizer2D_width;
      int var5 = 0;
   ...
   @ObfuscatedName("aj")
   public void method313(int var1, int var2, int var3, int var4, int var5) {
      if (var3 > 0 && var4 > 0) {
         int var6 = this.subWidth;
         int var7 = this.subHeight;
         int var8 = 0;
   ...
   @ObfuscatedName("ac")
   public void method314(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
   ...
   @ObfuscatedName("ah")
   public void method316(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
      try {
         int var10 = -var3 / 2;
         int var11 = -var4 / 2;
   ...
   @ObfuscatedName("ak")
   public void method317(int var1, int var2, int var3, int var4) {
      this.method318(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4);
   }

   @ObfuscatedName("aw")
   void method318(int var1, int var2, int var3, int var4, int var5, int var6) {
      if (var6 != 0) {
         var1 -= this.yOffset << 4;
         var2 -= this.xOffset << 4;
   ...
   @ObfuscatedName("al")
   public void method319(int var1, int var2, int var3, int var4) {
