...
public final class SpritePixels extends Rasterizer2D {
   ...
   @ObfuscatedName("j")
   public SpritePixels method4138() {
   ...
   @ObfuscatedName("u")
   public void method4142(int var1) {
   ...
   @ObfuscatedName("l")
   public void method4147(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var2 + var5 > Rasterizer2D.field3187) {
         var5 -= var2 + var5 - Rasterizer2D.field3187;
      }

      if(var1 < Rasterizer2D.field3192) {
         var9 = Rasterizer2D.field3192 - var1;
         var6 -= var9;
      ...
      if(var1 + var6 > Rasterizer2D.field3190) {
         var9 = var1 + var6 - Rasterizer2D.field3190;
         var6 -= var9;
         var8 += var9;
         var7 += var9;
      }
      ...
      if(var6 > 0 && var5 > 0) {
         method4148(Rasterizer2D.graphicsPixels, this.image, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("s")
   static void method4148(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
   ...
   public void method4149(int var1, int var2) {
      ...
      if(var6 > 0 && var5 > 0) {
         method4150(Rasterizer2D.graphicsPixels, this.image, 0, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("m")
   static void method4150(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("i")
   public void method4151(int var1, int var2, int var3, int var4) {
      if(var3 > 0 && var4 > 0) {
         int var5 = this.width;
         ...
         if(var1 + var3 > Rasterizer2D.field3190) {
            var15 = var1 + var3 - Rasterizer2D.field3190;
            var3 -= var15;
            var14 += var15;
         }

         if(var1 < Rasterizer2D.field3192) {
            var15 = Rasterizer2D.field3192 - var1;
            var3 -= var15;
            var13 += var15;
            var7 += var11 * var15;
            var14 += var15;
         ...
         method4152(Rasterizer2D.graphicsPixels, this.image, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5);
      }
   }

   @ObfuscatedName("f")
   static void method4152(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
   ...
   public void method4153(int var1, int var2, int var3, int var4) {
      ...
      if(var2 + var7 > Rasterizer2D.field3187) {
         var7 -= var2 + var7 - Rasterizer2D.field3187;
      }
      ...
      if(var1 + var8 > Rasterizer2D.field3190) {
         var11 = var1 + var8 - Rasterizer2D.field3190;
         var8 -= var11;
         var10 += var11;
         var9 += var11;
      }
      ...
      if(var8 > 0 && var7 > 0) {
         method4154(Rasterizer2D.graphicsPixels, this.image, 0, var6, var5, var8, var7, var9, var10, var3, var4);
      }
   }

   @ObfuscatedName("t")
   static void method4154(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      int var11 = 256 - var9;
   ...
   @ObfuscatedName("p")
   static void method4156(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      int var10 = 256 - var9;
   ...
   @ObfuscatedName("n")
   public void method4157(int var1, int var2, int var3, int var4, int var5) {
      if(var3 > 0 && var4 > 0) {
         int var6 = this.width;
         int var7 = this.height;
         int var8 = 0;
         ...
         if(var1 + var3 > Rasterizer2D.field3190) {
            var16 = var1 + var3 - Rasterizer2D.field3190;
            var3 -= var16;
            var15 += var16;
         }

         if(var1 < Rasterizer2D.field3192) {
            var16 = Rasterizer2D.field3192 - var1;
            var3 -= var16;
            var14 += var16;
            var8 += var12 * var16;
            var15 += var16;
         ...
         method4176(Rasterizer2D.graphicsPixels, this.image, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5);
      }
   }

   @ObfuscatedName("o")
   public void method4159(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
   ...
   @ObfuscatedName("an")
   public void method4160(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
      try {
         int var11 = -var3 / 2;
         int var12 = -var4 / 2;
   ...
   public void method4161(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
      try {
         int var10 = -var3 / 2;
         int var11 = -var4 / 2;
   ...
   @ObfuscatedName("aa")
   public void method4162(int var1, int var2, int var3, int var4) {
      this.method4163(this.maxWidth << 3, this.maxHeight << 3, var1 << 4, var2 << 4, var3, var4);
   }

   @ObfuscatedName("af")
   void method4163(int var1, int var2, int var3, int var4, int var5, int var6) {
      if(var6 != 0) {
         var1 -= this.offsetX << 4;
         var2 -= this.offsetY << 4;
         ...
         var21 >>= 4;
         var22 = var22 + 15 >> 4;
         if(var19 < Rasterizer2D.field3192) {
            var19 = Rasterizer2D.field3192;
         }

         if(var20 > Rasterizer2D.field3190) {
            var20 = Rasterizer2D.field3190;
         }
         ...
         if(var22 > Rasterizer2D.field3187) {
            var22 = Rasterizer2D.field3187;
         }
   ...
   @ObfuscatedName("z")
   public void method4165(int var1, int var2, int var3) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var2 + var6 > Rasterizer2D.field3187) {
         var6 -= var2 + var6 - Rasterizer2D.field3187;
      }
      ...
      if(var1 + var7 > Rasterizer2D.field3190) {
         var10 = var1 + var7 - Rasterizer2D.field3190;
         var7 -= var10;
         var9 += var10;
         var8 += var10;
      }
      ...
      if(var7 > 0 && var6 > 0) {
         method4156(Rasterizer2D.graphicsPixels, this.image, 0, var5, var4, var7, var6, var8, var9, var3);
      }
   }

   @ObfuscatedName("v")
   public void method4170(int var1) {
   ...
   @ObfuscatedName("a")
   static void method4176(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
      int var13 = 256 - var12;
      int var14 = var3;
   ...
   @ObfuscatedName("x")
   public SpritePixels method4203() {
   ...
   @ObfuscatedName("d")
   public void method4218(int var1, int var2, int var3) {
