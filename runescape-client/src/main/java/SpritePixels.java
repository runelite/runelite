...
public final class SpritePixels extends Rasterizer2D {
   ...
   @ObfuscatedName("b")
   public SpritePixels method4242() {
   ...
   @ObfuscatedName("l")
   public SpritePixels method4243() {
   ...
   @ObfuscatedName("t")
   public void method4245(int var1, int var2, int var3) {
   ...
   @ObfuscatedName("q")
   public void method4247(int var1, int var2, int var3, int var4) {
      if(var3 > 0 && var4 > 0) {
         int var5 = this.width;
         ...
         if(var2 < Rasterizer2D.field3187) {
            var15 = Rasterizer2D.field3187 - var2;
            var4 -= var15;
         ...
         if(var1 + var3 > Rasterizer2D.field3185) {
            var15 = var1 + var3 - Rasterizer2D.field3185;
            var3 -= var15;
            var14 += var15;
         }

         if(var1 < Rasterizer2D.field3186) {
            var15 = Rasterizer2D.field3186 - var1;
            var3 -= var15;
            var13 += var15;
            var7 += var11 * var15;
            var14 += var15;
         ...
         method4257(Rasterizer2D.graphicsPixels, this.image, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5);
      }
   }
   ...
   @ObfuscatedName("o")
   public void method4251(int var1) {
   ...
   @ObfuscatedName("y")
   public void method4252(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var6 > 0 && var5 > 0) {
         method4253(Rasterizer2D.graphicsPixels, this.image, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("w")
   static void method4253(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
   ...
   @ObfuscatedName("u")
   static void method4255(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("c")
   static void method4257(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
   ...
   public void method4258(int var1, int var2, int var3, int var4) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var2 + var7 > Rasterizer2D.field3182) {
         var7 -= var2 + var7 - Rasterizer2D.field3182;
      }
      ...
      if(var1 + var8 > Rasterizer2D.field3185) {
         var11 = var1 + var8 - Rasterizer2D.field3185;
         var8 -= var11;
         var10 += var11;
         var9 += var11;
      }
      ...
      if(var8 > 0 && var7 > 0) {
         method4264(Rasterizer2D.graphicsPixels, this.image, 0, var6, var5, var8, var7, var9, var10, var3, var4);
      }
   }

   @ObfuscatedName("aj")
   public void method4261(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
   ...
   @ObfuscatedName("ap")
   static void method4263(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
      int var13 = 256 - var12;
      int var14 = var3;
   ...
   @ObfuscatedName("e")
   static void method4264(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      int var11 = 256 - var9;
   ...
   @ObfuscatedName("ab")
   public void method4265(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
      try {
         int var11 = -var3 / 2;
         int var12 = -var4 / 2;
   ...
   public void method4266(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
      try {
         int var10 = -var3 / 2;
         int var11 = -var4 / 2;
   ...
   @ObfuscatedName("aw")
   public void method4267(int var1, int var2, int var3, int var4) {
      this.method4268(this.maxWidth << 3, this.maxHeight << 3, var1 << 4, var2 << 4, var3, var4);
   }

   @ObfuscatedName("ac")
   void method4268(int var1, int var2, int var3, int var4, int var5, int var6) {
      if(var6 != 0) {
         var1 -= this.offsetX << 4;
         var2 -= this.offsetY << 4;
         ...
         var21 >>= 4;
         var22 = var22 + 15 >> 4;
         if(var19 < Rasterizer2D.field3186) {
            var19 = Rasterizer2D.field3186;
         }

         if(var20 > Rasterizer2D.field3185) {
            var20 = Rasterizer2D.field3185;
         }

         if(var21 < Rasterizer2D.field3187) {
            var21 = Rasterizer2D.field3187;
         }

         if(var22 > Rasterizer2D.field3182) {
            var22 = Rasterizer2D.field3182;
         }
   ...
   @ObfuscatedName("j")
   public void method4271(int var1, int var2, int var3) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var2 + var6 > Rasterizer2D.field3182) {
         var6 -= var2 + var6 - Rasterizer2D.field3182;
      }
      ...
      if(var1 + var7 > Rasterizer2D.field3185) {
         var10 = var1 + var7 - Rasterizer2D.field3185;
         var7 -= var10;
         var9 += var10;
         var8 += var10;
      }
      ...
      if(var7 > 0 && var6 > 0) {
         method4280(Rasterizer2D.graphicsPixels, this.image, 0, var5, var4, var7, var6, var8, var9, var3);
      }
   }

   @ObfuscatedName("d")
   static void method4280(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      int var10 = 256 - var9;
   ...
   @ObfuscatedName("m")
   public void method4284(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      int var3 = var1 + var2 * Rasterizer2D.graphicsPixelsWidth;
      int var4 = 0;
      ...
      if(var6 > 0 && var5 > 0) {
         method4255(Rasterizer2D.graphicsPixels, this.image, 0, var4, var3, var6, var5, var7, var8);
      }
   }
   ...
   @ObfuscatedName("g")
   public void method4289(int var1, int var2, int var3, int var4, int var5) {
      if(var3 > 0 && var4 > 0) {
         int var6 = this.width;
         int var7 = this.height;
         int var8 = 0;
         ...
         int var16;
         if(var2 < Rasterizer2D.field3187) {
            var16 = Rasterizer2D.field3187 - var2;
            var4 -= var16;
         ...
         if(var1 + var3 > Rasterizer2D.field3185) {
            var16 = var1 + var3 - Rasterizer2D.field3185;
            var3 -= var16;
            var15 += var16;
         }

         if(var1 < Rasterizer2D.field3186) {
            var16 = Rasterizer2D.field3186 - var1;
            var3 -= var16;
            var14 += var16;
            var8 += var12 * var16;
            var15 += var16;
         ...
         method4263(Rasterizer2D.graphicsPixels, this.image, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5);
      }
   }
   ...
   public void method4295(int var1) {
   ...
   @ObfuscatedName("x")
   public void method4311(int var1) {
      if(this.width != this.maxWidth || this.height != this.maxHeight) {
         int var2 = var1;
