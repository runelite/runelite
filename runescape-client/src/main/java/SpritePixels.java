...
public final class SpritePixels extends Rasterizer2D {
   ...
   @ObfuscatedName("k")
   public SpritePixels method4102() {
   ...
   @ObfuscatedName("r")
   public void method4105(int var1, int var2, int var3) {
   ...
   @ObfuscatedName("h")
   static void method4113(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
   ...
   @ObfuscatedName("ap")
   public void method4114(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
   ...
   @ObfuscatedName("f")
   public void method4116(int var1, int var2, int var3, int var4) {
      if(var3 > 0 && var4 > 0) {
         int var5 = this.width;
         ...
         if(var2 < Rasterizer2D.field3172) {
            var15 = Rasterizer2D.field3172 - var2;
            var4 -= var15;
         ...
         if(var1 + var3 > Rasterizer2D.field3173) {
            var15 = var1 + var3 - Rasterizer2D.field3173;
            var3 -= var15;
            var14 += var15;
         }

         if(var1 < Rasterizer2D.field3175) {
            var15 = Rasterizer2D.field3175 - var1;
            var3 -= var15;
            var13 += var15;
            var7 += var11 * var15;
            var14 += var15;
         ...
         method4117(Rasterizer2D.graphicsPixels, this.image, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5);
      }
   }

   @ObfuscatedName("z")
   static void method4117(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
   ...
   @ObfuscatedName("b")
   static void method4119(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      int var11 = 256 - var9;
   ...
   @ObfuscatedName("m")
   public void method4120(int var1, int var2, int var3) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var2 + var6 > Rasterizer2D.field3169) {
         var6 -= var2 + var6 - Rasterizer2D.field3169;
      }
      ...
      if(var1 + var7 > Rasterizer2D.field3173) {
         var10 = var1 + var7 - Rasterizer2D.field3173;
         var7 -= var10;
         var9 += var10;
         var8 += var10;
      }
      ...
      if(var7 > 0 && var6 > 0) {
         method4164(Rasterizer2D.graphicsPixels, this.image, 0, var5, var4, var7, var6, var8, var9, var3);
      }
   }

   @ObfuscatedName("p")
   public void method4121(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      int var9;
      if(var2 < Rasterizer2D.field3172) {
         var9 = Rasterizer2D.field3172 - var2;
         var5 -= var9;
         var2 = Rasterizer2D.field3172;
         var4 += var9 * var6;
      ...
      if(var2 + var5 > Rasterizer2D.field3169) {
         var5 -= var2 + var5 - Rasterizer2D.field3169;
      }

      if(var1 < Rasterizer2D.field3175) {
         var9 = Rasterizer2D.field3175 - var1;
         var6 -= var9;
         var1 = Rasterizer2D.field3175;
         var4 += var9;
         var3 += var9;
      ...
      if(var1 + var6 > Rasterizer2D.field3173) {
         var9 = var1 + var6 - Rasterizer2D.field3173;
         var6 -= var9;
         var8 += var9;
         var7 += var9;
      }
      ...
      if(var6 > 0 && var5 > 0) {
         method4195(Rasterizer2D.graphicsPixels, this.image, 0, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("l")
   public void method4122(int var1, int var2, int var3, int var4, int var5) {
      if(var3 > 0 && var4 > 0) {
         int var6 = this.width;
         ...
         int var16;
         if(var2 < Rasterizer2D.field3172) {
            var16 = Rasterizer2D.field3172 - var2;
            var4 -= var16;
         ...
         if(var1 + var3 > Rasterizer2D.field3173) {
            var16 = var1 + var3 - Rasterizer2D.field3173;
            var3 -= var16;
            var15 += var16;
         }

         if(var1 < Rasterizer2D.field3175) {
            var16 = Rasterizer2D.field3175 - var1;
            var3 -= var16;
            var14 += var16;
            var8 += var12 * var16;
            var15 += var16;
         ...
         method4150(Rasterizer2D.graphicsPixels, this.image, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5);
      }
   }

   @ObfuscatedName("aq")
   public void method4125(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
      try {
         int var11 = -var3 / 2;
         int var12 = -var4 / 2;
   ...
   public void method4126(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
      try {
         int var10 = -var3 / 2;
         int var11 = -var4 / 2;
   ...
   @ObfuscatedName("as")
   public void method4127(int var1, int var2, int var3, int var4) {
      this.method4128(this.maxWidth << 3, this.maxHeight << 3, var1 << 4, var2 << 4, var3, var4);
   }

   @ObfuscatedName("ah")
   void method4128(int var1, int var2, int var3, int var4, int var5, int var6) {
      if(var6 != 0) {
         var1 -= this.offsetX << 4;
         var2 -= this.offsetY << 4;
         ...
         var21 >>= 4;
         var22 = var22 + 15 >> 4;
         if(var19 < Rasterizer2D.field3175) {
            var19 = Rasterizer2D.field3175;
         }

         if(var20 > Rasterizer2D.field3173) {
            var20 = Rasterizer2D.field3173;
         }

         if(var21 < Rasterizer2D.field3172) {
            var21 = Rasterizer2D.field3172;
         }

         if(var22 > Rasterizer2D.field3169) {
            var22 = Rasterizer2D.field3169;
         }
   ...
   @ObfuscatedName("a")
   public void method4139(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      int var3 = var1 + var2 * Rasterizer2D.graphicsPixelsWidth;
      int var4 = 0;
      ...
      if(var6 > 0 && var5 > 0) {
         method4113(Rasterizer2D.graphicsPixels, this.image, var4, var3, var6, var5, var7, var8);
      }
   }
   ...
   @ObfuscatedName("x")
   static void method4150(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
      int var13 = 256 - var12;
      int var14 = var3;
   ...
   @ObfuscatedName("e")
   static void method4164(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      int var10 = 256 - var9;
   ...
   @ObfuscatedName("y")
   public SpritePixels method4175() {
   ...
   @ObfuscatedName("v")
   public void method4177(int var1) {
   ...
   public void method4190(int var1, int var2, int var3, int var4) {
      ...
      if(var2 + var7 > Rasterizer2D.field3169) {
         var7 -= var2 + var7 - Rasterizer2D.field3169;
      }
      ...
      if(var1 + var8 > Rasterizer2D.field3173) {
         var11 = var1 + var8 - Rasterizer2D.field3173;
         var8 -= var11;
         var10 += var11;
         var9 += var11;
      }
      ...
      if(var8 > 0 && var7 > 0) {
         method4119(Rasterizer2D.graphicsPixels, this.image, 0, var6, var5, var8, var7, var9, var10, var3, var4);
      }
   }

   @ObfuscatedName("t")
   static void method4195(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
