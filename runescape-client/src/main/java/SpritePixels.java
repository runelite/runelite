...
public final class SpritePixels extends Rasterizer2D {
   ...
   @ObfuscatedName("an")
   public void method5088(int var1, int var2, int var3, int var4) {
      this.method5111(this.maxWidth << 3, this.maxHeight << 3, var1 << 4, var2 << 4, var3, var4);
   }
   ...
   @ObfuscatedName("f")
   public void method5091(int var1) {
      if(this.width != this.maxWidth || this.height != this.maxHeight) {
         int var2 = var1;
   ...
   public void method5094(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
      try {
         int var10 = -var3 / 2;
         int var11 = -var4 / 2;
   ...
   @ObfuscatedName("o")
   public void method5097(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var6 > 0 && var5 > 0) {
         method5098(Rasterizer2D.graphicsPixels, this.image, 0, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("x")
   static void method5098(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("a")
   public void method5099(int var1, int var2, int var3, int var4) {
      if(var3 > 0 && var4 > 0) {
         int var5 = this.width;
         ...
         method5100(Rasterizer2D.graphicsPixels, this.image, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5);
      }
   }

   @ObfuscatedName("y")
   static void method5100(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
   ...
   @ObfuscatedName("s")
   public void method5103(int var1, int var2, int var3) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var1 + var7 > Rasterizer2D.field3758) {
         var10 = var1 + var7 - Rasterizer2D.field3758;
         var7 -= var10;
         var9 += var10;
         var8 += var10;
      }
      ...
      if(var7 > 0 && var6 > 0) {
         method5104(Rasterizer2D.graphicsPixels, this.image, 0, var5, var4, var7, var6, var8, var9, var3);
      }
   }

   @ObfuscatedName("v")
   static void method5104(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      int var10 = 256 - var9;
   ...
   @ObfuscatedName("t")
   public void method5105(int var1, int var2, int var3, int var4, int var5) {
      if(var3 > 0 && var4 > 0) {
         int var6 = this.width;
         ...
         int var16;
         if(var2 < Rasterizer2D.field3755) {
            var16 = Rasterizer2D.field3755 - var2;
            var4 -= var16;
         ...
         if(var1 + var3 > Rasterizer2D.field3758) {
            var16 = var1 + var3 - Rasterizer2D.field3758;
            var3 -= var16;
            var15 += var16;
         }

         if(var1 < Rasterizer2D.field3754) {
            var16 = Rasterizer2D.field3754 - var1;
            var3 -= var16;
            var14 += var16;
            var8 += var12 * var16;
            var15 += var16;
         ...
         method5106(Rasterizer2D.graphicsPixels, this.image, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5);
      }
   }

   @ObfuscatedName("w")
   static void method5106(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
      int var13 = 256 - var12;
      int var14 = var3;
   ...
   @ObfuscatedName("aa")
   public void method5108(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
      try {
         int var11 = -var3 / 2;
         int var12 = -var4 / 2;
   ...
   public void method5109(int var1, int var2, int var3, int var4) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var1 + var8 > Rasterizer2D.field3758) {
         var11 = var1 + var8 - Rasterizer2D.field3758;
         var8 -= var11;
         var10 += var11;
         var9 += var11;
      }
      ...
      if(var8 > 0 && var7 > 0) {
         method5130(Rasterizer2D.graphicsPixels, this.image, 0, var6, var5, var8, var7, var9, var10, var3, var4);
      }
   }

   @ObfuscatedName("p")
   public SpritePixels method5110() {
   ...
   @ObfuscatedName("al")
   void method5111(int var1, int var2, int var3, int var4, int var5, int var6) {
      if(var6 != 0) {
         var1 -= this.offsetX << 4;
         var2 -= this.offsetY << 4;
         ...
         var21 >>= 4;
         var22 = var22 + 15 >> 4;
         if(var19 < Rasterizer2D.field3754) {
            var19 = Rasterizer2D.field3754;
         }

         if(var20 > Rasterizer2D.field3758) {
            var20 = Rasterizer2D.field3758;
         }

         if(var21 < Rasterizer2D.field3755) {
            var21 = Rasterizer2D.field3755;
         }
   ...
   @ObfuscatedName("at")
   public void method5112(int var1, int var2, int var3, int var4) {
      if(var3 <= this.maxWidth && var4 <= this.maxHeight) {
         ...
         if(var5 < Rasterizer2D.field3754) {
            var5 = Rasterizer2D.field3754;
         }

         if(var6 > Rasterizer2D.field3758) {
            var6 = Rasterizer2D.field3758;
         }

         if(var7 < Rasterizer2D.field3755) {
            var7 = Rasterizer2D.field3755;
         }
   ...
   @ObfuscatedName("n")
   public SpritePixels method5124() {
   ...
   @ObfuscatedName("b")
   static void method5130(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      int var11 = 256 - var9;
   ...
   @ObfuscatedName("u")
   public void method5140(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
   ...
   @ObfuscatedName("e")
   static void method5145(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
   ...
   @ObfuscatedName("g")
   public void method5164(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      int var3 = var1 + var2 * Rasterizer2D.graphicsPixelsWidth;
      int var4 = 0;
      ...
      if(var6 > 0 && var5 > 0) {
         method5145(Rasterizer2D.graphicsPixels, this.image, var4, var3, var6, var5, var7, var8);
      }
   }
