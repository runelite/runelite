...
public final class SpritePixels extends Rasterizer2D {
   ...
   public SpritePixels method5525() {
   ...
   @ObfuscatedName("j")
   public void method5529(int var1) {
      if(this.width != this.maxWidth || this.height != this.maxHeight) {
         int var2 = var1;
   ...
   @ObfuscatedName("m")
   public void method5533(int var1) {
   ...
   public void method5534(int var1, int var2) {
      ...
      if(var6 > 0 && var5 > 0) {
         method5535(Rasterizer2D.graphicsPixels, this.pixels, var4, var3, var6, var5, var7, var8);
      }
   }
   ...
   public void drawAt(int var1, int var2) {
      ...
      if(var6 > 0 && var5 > 0) {
         method5524(Rasterizer2D.graphicsPixels, this.pixels, 0, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("d")
   public void method5538(int var1, int var2, int var3, int var4) {
      if(var3 > 0 && var4 > 0) {
         int var5 = this.width;
         ...
         method5600(Rasterizer2D.graphicsPixels, this.pixels, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5);
      }
   }

   @ObfuscatedName("f")
   public void method5540(int var1, int var2, int var3, int var4) {
      if(var3 == 256) {
         ...
         if(var8 > 0 && var7 > 0) {
            method5541(Rasterizer2D.graphicsPixels, this.pixels, 0, var6, var5, var8, var7, var9, var10, var3, var4);
         }
      }
   }
   ...
   public void drawAtOpacity(int var1, int var2, int var3) {
      ...
      if(var7 > 0 && var6 > 0) {
         method5590(Rasterizer2D.graphicsPixels, this.pixels, 0, var5, var4, var7, var6, var8, var9, var3);
      }
   }

   @ObfuscatedName("z")
   public void method5544(int var1, int var2, int var3, int var4, int var5) {
      if(var3 > 0 && var4 > 0) {
         int var6 = this.width;
         int var7 = this.height;
         int var8 = 0;
         ...
         method5581(Rasterizer2D.graphicsPixels, this.pixels, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5);
      }
   }

   @ObfuscatedName("c")
   public void method5546(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
   ...
   @ObfuscatedName("aa")
   public void method5547(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
      try {
         int var11 = -var3 / 2;
         int var12 = -var4 / 2;
   ...
   @ObfuscatedName("ap")
   public void method5548(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
      try {
         int var10 = -var3 / 2;
         int var11 = -var4 / 2;
   ...
   @ObfuscatedName("ao")
   public void method5577(int var1, int var2, int var3, int var4) {
      this.method5583(this.maxWidth << 3, this.maxHeight << 3, var1 << 4, var2 << 4, var3, var4);
   }

   @ObfuscatedName("ar")
   void method5583(int var1, int var2, int var3, int var4, int var5, int var6) {
      if(var6 != 0) {
         var1 -= this.offsetX << 4;
         var2 -= this.offsetY << 4;
   ...
   @ObfuscatedName("ay")
   public void method5551(int var1, int var2, int var3, int var4) {
   ...
   @ObfuscatedName("o")
   static void method5535(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
   ...
   @ObfuscatedName("q")
   static void method5524(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("l")
   static void method5600(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
   ...
   @ObfuscatedName("k")
   static void method5541(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      int var11 = 256 - var9;
   ...
   @ObfuscatedName("u")
   static void method5590(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      int var10 = 256 - var9;
   ...
   @ObfuscatedName("b")
   static void method5581(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
      int var13 = 256 - var12;
      int var14 = var3;
