   ...
   static void method1113() {
      for(class81 var0 = (class81)class81.field1248.getFront(); var0 != null; var0 = (class81)class81.field1248.getNext()) {
         if(var0.field1253 != null) {
            MouseRecorder.field821.method1954(var0.field1253);
            var0.field1253 = null;
         }

         if(var0.field1250 != null) {
            MouseRecorder.field821.method1954(var0.field1250);
            var0.field1250 = null;
         }
      }
            ...
            if(var5 != 10 && var5 != 11) {
               if(var5 >= 12) {
                  ...
                  if(var5 >= 12 && var5 <= 17 && var5 != 13 && var0 > 0) {
                     BoundingBox3D.field242[var0][var1][var2] |= 2340;
                  }
                  ...
                  if(var4 == 0) {
                     ...
                     if(var8.modelClipped) {
                        BoundingBox3D.field242[var0][var1][var2] |= 585;
                     }
                  } else if(var4 == 1) {
                     if(var8.clipped) {
                        ScriptState.field745[var0][var1][var2 + 1] = 50;
                     ...
                     if(var8.modelClipped) {
                        BoundingBox3D.field242[var0][var1][1 + var2] |= 1170;
                     }
                  } else if(var4 == 2) {
                     if(var8.clipped) {
                     ...
                     if(var8.modelClipped) {
                        BoundingBox3D.field242[var0][var1 + 1][var2] |= 585;
                     }
                  } else if(var4 == 3) {
                     if(var8.clipped) {
                        ScriptState.field745[var0][var1][var2] = 50;
                     ...
                     if(var8.modelClipped) {
                        BoundingBox3D.field242[var0][var1][var2] |= 1170;
                     }
                  }

                  if(var8.interactType != 0 && var7 != null) {
                     var7.method3157(var1, var2, var5, var4, var8.boolean1);
                  }

                  if(var8.int2 != 16) {
                     var6.method2880(var0, var1, var2, var8.int2);
                  }
                  ...
                  if(var5 == 2) {
                     ...
                     if(var8.modelClipped) {
                        if(var4 == 0) {
                           ...
                           BoundingBox3D.field242[var0][var1][var2 + 1] |= 1170;
                           BoundingBox3D.field242[var0][var1 + 1][var2] |= 585;
                        } else if(var4 == 2) {
                           BoundingBox3D.field242[var0][var1 + 1][var2] |= 585;
                           BoundingBox3D.field242[var0][var1][var2] |= 1170;
                     ...
                     if(var22 != 0) {
                        var26 = class3.getObjectDefinition(var22 >> 14 & 32767).int2;
                     }
                     ...
                     var22 = var6.method2823(var0, var1, var2);
                     if(var22 != 0) {
                        var26 = class3.getObjectDefinition(var22 >> 14 & 32767).int2 / 2;
                     }
