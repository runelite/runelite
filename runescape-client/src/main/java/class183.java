...
public class class183 extends Node {
   ...
   class183(Buffer var1) {
      ...
      for(var29 = 0; var29 < var6; ++var29) {
         var28 = var28 + var1.method2571() & 127;
         if(var28 != 0 && var28 != 32) {
            if(var28 == 1) {
               ++var16;
            } else if(var28 == 33) {
      ...
      var1.offset += var5 * 3;
      this.field2979 = new byte[var4];
      Buffer var51 = new Buffer(this.field2979);
      var51.method2559(1297377380);
      var51.method2559(6);
      var51.method2638(var2 > 1?1:0);
      var51.method2638(var2);
      var51.method2638(var3);
      var1.offset = var13;
      int var52 = 0;
      int var53 = 0;
      int var54 = 0;
      ...
      for(int var60 = 0; var60 < var2; ++var60) {
         ...
         while(true) {
            while(true) {
               int var63 = var1.method2587();
               var51.method2570(var63);
               int var64 = var1.payload[var29++] & 255;
               boolean var65 = var64 != var62;
               var62 = var64 & 15;
               if(var64 == 7) {
                  if(var65) {
                     var51.method2556(255);
                  }

                  var51.method2556(47);
                  var51.method2556(0);
                  var51.method2584(var51.offset - var61);
                  continue label365;
               }
               ...
               if(var64 == 23) {
                  ...
                  var51.method2556(81);
                  var51.method2556(3);
                  var51.method2556(var1.payload[var50++]);
                  var51.method2556(var1.payload[var50++]);
                  var51.method2556(var1.payload[var50++]);
               } else {
                  var52 ^= var64 >> 4;
                  if(var62 == 0) {
                     if(var65) {
                        var51.method2556(144 + var52);
                     }

                     var53 += var1.payload[var37++];
                     var54 += var1.payload[var38++];
                     var51.method2556(var53 & 127);
                     var51.method2556(var54 & 127);
                  } else if(var62 == 1) {
                     if(var65) {
                        var51.method2556(128 + var52);
                     }

                     var53 += var1.payload[var37++];
                     var55 += var1.payload[var40++];
                     var51.method2556(var53 & 127);
                     var51.method2556(var55 & 127);
                  } else if(var62 == 2) {
                     if(var65) {
                        var51.method2556(176 + var52);
                     }

                     var28 = var28 + var1.payload[var15++] & 127;
                     var51.method2556(var28);
                     byte var66;
                     if(var28 != 0 && var28 != 32) {
                        if(var28 == 1) {
                     ...
                     var59[var28] = var67;
                     var51.method2556(var67 & 127);
                  } else if(var62 == 3) {
                     if(var65) {
                        var51.method2556(224 + var52);
                     }

                     var56 += var1.payload[var45++];
                     var56 += var1.payload[var33++] << 7;
                     var51.method2556(var56 & 127);
                     var51.method2556(var56 >> 7 & 127);
                  } else if(var62 == 4) {
                     if(var65) {
                        var51.method2556(208 + var52);
                     }

                     var57 += var1.payload[var32++];
                     var51.method2556(var57 & 127);
                  } else if(var62 == 5) {
                     if(var65) {
                        var51.method2556(160 + var52);
                     }

                     var53 += var1.payload[var37++];
                     var58 += var1.payload[var31++];
                     var51.method2556(var53 & 127);
                     var51.method2556(var58 & 127);
                  } else {
                     if(var62 != 6) {
                        throw new RuntimeException();
                     }
                     ...
                     if(var65) {
                        var51.method2556(192 + var52);
                     }

                     var51.method2556(var1.payload[var44++]);
                  }
               }
            }
         }
   ...
   void method3544() {
      if(this.field2978 == null) {
         this.field2978 = new XHashTable(16);
         int[] var1 = new int[16];
         int[] var2 = new int[16];
         var2[9] = 128;
         var1[9] = 128;
         class185 var4 = new class185(this.field2979);
         ...
         do {
            while(true) {
               var6 = var4.method3592();
               int var7 = var4.field2998[var6];

               while(var4.field2998[var6] == var7) {
                  var4.method3591(var6);
                  ...
                  if(var9 == 144) {
                     ...
                     if(var12 > 0) {
                        ...
                        class200 var14 = (class200)this.field2978.method3828((long)var13);
                        if(var14 == null) {
                           var14 = new class200(new byte[128]);
                           this.field2978.method3822(var14, (long)var13);
                        }
   ...
   @ObfuscatedName("k")
   static class183 method3554(class170 var0, int var1, int var2) {
