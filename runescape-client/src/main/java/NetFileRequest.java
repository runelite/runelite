      ...
      for (int var2 = 0; var2 < var0.length; ++var2) {
         ...
         if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !PacketBufferNode.method3673(var3))) {
            ...
            if (var3.type == 6) {
               ...
               if (var3.field963 != 0 && !var3.isIf3) {
                  int var8 = var3.field963 >> 16;
                  var7 = var3.field963 << 16 >> 16;
                  var8 *= Client.field183;
   ...
   static final void method4554(int var0, int var1, int var2, int var3, Sprite var4, SpriteMask var5) {
      if (var4 != null) {
         ...
         if (var7 <= 6400) {
            ...
            if (var7 > 2500) {
               var4.method314(var10 + var5.width / 2 - var4.width / 2, var5.height / 2 - var11 - var4.height / 2, var0, var1, var5.width, var5.height, var5.xStarts, var5.xWidths);
            } else {
