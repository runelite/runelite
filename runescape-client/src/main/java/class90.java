...
public enum class90 implements class185 {
      ...
      if(!var0) {
                  ...
                  while(true) {
                     while(!var12) {
                        ...
                        if(var49 > 0 && var50 > 0 && var49 < 103 && var50 < 103) {
                           ...
                           if(var16 != 22 || !Client.lowMemory || var19.field3518 != 0 || var19.interactType == 1 || var19.field3530) {
                              if(!var19.method4729()) {
                                 ++Client.field923;
                                 var7 = false;
                              }
         ...
         if(!var0) {
            ...
            if(Client.field955 != 0) {
               class148.drawStatusBox("Loading - please wait." + "<br>" + " (" + 100 + "%" + ")", true);
            }
            ...
            if(!Client.isDynamicRegion) {
               ...
               for(var44 = 0; var44 < var1; ++var44) {
                  ...
                  if(var47 != null) {
                     ...
                     class25.method190();
                     GameEngine.method1006(var47, var4, var5, class14.region, Client.collisionMaps);
                  }
               }
            }
                                    ...
                                    while(true) {
                                       ...
                                       if(var6 == var26 && var25 >= var15 && var25 < var15 + 8 && var24 >= var16 && var24 < var16 + 8) {
                                          ...
                                          if(var38 > 0 && var39 > 0 && var38 < 103 && var39 < 103) {
                                             ...
                                             class66.addObject(var44, var38, var39, var20, var29 + var57 & 3, var28, var17, var41);
                                          }
                                       }
                                    }
                                 }
            ...
            for(var4 = 0; var4 < 4; ++var4) {
               ...
               for(var13 = -5; var13 < 109; ++var13) {
                  for(var14 = 0; var14 < 104; ++var14) {
                     ...
                     if(var15 >= 0 && var15 < 104) {
                        ...
                        if(var16 > 0) {
                           FloorUnderlayDefinition var59 = ScriptState.method1093(var16 - 1);
                           class15.field287[var14] += var59.hue;
                     ...
                     if(var16 >= 0 && var16 < 104) {
                        ...
                        if(var49 > 0) {
                           FloorUnderlayDefinition var60 = ScriptState.method1093(var49 - 1);
                           class15.field287[var14] -= var60.hue;
                        ...
                        if(var51 >= 1 && var51 < 103 && (!Client.lowMemory || (class61.tileSettings[0][var13][var51] & 2) != 0 || (class61.tileSettings[var4][var13][var51] & 16) == 0)) {
                           ...
                           if(var22 > 0 || var23 > 0) {
                              ...
                              if(var4 > 0) {
                                 ...
                                 if(var23 > 0 && !class41.method570(var23 - 1).isHidden) {
                                    var63 = false;
                                 }

                                 if(var63 && var25 == var24 && var24 == var26 && var24 == var27) {
                                    class10.field242[var4][var13][var51] |= 2340;
                                 }
                              }
                              ...
                              if(var23 == 0) {
                                 ...
                                 Overlay var53 = class41.method570(var23 - 1);
                                 var38 = var53.texture;
                                 int var42;
                                 int var54;
                                 if(var38 >= 0) {
               ...
               for(var13 = 1; var13 < 103; ++var13) {
                  for(var14 = 1; var14 < 103; ++var14) {
                     var55.setPhysicalLevel(var4, var14, var13, class10.method60(var4, var14, var13));
                  }
               }
               ...
               for(var46 = 0; var46 <= var57; ++var46) {
                  for(var9 = 0; var9 <= 104; ++var9) {
                     for(var10 = 0; var10 <= 104; ++var10) {
                        short var62;
                        if((class10.field242[var46][var10][var9] & var4) != 0) {
                           var11 = var9;
                           var58 = var9;
                           var13 = var46;

                           for(var14 = var46; var11 > 0 && (class10.field242[var46][var10][var11 - 1] & var4) != 0; --var11) {
                              ;
                           }

                           while(var58 < 104 && (class10.field242[var46][var10][var58 + 1] & var4) != 0) {
                              ++var58;
                           }
                           ...
                           while(var13 > 0) {
                              for(var15 = var11; var15 <= var58; ++var15) {
                                 if((class10.field242[var13 - 1][var10][var15] & var4) == 0) {
                                    break label961;
                                 }
                              }
                           ...
                           while(var14 < var57) {
                              for(var15 = var11; var15 <= var58; ++var15) {
                                 if((class10.field242[var14 + 1][var10][var15] & var4) == 0) {
                                    break label950;
                                 }
                              }
                           ...
                           if(var15 >= 8) {
                              ...
                              for(var51 = var13; var51 <= var14; ++var51) {
                                 for(var20 = var11; var20 <= var58; ++var20) {
                                    class10.field242[var51][var10][var20] &= ~var4;
                                 }
                              }
                           }
                        }

                        if((class10.field242[var46][var10][var9] & var5) != 0) {
                           var11 = var10;
                           var58 = var10;
                           var13 = var46;

                           for(var14 = var46; var11 > 0 && (class10.field242[var46][var11 - 1][var9] & var5) != 0; --var11) {
                              ;
                           }

                           while(var58 < 104 && (class10.field242[var46][var58 + 1][var9] & var5) != 0) {
                              ++var58;
                           }
                           ...
                           while(var13 > 0) {
                              for(var15 = var11; var15 <= var58; ++var15) {
                                 if((class10.field242[var13 - 1][var15][var9] & var5) == 0) {
                                    break label1014;
                                 }
                              }
                           ...
                           while(var14 < var57) {
                              for(var15 = var11; var15 <= var58; ++var15) {
                                 if((class10.field242[var14 + 1][var15][var9] & var5) == 0) {
                                    break label1003;
                                 }
                              }
                           ...
                           if(var15 >= 8) {
                              ...
                              for(var51 = var13; var51 <= var14; ++var51) {
                                 for(var20 = var11; var20 <= var58; ++var20) {
                                    class10.field242[var51][var20][var9] &= ~var5;
                                 }
                              }
                           }
                        }

                        if((class10.field242[var46][var10][var9] & var6) != 0) {
                           var11 = var10;
                           var58 = var10;
                           var13 = var9;

                           for(var14 = var9; var13 > 0 && (class10.field242[var46][var10][var13 - 1] & var6) != 0; --var13) {
                              ;
                           }

                           while(var14 < 104 && (class10.field242[var46][var10][var14 + 1] & var6) != 0) {
                              ++var14;
                           }
                           ...
                           while(var11 > 0) {
                              for(var15 = var13; var15 <= var14; ++var15) {
                                 if((class10.field242[var46][var11 - 1][var15] & var6) == 0) {
                                    break label1067;
                                 }
                              }
                           ...
                           while(var58 < 104) {
                              for(var15 = var13; var15 <= var14; ++var15) {
                                 if((class10.field242[var46][var58 + 1][var15] & var6) == 0) {
                                    break label1056;
                                 }
                              }
                           ...
                           if((var58 - var11 + 1) * (var14 - var13 + 1) >= 4) {
                              ...
                              for(var16 = var11; var16 <= var58; ++var16) {
                                 for(var49 = var13; var49 <= var14; ++var49) {
                                    class10.field242[var46][var16][var49] &= ~var6;
                                 }
                              }
                           }
                        }
            ...
            if(Client.lowMemory) {
               class14.region.setup(class61.field735);
            } else {
               class14.region.setup(0);
            }
            ...
            PacketNode var67;
            if(class287.clientInstance.method884()) {
   ...
   static final void method1767(Widget var0, int var1, int var2) {
      if(Client.field1027 == null && !Client.isMenuOpen) {
         if(var0 != null && class51.method781(var0) != null) {
            Client.field1027 = var0;
            Client.field1028 = class51.method781(var0);
            ...
            if(var3 != -1) {
               ...
               class268.topContextMenuRow.param0 = Client.menuActionParams0[var3];
               class268.topContextMenuRow.param1 = Client.menuActionParams1[var3];
               class268.topContextMenuRow.type = Client.menuTypes[var3];
               class268.topContextMenuRow.identifier = Client.menuIdentifiers[var3];
               class268.topContextMenuRow.option = Client.menuOptions[var3];
            }
