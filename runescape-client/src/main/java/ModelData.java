...
public class ModelData extends Renderable {
   ...
   void decodeNewFormat(byte[] var1) {
      ...
      for(var49 = 0; var49 < var9; ++var49) {
         ...
         this.vertexX[var49] = var51 + var46;
      ...
      for(var53 = 0; var53 < var11; ++var53) {
         ...
         if(var54 == 1) {
            ...
            this.field1821[var53] = (short)var4.readUnsignedShort();
            this.field1819[var53] = (short)var4.readUnsignedShort();
            this.field1803[var53] = (short)var4.readUnsignedShort();
            this.field1816[var53] = (short)var5.readUnsignedShort();
            this.field1804[var53] = var6.readByte();
            this.field1825[var53] = (short)var7.readUnsignedShort();
         }
   ...
   public void method2421(int var1) {
      ...
      for(int var4 = 0; var4 < this.vertexCount; ++var4) {
         int var5 = this.vertexX[var4] * var3 + this.vertexZ[var4] * var2 >> 16;
   ...
   static void method2423(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
      ...
      if(var6 >= 3 && var5) {
         ...
         for(var9 = 0; var9 < var1.triangleFaceCount; ++var9) {
            if(field1844[var1.trianglePointsX[var9]] == field1845 && field1844[var1.trianglePointsY[var9]] == field1845 && field1844[var1.trianglePointsZ[var9]] == field1845) {
         ...
         if(var12 == -1) {
            if(var18 != 0) {
               if(var18 == 1) {
                  ...
                  var14 = (var5 * var15.z + var3 * var15.x + var15.y * var4) / (var7 + var7 / 2) + var1;
                  var8.field1943[var17] = method2431(this.faceColor[var17] & '\uffff', var14);
                  var8.field1945[var17] = -1;
               } else if(var18 == 3) {
                  var8.field1943[var17] = 128;
                  var8.field1945[var17] = -1;
               } else {
                  var8.field1945[var17] = -2;
               }
            } else {
               int var16 = this.faceColor[var17] & '\uffff';
               if(this.field1834 != null && this.field1834[this.trianglePointsX[var17]] != null) {
                  var13 = this.field1834[this.trianglePointsX[var17]];
               } else {
                  var13 = this.normals[this.trianglePointsX[var17]];
               }

               var14 = (var3 * var13.x + var13.y * var4 + var5 * var13.z) / (var7 * var13.magnitude) + var1;
               var8.field1943[var17] = method2431(var16, var14);
               if(this.field1834 != null && this.field1834[this.trianglePointsY[var17]] != null) {
                  var13 = this.field1834[this.trianglePointsY[var17]];
               } else {
                  var13 = this.normals[this.trianglePointsY[var17]];
               }

               var14 = (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude) + var1;
               var8.field1965[var17] = method2431(var16, var14);
               if(this.field1834 != null && this.field1834[this.trianglePointsZ[var17]] != null) {
                  var13 = this.field1834[this.trianglePointsZ[var17]];
               } else {
                  var13 = this.normals[this.trianglePointsZ[var17]];
               }

               var14 = (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude) + var1;
               var8.field1945[var17] = method2431(var16, var14);
            }
         } else if(var18 != 0) {
            if(var18 == 1) {
               var15 = this.faceNormals[var17];
               var14 = (var5 * var15.z + var3 * var15.x + var4 * var15.y) / (var7 + var7 / 2) + var1;
               var8.field1943[var17] = method2465(var14);
               var8.field1945[var17] = -1;
            } else {
               var8.field1945[var17] = -2;
            }
            ...
            var14 = (var3 * var13.x + var13.y * var4 + var5 * var13.z) / (var13.magnitude * var7) + var1;
            var8.field1965[var17] = method2465(var14);
            if(this.field1834 != null && this.field1834[this.trianglePointsZ[var17]] != null) {
               var13 = this.field1834[this.trianglePointsZ[var17]];
            } else {
               var13 = this.normals[this.trianglePointsZ[var17]];
            ...
            var8.field1945[var17] = method2465(var14);
         }
      }
   ...
   public ModelData method2467(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
      ...
      int var9 = this.field1842 + var4;
      int var10 = this.field1833 + var4;
            ...
            for(var11 = 0; var11 < var10.triangleFaceCount; ++var11) {
               ...
               if(var8) {
                  if(var10.textureCoords != null && var10.textureCoords[var11] != -1) {
                     this.textureCoords[this.triangleFaceCount] = (byte)(var10.textureCoords[var11] + this.field1827);
                  } else {
