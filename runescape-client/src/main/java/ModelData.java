...
public class ModelData extends Renderable {
   ...
   int field1275;
   @ObfuscatedName("ap")
   static int[] field1276 = new int[10000];
   @ObfuscatedName("ai")
   static int[] field1277 = new int[10000];
   @ObfuscatedName("n")
   short[] field1278;
   @ObfuscatedName("d")
   @Export("vertexZ")
   ...
   public static ModelData method1522(class182 var0, int var1, int var2) {
   ...
   void method1524(byte[] var1) {
      ...
      if(var11 > 0) {
         ...
         if(var24 > 0) {
            ...
            this.field1278 = new short[var24];
      ...
      for(var55 = 0; var55 < var11; ++var55) {
         ...
         if(var56 == 1) {
            ...
            this.field1255[var55] = (short)var4.readUnsignedShort();
            this.field1256[var55] = (short)var4.readUnsignedShort();
            this.field1278[var55] = (short)var5.readUnsignedShort();
            this.field1260[var55] = var6.readByte();
            this.field1258[var55] = (short)var7.readUnsignedShort();
         }
   ...
   public ModelData(ModelData[] var1, int var2) {
      ...
      if(this.field1249 > 0) {
         this.textureRenderTypes = new byte[this.field1249];
         this.texTriangleX = new short[this.field1249];
         this.texTriangleY = new short[this.field1249];
         this.texTriangleZ = new short[this.field1249];
         this.field1254 = new short[this.field1249];
         this.field1255 = new short[this.field1249];
         this.field1256 = new short[this.field1249];
         this.field1278 = new short[this.field1249];
         this.field1260 = new byte[this.field1249];
         this.field1258 = new short[this.field1249];
         this.texturePrimaryColor = new short[this.field1249];
      }
            ...
            for(var11 = 0; var11 < var10.triangleFaceCount; ++var11) {
               ...
               if(var8) {
                  if(var10.textureCoords != null && var10.textureCoords[var11] != -1) {
                     this.textureCoords[this.triangleFaceCount] = (byte)(var10.textureCoords[var11] + this.field1249);
                  } else {
               ...
               this.trianglePointsX[this.triangleFaceCount] = this.method1554(var10, var10.trianglePointsX[var11]);
               this.trianglePointsY[this.triangleFaceCount] = this.method1554(var10, var10.trianglePointsY[var11]);
               this.trianglePointsZ[this.triangleFaceCount] = this.method1554(var10, var10.trianglePointsZ[var11]);
               ++this.triangleFaceCount;
            }

            for(var11 = 0; var11 < var10.field1249; ++var11) {
               byte var12 = this.textureRenderTypes[this.field1249] = var10.textureRenderTypes[var11];
               if(var12 == 0) {
                  this.texTriangleX[this.field1249] = (short)this.method1554(var10, var10.texTriangleX[var11]);
                  this.texTriangleY[this.field1249] = (short)this.method1554(var10, var10.texTriangleY[var11]);
                  this.texTriangleZ[this.field1249] = (short)this.method1554(var10, var10.texTriangleZ[var11]);
               }

               if(var12 >= 1 && var12 <= 3) {
                  this.texTriangleX[this.field1249] = var10.texTriangleX[var11];
                  this.texTriangleY[this.field1249] = var10.texTriangleY[var11];
                  this.texTriangleZ[this.field1249] = var10.texTriangleZ[var11];
                  this.field1254[this.field1249] = var10.field1254[var11];
                  this.field1255[this.field1249] = var10.field1255[var11];
                  this.field1256[this.field1249] = var10.field1256[var11];
                  this.field1278[this.field1249] = var10.field1278[var11];
                  this.field1260[this.field1249] = var10.field1260[var11];
                  this.field1258[this.field1249] = var10.field1258[var11];
               }

               if(var12 == 2) {
                  this.texturePrimaryColor[this.field1249] = var10.texturePrimaryColor[var11];
               }
   ...
   @ObfuscatedName("y")
   public ModelData method1529(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
      this.method1541();
      int var7 = var2 + this.field1272;
      int var8 = var2 + this.field1257;
      int var9 = var4 + this.field1275;
      int var10 = var4 + this.field1274;
      if(var7 >= 0 && var8 + 128 >> 7 < var1.length && var9 >= 0 && var10 + 128 >> 7 < var1[0].length) {
         ...
         if(var1[var7][var9] == var3 && var1[var8][var9] == var3 && var1[var7][var10] == var3 && var1[var8][var10] == var3) {
            ...
            var11.field1254 = this.field1254;
            ...
            var11.field1269 = this.field1269;
   ...
   void computeAnimationTables() {
      ...
      if(this.triangleSkinValues != null) {
         ...
         this.field1264 = new int[var2 + 1][];

         for(var3 = 0; var3 <= var2; ++var3) {
            this.field1264[var3] = new int[var1[var3]];
            var1[var3] = 0;
         }

         for(var3 = 0; var3 < this.triangleFaceCount; this.field1264[var4][var1[var4]++] = var3++) {
            var4 = this.triangleSkinValues[var3];
         }
   ...
   public ModelData(ModelData var1, boolean var2, boolean var3, boolean var4, boolean var5) {
      ...
      this.field1269 = var1.field1269;
   }

   @ObfuscatedName("z")
   public void method1536(short var1, short var2) {
   ...
   void method1541() {
      if(!this.field1270) {
         super.modelHeight = 0;
         this.field1271 = 0;
         this.field1272 = 999999;
         this.field1257 = -999999;
         this.field1274 = -99999;
   ...
   @ObfuscatedName("ar")
   static void method1542(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
      var0.method1541();
      var0.computeNormals();
      var1.method1541();
      var1.computeNormals();
      ...
      for(var9 = 0; var9 < var0.vertexCount; ++var9) {
         ...
         if(var10.magnitude != 0) {
            ...
            if(var11 <= var1.field1271) {
               int var12 = var0.vertexX[var9] - var2;
               if(var12 >= var1.field1272 && var12 <= var1.field1257) {
                  int var13 = var0.vertexZ[var9] - var4;
                  if(var13 >= var1.field1275 && var13 <= var1.field1274) {
                     for(int var14 = 0; var14 < var8; ++var14) {
                        ...
                        if(var12 == var7[var14] && var13 == var1.vertexZ[var14] && var11 == var1.vertexY[var14] && var15.magnitude != 0) {
                           if(var0.field1239 == null) {
                              var0.field1239 = new VertexNormal[var0.vertexCount];
                           }

                           if(var1.field1239 == null) {
                              var1.field1239 = new VertexNormal[var8];
                           }

                           VertexNormal var16 = var0.field1239[var9];
                           if(var16 == null) {
                              var16 = var0.field1239[var9] = new VertexNormal(var10);
                           }

                           VertexNormal var17 = var1.field1239[var14];
                           if(var17 == null) {
                              var17 = var1.field1239[var14] = new VertexNormal(var15);
                           }
                           ...
                           ++var6;
                           field1276[var9] = field1267;
                           field1277[var14] = field1267;
                        }
                     }
                  }
               }
      ...
      if(var6 >= 3 && var5) {
         for(var9 = 0; var9 < var0.triangleFaceCount; ++var9) {
            if(field1276[var0.trianglePointsX[var9]] == field1267 && field1276[var0.trianglePointsY[var9]] == field1267 && field1276[var0.trianglePointsZ[var9]] == field1267) {
         ...
         for(var9 = 0; var9 < var1.triangleFaceCount; ++var9) {
            if(field1277[var1.trianglePointsX[var9]] == field1267 && field1277[var1.trianglePointsY[var9]] == field1267 && field1277[var1.trianglePointsZ[var9]] == field1267) {
   ...
   @ObfuscatedName("aa")
   public final Model method1543(int var1, int var2, int var3, int var4, int var5) {
      this.computeNormals();
      int var6 = (int)Math.sqrt((double)(var3 * var3 + var4 * var4 + var5 * var5));
      int var7 = var2 * var6 >> 8;
      Model var8 = new Model();
      var8.field1376 = new int[this.triangleFaceCount];
      var8.field1424 = new int[this.triangleFaceCount];
      var8.field1378 = new int[this.triangleFaceCount];
      if(this.field1249 > 0 && this.textureCoords != null) {
         int[] var9 = new int[this.field1249];
         ...
         for(var10 = 0; var10 < this.field1249; ++var10) {
            if(var9[var10] > 0 && this.textureRenderTypes[var10] == 0) {
               ++var8.field1387;
            }
         }

         var8.field1426 = new int[var8.field1387];
         var8.field1366 = new int[var8.field1387];
         var8.field1377 = new int[var8.field1387];
         var10 = 0;

         int var11;
         for(var11 = 0; var11 < this.field1249; ++var11) {
            if(var9[var11] > 0 && this.textureRenderTypes[var11] == 0) {
               var8.field1426[var10] = this.texTriangleX[var11] & '\uffff';
               var8.field1366[var10] = this.texTriangleY[var11] & '\uffff';
               var8.field1377[var10] = this.texTriangleZ[var11] & '\uffff';
               var9[var11] = var10++;
            } else {
               var9[var11] = -1;
            }
         ...
         var8.field1402 = new byte[this.triangleFaceCount];

         for(var11 = 0; var11 < this.triangleFaceCount; ++var11) {
            if(this.textureCoords[var11] != -1) {
               var8.field1402[var11] = (byte)var9[this.textureCoords[var11] & 255];
            } else {
               var8.field1402[var11] = -1;
            }
         }
      }
         ...
         if(var12 == -1) {
            if(var17 != 0) {
               if(var17 == 1) {
                  ...
                  var8.field1376[var16] = method1527(this.faceColor[var16] & '\uffff', var14);
                  var8.field1378[var16] = -1;
               } else if(var17 == 3) {
                  var8.field1376[var16] = 128;
                  var8.field1378[var16] = -1;
               } else {
                  var8.field1378[var16] = -2;
               }
            } else {
               int var15 = this.faceColor[var16] & '\uffff';
               if(this.field1239 != null && this.field1239[this.trianglePointsX[var16]] != null) {
                  var13 = this.field1239[this.trianglePointsX[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsX[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1376[var16] = method1527(var15, var14);
               if(this.field1239 != null && this.field1239[this.trianglePointsY[var16]] != null) {
                  var13 = this.field1239[this.trianglePointsY[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsY[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1424[var16] = method1527(var15, var14);
               if(this.field1239 != null && this.field1239[this.trianglePointsZ[var16]] != null) {
                  var13 = this.field1239[this.trianglePointsZ[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsZ[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1378[var16] = method1527(var15, var14);
            }
         } else if(var17 != 0) {
            if(var17 == 1) {
               var19 = this.faceNormals[var16];
               var14 = var1 + (var3 * var19.x + var4 * var19.y + var5 * var19.z) / (var7 + var7 / 2);
               var8.field1376[var16] = method1583(var14);
               var8.field1378[var16] = -1;
            } else {
               var8.field1378[var16] = -2;
            }
            ...
            var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
            var8.field1424[var16] = method1583(var14);
            if(this.field1239 != null && this.field1239[this.trianglePointsZ[var16]] != null) {
               var13 = this.field1239[this.trianglePointsZ[var16]];
            } else {
               var13 = this.normals[this.trianglePointsZ[var16]];
            ...
            var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
            var8.field1378[var16] = method1583(var14);
         }
      }

      this.computeAnimationTables();
      var8.field1368 = this.vertexCount;
      var8.verticesX = this.vertexX;
      var8.verticesY = this.vertexY;
      var8.verticesZ = this.vertexZ;
      var8.field1427 = this.triangleFaceCount;
      var8.indices1 = this.trianglePointsX;
      var8.indices2 = this.trianglePointsY;
      var8.indices3 = this.trianglePointsZ;
      var8.field1414 = this.faceRenderPriorities;
      var8.field1380 = this.faceAlphas;
      var8.field1383 = this.priority;
      var8.field1388 = this.field1273;
      var8.field1389 = this.field1264;
      var8.field1382 = this.faceTextures;
      return var8;
   }

   static {
      field1259 = class84.field1441;
      field1280 = class84.field1462;
   }

   @ObfuscatedName("w")
   final int method1554(ModelData var1, int var2) {
      int var3 = -1;
   ...
   @ObfuscatedName("t")
   public void method1555(short var1, short var2) {
      for(int var3 = 0; var3 < this.triangleFaceCount; ++var3) {
   ...
   @ObfuscatedName("n")
   public void method1574(int var1, int var2, int var3) {
      for(int var4 = 0; var4 < this.vertexCount; ++var4) {
   ...
   @ObfuscatedName("ax")
   static final int method1583(int var0) {
      if(var0 < 2) {
         var0 = 2;
      } else if(var0 > 126) {
         var0 = 126;
