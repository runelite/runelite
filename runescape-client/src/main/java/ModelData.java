...
public class ModelData extends Renderable {
   ...
   int field1263;
   @ObfuscatedName("aj")
   static int[] field1264 = new int[10000];
   @ObfuscatedName("ap")
   static int[] field1265 = new int[10000];
   @ObfuscatedName("al")
   VertexNormal[] field1266;
   @ObfuscatedName("aq")
   int field1267;
   @ObfuscatedName("an")
   ...
   void computeAnimationTables() {
      ...
      if(this.vertexSkins != null) {
         ...
         this.field1251 = new int[var2 + 1][];

         for(var3 = 0; var3 <= var2; ++var3) {
            this.field1251[var3] = new int[var1[var3]];
            var1[var3] = 0;
         }

         for(var3 = 0; var3 < this.vertexCount; this.field1251[var4][var1[var4]++] = var3++) {
            var4 = this.vertexSkins[var3];
         }
      ...
      if(this.triangleSkinValues != null) {
         ...
         this.field1252 = new int[var2 + 1][];

         for(var3 = 0; var3 <= var2; ++var3) {
            this.field1252[var3] = new int[var1[var3]];
            var1[var3] = 0;
         }

         for(var3 = 0; var3 < this.triangleFaceCount; this.field1252[var4][var1[var4]++] = var3++) {
            var4 = this.triangleSkinValues[var3];
         }
   ...
   public void method1437(int var1) {
      int var2 = field1258[var1];
      int var3 = field1249[var1];
   ...
   @ObfuscatedName("p")
   public void method1439(short var1, short var2) {
   ...
   @ObfuscatedName("z")
   public void method1440(short var1, short var2) {
   ...
   public ModelData(ModelData[] var1, int var2) {
      ...
      for(var9 = 0; var9 < var2; ++var9) {
         ...
         if(var10 != null) {
            ...
            this.field1237 += var10.field1237;
      ...
      this.faceColor = new short[this.triangleFaceCount];
      if(this.field1237 > 0) {
         this.textureRenderTypes = new byte[this.field1237];
         this.texTriangleX = new short[this.field1237];
         this.texTriangleY = new short[this.field1237];
         this.texTriangleZ = new short[this.field1237];
         this.field1250 = new short[this.field1237];
         this.field1243 = new short[this.field1237];
         this.field1244 = new short[this.field1237];
         this.field1245 = new short[this.field1237];
         this.field1260 = new byte[this.field1237];
         this.field1246 = new short[this.field1237];
         this.texturePrimaryColor = new short[this.field1237];
      }
            ...
            for(var11 = 0; var11 < var10.triangleFaceCount; ++var11) {
               ...
               if(var8) {
                  if(var10.textureCoords != null && var10.textureCoords[var11] != -1) {
                     this.textureCoords[this.triangleFaceCount] = (byte)(var10.textureCoords[var11] + this.field1237);
                  } else {
               ...
               this.trianglePointsX[this.triangleFaceCount] = this.method1482(var10, var10.trianglePointsX[var11]);
               this.trianglePointsY[this.triangleFaceCount] = this.method1482(var10, var10.trianglePointsY[var11]);
               this.trianglePointsZ[this.triangleFaceCount] = this.method1482(var10, var10.trianglePointsZ[var11]);
               ++this.triangleFaceCount;
            }

            for(var11 = 0; var11 < var10.field1237; ++var11) {
               byte var12 = this.textureRenderTypes[this.field1237] = var10.textureRenderTypes[var11];
               if(var12 == 0) {
                  this.texTriangleX[this.field1237] = (short)this.method1482(var10, var10.texTriangleX[var11]);
                  this.texTriangleY[this.field1237] = (short)this.method1482(var10, var10.texTriangleY[var11]);
                  this.texTriangleZ[this.field1237] = (short)this.method1482(var10, var10.texTriangleZ[var11]);
               }

               if(var12 >= 1 && var12 <= 3) {
                  this.texTriangleX[this.field1237] = var10.texTriangleX[var11];
                  this.texTriangleY[this.field1237] = var10.texTriangleY[var11];
                  this.texTriangleZ[this.field1237] = var10.texTriangleZ[var11];
                  this.field1250[this.field1237] = var10.field1250[var11];
                  this.field1243[this.field1237] = var10.field1243[var11];
                  this.field1244[this.field1237] = var10.field1244[var11];
                  this.field1245[this.field1237] = var10.field1245[var11];
                  this.field1260[this.field1237] = var10.field1260[var11];
                  this.field1246[this.field1237] = var10.field1246[var11];
               }

               if(var12 == 2) {
                  this.texturePrimaryColor[this.field1237] = var10.texturePrimaryColor[var11];
               }
   ...
   @ObfuscatedName("l")
   static void method1445(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
      var0.method1489();
      var0.computeNormals();
      var1.method1489();
      var1.computeNormals();
      ...
      for(var9 = 0; var9 < var0.vertexCount; ++var9) {
         ...
         if(var10.magnitude != 0) {
            ...
            if(var11 <= var1.field1236) {
               int var12 = var0.vertexX[var9] - var2;
               if(var12 >= var1.field1234 && var12 <= var1.field1261) {
                  int var13 = var0.vertexZ[var9] - var4;
                  if(var13 >= var1.field1263 && var13 <= var1.field1267) {
                     for(int var14 = 0; var14 < var8; ++var14) {
                        ...
                        if(var12 == var7[var14] && var13 == var1.vertexZ[var14] && var11 == var1.vertexY[var14] && var15.magnitude != 0) {
                           if(var0.field1266 == null) {
                              var0.field1266 = new VertexNormal[var0.vertexCount];
                           }

                           if(var1.field1266 == null) {
                              var1.field1266 = new VertexNormal[var8];
                           }

                           VertexNormal var16 = var0.field1266[var9];
                           if(var16 == null) {
                              var16 = var0.field1266[var9] = new VertexNormal(var10);
                           }

                           VertexNormal var17 = var1.field1266[var14];
                           if(var17 == null) {
                              var17 = var1.field1266[var14] = new VertexNormal(var15);
                           }
                           ...
                           ++var6;
                           field1264[var9] = field1248;
                           field1265[var14] = field1248;
                        }
                     }
                  }
               }
      ...
      if(var6 >= 3 && var5) {
         for(var9 = 0; var9 < var0.triangleFaceCount; ++var9) {
            if(field1264[var0.trianglePointsX[var9]] == field1248 && field1264[var0.trianglePointsY[var9]] == field1248 && field1264[var0.trianglePointsZ[var9]] == field1248) {
         ...
         for(var9 = 0; var9 < var1.triangleFaceCount; ++var9) {
            if(field1265[var1.trianglePointsX[var9]] == field1248 && field1265[var1.trianglePointsY[var9]] == field1248 && field1265[var1.trianglePointsZ[var9]] == field1248) {
   ...
   @ObfuscatedName("v")
   public final Model method1446(int var1, int var2, int var3, int var4, int var5) {
      this.computeNormals();
      ...
      var8.field1380 = new int[this.triangleFaceCount];
      if(this.field1237 > 0 && this.textureCoords != null) {
         int[] var9 = new int[this.field1237];
         ...
         for(var10 = 0; var10 < this.field1237; ++var10) {
            if(var9[var10] > 0 && this.textureRenderTypes[var10] == 0) {
               ++var8.field1366;
            }
         }

         var8.field1377 = new int[var8.field1366];
         var8.field1378 = new int[var8.field1366];
         var8.field1395 = new int[var8.field1366];
         var10 = 0;

         int var11;
         for(var11 = 0; var11 < this.field1237; ++var11) {
            if(var9[var11] > 0 && this.textureRenderTypes[var11] == 0) {
               var8.field1377[var10] = this.texTriangleX[var11] & '\uffff';
               var8.field1378[var10] = this.texTriangleY[var11] & '\uffff';
               var8.field1395[var10] = this.texTriangleZ[var11] & '\uffff';
               var9[var11] = var10++;
            } else {
               var9[var11] = -1;
            }
         ...
         var8.field1360 = new byte[this.triangleFaceCount];

         for(var11 = 0; var11 < this.triangleFaceCount; ++var11) {
            if(this.textureCoords[var11] != -1) {
               var8.field1360[var11] = (byte)var9[this.textureCoords[var11] & 255];
            } else {
               var8.field1360[var11] = -1;
            }
         }
      }
         ...
         if(var12 == -1) {
            if(var17 != 0) {
               if(var17 == 1) {
                  ...
                  var8.field1368[var16] = method1447(this.faceColor[var16] & '\uffff', var14);
                  var8.field1380[var16] = -1;
               } else if(var17 == 3) {
                  var8.field1368[var16] = 128;
                  var8.field1380[var16] = -1;
               } else {
                  var8.field1380[var16] = -2;
               }
            } else {
               int var15 = this.faceColor[var16] & '\uffff';
               if(this.field1266 != null && this.field1266[this.trianglePointsX[var16]] != null) {
                  var13 = this.field1266[this.trianglePointsX[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsX[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1368[var16] = method1447(var15, var14);
               if(this.field1266 != null && this.field1266[this.trianglePointsY[var16]] != null) {
                  var13 = this.field1266[this.trianglePointsY[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsY[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1361[var16] = method1447(var15, var14);
               if(this.field1266 != null && this.field1266[this.trianglePointsZ[var16]] != null) {
                  var13 = this.field1266[this.trianglePointsZ[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsZ[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1380[var16] = method1447(var15, var14);
            }
         } else if(var17 != 0) {
            if(var17 == 1) {
               var19 = this.faceNormals[var16];
               var14 = var1 + (var3 * var19.x + var4 * var19.y + var5 * var19.z) / (var7 + var7 / 2);
               var8.field1368[var16] = method1448(var14);
               var8.field1380[var16] = -1;
            } else {
               var8.field1380[var16] = -2;
            }
            ...
            var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
            var8.field1361[var16] = method1448(var14);
            if(this.field1266 != null && this.field1266[this.trianglePointsZ[var16]] != null) {
               var13 = this.field1266[this.trianglePointsZ[var16]];
            } else {
               var13 = this.normals[this.trianglePointsZ[var16]];
            ...
            var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
            var8.field1380[var16] = method1448(var14);
         }
      }

      this.computeAnimationTables();
      var8.field1358 = this.vertexCount;
      var8.verticesX = this.vertexX;
      var8.verticesY = this.vertexY;
      var8.verticesZ = this.vertexZ;
      var8.field1369 = this.triangleFaceCount;
      var8.indices1 = this.trianglePointsX;
      var8.indices2 = this.trianglePointsY;
      var8.indices3 = this.trianglePointsZ;
      var8.field1371 = this.faceRenderPriorities;
      var8.field1372 = this.faceAlphas;
      var8.field1375 = this.priority;
      var8.field1374 = this.field1251;
      var8.field1381 = this.field1252;
      var8.field1415 = this.faceTextures;
      return var8;
   }
   ...
   @ObfuscatedName("ai")
   static final int method1448(int var0) {
      if(var0 < 2) {
         var0 = 2;
      } else if(var0 > 126) {
         var0 = 126;
   ...
   static {
      field1258 = class84.field1444;
      field1249 = class84.field1453;
   }

   @ObfuscatedName("d")
   public void method1449(int var1, int var2, int var3) {
      for(int var4 = 0; var4 < this.vertexCount; ++var4) {
   ...
   void method1463(byte[] var1) {
      ...
      if(var11 > 0) {
         ...
         if(var24 > 0) {
            ...
            this.field1245 = new short[var24];
            this.field1260 = new byte[var24];
            this.field1246 = new short[var24];
         }
      ...
      for(var55 = 0; var55 < var11; ++var55) {
         ...
         if(var56 == 1) {
            ...
            this.field1250[var55] = (short)var4.readUnsignedShort();
            this.field1243[var55] = (short)var4.readUnsignedShort();
            this.field1244[var55] = (short)var4.readUnsignedShort();
            this.field1245[var55] = (short)var5.readUnsignedShort();
            this.field1260[var55] = var6.readByte();
            this.field1246[var55] = (short)var7.readUnsignedShort();
         }
   ...
   @ObfuscatedName("w")
   public void method1467(int var1, int var2, int var3) {
      for(int var4 = 0; var4 < this.vertexCount; ++var4) {
   ...
   @ObfuscatedName("k")
   final int method1482(ModelData var1, int var2) {
      int var3 = -1;
   ...
   void method1489() {
      if(!this.field1242) {
         super.modelHeight = 0;
         this.field1236 = 0;
         this.field1234 = 999999;
         this.field1261 = -999999;
         this.field1267 = -99999;
   ...
   @ObfuscatedName("b")
   public ModelData method1499(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
      this.method1489();
      int var7 = var2 + this.field1234;
      int var8 = var2 + this.field1261;
      int var9 = var4 + this.field1263;
      int var10 = var4 + this.field1267;
      if(var7 >= 0 && var8 + 128 >> 7 < var1.length && var9 >= 0 && var10 + 128 >> 7 < var1[0].length) {
         ...
         if(var1[var7][var9] == var3 && var1[var8][var9] == var3 && var1[var7][var10] == var3 && var1[var8][var10] == var3) {
            ...
            var11.field1250 = this.field1250;
            var11.field1243 = this.field1243;
            var11.field1244 = this.field1244;
            var11.field1245 = this.field1245;
            var11.field1260 = this.field1260;
            var11.field1246 = this.field1246;
            ...
            var11.field1251 = this.field1251;
            var11.field1252 = this.field1252;
            var11.field1268 = this.field1268;
            var11.field1257 = this.field1257;
