...
public class ModelData extends Renderable {
   ...
   public static ModelData method2416(IndexDataBase var0, int var1, int var2) {
   ...
   void method2417() {
      if(!this.field1836) {
         ...
         this.field1800 = -999999;
         this.field1840 = -99999;
   ...
   void method2418(byte[] var1) {
      ...
      if(var11 > 0) {
         ...
         if(var24 > 0) {
            ...
            this.field1845 = new short[var24];
            this.field1823 = new short[var24];
            this.field1842 = new short[var24];
            this.field1826 = new byte[var24];
      ...
      for(var55 = 0; var55 < var11; ++var55) {
         ...
         if(var56 == 1) {
            ...
            this.field1845[var55] = (short)var4.readUnsignedShort();
            this.field1823[var55] = (short)var4.readUnsignedShort();
            this.field1842[var55] = (short)var5.readUnsignedShort();
            this.field1826[var55] = var6.readByte();
            this.field1824[var55] = (short)var7.readUnsignedShort();
         }
   ...
   @ObfuscatedName("c")
   public ModelData method2421(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
      this.method2417();
      int var7 = var2 + this.field1838;
      int var8 = var2 + this.field1800;
      int var9 = var4 + this.field1841;
      int var10 = var4 + this.field1840;
   ...
   public ModelData(ModelData var1, boolean var2, boolean var3, boolean var4, boolean var5) {
      ...
      this.field1845 = var1.field1845;
      this.field1823 = var1.field1823;
      this.field1842 = var1.field1842;
   ...
   public void method2422(int var1) {
      int var2 = field1834[var1];
   ...
   @ObfuscatedName("x")
   public void method2428(int var1, int var2, int var3) {
      for(int var4 = 0; var4 < this.vertexCount; ++var4) {
   ...
   @ObfuscatedName("r")
   public void method2430(short var1, short var2) {
   ...
   @ObfuscatedName("s")
   public void method2432(int var1, int var2, int var3) {
      for(int var4 = 0; var4 < this.vertexCount; ++var4) {
   ...
   public final Model light(int var1, int var2, int var3, int var4, int var5) {
      ...
      var8.field1976 = new int[this.triangleFaceCount];
      var8.field1947 = new int[this.triangleFaceCount];
      if(this.field1815 > 0 && this.textureCoords != null) {
         int[] var9 = new int[this.field1815];
         ...
         for(var10 = 0; var10 < this.field1815; ++var10) {
         ...
         var8.field1977 = new int[var8.field1951];
         var8.field1954 = new int[var8.field1951];
         var10 = 0;

         int var11;
         for(var11 = 0; var11 < this.field1815; ++var11) {
            if(var9[var11] > 0 && this.textureRenderTypes[var11] == 0) {
               var8.field1952[var10] = this.texTriangleX[var11] & '\uffff';
               var8.field1977[var10] = this.texTriangleY[var11] & '\uffff';
               var8.field1954[var10] = this.texTriangleZ[var11] & '\uffff';
               var9[var11] = var10++;
            } else {
               var9[var11] = -1;
            }
         ...
         var8.field1948 = new byte[this.triangleFaceCount];

         for(var11 = 0; var11 < this.triangleFaceCount; ++var11) {
            if(this.textureCoords[var11] != -1) {
               var8.field1948[var11] = (byte)var9[this.textureCoords[var11] & 255];
            } else {
               var8.field1948[var11] = -1;
            }
         }
      }
         ...
         if(var12 == -1) {
            if(var17 != 0) {
               if(var17 == 1) {
                  ...
                  var8.field1943[var16] = method2438(this.faceColor[var16] & '\uffff', var14);
                  var8.field1947[var16] = -1;
               } else if(var17 == 3) {
                  var8.field1943[var16] = 128;
                  var8.field1947[var16] = -1;
               } else {
                  var8.field1947[var16] = -2;
               }
            } else {
               int var15 = this.faceColor[var16] & '\uffff';
               if(this.field1833 != null && this.field1833[this.trianglePointsX[var16]] != null) {
                  var13 = this.field1833[this.trianglePointsX[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsX[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1943[var16] = method2438(var15, var14);
               if(this.field1833 != null && this.field1833[this.trianglePointsY[var16]] != null) {
                  var13 = this.field1833[this.trianglePointsY[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsY[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1976[var16] = method2438(var15, var14);
               if(this.field1833 != null && this.field1833[this.trianglePointsZ[var16]] != null) {
                  var13 = this.field1833[this.trianglePointsZ[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsZ[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1947[var16] = method2438(var15, var14);
            }
         } else if(var17 != 0) {
            if(var17 == 1) {
               var19 = this.faceNormals[var16];
               var14 = var1 + (var3 * var19.x + var4 * var19.y + var5 * var19.z) / (var7 + var7 / 2);
               var8.field1943[var16] = method2439(var14);
               var8.field1947[var16] = -1;
            } else {
               var8.field1947[var16] = -2;
            }
            ...
            var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
            var8.field1976[var16] = method2439(var14);
            if(this.field1833 != null && this.field1833[this.trianglePointsZ[var16]] != null) {
               var13 = this.field1833[this.trianglePointsZ[var16]];
            } else {
               var13 = this.normals[this.trianglePointsZ[var16]];
            ...
            var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
            var8.field1947[var16] = method2439(var14);
         }
      }

      this.computeAnimationTables();
      var8.field1955 = this.vertexCount;
      ...
      var8.field1985 = this.faceAlphas;
      var8.field1950 = this.priority;
      var8.field1940 = this.field1821;
      var8.field1956 = this.field1839;
      var8.field1949 = this.faceTextures;
      return var8;
   }

   @ObfuscatedName("aw")
   static final int method2438(int var0, int var1) {
   ...
   @ObfuscatedName("an")
   static final int method2439(int var0) {
      if(var0 < 2) {
         var0 = 2;
      } else if(var0 > 126) {
         var0 = 126;
   ...
   void computeAnimationTables() {
      ...
      if(this.vertexSkins != null) {
         ...
         this.field1821 = new int[var2 + 1][];

         for(var3 = 0; var3 <= var2; ++var3) {
            this.field1821[var3] = new int[var1[var3]];
            var1[var3] = 0;
         }

         for(var3 = 0; var3 < this.vertexCount; this.field1821[var4][var1[var4]++] = var3++) {
            var4 = this.vertexSkins[var3];
         }
   ...
   @ObfuscatedName("f")
   final int method2449(ModelData var1, int var2) {
      int var3 = -1;
   ...
   static void method2485(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
      ...
      for(var9 = 0; var9 < var0.vertexCount; ++var9) {
         ...
         if(var10.magnitude != 0) {
            ...
            if(var11 <= var1.field1829) {
               int var12 = var0.vertexX[var9] - var2;
               if(var12 >= var1.field1838 && var12 <= var1.field1800) {
                  int var13 = var0.vertexZ[var9] - var4;
                  if(var13 >= var1.field1841 && var13 <= var1.field1840) {
                     for(int var14 = 0; var14 < var8; ++var14) {
                        ...
                        if(var12 == var7[var14] && var13 == var1.vertexZ[var14] && var11 == var1.vertexY[var14] && var15.magnitude != 0) {
                           if(var0.field1833 == null) {
                              var0.field1833 = new VertexNormal[var0.vertexCount];
                           }

                           if(var1.field1833 == null) {
                              var1.field1833 = new VertexNormal[var8];
                           }

                           VertexNormal var16 = var0.field1833[var9];
                           if(var16 == null) {
                              var16 = var0.field1833[var9] = new VertexNormal(var10);
                           }

                           VertexNormal var17 = var1.field1833[var14];
                           if(var17 == null) {
                              var17 = var1.field1833[var14] = new VertexNormal(var15);
                           }
                           ...
                           ++var6;
                           field1822[var9] = field1844;
                           field1814[var14] = field1844;
                        }
                     }
                  }
               }
      ...
      if(var6 >= 3 && var5) {
         for(var9 = 0; var9 < var0.triangleFaceCount; ++var9) {
            if(field1822[var0.trianglePointsX[var9]] == field1844 && field1822[var0.trianglePointsY[var9]] == field1844 && field1822[var0.trianglePointsZ[var9]] == field1844) {
         ...
         for(var9 = 0; var9 < var1.triangleFaceCount; ++var9) {
            if(field1814[var1.trianglePointsX[var9]] == field1844 && field1814[var1.trianglePointsY[var9]] == field1844 && field1814[var1.trianglePointsZ[var9]] == field1844) {
   ...
   public ModelData(ModelData[] var1, int var2) {
      ...
      for(var9 = 0; var9 < var2; ++var9) {
         ...
         if(var10 != null) {
            ...
            this.field1815 += var10.field1815;
      ...
      this.faceColor = new short[this.triangleFaceCount];
      if(this.field1815 > 0) {
         this.textureRenderTypes = new byte[this.field1815];
         this.texTriangleX = new short[this.field1815];
         this.texTriangleY = new short[this.field1815];
         this.texTriangleZ = new short[this.field1815];
         this.field1820 = new short[this.field1815];
         this.field1845 = new short[this.field1815];
         this.field1823 = new short[this.field1815];
         this.field1842 = new short[this.field1815];
         this.field1826 = new byte[this.field1815];
         this.field1824 = new short[this.field1815];
         this.texturePrimaryColor = new short[this.field1815];
      }
            ...
            for(var11 = 0; var11 < var10.triangleFaceCount; ++var11) {
               ...
               if(var8) {
                  if(var10.textureCoords != null && var10.textureCoords[var11] != -1) {
                     this.textureCoords[this.triangleFaceCount] = (byte)(var10.textureCoords[var11] + this.field1815);
                  } else {
               ...
               this.trianglePointsX[this.triangleFaceCount] = this.method2449(var10, var10.trianglePointsX[var11]);
               this.trianglePointsY[this.triangleFaceCount] = this.method2449(var10, var10.trianglePointsY[var11]);
               this.trianglePointsZ[this.triangleFaceCount] = this.method2449(var10, var10.trianglePointsZ[var11]);
               ++this.triangleFaceCount;
            }

            for(var11 = 0; var11 < var10.field1815; ++var11) {
               byte var12 = this.textureRenderTypes[this.field1815] = var10.textureRenderTypes[var11];
               if(var12 == 0) {
                  this.texTriangleX[this.field1815] = (short)this.method2449(var10, var10.texTriangleX[var11]);
                  this.texTriangleY[this.field1815] = (short)this.method2449(var10, var10.texTriangleY[var11]);
                  this.texTriangleZ[this.field1815] = (short)this.method2449(var10, var10.texTriangleZ[var11]);
               }

               if(var12 >= 1 && var12 <= 3) {
                  this.texTriangleX[this.field1815] = var10.texTriangleX[var11];
                  this.texTriangleY[this.field1815] = var10.texTriangleY[var11];
                  this.texTriangleZ[this.field1815] = var10.texTriangleZ[var11];
                  this.field1820[this.field1815] = var10.field1820[var11];
                  this.field1845[this.field1815] = var10.field1845[var11];
                  this.field1823[this.field1815] = var10.field1823[var11];
                  this.field1842[this.field1815] = var10.field1842[var11];
                  this.field1826[this.field1815] = var10.field1826[var11];
                  this.field1824[this.field1815] = var10.field1824[var11];
               }

               if(var12 == 2) {
                  this.texturePrimaryColor[this.field1815] = var10.texturePrimaryColor[var11];
               }
   ...
   @ObfuscatedName("y")
   public void method2490(short var1, short var2) {
      for(int var3 = 0; var3 < this.triangleFaceCount; ++var3) {
   ...
   static {
      field1822 = new int[10000];
      field1814 = new int[10000];
      field1844 = 0;
      field1834 = class136.SINE;
      field1846 = class136.COSINE;
   }
