...
public class ModelData extends Renderable {
   ...
   int field1228;
   @ObfuscatedName("ad")
   static int[] field1229 = new int[10000];
   @ObfuscatedName("g")
   ...
   short[] texTriangleZ;
   @ObfuscatedName("ag")
   static int[] field1247 = new int[10000];
   @ObfuscatedName("an")
   @Export("normals")
   ...
   ModelData(byte[] var1) {
      if(var1[var1.length - 1] == -1 && var1[var1.length - 2] == -1) {
         this.method1523(var1);
      } else {
         this.method1524(var1);
      }

   }

   @ObfuscatedName("l")
   void method1523(byte[] var1) {
      ...
      if(var11 > 0) {
         ...
         if(var24 > 0) {
            ...
            this.field1232 = new byte[var24];
            this.field1215 = new short[var24];
         }
      ...
      for(var55 = 0; var55 < var11; ++var55) {
         ...
         if(var56 == 1) {
            ...
            this.field1225[var55] = (short)var4.readUnsignedShort();
            this.field1226[var55] = (short)var4.readUnsignedShort();
            this.field1227[var55] = (short)var4.readUnsignedShort();
            this.field1249[var55] = (short)var5.readUnsignedShort();
            this.field1232[var55] = var6.readByte();
            this.field1215[var55] = (short)var7.readUnsignedShort();
         }
   ...
   public ModelData(ModelData[] var1, int var2) {
      ...
      if(this.field1220 > 0) {
         this.textureRenderTypes = new byte[this.field1220];
         this.texTriangleX = new short[this.field1220];
         this.texTriangleY = new short[this.field1220];
         this.texTriangleZ = new short[this.field1220];
         this.field1225 = new short[this.field1220];
         this.field1226 = new short[this.field1220];
         this.field1227 = new short[this.field1220];
         this.field1249 = new short[this.field1220];
         this.field1232 = new byte[this.field1220];
         this.field1215 = new short[this.field1220];
         this.texturePrimaryColor = new short[this.field1220];
      }
            ...
            for(var11 = 0; var11 < var10.triangleFaceCount; ++var11) {
               ...
               if(var8) {
                  if(var10.textureCoords != null && var10.textureCoords[var11] != -1) {
                     this.textureCoords[this.triangleFaceCount] = (byte)(var10.textureCoords[var11] + this.field1220);
                  } else {
               ...
               this.trianglePointsX[this.triangleFaceCount] = this.method1598(var10, var10.trianglePointsX[var11]);
               this.trianglePointsY[this.triangleFaceCount] = this.method1598(var10, var10.trianglePointsY[var11]);
               this.trianglePointsZ[this.triangleFaceCount] = this.method1598(var10, var10.trianglePointsZ[var11]);
               ++this.triangleFaceCount;
            }

            for(var11 = 0; var11 < var10.field1220; ++var11) {
               byte var12 = this.textureRenderTypes[this.field1220] = var10.textureRenderTypes[var11];
               if(var12 == 0) {
                  this.texTriangleX[this.field1220] = (short)this.method1598(var10, var10.texTriangleX[var11]);
                  this.texTriangleY[this.field1220] = (short)this.method1598(var10, var10.texTriangleY[var11]);
                  this.texTriangleZ[this.field1220] = (short)this.method1598(var10, var10.texTriangleZ[var11]);
               }

               if(var12 >= 1 && var12 <= 3) {
                  this.texTriangleX[this.field1220] = var10.texTriangleX[var11];
                  this.texTriangleY[this.field1220] = var10.texTriangleY[var11];
                  this.texTriangleZ[this.field1220] = var10.texTriangleZ[var11];
                  this.field1225[this.field1220] = var10.field1225[var11];
                  this.field1226[this.field1220] = var10.field1226[var11];
                  this.field1227[this.field1220] = var10.field1227[var11];
                  this.field1249[this.field1220] = var10.field1249[var11];
                  this.field1232[this.field1220] = var10.field1232[var11];
                  this.field1215[this.field1220] = var10.field1215[var11];
               }

               if(var12 == 2) {
                  this.texturePrimaryColor[this.field1220] = var10.texturePrimaryColor[var11];
               }
   ...
   void computeAnimationTables() {
      ...
      if(this.vertexSkins != null) {
         ...
         this.field1234 = new int[var2 + 1][];

         for(var3 = 0; var3 <= var2; ++var3) {
            this.field1234[var3] = new int[var1[var3]];
            var1[var3] = 0;
         }

         for(var3 = 0; var3 < this.vertexCount; this.field1234[var4][var1[var4]++] = var3++) {
            var4 = this.vertexSkins[var3];
         }
      ...
      if(this.triangleSkinValues != null) {
         ...
         for(var3 = 0; var3 <= var2; ++var3) {
            this.field1235[var3] = new int[var1[var3]];
            var1[var3] = 0;
         }

         for(var3 = 0; var3 < this.triangleFaceCount; this.field1235[var4][var1[var4]++] = var3++) {
            var4 = this.triangleSkinValues[var3];
         }
   ...
   public void method1532(int var1) {
      int var2 = field1250[var1];
      int var3 = field1251[var1];
   ...
   static {
      field1250 = class84.field1435;
      field1251 = class84.field1432;
   }
   ...
   @ObfuscatedName("ab")
   static void method1540(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
      var0.method1566();
      var0.computeNormals();
      var1.method1566();
      var1.computeNormals();
      ...
      for(var9 = 0; var9 < var0.vertexCount; ++var9) {
         ...
         if(var10.magnitude != 0) {
            ...
            if(var11 <= var1.field1242) {
               int var12 = var0.vertexX[var9] - var2;
               if(var12 >= var1.field1224 && var12 <= var1.field1244) {
                  int var13 = var0.vertexZ[var9] - var4;
                  if(var13 >= var1.field1228 && var13 <= var1.field1245) {
                     for(int var14 = 0; var14 < var8; ++var14) {
                        ...
                        if(var12 == var7[var14] && var13 == var1.vertexZ[var14] && var11 == var1.vertexY[var14] && var15.magnitude != 0) {
                           if(var0.field1238 == null) {
                              var0.field1238 = new VertexNormal[var0.vertexCount];
                           }

                           if(var1.field1238 == null) {
                              var1.field1238 = new VertexNormal[var8];
                           }

                           VertexNormal var16 = var0.field1238[var9];
                           if(var16 == null) {
                              var16 = var0.field1238[var9] = new VertexNormal(var10);
                           }

                           VertexNormal var17 = var1.field1238[var14];
                           if(var17 == null) {
                              var17 = var1.field1238[var14] = new VertexNormal(var15);
                           }
                           ...
                           ++var6;
                           field1247[var9] = field1205;
                           field1229[var14] = field1205;
                        }
                     }
                  }
               }
      ...
      if(var6 >= 3 && var5) {
         for(var9 = 0; var9 < var0.triangleFaceCount; ++var9) {
            if(field1247[var0.trianglePointsX[var9]] == field1205 && field1247[var0.trianglePointsY[var9]] == field1205 && field1247[var0.trianglePointsZ[var9]] == field1205) {
         ...
         for(var9 = 0; var9 < var1.triangleFaceCount; ++var9) {
            if(field1229[var1.trianglePointsX[var9]] == field1205 && field1229[var1.trianglePointsY[var9]] == field1205 && field1229[var1.trianglePointsZ[var9]] == field1205) {
   ...
   @ObfuscatedName("e")
   public void method1541(short var1, short var2) {
   ...
   @ObfuscatedName("ac")
   static final int method1543(int var0) {
      if(var0 < 2) {
         var0 = 2;
      } else if(var0 > 126) {
         var0 = 126;
   ...
   @ObfuscatedName("af")
   public final Model method1544(int var1, int var2, int var3, int var4, int var5) {
      this.computeNormals();
      int var6 = (int)Math.sqrt((double)(var3 * var3 + var4 * var4 + var5 * var5));
      int var7 = var2 * var6 >> 8;
      Model var8 = new Model();
      var8.field1348 = new int[this.triangleFaceCount];
      var8.field1349 = new int[this.triangleFaceCount];
      var8.field1350 = new int[this.triangleFaceCount];
      if(this.field1220 > 0 && this.textureCoords != null) {
         int[] var9 = new int[this.field1220];
         ...
         for(var10 = 0; var10 < this.field1220; ++var10) {
            if(var9[var10] > 0 && this.textureRenderTypes[var10] == 0) {
               ++var8.field1397;
            }
         }

         var8.field1396 = new int[var8.field1397];
         var8.field1358 = new int[var8.field1397];
         var8.field1359 = new int[var8.field1397];
         var10 = 0;

         int var11;
         for(var11 = 0; var11 < this.field1220; ++var11) {
            if(var9[var11] > 0 && this.textureRenderTypes[var11] == 0) {
               var8.field1396[var10] = this.texTriangleX[var11] & '\uffff';
               var8.field1358[var10] = this.texTriangleY[var11] & '\uffff';
               var8.field1359[var10] = this.texTriangleZ[var11] & '\uffff';
               var9[var11] = var10++;
            } else {
               var9[var11] = -1;
            }
         ...
         var8.field1353 = new byte[this.triangleFaceCount];

         for(var11 = 0; var11 < this.triangleFaceCount; ++var11) {
            if(this.textureCoords[var11] != -1) {
               var8.field1353[var11] = (byte)var9[this.textureCoords[var11] & 255];
            } else {
               var8.field1353[var11] = -1;
            }
         }
      }
         ...
         if(var12 == -1) {
            if(var17 != 0) {
               if(var17 == 1) {
                  ...
                  var8.field1348[var16] = method1577(this.faceColor[var16] & '\uffff', var14);
                  var8.field1350[var16] = -1;
               } else if(var17 == 3) {
                  var8.field1348[var16] = 128;
                  var8.field1350[var16] = -1;
               } else {
                  var8.field1350[var16] = -2;
               }
            } else {
               int var15 = this.faceColor[var16] & '\uffff';
               if(this.field1238 != null && this.field1238[this.trianglePointsX[var16]] != null) {
                  var13 = this.field1238[this.trianglePointsX[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsX[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1348[var16] = method1577(var15, var14);
               if(this.field1238 != null && this.field1238[this.trianglePointsY[var16]] != null) {
                  var13 = this.field1238[this.trianglePointsY[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsY[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1349[var16] = method1577(var15, var14);
               if(this.field1238 != null && this.field1238[this.trianglePointsZ[var16]] != null) {
                  var13 = this.field1238[this.trianglePointsZ[var16]];
               } else {
                  var13 = this.normals[this.trianglePointsZ[var16]];
               }

               var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
               var8.field1350[var16] = method1577(var15, var14);
            }
         } else if(var17 != 0) {
            if(var17 == 1) {
               var19 = this.faceNormals[var16];
               var14 = var1 + (var3 * var19.x + var4 * var19.y + var5 * var19.z) / (var7 + var7 / 2);
               var8.field1348[var16] = method1543(var14);
               var8.field1350[var16] = -1;
            } else {
               var8.field1350[var16] = -2;
            }
            ...
            var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
            var8.field1349[var16] = method1543(var14);
            if(this.field1238 != null && this.field1238[this.trianglePointsZ[var16]] != null) {
               var13 = this.field1238[this.trianglePointsZ[var16]];
            } else {
               var13 = this.normals[this.trianglePointsZ[var16]];
            ...
            var14 = var1 + (var3 * var13.x + var4 * var13.y + var5 * var13.z) / (var7 * var13.magnitude);
            var8.field1350[var16] = method1543(var14);
         }
      }

      this.computeAnimationTables();
      var8.field1340 = this.vertexCount;
      var8.verticesX = this.vertexX;
      var8.verticesY = this.vertexY;
      var8.verticesZ = this.vertexZ;
      var8.field1344 = this.triangleFaceCount;
      var8.indices1 = this.trianglePointsX;
      var8.indices2 = this.trianglePointsY;
      var8.indices3 = this.trianglePointsZ;
      var8.field1356 = this.faceRenderPriorities;
      var8.field1352 = this.faceAlphas;
      var8.field1355 = this.priority;
      var8.field1342 = this.field1234;
      var8.field1361 = this.field1235;
      var8.field1354 = this.faceTextures;
      return var8;
   }

   @ObfuscatedName("c")
   public void method1558(int var1, int var2, int var3) {
      for(int var4 = 0; var4 < this.vertexCount; ++var4) {
   ...
   @ObfuscatedName("z")
   public ModelData method1560(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
      this.method1566();
      int var7 = var2 + this.field1224;
      int var8 = var2 + this.field1244;
      int var9 = var4 + this.field1228;
      int var10 = var4 + this.field1245;
      if(var7 >= 0 && var8 + 128 >> 7 < var1.length && var9 >= 0 && var10 + 128 >> 7 < var1[0].length) {
         ...
         if(var1[var7][var9] == var3 && var1[var8][var9] == var3 && var1[var7][var10] == var3 && var1[var8][var10] == var3) {
            ...
            var11.field1249 = this.field1249;
            var11.field1232 = this.field1232;
            var11.field1215 = this.field1215;
   ...
   public static ModelData method1563(class182 var0, int var1, int var2) {
   ...
   void method1566() {
      if(!this.field1222) {
         ...
         this.field1244 = -999999;
         this.field1245 = -99999;
         this.field1228 = 99999;
         ...
         for(int var1 = 0; var1 < this.vertexCount; ++var1) {
            ...
            if(var2 > this.field1244) {
               this.field1244 = var2;
            }

            if(var4 < this.field1228) {
               this.field1228 = var4;
            }
   ...
   @ObfuscatedName("aw")
   static final int method1577(int var0, int var1) {
   ...
   @ObfuscatedName("v")
   public void method1579(short var1, short var2) {
      for(int var3 = 0; var3 < this.triangleFaceCount; ++var3) {
   ...
   @ObfuscatedName("k")
   final int method1598(ModelData var1, int var2) {
      int var3 = -1;
