...
public class ModelData extends Renderable {
   ...
   @ObfuscatedName("av")
   static int[] field1269 = new int[10000];
   @ObfuscatedName("t")
   ...
   short[] field1274;
   @ObfuscatedName("az")
   static int[] field1275 = new int[10000];
   @ObfuscatedName("a")
   ...
   public static ModelData method1547(class182 var0, int var1, int var2) {
   ...
   public ModelData(ModelData[] var1, int var2) {
      ...
      if(this.field1253 > 0) {
         this.textureRenderTypes = new byte[this.field1253];
         this.texTriangleX = new short[this.field1253];
         this.texTriangleY = new short[this.field1253];
         this.texTriangleZ = new short[this.field1253];
         this.field1271 = new short[this.field1253];
         this.field1254 = new short[this.field1253];
         this.field1274 = new short[this.field1253];
         this.field1256 = new short[this.field1253];
         this.field1259 = new byte[this.field1253];
         this.field1257 = new short[this.field1253];
         this.texturePrimaryColor = new short[this.field1253];
      }
            ...
            for(var11 = 0; var11 < var10.triangleFaceCount; ++var11) {
               ...
               if(var8) {
                  if(var10.textureCoords != null && var10.textureCoords[var11] != -1) {
                     this.textureCoords[this.triangleFaceCount] = (byte)(var10.textureCoords[var11] + this.field1253);
                  } else {
               ...
               this.trianglePointsX[this.triangleFaceCount] = this.method1550(var10, var10.trianglePointsX[var11]);
               this.trianglePointsY[this.triangleFaceCount] = this.method1550(var10, var10.trianglePointsY[var11]);
               this.trianglePointsZ[this.triangleFaceCount] = this.method1550(var10, var10.trianglePointsZ[var11]);
               ++this.triangleFaceCount;
            }

            for(var11 = 0; var11 < var10.field1253; ++var11) {
               byte var12 = this.textureRenderTypes[this.field1253] = var10.textureRenderTypes[var11];
               if(var12 == 0) {
                  this.texTriangleX[this.field1253] = (short)this.method1550(var10, var10.texTriangleX[var11]);
                  this.texTriangleY[this.field1253] = (short)this.method1550(var10, var10.texTriangleY[var11]);
                  this.texTriangleZ[this.field1253] = (short)this.method1550(var10, var10.texTriangleZ[var11]);
               }

               if(var12 >= 1 && var12 <= 3) {
                  this.texTriangleX[this.field1253] = var10.texTriangleX[var11];
                  this.texTriangleY[this.field1253] = var10.texTriangleY[var11];
                  this.texTriangleZ[this.field1253] = var10.texTriangleZ[var11];
                  this.field1271[this.field1253] = var10.field1271[var11];
                  this.field1254[this.field1253] = var10.field1254[var11];
                  this.field1274[this.field1253] = var10.field1274[var11];
                  this.field1256[this.field1253] = var10.field1256[var11];
                  this.field1259[this.field1253] = var10.field1259[var11];
                  this.field1257[this.field1253] = var10.field1257[var11];
               }

               if(var12 == 2) {
                  this.texturePrimaryColor[this.field1253] = var10.texturePrimaryColor[var11];
               }
   ...
   @ObfuscatedName("y")
   final int method1550(ModelData var1, int var2) {
      int var3 = -1;
   ...
   public void method1557(int var1) {
      int var2 = field1278[var1];
      int var3 = field1279[var1];
   ...
   void method1565() {
      if(!this.field1250) {
         ...
         this.field1241 = -99999;
         this.field1233 = 99999;
         ...
         for(int var1 = 0; var1 < this.vertexCount; ++var1) {
            ...
            if(var4 < this.field1233) {
               this.field1233 = var4;
            }

            if(var4 > this.field1241) {
               this.field1241 = var4;
            }
   ...
   @ObfuscatedName("j")
   public ModelData method1570(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
      this.method1565();
      int var7 = var2 + this.field1264;
      int var8 = var2 + this.field1272;
      int var9 = var4 + this.field1233;
      int var10 = var4 + this.field1241;
      if(var7 >= 0 && var8 + 128 >> 7 < var1.length && var9 >= 0 && var10 + 128 >> 7 < var1[0].length) {
         ...
         if(var1[var7][var9] == var3 && var1[var8][var9] == var3 && var1[var7][var10] == var3 && var1[var8][var10] == var3) {
            ...
            var11.field1271 = this.field1271;
   ...
   static {
      field1278 = class84.field1460;
      field1279 = class84.field1446;
   }
   ...
   @ObfuscatedName("t")
   static void method1616(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
      var0.method1565();
      var0.computeNormals();
      var1.method1565();
      var1.computeNormals();
      ...
      for(var9 = 0; var9 < var0.vertexCount; ++var9) {
         ...
         if(var10.magnitude != 0) {
            ...
            if(var11 <= var1.field1265) {
               int var12 = var0.vertexX[var9] - var2;
               if(var12 >= var1.field1264 && var12 <= var1.field1272) {
                  int var13 = var0.vertexZ[var9] - var4;
                  if(var13 >= var1.field1233 && var13 <= var1.field1241) {
                     for(int var14 = 0; var14 < var8; ++var14) {
                        ...
                        if(var12 == var7[var14] && var13 == var1.vertexZ[var14] && var11 == var1.vertexY[var14] && var15.magnitude != 0) {
                           ...
                           ++var6;
                           field1275[var9] = field1258;
                           field1269[var14] = field1258;
                        }
                     }
                  }
               }
      ...
      if(var6 >= 3 && var5) {
         for(var9 = 0; var9 < var0.triangleFaceCount; ++var9) {
            if(field1275[var0.trianglePointsX[var9]] == field1258 && field1275[var0.trianglePointsY[var9]] == field1258 && field1275[var0.trianglePointsZ[var9]] == field1258) {
         ...
         for(var9 = 0; var9 < var1.triangleFaceCount; ++var9) {
            if(field1269[var1.trianglePointsX[var9]] == field1258 && field1269[var1.trianglePointsY[var9]] == field1258 && field1269[var1.trianglePointsZ[var9]] == field1258) {
   ...
   public final Model method1624(int var1, int var2, int var3, int var4, int var5) {
      ...
      if(this.field1253 > 0 && this.textureCoords != null) {
         int[] var16 = new int[this.field1253];
         ...
         for(var10 = 0; var10 < this.field1253; ++var10) {
            if(var16[var10] > 0 && this.textureRenderTypes[var10] == 0) {
               ++var8.field1385;
            }
         }

         var8.field1386 = new int[var8.field1385];
         var8.field1387 = new int[var8.field1385];
         var8.field1380 = new int[var8.field1385];
         var10 = 0;

         int var11;
         for(var11 = 0; var11 < this.field1253; ++var11) {
            if(var16[var11] > 0 && this.textureRenderTypes[var11] == 0) {
               var8.field1386[var10] = this.texTriangleX[var11] & '\uffff';
               var8.field1387[var10] = this.texTriangleY[var11] & '\uffff';
         ...
         var8.field1382 = new byte[this.triangleFaceCount];

         for(var11 = 0; var11 < this.triangleFaceCount; ++var11) {
            if(this.textureCoords[var11] != -1) {
               var8.field1382[var11] = (byte)var16[this.textureCoords[var11] & 255];
            } else {
               var8.field1382[var11] = -1;
            }
         }
      }
      ...
      for(int var9 = 0; var9 < this.triangleFaceCount; ++var9) {
         ...
         if(var12 == -1) {
            if(var17 != 0) {
               ...
               if(this.field1266 != null && this.field1266[this.trianglePointsX[var9]] != null) {
                  var13 = this.field1266[this.trianglePointsX[var9]];
               } else {
               ...
               if(this.field1266 != null && this.field1266[this.trianglePointsY[var9]] != null) {
                  var13 = this.field1266[this.trianglePointsY[var9]];
               } else {
               ...
               if(this.field1266 != null && this.field1266[this.trianglePointsZ[var9]] != null) {
                  var13 = this.field1266[this.trianglePointsZ[var9]];
               } else {
      ...
      var8.field1396 = this.priority;
      var8.field1389 = this.field1262;
      var8.field1390 = this.field1263;
      var8.field1374 = this.faceTextures;
      return var8;
   }
}
