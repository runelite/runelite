...
public class class34 {
            ...
            for(int var7 = 0; var7 < var6.length; ++var7) {
               ...
               if(class31.method268(var8.field453)) {
                  ...
                  if(var8.field453 == class221.field2822.field2842) {
                     ...
                     if(var8.field455 == 1) {
                        Rasterizer2D.method4941(this.field493 * var1 + this.field493 - 1, this.field493 * (63 - var2), 1, var10);
                     }

                     if(var8.field455 == 2) {
                        Rasterizer2D.method4941(var1 * this.field493 + this.field493 - 1, this.field493 * (63 - var2) + this.field493 - 1, 1, var10);
                     }

                     if(var8.field455 == 3) {
                        Rasterizer2D.method4941(this.field493 * var1, this.field493 * (63 - var2) + this.field493 - 1, 1, var10);
                     }
                  }
                  ...
                  if(var8.field453 == class221.field2823.field2842) {
                     ...
                     if(var11 == 0) {
                        for(var12 = 0; var12 < this.field493; ++var12) {
                           Rasterizer2D.method4941(var12 + this.field493 * var1, (64 - var2) * this.field493 - 1 - var12, 1, var10);
                        }
                     } else {
                        for(var12 = 0; var12 < this.field493; ++var12) {
                           Rasterizer2D.method4941(var12 + this.field493 * var1, var12 + this.field493 * (63 - var2), 1, var10);
                        }
                     }
                  }
               }
   ...
   void method419(int var1, int var2, class28 var3, class46 var4) {
      ...
      if(var6 != -1) {
         ...
         if(var10 == null) {
            ...
            int var11 = ChatLineBuffer.method1877(Graphics3D.textureLoader.getAverageTextureRGB(var10.texture), 96);
            ...
            int var15 = (var12 / 4 << 10) + (var13 / 32 << 7) + var14 / 2;
            ...
            for(int var9 = 0; var9 < var5.field413; ++var9) {
               ...
               if(var10 != null && var10.length != 0) {
                  ...
                  for(int var12 = 0; var12 < var11.length; ++var12) {
                     ...
                     if(var14 != null) {
                        Coordinates var15 = new Coordinates(var9, var6 + this.field485 * 64, var7 + this.field486 * 64);
                        Coordinates var16 = null;
                        if(this.field487 != null) {
                           var16 = new Coordinates(this.field487.field412 + var9, var6 + this.field487.field420 * 64, var7 + this.field487.field409 * 64);
                        } else {
                           class45 var17 = (class45)var5;
                           var16 = new Coordinates(var9 + var17.field412, var6 + var17.field420 * 64 + var17.method656() * 8, var7 + var17.field409 * 64 + var17.method657() * 8);
                        }
         ...
         if(var5 != null && var5.length != 0) {
            ...
            for(int var7 = 0; var7 < var6.length; ++var7) {
               ...
               if(var9 != null) {
                  ...
                  if(var10 != null) {
                     if(var10.field548 != var9.field3297) {
                     ...
                     var10.field547.plane = var4 + var15;
                     return;
                  }

                  Coordinates var11 = new Coordinates(var4, this.field485 * 64 + var1, this.field486 * 64 + var2);
                  ...
                  if(this.field487 != null) {
                     ...
                     while(var13.hasNext()) {
                        ...
                        if(var14.method667(var1, var2)) {
                           var12 = new Coordinates(var4 + var14.field412, var14.field420 * 64 + var1 + var14.method656() * 8, var14.field409 * 64 + var2 + var14.method657() * 8);
                           break;
                        }
                     }
                  }
      ...
      for(int var5 = 1; var5 < var3.field413; ++var5) {
         ...
         if(var6 > -1) {
            ...
            if(var9 == null) {
               ...
               int var10 = ChatLineBuffer.method1877(Graphics3D.textureLoader.getAverageTextureRGB(var9.texture), 96);
               ...
               int var14 = (var11 / 4 << 10) + (var12 / 32 << 7) + var13 / 2;
   ...
   void method370(int var1, int var2, int var3, int var4) {
      ...
      if(var3 == 2) {
         Rasterizer2D.method4943(this.field493 + this.field493 * var1 - 1, this.field493 * (63 - var2), this.field493, var4);
      }

      if(var3 == 3) {
         Rasterizer2D.method4941(this.field493 * var1, this.field493 * (63 - var2) + this.field493 - 1, this.field493, var4);
      }
   ...
   static void decodeMovement(PacketBuffer var0, int var1) {
      ...
      if(var3 == 0) {
         if(var2) {
            ...
            class96.field1522[var1] = (var4.field911 << 28) + (var4.pathX[0] + KeyFocusListener.baseX >> 13 << 14) + (var4.pathY[0] + class266.baseY >> 13);
            if(var4.field1266 != -1) {
