...
public class IndexData extends IndexDataBase {
   ...
   void method4218(int var1, int var2) {
      this.field3255 = var1;
      this.field3256 = var2;
      if(this.field3249 != null) {
         class5.method19(this.index, this.field3249, this);
      } else {
         PacketBuffer.method3413(this, 255, this.index, this.field3255, (byte)0, true);
      }
      ...
      if(var3) {
         ...
         if(this.field3249 != null) {
            ...
            synchronized(class236.field3247) {
               class236.field3247.method3603(var7);
            }
         ...
         if(this.field3257 != null) {
            ...
            synchronized(class236.field3247) {
               class236.field3247.method3603(var14);
            }
   ...
   public void method4220(IndexFile var1, int var2, byte[] var3, boolean var4) {
      ...
      if(this.field3249 == var1) {
         if(this.field3251) {
            ...
            field3259.reset();
            field3259.update(var3, 0, var3.length);
            var5 = (int)field3259.getValue();
            Buffer var9 = new Buffer(class162.method3047(var3));
            ...
            if(var7 != 5 && var7 != 6) {
               ...
               if(var5 != this.field3255 || var8 != this.field3256) {
                  PacketBuffer.method3413(this, 255, this.index, this.field3255, (byte)0, true);
               } else {
         ...
         if(var3 != null && var3.length > 2) {
            field3259.reset();
            field3259.update(var3, 0, var3.length - 2);
            var5 = (int)field3259.getValue();
            int var6 = (var3[var3.length - 1] & 255) + ((var3[var3.length - 2] & 255) << 8);
            if(var5 == super.archiveCrcs[var2] && super.archiveRevisions[var2] == var6) {
