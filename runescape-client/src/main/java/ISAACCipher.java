...
public final class ISAACCipher {
   ...
   @ObfuscatedSignature(
      signature = "(I)V",
      garbageValue = "-521545075"
   )
   @Export("generateMoreResults")
   final void generateMoreResults() {
      this.field2415 += ++this.field2414;

      for(int var1 = 0; var1 < 256; ++var1) {
         int var2 = this.mm[var1];
         if((var1 & 2) == 0) {
            if((var1 & 1) == 0) {
               this.field2419 ^= this.field2419 << 13;
            } else {
               this.field2419 ^= this.field2419 >>> 6;
            }
         } else if((var1 & 1) == 0) {
            this.field2419 ^= this.field2419 << 2;
         } else {
            this.field2419 ^= this.field2419 >>> 16;
         }

         this.field2419 += this.mm[var1 + 128 & 255];
         int var3;
         this.mm[var1] = var3 = this.mm[(var2 & 1020) >> 2] + this.field2415 + this.field2419;
         this.randResult[var1] = this.field2415 = this.mm[(var3 >> 8 & 1020) >> 2] + var2;
      }
