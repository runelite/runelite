...
public class Track1 extends Node {
   ...
   Track1(Buffer var1) {
      ...
      var4 += var10 + var12;
      var13 = var1.offset;
      var14 = var9 + var8 + var6 + var2 + var5 + var7 + var10 + var11 + var12;
   ...
   void method3892() {
      if(this.field2600 == null) {
         this.field2600 = new XHashTable(16);
         int[] var1 = new int[16];
         int[] var2 = new int[16];
         var2[9] = 128;
         var1[9] = 128;
               ...
               while(var7 == var4.field2571[var6]) {
                  ...
                  if(var9 == 144) {
                     ...
                     if(var12 > 0) {
                        ...
                        class199 var14 = (class199)this.field2600.get((long)var13);
                        if(var14 == null) {
                           var14 = new class199(new byte[128]);
                           this.field2600.put(var14, (long)var13);
                        }
