...
public class Track1 extends Node {
   ...
   Track1(Buffer var1) {
      ...
      Buffer var51 = new Buffer(this.field2761);
   ...
   void method4370() {
      if(this.field2762 == null) {
         this.field2762 = new HashTable(16);
         int[] var1 = new int[16];
         int[] var2 = new int[16];
         var2[9] = 128;
         var1[9] = 128;
         class232 var4 = new class232(this.field2761);
         int var5 = var4.method4278();

         int var6;
         for(var6 = 0; var6 < var5; ++var6) {
            var4.method4268(var6);
            var4.method4271(var6);
            var4.method4269(var6);
         }

         label53:
         do {
            while(true) {
               var6 = var4.method4267();
               int var7 = var4.field2739[var6];

               while(var7 == var4.field2739[var6]) {
                  var4.method4268(var6);
                  int var8 = var4.method4293(var6);
                  if(var8 == 1) {
                     var4.method4270();
                     var4.method4269(var6);
                     continue label53;
                  ...
                  if(var9 == 144) {
                     ...
                     if(var12 > 0) {
                        ...
                        ByteArrayNode var14 = (ByteArrayNode)this.field2762.get((long)var13);
                        if(var14 == null) {
                           var14 = new ByteArrayNode(new byte[128]);
                           this.field2762.put(var14, (long)var13);
                        }
