...
public class Track1 extends Node {
   ...
   byte[] field2604;
   @ObfuscatedName("p")
   XHashTable field2605;

   @ObfuscatedName("m")
   void method3797() {
      if(this.field2605 == null) {
         this.field2605 = new XHashTable(16);
         int[] var1 = new int[16];
         int[] var2 = new int[16];
         var2[9] = 128;
         var1[9] = 128;
         class206 var3 = new class206(this.field2604);
         int var4 = var3.method3713();

         int var5;
         for(var5 = 0; var5 < var4; ++var5) {
            var3.method3714(var5);
            var3.method3717(var5);
            var3.method3718(var5);
         }

         label56:
         do {
            while(true) {
               var5 = var3.method3721();
               int var6 = var3.field2580[var5];

               while(var3.field2580[var5] == var6) {
                  var3.method3714(var5);
                  int var7 = var3.method3757(var5);
                  if(var7 == 1) {
                     var3.method3715();
                     var3.method3718(var5);
                     continue label56;
                  ...
                  if(var8 == 144) {
                     ...
                     if(var11 > 0) {
                        int var12 = var2[var9];
                        class199 var13 = (class199)this.field2605.method3425((long)var12);
                        if(var13 == null) {
                           var13 = new class199(new byte[128]);
                           this.field2605.method3426(var13, (long)var12);
                        }

                        var13.field2497[var10] = 1;
                     }
                  }
   ...
   Track1(Buffer var1) {
      ...
      var1.offset += var5 * 3;
      this.field2604 = new byte[var4];
      Buffer var51 = new Buffer(this.field2604);
   ...
   @ObfuscatedName("p")
   public static Track1 method3800(IndexDataBase var0, int var1, int var2) {
