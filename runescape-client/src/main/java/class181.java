      ...
      if(XItemContainer.localPlayer != var0) {
         if(Client.menuOptionCount < 400) {
            ...
            if(Client.itemSelectionState == 1) {
               class175.addMenuEntry("Use", Client.selectedItemName + " " + "->" + " " + class220.method4055(16777215) + var4, 14, var1, var2, var3);
            } else if(Client.field1082) {
               if((WorldMapType3.spellTargetFlags & 8) == 8) {
                  class175.addMenuEntry(Client.field1078, Client.field1159 + " " + "->" + " " + class220.method4055(16777215) + var4, 15, var1, var2, var3);
               }
            } else {
               for(var10 = 7; var10 >= 0; --var10) {
                  if(Client.playerOptions[var10] != null) {
                     ...
                     class175.addMenuEntry(Client.playerOptions[var10], class220.method4055(16777215) + var4, var7, var1, var2, var3);
                  }
               }
            }
            ...
            for(var10 = 0; var10 < Client.menuOptionCount; ++var10) {
               if(Client.menuTypes[var10] == 23) {
                  Client.menuTargets[var10] = class220.method4055(16777215) + var4;
                  break;
               }
            }
