...
public class class181 {
   ...
   static final void method3429(Player var0, int var1, int var2, int var3) {
      if(XItemContainer.localPlayer != var0 && Client.menuOptionCount < 400) {
         String var4;
         int var5;
         if(var0.totalLevel == 0) {
            String var6 = var0.actions[0] + var0.name + var0.actions[1];
            var5 = var0.combatLevel;
            int var7 = XItemContainer.localPlayer.combatLevel;
            int var8 = var7 - var5;
            String var9;
            if(var8 < -9) {
               var9 = class220.getColTags(16711680);
            } else if(var8 < -6) {
               var9 = class220.getColTags(16723968);
            } else if(var8 < -3) {
               var9 = class220.getColTags(16740352);
            } else if(var8 < 0) {
               var9 = class220.getColTags(16756736);
            } else if(var8 > 9) {
               var9 = class220.getColTags('\uff00');
            } else if(var8 > 6) {
               var9 = class220.getColTags(4259584);
            } else if(var8 > 3) {
               var9 = class220.getColTags(8453888);
            } else if(var8 > 0) {
               var9 = class220.getColTags(12648192);
            } else {
               var9 = class220.getColTags(16776960);
            }
         ...
         if(Client.itemSelectionState == 1) {
            ...
            for(var10 = 7; var10 >= 0; --var10) {
               if(Client.playerOptions[var10] != null) {
                  ...
                  boolean var12 = false;
                  var5 = Client.playerMenuTypes[var10] + var11;
                  class175.addMenuEntry(Client.playerOptions[var10], class220.getColTags(16777215) + var4, var5, var1, var2, var3);
               }
            }
         }
