...
public class class174 {
   @ObfuscatedName("c")
   public static final boolean[] field2354;
   @ObfuscatedName("n")
   public static int[] field2355;

   static {
      field2354 = new boolean[]{true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, false, false};
      field2355 = new int[99];
      int var0 = 0;
   ...
   static final void method3260() {
      ...
      if(Client.packetOpcode == 193) {
         ...
         var3 = Client.secretPacketBuffer2.method2419();
         ...
         if(Client.packetOpcode == 85) {
            var0 = Client.secretPacketBuffer2.method2409();
            var1 = var0 >> 2;
            var2 = var0 & 3;
            var3 = Client.field345[var1];
            var4 = Client.secretPacketBuffer2.method2410();
            var29 = (var4 >> 4 & 7) + class215.field3157;
            var6 = (var4 & 7) + class39.field802;
            var7 = Client.secretPacketBuffer2.method2420();
            ...
            var0 = Client.secretPacketBuffer2.method2558();
            var1 = var0 >> 2;
            var2 = var0 & 3;
            var3 = Client.field345[var1];
            var4 = Client.secretPacketBuffer2.readUnsignedByte();
            ...
            if(Client.packetOpcode == 102) {
               ...
               var29 = Client.secretPacketBuffer2.readShort();
               ...
               if(Client.packetOpcode == 97) {
                  ...
                  var1 = class215.field3157 + (var0 >> 4 & 7);
                  var2 = (var0 & 7) + class39.field802;
                  var3 = Client.secretPacketBuffer2.method2418();
                  if(var1 >= 0 && var2 >= 0 && var1 < 104 && var2 < 104) {
                  ...
                  if(Client.packetOpcode == 232) {
                     ...
                     byte var35 = Client.secretPacketBuffer2.method2515();
                     byte var36 = Client.secretPacketBuffer2.readByte();
                     var3 = Client.secretPacketBuffer2.method2558();
                     var4 = var3 >> 2;
                     var29 = var3 & 3;
                     var6 = Client.field345[var4];
                     var7 = Client.secretPacketBuffer2.readUnsignedShort();
                     byte var40 = Client.secretPacketBuffer2.method2412();
                     var9 = Client.secretPacketBuffer2.method2419();
                     var10 = Client.secretPacketBuffer2.method2409();
                     var11 = class215.field3157 + (var10 >> 4 & 7);
                     var12 = class39.field802 + (var10 & 7);
                     byte var13 = Client.secretPacketBuffer2.method2501();
                     int var14 = Client.secretPacketBuffer2.method2418();
                     Player var15;
