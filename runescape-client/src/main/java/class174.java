...
public class class174 {
   ...
   static String method3451(String var0, boolean var1) {
      ...
      if(client.field548 == 1) {
         ...
         var0 = var0 + "-wtqa";
      } else if(client.field548 == 3) {
         var0 = var0 + "-wtwip";
      } else if(client.field548 == 5) {
         var0 = var0 + "-wti";
      } else if(client.field548 == 4) {
         var0 = "local";
      }

      String var3 = "";
      if(client.field563 != null) {
         var3 = "/p=" + client.field563;
      }

      String var4 = "runescape.com";
      return var2 + var0 + "." + var4 + "/l=" + client.field292 + "/a=" + class17.field254 + var3 + "/";
   }
}
