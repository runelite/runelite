         ...
         if((Client.friendCount < 200 || Client.field918 == 1) && Client.friendCount < 400) {
            ...
            if(var1 != null) {
               ...
               for(var2 = 0; var2 < Client.friendCount; ++var2) {
                  ...
                  var4 = SpritePixels2.cleanUsername(var3.name, PendingSpawn.jagexLoginType);
                  ...
                  if(var3.previousName != null) {
                     var5 = SpritePixels2.cleanUsername(var3.previousName, PendingSpawn.jagexLoginType);
               ...
               for(var2 = 0; var2 < Client.ignoreCount; ++var2) {
                  ...
                  var4 = SpritePixels2.cleanUsername(var7.name, PendingSpawn.jagexLoginType);
                  if(var4 != null && var4.equals(var1)) {
                  ...
                  if(var7.previousName != null) {
                     var5 = SpritePixels2.cleanUsername(var7.previousName, PendingSpawn.jagexLoginType);
                     if(var5 != null && var5.equals(var1)) {
                        class25.sendGameMessage(30, "", "Please remove " + var0 + " from your ignore list first");
                        return;
                     }
