...
public class class215 {
   ...
   public static int djb2Hash(CharSequence var0) {
      ...
      for(int var3 = 0; var3 < var1; ++var3) {
         var2 = (var2 << 5) - var2 + class91.method1737(var0.charAt(var3));
      }
