...
public class class70 implements Runnable {
   ...
   class70() {
      this.field823 = true;
      this.field819 = new Object();
      this.field818 = 0;
      this.field824 = new int[500];
      this.field822 = new int[500];
   }

   public void run() {
      for(; this.field823; BaseVarType.method12(50L)) {
         Object var1 = this.field819;
         synchronized(this.field819) {
            if(this.field818 < 500) {
               this.field824[this.field818] = MouseInput.field703;
               this.field822[this.field818] = MouseInput.field715 * 10625923;
               ++this.field818;
            }
         }
      }
   ...
   static final void method1129(Actor var0, int var1) {
      ...
      if(var0.field1176 > Client.gameCycle) {
         ...
         if(var0.field1193 == Client.gameCycle || var0.animation == -1 || var0.actionAnimationDisable != 0 || var0.field1180 + 1 > class13.getAnimation(var0.animation).frameLenghts[var0.actionFrame]) {
   ...
   static void method1130(Player var0, int var1, int var2) {
      if(var0.animation == var1 && var1 != -1) {
         int var3 = class13.getAnimation(var1).replyMode;
         if(var3 == 1) {
            var0.actionFrame = 0;
            var0.field1180 = 0;
      ...
      } else if(var1 == -1 || var0.animation == -1 || class13.getAnimation(var1).forcedPriority >= class13.getAnimation(var0.animation).forcedPriority) {
         var0.animation = var1;
         var0.actionFrame = 0;
         var0.field1180 = 0;
         var0.actionAnimationDisable = var2;
         ...
         if(var3 != null && var3.parentId == var1 && (!var3.hasScript || !Buffer.method3509(var3))) {
            ...
            if(var3.type == 6) {
               if(var3.field2844 != -1 || var3.field2772 != -1) {
                  ...
                  if(var5 != -1) {
                     Sequence var6 = class13.getAnimation(var5);
