      ...
      if(var0 == 3600) {
         ...
         if(var0 == 3601) {
            ...
            if(Client.field573 == 2 && var3 < Client.friendCount) {
               class32.field748[++class32.field749 - 1] = Client.field422[var3].name;
               class32.field748[++class32.field749 - 1] = Client.field422[var3].field160;
            } else {
            ...
            var3 = class32.field747[--class103.field1686];
            if(Client.field573 == 2 && var3 < Client.friendCount) {
               class32.field747[++class103.field1686 - 1] = Client.field422[var3].world;
            } else {
            ...
            var3 = class32.field747[--class103.field1686];
            if(Client.field573 == 2 && var3 < Client.friendCount) {
               class32.field747[++class103.field1686 - 1] = Client.field422[var3].field162;
            } else {
               class32.field747[++class103.field1686 - 1] = 0;
            }
            ...
            String var11;
            if(var0 == 3604) {
               var11 = class32.field748[--class32.field749];
               ...
               if(var0 == 3605) {
                           ...
                           while(true) {
                              if(var5 >= Client.friendCount) {
                                 for(var5 = 0; var5 < Client.ignoreCount; ++var5) {
                                    var15 = Client.field504[var5];
                                    var7 = GroundObject.method1594(var15.name, MessageNode.field244);
                                    if(var7 != null && var7.equals(var14)) {
                                       class16.method186(30, "", "Please remove " + var11 + " from your ignore list first");
                                       return 1;
                                    }
                              ...
                              var16 = Client.field422[var5];
                              var7 = GroundObject.method1594(var16.name, MessageNode.field244);
                              if(var7 != null && var7.equals(var14)) {
                                 class16.method186(30, "", var11 + " is already on your friend list");
                                 break;
                              }

                              if(var16.field160 != null) {
                                 var8 = GroundObject.method1594(var16.field160, MessageNode.field244);
                  ...
                  if(var0 == 3606) {
                           ...
                           for(var5 = 0; var5 < Client.friendCount; ++var5) {
                              ...
                              if(var17) {
                                 ...
                                 for(var10 = var5; var10 < Client.friendCount; ++var10) {
                                    Client.field422[var10] = Client.field422[1 + var10];
                                 }
                        ...
                        if((Client.ignoreCount < 100 || Client.field427 == 1) && Client.ignoreCount < 400) {
                           ...
                           if(var14 != null) {
                              ...
                              while(true) {
                                 if(var5 >= Client.ignoreCount) {
                                    for(var5 = 0; var5 < Client.friendCount; ++var5) {
                                       ...
                                       if(null != var7 && var7.equals(var14)) {
                                          class16.method186(31, "", "Please remove " + var11 + " from your friend list first");
                                          return 1;
                                       }
                                 ...
                                 var7 = GroundObject.method1594(var15.name, MessageNode.field244);
                                 if(null != var7 && var7.equals(var14)) {
                                    class16.method186(31, "", var11 + " is already on your ignore list");
                                    break;
                                 }
                           ...
                           for(var5 = 0; var5 < Client.ignoreCount; ++var5) {
                              ...
                              if(var17) {
                                 ...
                                 for(var10 = var5; var10 < Client.ignoreCount; ++var10) {
                                    Client.field504[var10] = Client.field504[var10 + 1];
                                 }
                     ...
                     if(Client.field532 != null) {
                        class32.field748[++class32.field749 - 1] = class150.method2805(Client.field532);
                     } else {
                        class32.field748[++class32.field749 - 1] = "";
                     }
                     ...
                     if(Client.field532 != null && var3 < Player.clanChatCount) {
                        class32.field748[++class32.field749 - 1] = class72.field1204[var3].field295;
                     } else {
                        class32.field748[++class32.field749 - 1] = "";
                     }
                     ...
                     if(null != Client.field532 && var3 < Player.clanChatCount) {
                        class32.field747[++class103.field1686 - 1] = class72.field1204[var3].field290;
                     } else {
                        class32.field747[++class103.field1686 - 1] = 0;
                     }
                     ...
                     var3 = class32.field747[--class103.field1686];
                     if(null != Client.field532 && var3 < Player.clanChatCount) {
                        class32.field747[++class103.field1686 - 1] = class72.field1204[var3].field298;
                     } else {
                        class32.field747[++class103.field1686 - 1] = 0;
                     }
                     ...
                     if(Client.field573 != 0 && var3 < Client.ignoreCount) {
                        class32.field748[++class32.field749 - 1] = Client.field504[var3].name;
                        class32.field748[++class32.field749 - 1] = Client.field504[var3].previousName;
                     } else {
                        class32.field748[++class32.field749 - 1] = "";
                        class32.field748[++class32.field749 - 1] = "";
                     }
                     ...
                     if(var0 == 3625) {
                        if(null != Client.field533) {
                           class32.field748[++class32.field749 - 1] = class150.method2805(Client.field533);
                        } else {
                           class32.field748[++class32.field749 - 1] = "";
                        }
                     ...
                     var3 = class32.field747[--class103.field1686];
                     if(class72.field1204 != null && var3 < Player.clanChatCount && class72.field1204[var3].field295.equalsIgnoreCase(class36.localPlayer.name)) {
                        class32.field747[++class103.field1686 - 1] = 1;
                     } else {
                        class32.field747[++class103.field1686 - 1] = 0;
                     }
   ...
   static boolean method183(String var0, boolean var1) {
      if(var0 == null) {
         ...
         for(int var3 = 0; var3 < Client.friendCount; ++var3) {
            if(var2.equalsIgnoreCase(GroundObject.method1594(Client.field422[var3].name, MessageNode.field244)) && (!var1 || Client.field422[var3].world != 0)) {
               return true;
            }
         }
