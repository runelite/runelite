...
public final class IndexedSprite extends Rasterizer2D {
   ...
   @ObfuscatedName("w")
   public void method5175(int var1, int var2, int var3) {
   ...
   @ObfuscatedName("e")
   public void method5176(int var1, int var2) {
      var1 += this.offsetX;
      var2 += this.offsetY;
      ...
      if(var6 > 0 && var5 > 0) {
         method5177(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("u")
   public void method5189(int var1, int var2, int var3, int var4) {
      ...
      method5179(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var7, var8, var13, var14, var3, var4, var11, var12, var5);
   }

   @ObfuscatedName("k")
   static void method5177(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("z")
   static void method5179(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
