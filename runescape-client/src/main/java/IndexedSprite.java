...
public final class IndexedSprite extends Rasterizer2D {
   ...
   public void method5147(int var1, int var2) {
      ...
      if(var6 > 0 && var5 > 0) {
         method5138(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("g")
   public void method5161(int var1, int var2, int var3, int var4) {
   ...
   @ObfuscatedName("o")
   static void method5138(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("v")
   static void method5139(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
