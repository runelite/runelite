...
public final class IndexedSprite extends Rasterizer2D {
   ...
   @ObfuscatedName("v")
   public void method5259(int var1, int var2, int var3) {
   ...
   public void method5253(int var1, int var2) {
      ...
      if(var6 > 0 && var5 > 0) {
         method5254(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8);
      }
   }

   @ObfuscatedName("h")
   public void method5255(int var1, int var2, int var3, int var4) {
      ...
      method5260(Rasterizer2D.graphicsPixels, this.pixels, this.palette, var7, var8, var13, var14, var3, var4, var11, var12, var5);
   }

   @ObfuscatedName("r")
   static void method5254(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = -(var5 >> 2);
      var5 = -(var5 & 3);
   ...
   @ObfuscatedName("d")
   static void method5260(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      int var12 = var3;
