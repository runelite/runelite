...
public final class class41 {
      ...
      if(!this.field558) {
         ...
         for(int var17 = 0; var17 < var9; ++var17) {
            for(int var18 = 0; var18 < var10; ++var18) {
               if(this.field569[var17][var18] == null) {
                  this.field569[var17][var18] = new class34(this.field560.method293() + var17, this.field560.method305() + var18, this.field560.method291(), this.field575);
                  this.field569[var17][var18].method377(this.field560.field586, this.field560.field587);
               }
            }
         }
         ...
         if(var1.method4013(class40.field557.field548, var2)) {
            byte[] var21 = var1.method4014(class40.field557.field548, var2);
            this.field561 = RSCanvas.method740(var21);
         }
         ...
         if(var6 > 0 && var6 % var7 < var7 / 2) {
            ...
            while(true) {
               ...
               do {
                  ...
                  var10 = (List)this.field563.get(Integer.valueOf(var9));
               } while(var10 == null);
               ...
               while(var11.hasNext()) {
                  ...
                  int var13 = var3 * (var12.field538.worldX - this.field567) / this.field559;
                  int var14 = var4 - var4 * (var12.field538.worldY - this.field565) / this.field570;
                  Rasterizer2D.method4824(var13 + var1, var2 + var14, 2, 16776960, 256);
               }
            }
         }
      }
   ...
   static final void method572(PacketBuffer var0, int var1, Player var2, int var3) {
      ...
      if((var3 & 64) != 0) {
         ...
         class10.method57(var2, var5, var16);
      }
      ...
      if((var3 & 2) != 0) {
         ...
         if(var5 > 0) {
            for(var16 = 0; var16 < var5; ++var16) {
               ...
               var2.method1443(var17, var9, var8, var10, Client.gameCycle, var11);
            }
         }
         ...
         if(var16 > 0) {
            for(var17 = 0; var17 < var16; ++var17) {
               ...
               if(var9 != 32767) {
                  ...
                  var2.method1445(var8, Client.gameCycle, var9, var10, var11, var12);
               } else {
                  var2.method1446(var8);
               }
            }
         }
      }
      ...
      if((var3 & 16) != 0) {
         ...
         if(var2.name != null && var2.composition != null) {
            ...
            if(!var23 && Client.field1025 == 0 && !var2.hidden) {
               class96.field1501.offset = 0;
               var0.readBytes(class96.field1501.payload, 0, var9);
               class96.field1501.offset = 0;
               Buffer var13 = class96.field1501;
               String var18 = class162.method2947(var13, 32767);
               String var14 = FontTypeFace.method4631(class210.method3816(var18));
               var2.overhead = var14.trim();
               var2.field1225 = var5 >> 8;
               var2.field1262 = var5 & 255;
               var2.field1234 = 150;
               var2.field1222 = var22;
               var2.inSequence = var2 != class20.localPlayer && var20.field3186 && "" != Client.field1124 && var14.toLowerCase().indexOf(Client.field1124) == -1;
               int var15;
               if(var20.field3185) {
                  var15 = var22?91:1;
               } else {
               ...
               if(var20.field3184 != -1) {
                  class5.sendGameMessage(var15, RSCanvas.method741(var20.field3184) + var2.name, var14);
               } else {
                  class5.sendGameMessage(var15, var2.name, var14);
               }
            }
         }
