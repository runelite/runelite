            ...
            if(var0 == 4104) {
               ...
               if(var0 == 4107) {
                  ...
                  if(var0 == 4108) {
                     ...
                     var24 = class0.field0.getConfigData(var5, 0);
                     var25 = new Font(var24);
                     class32.field747[++field1686 - 1] = var25.method3895(var3, var4);
                     return 1;
                  } else if(var0 == 4110) {
                     class32.field749 -= 2;
                     var3 = class32.chatboxSegments[class32.field749];
                     ...
                     if(var0 != 4113) {
                        if(var0 == 4114) {
                           var21 = class32.field747[--field1686];
                           class32.field747[++field1686 - 1] = class60.method1205((char)var21)?1:0;
                           return 1;
                        } else if(var0 == 4115) {
                           var21 = class32.field747[--field1686];
                           class32.field747[++field1686 - 1] = ChatMessages.method943((char)var21)?1:0;
                           return 1;
                        } else if(var0 == 4116) {
                           var21 = class32.field747[--field1686];
                           ...
                           if(null != var3) {
                              ...
                              class32.field747[++field1686 - 1] = 0;
                           }
