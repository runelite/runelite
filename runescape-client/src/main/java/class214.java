...
public class class214 {
   @ObfuscatedName("e")
   public static final short[] field2637;
   @ObfuscatedName("t")
   ...
   public static String method3869(byte[] var0) {
      int var1 = var0.length;
      StringBuilder var2 = new StringBuilder();

      for(int var3 = 0; var3 < var1 + 0; var3 += 3) {
         int var4 = var0[var3] & 255;
         var2.append(class269.field3678[var4 >>> 2]);
         if(var3 < var1 - 1) {
            int var5 = var0[var3 + 1] & 255;
            var2.append(class269.field3678[(var4 & 3) << 4 | var5 >>> 4]);
            if(var3 < var1 - 2) {
               int var6 = var0[var3 + 2] & 255;
               var2.append(class269.field3678[(var5 & 15) << 2 | var6 >>> 6]).append(class269.field3678[var6 & 63]);
            } else {
               var2.append(class269.field3678[(var5 & 15) << 2]).append("=");
            }
         } else {
            var2.append(class269.field3678[(var4 & 3) << 4]).append("==");
         }
      }
