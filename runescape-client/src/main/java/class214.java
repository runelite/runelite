...
public class class214 {
   @ObfuscatedName("c")
   public static final short[] field2597;
   @ObfuscatedName("o")
   public static final short[][] field2595;
   @ObfuscatedName("i")
   public static final short[] field2596;
   @ObfuscatedName("u")
   public static final short[][] field2599;
   @ObfuscatedName("qq")
   @ObfuscatedSignature(
      signature = "Lku;"
   )
   static MachineInfo field2600;

   static {
      field2597 = new short[]{(short)6798, (short)8741, (short)25238, (short)4626, (short)4550};
