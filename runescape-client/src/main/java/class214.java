...
public class class214 {
   ...
   public static String method3869(byte[] var0) {
      ...
      for(int var4 = 0; var4 < var2 + 0; var4 += 3) {
         ...
         var3.append(class269.field3678[var5 >>> 2]);
         if(var4 < var2 - 1) {
            int var6 = var0[var4 + 1] & 255;
            var3.append(class269.field3678[(var5 & 3) << 4 | var6 >>> 4]);
            if(var4 < var2 - 2) {
               int var7 = var0[var4 + 2] & 255;
               var3.append(class269.field3678[(var6 & 15) << 2 | var7 >>> 6]).append(class269.field3678[var7 & 63]);
            } else {
               var3.append(class269.field3678[(var6 & 15) << 2]).append("=");
            }
         } else {
            var3.append(class269.field3678[(var5 & 3) << 4]).append("==");
         }
      }
