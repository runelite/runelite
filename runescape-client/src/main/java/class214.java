...
public class class214 {
   ...
   public static void method3963(int var0, IndexDataBase var1, String var2, String var3, int var4, boolean var5) {
      ...
      class203.field2503 = var6;
      MilliTimer.field2204 = var7;
      class203.field2504 = var4;
      class203.field2505 = var5;
      class73.field861 = var0;
   }

   @ObfuscatedName("r")
   @ObfuscatedSignature(
      signature = "(II)Z",
      garbageValue = "-1870261434"
   )
   public static boolean method3964(int var0) {
      return (var0 >> 21 & 1) != 0;
   }
}
