...
public class class102 {
   ...
   class102() {
      ...
      if (var1 != 1) {
         ...
         if (field1108 == null || field1108.length < var5) {
            field1108 = new int[var5];
            field1109 = new int[var5];
            field1110 = new boolean[var5];
         }
   ...
   void method2366(int var1, int var2) {
      if (var1 < var2) {
         ...
         int var5 = field1109[var1];
         boolean var6 = field1110[var1];

         for (int var7 = var1 + 1; var7 <= var2; ++var7) {
            int var8 = field1108[var7];
            if (var8 < var4) {
               field1108[var3] = var8;
               field1109[var3] = field1109[var7];
               field1110[var3] = field1110[var7];
               ++var3;
               field1108[var7] = field1108[var3];
               field1109[var7] = field1109[var3];
               field1110[var7] = field1110[var3];
            }
         }
   ...
   boolean method2367() {
      ...
      if (!var1) {
         ...
         for (var3 = 0; var3 < var2; ++var3) {
            field1108[var3] = this.field1353[var3];
         }

         var3 = field1106[this.field1360 - 1];
         int var4 = WorldMapCacheName.method634(var3 - 1);
         field1109[0] = MusicSample.method2352(var4);
         field1109[1] = MusicSample.method2352(var4);
         int var5 = 2;
         ...
         for (int var6 = 0; var6 < this.field1357.length; ++var6) {
            ...
            for (int var12 = 0; var12 < var8; ++var12) {
               ...
               var11 >>>= var9;
               field1109[var5++] = var13 >= 0 ? MusicSample.field1323[var13].method2306() : 0;
            }
         }
   ...
   void method2375(float[] var1, int var2) {
      ...
      int var4 = field1106[this.field1360 - 1];
      boolean[] var5 = field1110;
      field1110[1] = true;
      var5[0] = true;
      ...
      for (var6 = 2; var6 < var3; ++var6) {
         var7 = method2369(field1108, var6);
         var8 = method2363(field1108, var6);
         var9 = this.method2379(field1108[var7], field1109[var7], field1108[var8], field1109[var8], field1108[var6]);
         var10 = field1109[var6];
         int var11 = var4 - var9;
         int var12 = (var11 < var9 ? var11 : var9) << 1;
         if (var10 != 0) {
            boolean[] var13 = field1110;
            field1110[var8] = true;
            var13[var7] = true;
            field1110[var6] = true;
            if (var10 >= var12) {
               field1109[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
            } else {
               field1109[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
            }
         } else {
            field1110[var6] = false;
            field1109[var6] = var9;
         }
      }
      ...
      var6 = 0;
      var7 = field1109[0] * this.field1360;

      for (var8 = 1; var8 < var3; ++var8) {
         if (field1110[var8]) {
            var9 = field1108[var8];
            var10 = field1109[var8] * this.field1360;
