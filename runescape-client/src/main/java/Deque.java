...
public class Deque {
   ...
   @ObfuscatedName("v")
   public static void method2487(Node var0, Node var1) {
   ...
   @ObfuscatedName("n")
   public void method2511(Node var1) {
      if(var1.previous != null) {
         var1.unlink();
      }
