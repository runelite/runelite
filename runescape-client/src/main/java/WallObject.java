...
public final class WallObject {
   ...
   static void method2866(Widget var0, int var1, int var2, boolean var3) {
      ...
      if(var3 && var0.field2763 != null && (var4 != var0.width || var5 != var0.height)) {
   ...
   static final void gameDraw(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      ...
      for(int var9 = 0; var9 < var0.length; ++var9) {
         ...
         if(var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.field1100)) {
            int var11;
            if(var8 == -1) {
               Client.widgetPositionX[Client.field1061] = var10.relativeX + var6;
               ...
               if(!var10.hasScript || var15 < var17 && var16 < var18) {
                  ...
                  if(var10.contentType != 0) {
                     ...
                     if(var10.contentType == 1338) {
                        ...
                        if(var64 != null) {
                           Rasterizer2D.setDrawRegion(var12, var13, var12 + var64.field2607, var13 + var64.field2602);
                           if(Client.field1161 != 2 && Client.field1161 != 5) {
                              ...
                              MouseInput.field758.method5096(var12, var13, var64.field2607, var64.field2602, var21, var22, var20, Client.mapScaleDelta + 256, var64.field2604, var64.field2608);

                              for(var23 = 0; var23 < Client.field1155; ++var23) {
                                 var24 = Client.field1156[var23] * 4 + 2 - XItemContainer.localPlayer.x / 32;
                                 var25 = 4 * Client.field1011[var23] + 2 - XItemContainer.localPlayer.y / 32;
                                 class40.drawDot(var12, var13, var24, var25, Client.field927[var23], var64);
                              }
                              ...
                              while(true) {
                                 if(var23 >= 104) {
                                    for(var23 = 0; var23 < Client.field937; ++var23) {
                                       ...
                                       if(var69 != null && var69.hasConfig()) {
                                          ...
                                          if(var63 != null && var63.isMinimapVisible && var63.field3588) {
                                             ...
                                             class40.drawDot(var12, var13, var26, var49, WorldMapType3.mapDots[1], var64);
                                          }
                                       }
                                    }
                                    ...
                                    for(var25 = 0; var25 < var23; ++var25) {
                                       ...
                                       if(var54 != null && var54.hasConfig() && !var54.hidden && var54 != XItemContainer.localPlayer) {
                                          var49 = var54.x / 32 - XItemContainer.localPlayer.x / 32;
                                          var53 = var54.y / 32 - XItemContainer.localPlayer.y / 32;
                                          boolean var59 = false;
                                          if(class25.isFriended(var54.name, true)) {
                                             var59 = true;
                                          }
                                          ...
                                          if(var59) {
                                             class40.drawDot(var12, var13, var49, var53, WorldMapType3.mapDots[3], var64);
                                          } else if(var60) {
                                             class40.drawDot(var12, var13, var49, var53, WorldMapType3.mapDots[4], var64);
                                          } else if(var58) {
                                             class40.drawDot(var12, var13, var49, var53, WorldMapType3.mapDots[5], var64);
                                          } else {
                                             class40.drawDot(var12, var13, var49, var53, WorldMapType3.mapDots[2], var64);
                                          }
                                       }
                                    }
                                    ...
                                    if(Client.destinationX != 0) {
                                       ...
                                       class40.drawDot(var12, var13, var25, var26, class31.field458[0], var64);
                                    }

                                    if(!XItemContainer.localPlayer.hidden) {
                                       Rasterizer2D.method4983(var12 + var64.field2607 / 2 - 1, var13 + var64.field2602 / 2 - 1, 3, 3, 16777215);
                                    }
                                    break;
                                 }
                                 ...
                                 for(var24 = 0; var24 < 104; ++var24) {
                                    ...
                                    if(var47 != null) {
                                       var26 = 4 * var23 + 2 - XItemContainer.localPlayer.x / 32;
                                       var49 = var24 * 4 + 2 - XItemContainer.localPlayer.y / 32;
                                       class40.drawDot(var12, var13, var26, var49, WorldMapType3.mapDots[0], var64);
                                    }
                                 }
                     ...
                     if(var10.contentType == 1339) {
                        ...
                        if(var64 != null) {
                           if(Client.field1161 < 3) {
                              class19.compass.method5096(var12, var13, var64.field2607, var64.field2602, 25, 25, Client.mapAngle, 256, var64.field2604, var64.field2608);
                           } else {
                              Rasterizer2D.method4947(var12, var13, 0, var64.field2604, var64.field2608);
                           }
                        }
                  ...
                  if(Client.isResized || Client.field1030[var11] || Client.gameDrawingMode > 1) {
                     if(var10.type == 0 && !var10.hasScript && var10.scrollHeight > var10.height) {
                        ...
                        Rasterizer2D.method4943(var19, var13 + 16 + var24, var23, Client.field1006);
                        ...
                        Rasterizer2D.method4941(var19, 17 + var13 + var24, 16, Client.field1006);
                        Rasterizer2D.method4943(var19 + 15, var24 + var13 + 16, var23, Client.field1005);
                        Rasterizer2D.method4943(var19 + 14, var13 + 17 + var24, var23 - 1, Client.field1005);
                        Rasterizer2D.method4941(var19, var23 + var24 + var13 + 15, 16, Client.field1005);
                        Rasterizer2D.method4941(var19 + 1, var23 + 14 + var13 + var24, 15, Client.field1005);
                     }
                              ...
                              for(var21 = 0; var21 < var10.originalWidth; ++var21) {
                                 ...
                                 if(var10.itemIds[var19] <= 0) {
                                    ...
                                    if(var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5 || var10 == class95.field1513 && var19 == Client.field1039) {
                                       SpritePixels var27;
                                       if(Client.itemSelectionState == 1 && var19 == FileSystem.selectedItemIndex && var10.id == class40.field571) {
                                       ...
                                       if(var27 != null) {
                                          if(var10 == class95.field1513 && var19 == Client.field1039) {
                                             ...
                                             var27.method5057(var22 + var24, var25 + var23, 128);
                                             if(var1 != -1) {
                           ...
                           if(var10.type == 4) {
                              ...
                              if(var61 == null) {
                                 ...
                                 if(var10.hasScript && var10.itemId != -1) {
                                    ItemComposition var74 = AbstractByteBuffer.getItemDefinition(var10.itemId);
                                    var73 = var74.name;
                                    if(var73 == null) {
                                       var73 = "null";
                                    }
                                    ...
                                    if((var74.isStackable == 1 || var10.itemQuantity != 1) && var10.itemQuantity != -1) {
                                       var73 = class220.getColTags(16748608) + var73 + "</col>" + " " + 'x' + class45.method684(var10.itemQuantity);
                                    }
                                 }
                                 ...
                                 if(!var10.hasScript) {
                                    var73 = KeyFocusListener.method788(var73, var10);
                                 }

                                 var61.method4788(var73, var12, var13, var10.width, var10.height, var20, var10.textShadowed?0:-1, var10.field2652, var10.field2726, var10.field2716);
                              }
                                 ...
                                 if(var62 == null) {
                                    ...
                                    if(!var10.field2692) {
                                       ...
                                       if(var10.textureId != 0) {
                                          var62.method5064(var12 + var10.width / 2, var13 + var10.height / 2, var10.textureId, var22);
                                       } else if(var14 != 0) {
                                       ...
                                       for(var24 = 0; var24 < var22; ++var24) {
                                          for(var25 = 0; var25 < var23; ++var25) {
                                             if(var10.textureId != 0) {
                                                var62.method5064(var12 + var24 * var20 + var20 / 2, var21 * var25 + var13 + var21 / 2, var10.textureId, 4096);
                                             } else if(var14 != 0) {
                                                var62.method5057(var12 + var24 * var20, var13 + var21 * var25, 256 - (var14 & 255));
                                             } else {
                                                var62.method5042(var12 + var24 * var20, var13 + var21 * var25);
                                             }
                                          }
                                       }
                              ...
                              if(var10.type == 6) {
                                 ...
                                 var22 = 0;
                                 if(var10.itemId != -1) {
                                    var52 = AbstractByteBuffer.getItemDefinition(var10.itemId);
                                    if(var52 != null) {
                                 ...
                                 Graphics3D.method2585(var12 + var10.width / 2, var13 + var10.height / 2);
                                 ...
                                 if(var71 != null) {
                                    if(!var10.hasScript) {
                                       ...
                                       var71.method2493();
                                       if(var10.field2711) {
                                          var71.method2507(0, var10.rotationZ, var10.rotationY, var10.rotationX, var10.field2703, var10.field2704 + var23 + var22, var24 + var10.field2704, var10.modelZoom);
                                       } else {
                                          var71.method2506(0, var10.rotationZ, var10.rotationY, var10.rotationX, var10.field2703, var10.field2704 + var23 + var22, var24 + var10.field2704);
                                       }
                                    }
                                 }
                                    ...
                                    for(var21 = 0; var21 < var10.field2707; ++var21) {
                                       for(var22 = 0; var22 < var10.originalWidth; ++var22) {
                                          if(var10.itemIds[var20] > 0) {
                                             var52 = AbstractByteBuffer.getItemDefinition(var10.itemIds[var20] - 1);
                                             String var48;
                                             if(var52.isStackable != 1 && var10.itemQuantities[var20] == 1) {
                                                var48 = class220.getColTags(16748608) + var52.name + "</col>";
                                             } else {
                                                var48 = class220.getColTags(16748608) + var52.name + "</col>" + " " + 'x' + class45.method684(var10.itemQuantities[var20]);
                                             }

                                             var25 = var22 * (var10.paddingX + 115) + var12;
                                             var26 = var21 * (var10.paddingY + 12) + var13;
                                             if(var10.field2652 == 0) {
                                                var61.method4790(var48, var25, var26, var10.textColor, var10.textShadowed?0:-1);
                                             } else if(var10.field2652 == 1) {
                                                var61.method4757(var48, var25 + var10.width / 2, var26, var10.textColor, var10.textShadowed?0:-1);
                                             } else {
                                                var61.method4756(var48, var25 + var10.width - 1, var26, var10.textColor, var10.textShadowed?0:-1);
                                             }
                                          }
                                 ...
                                 if(var10.type == 8 && var10 == PendingSpawn.field1211 && Client.field1054 == Client.field1079) {
                                    ...
                                    String var72;
                                    for(var51 = KeyFocusListener.method788(var51, var10); var51.length() > 0; var20 += var50.verticalSpace + 1) {
                                    ...
                                    for(var51 = KeyFocusListener.method788(var51, var10); var51.length() > 0; var26 += var50.verticalSpace + 1) {
