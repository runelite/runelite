            ...
            if(var6 == 60) {
               ...
               if(var2 == -1) {
                  ...
                  if(this.field3653 != null && var3 != -1) {
                     var4 += this.field3653[var6 + (var3 << 8)];
                  }
            ...
            if(var7 == 60) {
                     ...
                     if(!var8.equals("gt")) {
                        if(var8.startsWith("img=")) {
                           try {
                              ...
                              var12.method5025(var2, var3 + this.verticalSpace - var12.originalHeight);
                              var2 += var12.width;
                              var5 = -1;
               ...
               if(var4 == -1) {
                  if(this.field3653 != null && var5 != -1) {
                     var2 += this.field3653[var7 + (var5 << 8)];
                  }
                  ...
                  if(var7 != 32) {
                     if(field3660 == 256) {
                        ...
                        if(shadow != -1) {
                           renderShadeRGBA(this.gylphs[var7], var2 + this.horizontalOffsets[var7] + 1, var3 + this.verticalOffsets[var7] + 1, var11, var9, shadow, field3660);
                        }

                        this.renderRGBA(this.gylphs[var7], var2 + this.horizontalOffsets[var7], var3 + this.verticalOffsets[var7], var11, var9, color, field3660);
                     }
                  } else if(field3643 > 0) {
                     field3662 += field3643;
                     var2 += field3662 >> 8;
            ...
            if(var10 == 60) {
                     ...
                     if(!var11.equals("gt")) {
                        if(var11.startsWith("img=")) {
                           try {
                              ...
                              var17.method5025(var12 + var2, var13 + (var3 + this.verticalSpace - var17.originalHeight));
                              var2 += var17.width;
                              var7 = -1;
               ...
               if(var6 == -1) {
                  if(this.field3653 != null && var7 != -1) {
                     var2 += this.field3653[var10 + (var7 << 8)];
                  }
                  ...
                  if(var10 != 32) {
                     if(field3660 == 256) {
                        ...
                        if(shadow != -1) {
                           renderShadeRGBA(this.gylphs[var10], var2 + this.horizontalOffsets[var10] + 1 + var13, var14 + var3 + this.verticalOffsets[var10] + 1, var16, var12, shadow, field3660);
                        }

                        this.renderRGBA(this.gylphs[var10], var2 + this.horizontalOffsets[var10] + var13, var14 + var3 + this.verticalOffsets[var10], var16, var12, color, field3660);
                     }
                  } else if(field3643 > 0) {
                     field3662 += field3643;
                     var2 += field3662 >> 8;
