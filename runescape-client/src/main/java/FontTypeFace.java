...
public abstract class FontTypeFace extends Rasterizer2D {
   ...
   public int method4636(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      if(var1 == null) {
         ...
         this.method4655(var6, var7);
         if(var10 == 0) {
            var10 = this.field3643;
         }

         int[] var11 = new int[]{var4};
         if(var5 < this.field3651 + this.field3645 + var10 && var5 < var10 + var10) {
            var11 = null;
         }
         ...
         if(var9 == 0) {
            ...
            var13 = var3 + this.field3651 + (var5 - this.field3651 - this.field3645 - (var12 - 1) * var10) / 2;
         } else if(var9 == 2) {
            var13 = var3 + var5 - this.field3645 - (var12 - 1) * var10;
         } else {
            var14 = (var5 - this.field3651 - this.field3645 - (var12 - 1) * var10) / (var12 + 1);
            if(var14 < 0) {
               var14 = 0;
            }
   ...
   public void method4638(String var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         ...
         this.method4645(var1, var2 - this.method4696(var1) / 2, var3, var7, var8);
      }
   }
   ...
   public void method4639(String var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if(var1 != null) {
         ...
         this.method4645(var1, var2 - this.method4696(var1) / 2, var3, (int[])null, var10);
      }
   }
   ...
   public void method4641(String var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         ...
         this.method4645(var1, var2 - this.method4696(var1) / 2, var3, (int[])null, var7);
      }
   }
   ...
   void method4642(String var1) {
      try {
         ...
         if(var1.startsWith("col=")) {
            ...
            var2 = class12.method63(var3, 16, true);
            field3657 = var2;
            ...
            this.method4655(field3637, field3650);
         }
         ...
         if(var1.charAt(var6) != 0) {
            ...
            if(var7 == 60) {
                  ...
                  if(var8.equals("lt")) {
                     ...
                     if(!var8.equals("gt")) {
                        if(var8.startsWith("img=")) {
                           try {
                              var9 = class112.method1991(var8.substring(4));
                              ModIcon var12 = modIcons[var9];
                              var12.method4923(var2, var3 + this.field3643 - var12.originalHeight);
                              var2 += var12.width;
                              var5 = -1;
               ...
               if(var4 == -1) {
                  ...
                  int var11 = this.field3644[var7];
                  var9 = this.field3640[var7];
                  if(var7 != 32) {
                     if(field3654 == 256) {
                        if(field3652 != -1) {
                           method4707(this.field3653[var7], var2 + this.field3641[var7] + 1, var3 + this.field3656[var7] + 1, var11, var9, field3652);
                        }

                        this.vmethod4624(this.field3653[var7], var2 + this.field3641[var7], var3 + this.field3656[var7], var11, var9, field3657);
                     } else {
                        if(field3652 != -1) {
                           method4650(this.field3653[var7], var2 + this.field3641[var7] + 1, var3 + this.field3656[var7] + 1, var11, var9, field3652, field3654);
                        }

                        this.vmethod4721(this.field3653[var7], var2 + this.field3641[var7], var3 + this.field3656[var7], var11, var9, field3657, field3654);
                     }
                  } else if(field3655 > 0) {
                     field3642 += field3655;
                     var2 += field3642 >> 8;
   ...
   @ObfuscatedName("ab")
   void method4645(String var1, int var2, int var3, int[] var4, int[] var5) {
      var3 -= this.field3643;
      int var6 = -1;
      int var7 = -1;
      int var8 = 0;
            ...
            if(var10 == 60) {
                     ...
                     if(!var11.equals("gt")) {
                        if(var11.startsWith("img=")) {
                           try {
                              ...
                              ++var8;
                              var14 = class112.method1991(var11.substring(4));
                              ModIcon var17 = modIcons[var14];
                              var17.method4923(var2 + var12, var3 + this.field3643 - var17.originalHeight + var13);
                              var2 += var17.width;
                              var7 = -1;
               ...
               if(var6 == -1) {
                  if(this.field3647 != null && var7 != -1) {
                     var2 += this.field3647[(var7 << 8) + var10];
                  }

                  int var16 = this.field3644[var10];
                  var12 = this.field3640[var10];
                  if(var4 != null) {
                     var13 = var4[var8];
                  } else {
                     var13 = 0;
                  ...
                  if(var10 != 32) {
                     if(field3654 == 256) {
                        if(field3652 != -1) {
                           method4707(this.field3653[var10], var2 + this.field3641[var10] + 1 + var13, var3 + this.field3656[var10] + 1 + var14, var16, var12, field3652);
                        }

                        this.vmethod4624(this.field3653[var10], var2 + this.field3641[var10] + var13, var3 + this.field3656[var10] + var14, var16, var12, field3657);
                     } else {
                        if(field3652 != -1) {
                           method4650(this.field3653[var10], var2 + this.field3641[var10] + 1 + var13, var3 + this.field3656[var10] + 1 + var14, var16, var12, field3652, field3654);
                        }

                        this.vmethod4721(this.field3653[var10], var2 + this.field3641[var10] + var13, var3 + this.field3656[var10] + var14, var16, var12, field3657, field3654);
                     }
                  } else if(field3655 > 0) {
                     field3642 += field3655;
                     var2 += field3642 >> 8;
   ...
   static void method4650(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      if(var1 + var3 > Rasterizer2D.drawingAreaBottom) {
         var11 = var1 + var3 - Rasterizer2D.drawingAreaBottom;
         var3 -= var11;
         var9 += var11;
         var8 += var11;
      }
   ...
   @ObfuscatedName("ae")
   void method4655(int var1, int var2) {
      field3658 = -1;
      field3649 = -1;
      field3650 = var2;
      field3652 = var2;
   ...
   static void method4707(byte[] var0, int var1, int var2, int var3, int var4, int var5) {
      ...
      if(var1 + var3 > Rasterizer2D.drawingAreaBottom) {
         var10 = var1 + var3 - Rasterizer2D.drawingAreaBottom;
         var3 -= var10;
         var8 += var10;
         var7 += var10;
      }
   ...
   @ObfuscatedName("af")
   public void method4709(String var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         this.method4655(var4, var5);
         ...
         this.method4645(var1, var2, var3, var7, (int[])null);
      }
   }
         ...
         for(var13 = 0; var13 < 256; ++var13) {
            if(var13 != 32 && var13 != 160) {
               for(var8 = 0; var8 < 256; ++var8) {
                  if(var8 != 32 && var8 != 160) {
                     this.field3647[(var13 << 8) + var8] = (byte)method4626(var11, var12, var4, this.field3639, var10, var13, var8);
                  }
               }
            }
         }

         this.field3643 = var4[32] + var10[32];
      }
