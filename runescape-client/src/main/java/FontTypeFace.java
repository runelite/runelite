...
public abstract class FontTypeFace extends Rasterizer2D {
   ...
   @ObfuscatedName("m")
   static String[] field3637;
   @ObfuscatedName("o")
   @Export("underlineRGB")
   static int underlineRGB;
   @ObfuscatedName("l")
   static Random field3636;
   @ObfuscatedName("k")
   ...
   static {
      ...
      field3624 = 0;
      field3626 = 0;
      field3636 = new Random();
      field3637 = new String[100];
   }
   ...
   @ObfuscatedName("g")
   public int method4820(String var1) {
      if(var1 == null) {
         return 0;
      } else {
         int var2 = -1;
         ...
         for(int var5 = 0; var5 < var1.length(); ++var5) {
            ...
            if(var6 == 60) {
                     ...
                     if(!var7.equals("gt")) {
                        if(var7.startsWith("img=")) {
                           try {
                              ...
                              int var8 = Timer.parseInt(var9, 10, true);
               ...
               if(var2 == -1) {
                  var4 += this.field3617[(char)(WorldListFetcher.method1528(var6) & 255)];
                  if(this.field3623 != null && var3 != -1) {
                     var4 += this.field3623[var6 + (var3 << 8)];
                  }
   ...
   @ObfuscatedName("s")
   public int method4827(String var1, int[] var2, String[] var3) {
      if(var1 == null) {
         return 0;
      } else {
         int var4 = 0;
            ...
            if(var15 == 60) {
               ...
               if(var15 == 62 && var10 != -1) {
                  ...
                  if(var16.equals("br")) {
                     ...
                     var4 += this.method4734('<');
                     if(this.field3623 != null && var11 != -1) {
                        var4 += this.field3623[(var11 << 8) + 60];
                     }
                     ...
                     var4 += this.method4734('>');
                     if(this.field3623 != null && var11 != -1) {
                        var4 += this.field3623[(var11 << 8) + 62];
                     }
                     ...
                     try {
                        ...
                        int var17 = Timer.parseInt(var18, 10, true);
               ...
               if(var10 == -1) {
                  if(var15 != 0) {
                     var6.append(var15);
                     var4 += this.method4734(var15);
                     if(this.field3623 != null && var11 != -1) {
                        var4 += this.field3623[var15 + (var11 << 8)];
                     }
   ...
   @ObfuscatedName("ar")
   void method4808(String var1, int var2, int var3) {
      ...
      for(int var6 = 0; var6 < var1.length(); ++var6) {
         if(var1.charAt(var6) != 0) {
            char var7 = (char)(WorldListFetcher.method1528(var1.charAt(var6)) & 255);
            if(var7 == 60) {
               var4 = var6;
            } else {
               int var9;
                  ...
                  if(var8.equals("lt")) {
                     ...
                     if(!var8.equals("gt")) {
                        if(var8.startsWith("img=")) {
                           try {
                              var9 = class177.method3425(var8.substring(4));
                              IndexedSprite var12 = modIcons[var9];
                              var12.method5034(var2, var3 + this.verticalSpace - var12.originalHeight);
                              var2 += var12.width;
                              var5 = -1;
               ...
               if(var4 == -1) {
                  if(this.field3623 != null && var5 != -1) {
                     var2 += this.field3623[var7 + (var5 << 8)];
                  }
                  ...
                  if(var7 != 32) {
                     if(field3633 == 256) {
                        ...
                        if(shadow != -1) {
                           renderShadeRGBA(this.gylphs[var7], var2 + this.horizontalOffsets[var7] + 1, var3 + this.verticalOffsets[var7] + 1, var11, var9, shadow, field3633);
                        }

                        this.renderRGBA(this.gylphs[var7], var2 + this.horizontalOffsets[var7], var3 + this.verticalOffsets[var7], var11, var9, color, field3633);
                     }
                  } else if(field3624 > 0) {
                     field3626 += field3624;
                     var2 += field3626 >> 8;
                  ...
                  int var10 = this.field3617[var7];
                  if(strikeRGB != -1) {
                     Rasterizer2D.method5003(var2, var3 + (int)((double)this.verticalSpace * 0.7D), var10, strikeRGB);
                  }

                  if(underlineRGB != -1) {
                     Rasterizer2D.method5003(var2, var3 + this.verticalSpace + 1, var10, underlineRGB);
                  }
   ...
   @ObfuscatedName("t")
   void method4732(byte[] var1) {
      this.field3617 = new int[256];
      int var2;
      if(var1.length == 257) {
         for(var2 = 0; var2 < this.field3617.length; ++var2) {
            this.field3617[var2] = var1[var2] & 255;
         }
         ...
         for(int var3 = 0; var3 < 256; ++var3) {
            this.field3617[var3] = var1[var2++] & 255;
         }
         ...
         this.field3623 = new byte[65536];

         for(var13 = 0; var13 < 256; ++var13) {
            if(var13 != 32 && var13 != 160) {
               for(var8 = 0; var8 < 256; ++var8) {
                  if(var8 != 32 && var8 != 160) {
                     this.field3623[var8 + (var13 << 8)] = (byte)method4733(var11, var12, var4, this.field3617, var10, var13, var8);
                  }
               }
            }
         }
   ...
   void drawMouseoverText(String var1, int var2, int var3, int[] var4, int[] var5) {
      ...
      for(int var9 = 0; var9 < var1.length(); ++var9) {
         if(var1.charAt(var9) != 0) {
            char var10 = (char)(WorldListFetcher.method1528(var1.charAt(var9)) & 255);
            if(var10 == 60) {
               var6 = var9;
            } else {
               int var12;
                     ...
                     if(!var11.equals("gt")) {
                        if(var11.startsWith("img=")) {
                           try {
                              ...
                              var14 = Timer.parseInt(var19, 10, true);
                              IndexedSprite var17 = modIcons[var14];
                              var17.method5034(var12 + var2, var3 + this.verticalSpace - var17.originalHeight + var13);
                              var2 += var17.width;
                              var7 = -1;
               ...
               if(var6 == -1) {
                  if(this.field3623 != null && var7 != -1) {
                     var2 += this.field3623[var10 + (var7 << 8)];
                  }
                  ...
                  if(var10 != 32) {
                     if(field3633 == 256) {
                        ...
                        if(shadow != -1) {
                           renderShadeRGBA(this.gylphs[var10], var13 + var2 + this.horizontalOffsets[var10] + 1, var3 + var14 + this.verticalOffsets[var10] + 1, var18, var12, shadow, field3633);
                        }

                        this.renderRGBA(this.gylphs[var10], var13 + var2 + this.horizontalOffsets[var10], var3 + var14 + this.verticalOffsets[var10], var18, var12, color, field3633);
                     }
                  } else if(field3624 > 0) {
                     field3626 += field3624;
                     var2 += field3626 >> 8;
                  ...
                  int var15 = this.field3617[var10];
                  if(strikeRGB != -1) {
                     Rasterizer2D.method5003(var2, var3 + (int)((double)this.verticalSpace * 0.7D), var15, strikeRGB);
                  }

                  if(underlineRGB != -1) {
                     Rasterizer2D.method5003(var2, var3 + this.verticalSpace, var15, underlineRGB);
                  }
   ...
   @ObfuscatedName("r")
   int method4734(char var1) {
      if(var1 == 160) {
         var1 = 32;
      }

      return this.field3617[WorldListFetcher.method1528(var1) & 255];
   }
   ...
   void setRGB(String var1) {
      try {
         ...
         if(var1.startsWith("col=")) {
            ...
            var2 = Timer.parseInt(var3, 16, true);
            color = var2;
   ...
   @ObfuscatedName("p")
   public int method4791(String var1, int var2) {
      return this.method4827(var1, new int[]{var2}, field3637);
   }

   @ObfuscatedName("h")
   public int method4833(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      if(var1 == null) {
         return 0;
      } else {
         ...
         int var12 = this.method4827(var1, var11, field3637);
         if(var9 == 3 && var12 == 1) {
            var9 = 1;
         }
         ...
         for(var14 = 0; var14 < var12; ++var14) {
            if(var8 == 0) {
               this.method4808(field3637[var14], var2, var13);
            } else if(var8 == 1) {
               this.method4808(field3637[var14], var2 + (var4 - this.method4820(field3637[var14])) / 2, var13);
            } else if(var8 == 2) {
               this.method4808(field3637[var14], var2 + var4 - this.method4820(field3637[var14]), var13);
            } else if(var12 - 1 == var14) {
               this.method4808(field3637[var14], var2, var13);
            } else {
               this.method4750(field3637[var14], var4);
               this.method4808(field3637[var14], var2, var13);
               field3624 = 0;
            }
   ...
   @ObfuscatedName("ag")
   void method4750(String var1, int var2) {
      int var3 = 0;
      boolean var4 = false;
      ...
      if(var3 > 0) {
         field3624 = (var2 - this.method4820(var1) << 8) / var3;
      }
   ...
   @ObfuscatedName("o")
   public int method4766(String var1, int var2) {
      int var3 = this.method4827(var1, new int[]{var2}, field3637);
      int var4 = 0;

      for(int var5 = 0; var5 < var3; ++var5) {
         int var6 = this.method4820(field3637[var5]);
         if(var6 > var4) {
            var4 = var6;
         }
      }
   ...
   public void drawRandomizedMouseoverText(String var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         ...
         field3636.setSeed((long)var6);
         field3633 = 192 + (field3636.nextInt() & 31);
         int[] var7 = new int[var1.length()];
         int var8 = 0;

         for(int var9 = 0; var9 < var1.length(); ++var9) {
            var7[var9] = var8;
            if((field3636.nextInt() & 3) == 0) {
               ++var8;
            }
         }
   ...
   @ObfuscatedName("c")
   public void method4742(String var1, int var2, int var3, int var4, int var5) {
      if(var1 != null) {
         this.setColor(var4, var5);
         this.method4808(var1, var2 - this.method4820(var1) / 2, var3);
      }
   }

   @ObfuscatedName("b")
   public void method4751(String var1, int var2, int var3, int var4, int var5) {
      if(var1 != null) {
         this.setColor(var4, var5);
         this.method4808(var1, var2, var3);
      }
   }

   @ObfuscatedName("k")
   public void method4741(String var1, int var2, int var3, int var4, int var5) {
      if(var1 != null) {
         this.setColor(var4, var5);
         this.method4808(var1, var2 - this.method4820(var1), var3);
      }
   }

   @ObfuscatedName("z")
   public void method4744(String var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         this.setColor(var4, var5);
         int[] var7 = new int[var1.length()];
         ...
         this.drawMouseoverText(var1, var2 - this.method4820(var1) / 2, var3, (int[])null, var7);
      }
   }

   @ObfuscatedName("j")
   public void method4745(String var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         this.setColor(var4, var5);
         int[] var7 = new int[var1.length()];
         ...
         this.drawMouseoverText(var1, var2 - this.method4820(var1) / 2, var3, var7, var8);
      }
   }
   ...
   public void method4737(String var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if(var1 != null) {
         ...
         this.drawMouseoverText(var1, var2 - this.method4820(var1) / 2, var3, (int[])null, var10);
      }
   }

   @ObfuscatedName("w")
   public void method4740(String var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         this.setColor(var4, var5);
         field3633 = var6;
         this.method4808(var1, var2, var3);
   ...
   @ObfuscatedName("i")
   static int method4733(byte[][] var0, byte[][] var1, int[] var2, int[] var3, int[] var4, int var5, int var6) {
      int var7 = var2[var5];
   ...
   static void renderRGBA(int[] var0, byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      var2 = ((var2 & 16711935) * var9 & -16711936) + (var9 * (var2 & '\uff00') & 16711680) >> 8;
      var9 = 256 - var9;
      ...
      for(int var10 = -var6; var10 < 0; ++var10) {
         for(int var11 = -var5; var11 < 0; ++var11) {
            if(var1[var3++] != 0) {
               int var12 = var0[var4];
               var0[var4++] = (((var12 & '\uff00') * var9 & 16711680) + (var9 * (var12 & 16711935) & -16711936) >> 8) + var2;
            } else {
               ++var4;
            }
         }
