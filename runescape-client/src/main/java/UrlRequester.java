...
public class UrlRequester implements Runnable {
   ...
   static final void method3091(PacketBuffer incoming) {
      for(int var1 = 0; var1 < Client.pendingNpcFlagsCount; ++var1) {
         ...
         int var4 = incoming.readUnsignedByte();
         int var5;
         int var6;
         int var7;
         if((var4 & 4) != 0) {
            var5 = incoming.readUnsignedShort();
            if(var5 == 65535) {
               var5 = -1;
            }

            var6 = incoming.readUnsignedShortOb1();
         ...
         if((var4 & 64) != 0) {
            var3.composition = class234.getNpcDefinition(incoming.readUnsignedShort());
         ...
         if((var4 & 32) != 0) {
            var3.interacting = incoming.readLEUShortA();
         ...
         if((var4 & 16) != 0) {
            ...
            if(var5 > 0) {
               for(var6 = 0; var6 < var5; ++var6) {
                  ...
                  var9 = -1;
                  var10 = -1;
                  var7 = incoming.getUSmart();
                  if(var7 == 32767) {
                     var7 = incoming.getUSmart();
                     var9 = incoming.getUSmart();
                     var8 = incoming.getUSmart();
                     var10 = incoming.getUSmart();
                  } else if(var7 != 32766) {
                     var9 = incoming.getUSmart();
                  } else {
                     var7 = -1;
            ...
            if(var6 > 0) {
               for(var7 = 0; var7 < var6; ++var7) {
                  ...
                  if(var9 != 32767) {
                     var10 = incoming.getUSmart();
                     var11 = incoming.readUnsignedShortOb1();
                     int var12 = var9 > 0?incoming.readUnsignedShortOb1():var11;
         ...
         if((var4 & 8) != 0) {
            var3.overhead = incoming.readString();
