...
public class class92 {
   ...
   public static final boolean method1693(int var0, int var1, class163 var2, CollisionData var3) {
      ...
      while(var11 != var18) {
         ...
         if(var17 < 127 && class162.field2262[var16][var17 + 1] == 0 && (var12[var13][1 + var14] & 19136800) == 0) {
            class162.field2268[var18] = var4;
            class162.field2269[var18] = var5 + 1;
            var18 = var18 + 1 & 4095;
         ...
         if(var16 < 127 && var17 > 0 && class162.field2262[var16 + 1][var17 - 1] == 0 && (var12[var13 + 1][var14 - 1] & 19136899) == 0 && (var12[1 + var13][var14] & 19136896) == 0 && (var12[var13][var14 - 1] & 19136770) == 0) {
            class162.field2268[var18] = var4 + 1;
            class162.field2269[var18] = var5 - 1;
            var18 = var18 + 1 & 4095;
