            ...
            if(!var9.hasScript || var12 < var14 && var13 < var15) {
               ...
               if(var9.contentType == 1337) {
                        ...
                        if(var20 != var22) {
                           ...
                           if(var25 == 2 && class2.region.method2696(WallObject.plane, var23, var24, var22) >= 0) {
                              ...
                              if(Client.itemSelectionState == 1) {
                                 class175.addMenuEntry("Use", Client.selectedItemName + " " + "->" + " " + class220.getColTags('\uffff') + var35.name, 1, var22, var23, var24);
                              } else if(Client.spellSelected) {
                                 if((WorldMapType3.spellTargetFlags & 4) == 4) {
                                    class175.addMenuEntry(Client.field1078, Client.field1159 + " " + "->" + " " + class220.getColTags('\uffff') + var35.name, 2, var22, var23, var24);
                                 }
                              } else {
                                 ...
                                 if(var40 != null) {
                                    for(int var41 = 4; var41 >= 0; --var41) {
                                       if(var40[var41] != null) {
                                          ...
                                          class175.addMenuEntry(var40[var41], class220.getColTags('\uffff') + var35.name, var30, var22, var23, var24);
                                       }
                                    }
                                 }

                                 class175.addMenuEntry("Examine", class220.getColTags('\uffff') + var35.name, 1002, var35.id << 14, var23, var24);
                              }
                           }
                           ...
                           if(var25 == 1) {
                              ...
                              if(var52.composition.field3561 == 1 && (var52.x & 127) == 64 && (var52.y & 127) == 64) {
                                 for(var28 = 0; var28 < Client.field937; ++var28) {
                                    ...
                                    if(var29 != null && var52 != var29 && var29.composition.field3561 == 1 && var52.x == var29.x && var29.y == var52.y) {
                                 ...
                                 for(var49 = 0; var49 < var28; ++var49) {
                                    ...
                                    if(var31 != null && var31.x == var52.x && var52.y == var31.y) {
                           ...
                           if(var25 == 0) {
                              ...
                              if((var53.x & 127) == 64 && (var53.y & 127) == 64) {
                                 for(var28 = 0; var28 < Client.field937; ++var28) {
                                    var29 = Client.cachedNPCs[Client.npcIndices[var28]];
                                    if(var29 != null && var29.composition.field3561 == 1 && var29.x == var53.x && var53.y == var29.y) {
                                       class33.method349(var29.composition, Client.npcIndices[var28], var23, var24);
                                    }
                                 }
                                 ...
                                 for(var49 = 0; var49 < var28; ++var49) {
                                    var31 = Client.cachedPlayers[var47[var49]];
                                    if(var31 != null && var31 != var53 && var53.x == var31.x && var31.y == var53.y) {
                                       class181.method3429(var31, var47[var49], var23, var24);
                                    }
                                 }
                              }
                           ...
                           if(var25 == 3) {
                              ...
                              if(var54 != null) {
                                 for(Item var55 = (Item)var54.getTail(); var55 != null; var55 = (Item)var54.getPrevious()) {
                                    ItemComposition var48 = AbstractByteBuffer.getItemDefinition(var55.id);
                                    if(Client.itemSelectionState == 1) {
                                       class175.addMenuEntry("Use", Client.selectedItemName + " " + "->" + " " + class220.getColTags(16748608) + var48.name, 16, var55.id, var23, var24);
                                    } else if(Client.spellSelected) {
                                       if((WorldMapType3.spellTargetFlags & 1) == 1) {
                                          class175.addMenuEntry(Client.field1078, Client.field1159 + " " + "->" + " " + class220.getColTags(16748608) + var48.name, 17, var55.id, var23, var24);
                                       }
                                    } else {
                                       ...
                                       for(int var43 = 4; var43 >= 0; --var43) {
                                          if(var42 != null && var42[var43] != null) {
                                             ...
                                             class175.addMenuEntry(var42[var43], class220.getColTags(16748608) + var48.name, var32, var55.id, var23, var24);
                                          } else if(var43 == 2) {
                                             class175.addMenuEntry("Take", class220.getColTags(16748608) + var48.name, 20, var55.id, var23, var24);
                                          }
                                       }

                                       class175.addMenuEntry("Examine", class220.getColTags(16748608) + var48.name, 1004, var55.id, var23, var24);
                                    }
                                 }
                              }
                           }
                  ...
                  if((Client.field1161 == 0 || Client.field1161 == 3) && (MouseInput.field742 == 1 || !class34.field499 && MouseInput.field742 == 4)) {
                     ...
                     if(var51 != null) {
                        ...
                        if(var51.method3898(var20, var21)) {
                           ...
                           var26 = var21 * var24 - var23 * var20 >> 11;
                           ...
                           Client.secretPacketBuffer1.putShort(var27 + KeyFocusListener.baseX);
                  ...
                  if(var9.contentType == 1400) {
                     class43.renderOverview.method5240(MouseInput.field748, MouseInput.field749, var44, var10, var11, var9.width, var9.height);
                  }
                  ...
                  if(var9.type == 0) {
                     ...
                     if(var34 != null) {
                        if(var34.owner == 0 && MouseInput.field748 >= var12 && MouseInput.field749 >= var13 && MouseInput.field748 < var14 && MouseInput.field749 < var15 && !Client.isMenuOpen && !Client.field1097) {
                           for(ScriptEvent var39 = (ScriptEvent)Client.field1035.getFront(); var39 != null; var39 = (ScriptEvent)Client.field1035.getNext()) {
                              if(var39.field848) {
                                 var39.unlink();
                  ...
                  if(var9.hasScript) {
                     ...
                     if(!var9.field2685) {
                        if(var9.field2783 && MouseInput.field748 >= var12 && MouseInput.field749 >= var13 && MouseInput.field748 < var14 && MouseInput.field749 < var15) {
                           for(var50 = (ScriptEvent)Client.field1035.getFront(); var50 != null; var50 = (ScriptEvent)Client.field1035.getNext()) {
                              if(var50.field848 && var50.widget.scrollListener == var50.field857) {
                                 var50.unlink();
                              }
                           }
                        }
                     ...
                     boolean var45 = false;
                     if((MouseInput.field754 == 1 || !class34.field499 && MouseInput.field754 == 4) && var44) {
                        var45 = true;
                     }
                     ...
                     if(var9.contentType == 1400) {
                        class43.renderOverview.method5182(MouseInput.field748, MouseInput.field749, var44 & var45);
                     }

                     if(Client.field1100 != null && var9 != Client.field1100 && var44 && FrameMap.method2664(WorldMapType3.getWidgetConfig(var9))) {
                     ...
                     if(var9.field2734) {
                        ScriptEvent var36;
                        if(var44 && Client.field1125 != 0 && var9.scrollListener != null) {
                           var36 = new ScriptEvent();
                           var36.field848 = true;
                           var36.widget = var9;
                           var36.field853 = Client.field1125;
                           var36.field857 = var9.scrollListener;
                           Client.field1035.addFront(var36);
                        }
                        ...
                        if(!var9.field2780 && var46) {
                           ...
                           if(var9.field2725 != null) {
                              ...
                              var36.field848 = true;
                              var36.widget = var9;
                              var36.field850 = MouseInput.field747 - var10;
                              var36.field853 = MouseInput.field756 - var11;
                        ...
                        if(var9.field2780 && var45 && var9.field2677 != null) {
                           ...
                           var36.field848 = true;
                           var36.widget = var9;
                           var36.field850 = MouseInput.field748 - var10;
                           var36.field853 = MouseInput.field749 - var11;
                        ...
                        if(var9.field2780 && !var45) {
                           ...
                           if(var9.field2738 != null) {
                              ...
                              Client.field1128.addFront(var36);
                           }
                        }
                        ...
                        if(!var9.field2776 && var44) {
                           ...
                           if(var9.mouseEnterListener != null) {
                              ...
                              var36.field850 = MouseInput.field748 - var10;
                              var36.field853 = MouseInput.field749 - var11;
                              var36.field857 = var9.mouseEnterListener;
                              Client.field1035.addFront(var36);
                           }
                        }

                        if(var9.field2776 && var44 && var9.mouseHoverListener != null) {
                           var36 = new ScriptEvent();
                           var36.field848 = true;
                           var36.widget = var9;
                           var36.field850 = MouseInput.field748 - var10;
                           var36.field853 = MouseInput.field749 - var11;
                           var36.field857 = var9.mouseHoverListener;
                           Client.field1035.addFront(var36);
                        }
                        ...
                        if(var9.field2776 && !var44) {
                           ...
                           if(var9.mouseExitListener != null) {
                              ...
                              var36.field850 = MouseInput.field748 - var10;
                              var36.field853 = MouseInput.field749 - var11;
                              var36.field857 = var9.mouseExitListener;
                              Client.field1128.addFront(var36);
                           }
                        }
                        ...
                        if(var9.renderListener != null) {
                           var36 = new ScriptEvent();
                           var36.widget = var9;
                           var36.field857 = var9.renderListener;
                           Client.field1127.addFront(var36);
                        }
                        ...
                        if(var9.configListenerArgs != null && Client.field975 > var9.field2736) {
                           if(var9.configTriggers != null && Client.field975 - var9.field2736 <= 32) {
                              ...
                              for(var21 = var9.field2736; var21 < Client.field975; ++var21) {
                                 ...
                                 for(var23 = 0; var23 < var9.configTriggers.length; ++var23) {
                                    if(var22 == var9.configTriggers[var23]) {
                                       ...
                                       var37.widget = var9;
                                       var37.field857 = var9.configListenerArgs;
                                       Client.field1035.addFront(var37);
                                       break label1115;
                                    }
                                 }
                              }
                              ...
                              var36 = new ScriptEvent();
                              var36.widget = var9;
                              var36.field857 = var9.configListenerArgs;
                              Client.field1035.addFront(var36);
                           }
                        ...
                        if(var9.tableListenerArgs != null && Client.field1116 > var9.field2669) {
                           if(var9.tableModTriggers != null && Client.field1116 - var9.field2669 <= 32) {
                              ...
                              for(var21 = var9.field2669; var21 < Client.field1116; ++var21) {
                                 ...
                                 for(var23 = 0; var23 < var9.tableModTriggers.length; ++var23) {
                                    if(var22 == var9.tableModTriggers[var23]) {
                                       var37 = new ScriptEvent();
                                       var37.widget = var9;
                                       var37.field857 = var9.tableListenerArgs;
                                       Client.field1035.addFront(var37);
                                       break label1091;
                                    }
                                 }
                              ...
                              var36 = new ScriptEvent();
                              var36.widget = var9;
                              var36.field857 = var9.tableListenerArgs;
                              Client.field1035.addFront(var36);
                           }
                        ...
                        if(var9.skillListenerArgs != null && Client.field1067 > var9.field2666) {
                           if(var9.skillTriggers != null && Client.field1067 - var9.field2666 <= 32) {
                              ...
                              for(var21 = var9.field2666; var21 < Client.field1067; ++var21) {
                                 ...
                                 for(var23 = 0; var23 < var9.skillTriggers.length; ++var23) {
                                    if(var22 == var9.skillTriggers[var23]) {
                                       var37 = new ScriptEvent();
                                       var37.widget = var9;
                                       var37.field857 = var9.skillListenerArgs;
                                       Client.field1035.addFront(var37);
                                       break label1067;
                                    }
                                 }
                              ...
                              var36 = new ScriptEvent();
                              var36.widget = var9;
                              var36.field857 = var9.skillListenerArgs;
                              Client.field1035.addFront(var36);
                           }
                        ...
                        if(var9.field2761 != null) {
                           for(var21 = 0; var21 < Client.field1037; ++var21) {
                              ...
                              Client.field1035.addFront(var38);
                           }
                        }
                     }
                  }
