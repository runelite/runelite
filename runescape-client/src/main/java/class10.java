...
public final class class10 {
   ...
   static final void method115(class15 var0) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         if(null != var5 && var5.vmethod738() && !var5.field265) {
            var5.field273 = false;
      ...
      if(var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
         ...
         if(var7 != 0) {
            ...
            if(var1 == 0) {
               ...
               var12 = class140.getObjectDefinition(var34);
               if(var12.field2914 != 0) {
                  Client.collisionMaps[var0].method2322(var2, var3, var35, var36, var12.field2915);
               }
            }
            ...
            if(var1 == 2) {
               ...
               if(var12.field2914 != 0) {
                  Client.collisionMaps[var0].method2323(var2, var3, var12.sizeX, var12.sizeY, var36, var12.field2915);
               }
            }
         ...
         if(var4 >= 0) {
            ...
            Region var37 = CombatInfo1.region;
            CollisionData var13 = Client.collisionMaps[var0];
            ObjectComposition var14 = class140.getObjectDefinition(var4);
            int var15;
            int var16;
            if(var5 != 1 && var5 != 3) {
               var15 = var14.sizeX;
            ...
            if(var6 == 22) {
               if(var14.animationId == -1 && null == var14.impostorIds) {
                  var32 = var14.method3644(22, var5, var21, var23, var22, var24);
               } else {
               ...
               if(var6 >= 12) {
                  if(var14.animationId == -1 && null == var14.impostorIds) {
                     var32 = var14.method3644(var6, var5, var21, var23, var22, var24);
                  } else {
                     var32 = new class49(var4, var6, var5, var11, var2, var3, var14.animationId, true, (Renderable)null);
                  }

                  var37.method1749(var0, var2, var3, var22, 1, 1, (Renderable)var32, 0, var25, var26);
                  if(var14.field2914 != 0) {
                     var13.method2330(var2, var3, var15, var16, var14.field2915);
                  }
               } else if(var6 == 0) {
                  if(var14.animationId == -1 && var14.impostorIds == null) {
                     var32 = var14.method3644(0, var5, var21, var23, var22, var24);
                  } else {
                     var32 = new class49(var4, 0, var5, var11, var2, var3, var14.animationId, true, (Renderable)null);
                  }

                  var37.method1876(var0, var2, var3, var22, (Renderable)var32, (Renderable)null, field90[var5], 0, var25, var26);
                  if(var14.field2914 != 0) {
                     var13.method2317(var2, var3, var6, var5, var14.field2915);
                  }
               } else if(var6 == 1) {
                  if(var14.animationId == -1 && var14.impostorIds == null) {
                     var32 = var14.method3644(1, var5, var21, var23, var22, var24);
                  } else {
                     var32 = new class49(var4, 1, var5, var11, var2, var3, var14.animationId, true, (Renderable)null);
                  }

                  var37.method1876(var0, var2, var3, var22, (Renderable)var32, (Renderable)null, field101[var5], 0, var25, var26);
                  if(var14.field2914 != 0) {
                     var13.method2317(var2, var3, var6, var5, var14.field2915);
                  }
               } else {
                  ...
                  if(var6 == 2) {
                     ...
                     Object var33;
                     if(var14.animationId == -1 && var14.impostorIds == null) {
                        var33 = var14.method3644(2, var5 + 4, var21, var23, var22, var24);
                        var29 = var14.method3644(2, var27, var21, var23, var22, var24);
                     } else {
                        var33 = new class49(var4, 2, 4 + var5, var11, var2, var3, var14.animationId, true, (Renderable)null);
                        var29 = new class49(var4, 2, var27, var11, var2, var3, var14.animationId, true, (Renderable)null);
                     }

                     var37.method1876(var0, var2, var3, var22, (Renderable)var33, (Renderable)var29, field90[var5], field90[var27], var25, var26);
                     if(var14.field2914 != 0) {
                        var13.method2317(var2, var3, var6, var5, var14.field2915);
                     }
                  } else if(var6 == 3) {
                     if(var14.animationId == -1 && null == var14.impostorIds) {
                        var32 = var14.method3644(3, var5, var21, var23, var22, var24);
                     } else {
                     ...
                     if(var14.animationId == -1 && var14.impostorIds == null) {
                        var32 = var14.method3644(4, var5, var21, var23, var22, var24);
                     } else {
                        var32 = new class49(var4, 4, var5, var11, var2, var3, var14.animationId, true, (Renderable)null);
                     }

                     var37.method1745(var0, var2, var3, var22, (Renderable)var32, (Renderable)null, field90[var5], 0, 0, 0, var25, var26);
                  } else {
                     int var28;
                     if(var6 == 5) {
                        var27 = 16;
                        var28 = var37.method1762(var0, var2, var3);
                        if(var28 != 0) {
                           var27 = class140.getObjectDefinition(var28 >> 14 & 32767).field2899;
                        }

                        if(var14.animationId == -1 && var14.impostorIds == null) {
                           var29 = var14.method3644(4, var5, var21, var23, var22, var24);
                        } else {
                           var29 = new class49(var4, 4, var5, var11, var2, var3, var14.animationId, true, (Renderable)null);
                        }

                        var37.method1745(var0, var2, var3, var22, (Renderable)var29, (Renderable)null, field90[var5], 0, field92[var5] * var27, field93[var5] * var27, var25, var26);
                     } else if(var6 == 6) {
                        var27 = 8;
                        var28 = var37.method1762(var0, var2, var3);
                        if(var28 != 0) {
                           var27 = class140.getObjectDefinition(var28 >> 14 & 32767).field2899 / 2;
                        }

                        if(var14.animationId == -1 && null == var14.impostorIds) {
                           var29 = var14.method3644(4, 4 + var5, var21, var23, var22, var24);
                        } else {
                           var29 = new class49(var4, 4, var5 + 4, var11, var2, var3, var14.animationId, true, (Renderable)null);
                        }

                        var37.method1745(var0, var2, var3, var22, (Renderable)var29, (Renderable)null, 256, var5, var27 * field84[var5], var27 * field95[var5], var25, var26);
                     } else if(var6 == 7) {
                        var28 = 2 + var5 & 3;
                        if(var14.animationId == -1 && var14.impostorIds == null) {
                           var32 = var14.method3644(4, var28 + 4, var21, var23, var22, var24);
                        } else {
                           var32 = new class49(var4, 4, 4 + var28, var11, var2, var3, var14.animationId, true, (Renderable)null);
                        }

                        var37.method1745(var0, var2, var3, var22, (Renderable)var32, (Renderable)null, 256, var28, 0, 0, var25, var26);
                     } else if(var6 == 8) {
                        var27 = 8;
                        var28 = var37.method1762(var0, var2, var3);
                        if(var28 != 0) {
                        ...
                        if(var14.animationId == -1 && var14.impostorIds == null) {
                           var29 = var14.method3644(4, 4 + var5, var21, var23, var22, var24);
                           var30 = var14.method3644(4, 4 + var31, var21, var23, var22, var24);
                        } else {
                        ...
                        var37.method1745(var0, var2, var3, var22, (Renderable)var29, (Renderable)var30, 256, var5, field84[var5] * var27, field95[var5] * var27, var25, var26);
                     }
                  }
               }
            } else {
               if(var14.animationId == -1 && null == var14.impostorIds) {
                  var32 = var14.method3644(10, var5, var21, var23, var22, var24);
               } else {
                  var32 = new class49(var4, 10, var5, var11, var2, var3, var14.animationId, true, (Renderable)null);
               }

               if(null != var32) {
                  var37.method1749(var0, var2, var3, var22, var15, var16, (Renderable)var32, var6 == 11?256:0, var25, var26);
               }
   ...
   static int method140(int var0, Script var1, boolean var2) {
      if(var0 == 5306) {
         ...
         if(var0 == 5307) {
            ...
            var6 = class32.field743[--class30.field713];
            if(var6 == 1 || var6 == 2) {
               class148.field2058.field714 = var6;
               class150.method2839();
            }
