...
public class WidgetNode extends Node {
   ...
   static final void method200(boolean var0) {
      Client.field407 = 0;
      Client.field292 = 0;
      Client.secretPacketBuffer2.method2644();
      int var1 = Client.secretPacketBuffer2.method2645(8);
      int var2;
      ...
      if(var1 > Client.field321) {
         ...
         for(var2 = 0; var2 < var1; ++var2) {
            ...
            var5 = Client.secretPacketBuffer2.method2645(1);
            if(var5 == 0) {
               Client.field350[++Client.field321 - 1] = var3;
               var4.field648 = Client.gameCycle;
            } else {
               var6 = Client.secretPacketBuffer2.method2645(2);
               if(var6 == 0) {
                  Client.field350[++Client.field321 - 1] = var3;
                  var4.field648 = Client.gameCycle;
                  ...
                  Client.field350[++Client.field321 - 1] = var3;
                  var4.field648 = Client.gameCycle;
                  var7 = Client.secretPacketBuffer2.method2645(3);
                  var4.method735(var7, (byte)1);
                  var8 = Client.secretPacketBuffer2.method2645(1);
                  if(var8 == 1) {
                     Client.field324[++Client.field292 - 1] = var3;
                  }
               } else if(var6 == 2) {
                  ...
                  var8 = Client.secretPacketBuffer2.method2645(3);
                  var4.method735(var8, (byte)2);
                  var9 = Client.secretPacketBuffer2.method2645(1);
                  if(var9 == 1) {
                     Client.field324[++Client.field292 - 1] = var3;
                  }
               } else if(var6 == 3) {
         ...
         for(var1 = 0; var1 < Client.field292; ++var1) {
            ...
            if((var14 & 2) != 0) {
               var13.interacting = Client.secretPacketBuffer2.method2418();
            ...
            if((var14 & 32) != 0) {
               var5 = Client.secretPacketBuffer2.method2409();
               int var10;
               int var11;
               if(var5 > 0) {
                  for(var6 = 0; var6 < var5; ++var6) {
                     ...
                     var9 = -1;
                     var10 = -1;
                     var7 = Client.secretPacketBuffer2.method2395();
                     if(var7 == 32767) {
                        var7 = Client.secretPacketBuffer2.method2395();
                        var9 = Client.secretPacketBuffer2.method2395();
                        var8 = Client.secretPacketBuffer2.method2395();
                        var10 = Client.secretPacketBuffer2.method2395();
                     } else if(var7 != 32766) {
                        var9 = Client.secretPacketBuffer2.method2395();
                     } else {
                        var7 = -1;
                     ...
                     var11 = Client.secretPacketBuffer2.method2395();
               ...
               if(var6 > 0) {
                  for(var7 = 0; var7 < var6; ++var7) {
                     ...
                     if(var9 != 32767) {
                        var10 = Client.secretPacketBuffer2.method2395();
                        var11 = Client.secretPacketBuffer2.method2409();
                        int var12 = var9 > 0?Client.secretPacketBuffer2.method2409():var11;
            ...
            if((var14 & 4) != 0) {
               var5 = Client.secretPacketBuffer2.method2420();
               var6 = Client.secretPacketBuffer2.method2419();
            ...
            if((var14 & 64) != 0) {
               var13.composition = Widget.getNpcDefinition(Client.secretPacketBuffer2.method2418());
            ...
            if((var14 & 1) != 0) {
               var13.graphic = Client.secretPacketBuffer2.method2420();
            ...
            if((var14 & 8) != 0) {
               ...
               var6 = Client.secretPacketBuffer2.method2558();
