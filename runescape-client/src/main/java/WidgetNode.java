...
public class WidgetNode extends Node {
   ...
   static int method196(int var0, Script var1, boolean var2) {
      ...
      if(var0 == 1300) {
         ...
         if(var4 >= 0 && var4 <= 9) {
            var3.method3220(var4, class32.scriptStringStack[--class32.scriptStringStackSize]);
            return 1;
         } else {
         ...
         var3.field2283 = class32.scriptIntStack[--class103.scriptIntStackSize] == 1;
         return 1;
      } else if(var0 == 1303) {
         var3.field2281 = class32.scriptIntStack[--class103.scriptIntStackSize];
         return 1;
      } else if(var0 == 1304) {
         var3.field2236 = class32.scriptIntStack[--class103.scriptIntStackSize];
         return 1;
      } else if(var0 == 1305) {
         var3.name = class32.scriptStringStack[--class32.scriptStringStackSize];
         return 1;
      } else if(var0 == 1306) {
         var3.field2306 = class32.scriptStringStack[--class32.scriptStringStackSize];
         return 1;
      } else if(var0 == 1307) {
         var3.actions = null;
         return 1;
