...
public class class104 extends Node {
   ...
   class104(byte[] var1) {
      this.method1996(var1);
   }

   @ObfuscatedName("g")
   void method1996(byte[] var1) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         this.field1584[var4] = var7;
      }

   }

   @ObfuscatedName("p")
   float[] method1998(int var1) {
      setBytes(this.field1584[var1], 0);
      getBit();
      int var2 = getInt(World.ilog(modeMappings.length - 1));
      ...
      for(var17 = 0; var17 < var14.field1709; ++var17) {
         Residue var18 = residues[var14.field1707[var17]];
      ...
      if(var15) {
         ...
         float[] var44 = var3?field1591:field1588;
         float[] var22 = var3?field1576:field1594;
         float[] var23 = var3?field1593:field1583;
         int[] var24 = var3?field1579:field1590;
      ...
      float[] var42 = null;
      if(this.field1572 > 0) {
         var40 = var4 + this.field1572 >> 2;
         var42 = new float[var40];
         int var43;
         if(!this.field1586) {
            for(var41 = 0; var41 < this.field1585; ++var41) {
               var43 = var41 + (this.field1572 >> 1);
               var42[var41] += this.field1595[var43];
            }
         }
         ...
         if(!var15) {
            for(var41 = var8; var41 < var4 >> 1; ++var41) {
               ...
               var42[var43] += field1587[var41];
            }
         }
      }

      float[] var46 = this.field1595;
      this.field1595 = field1587;
      field1587 = var46;
      this.field1572 = var4;
   ...
   class105 method2001(int[] var1) {
      if(var1 != null && var1[0] <= 0) {
         return null;
      } else {
         if(this.field1596 == null) {
            this.field1572 = 0;
            this.field1595 = new float[blockSize1];
            this.field1596 = new byte[this.field1567];
            this.field1597 = 0;
            this.field1598 = 0;
         }

         for(; this.field1598 < this.field1584.length; ++this.field1598) {
            if(var1 != null && var1[0] <= 0) {
               return null;
            }

            float[] var2 = this.method1998(this.field1598);
            if(var2 != null) {
               int var3 = this.field1597;
               int var4 = var2.length;
               if(var4 > this.field1567 - var3) {
                  var4 = this.field1567 - var3;
               }
         ...
         this.field1596 = null;
         return new class105(this.field1566, var7, this.field1568, this.field1569, this.field1570);
      }
   }
   ...
   @ObfuscatedName("v")
   static void method1997(byte[] var0) {
      setBytes(var0, 0);
   ...
   static boolean method1999(IndexDataBase var0) {
      if(!field1565) {
   ...
   @ObfuscatedName("d")
   @ObfuscatedSignature(
      signature = "(Lip;II)Ldf;"
   )
   static class104 method2000(IndexDataBase var0, int var1, int var2) {
      if(!method1999(var0)) {
         var0.method4192(var1, var2);
         return null;
      } else {
