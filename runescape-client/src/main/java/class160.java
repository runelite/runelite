   ...
   static void method3048(Font var0, Font var1) {
      ...
      if(FriendLoginUpdate.field760 != null) {
         ...
         for(var14 = 0; var14 < World.worldCount; ++var14) {
            ...
            if(MouseInput.mouseLastX >= var11 && MouseInput.mouseLastY * -469125321 >= var10 && MouseInput.mouseLastX < var11 + var21 && MouseInput.mouseLastY * -469125321 < var22 + var10 && var16) {
         ...
         if(var13) {
            ...
            Rasterizer2D.Rasterizer2D_fillRectangle(MouseInput.mouseLastX - var14 / 2, MouseInput.mouseLastY * -469125321 + 20 + 5, var14, var20, 16777120);
            Rasterizer2D.drawRectangle(MouseInput.mouseLastX - var14 / 2, MouseInput.mouseLastY * -469125321 + 20 + 5, var14, var20, 0);
            var1.drawTextCentered(ItemContainer.worldList[class91.field1326].activity, MouseInput.mouseLastX, var1.verticalSpace + MouseInput.mouseLastY * -469125321 + 20 + 5 + 4, 0, -1);
         }
      }
