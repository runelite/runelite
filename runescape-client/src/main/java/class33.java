      ...
      synchronized(KeyFocusListener.keyboard) {
         ...
         if(KeyFocusListener.field667 < 0) {
            for(var1 = 0; var1 < 112; ++var1) {
               KeyFocusListener.field659[var1] = false;
            }

            KeyFocusListener.field667 = KeyFocusListener.field663;
         } else {
            while(KeyFocusListener.field663 != KeyFocusListener.field667) {
               var1 = KeyFocusListener.field665[KeyFocusListener.field663];
               KeyFocusListener.field663 = KeyFocusListener.field663 + 1 & 127;
               if(var1 < 0) {
                  KeyFocusListener.field659[~var1] = false;
               } else {
                  if(!KeyFocusListener.field659[var1] && KeyFocusListener.field671 < KeyFocusListener.field670.length - 1) {
                     KeyFocusListener.field670[++KeyFocusListener.field671 - 1] = var1;
                  }

                  KeyFocusListener.field659[var1] = true;
               }
            }
         }
                     ...
                     if(var11 != null) {
                        for(var7 = 4; var7 >= 0; --var7) {
                           if(var11[var7] != null && !var11[var7].equalsIgnoreCase("Attack")) {
                              ...
                              class175.addMenuEntry(var11[var7], class220.getColTags(16776960) + var4, var8, var1, var2, var3);
                           }
                        }
                     }
