...
public class class167 {
   ...
   @ObfuscatedName("x")
   public static final short[] field2183 = new short[]{(short)6798, (short)8741, (short)25238, (short)4626, (short)4550};
   @ObfuscatedName("g")
   public static final short[] field2184 = new short[]{(short)-10304, (short)9104, (short)-1, (short)-1, (short)-1};
   @ObfuscatedName("v")
   ...
   @ObfuscatedSignature(
      signature = "(I)Z",
      garbageValue = "-1076530513"
   )
   static final boolean method3272() {
      return Client.menuOptionCount <= 0?false:Client.field437 && class105.field1718[81] && Client.field436 != -1;
   }
}
