...
public class class167 {
   ...
   static class30 method3200() {
      FileOnDisk var0 = null;
      class30 var1 = new class30();

      try {
         var0 = class22.method220("", Client.field306.field2689, false);
         byte[] var2 = new byte[(int)var0.method1477()];

         int var4;
         for(int var3 = 0; var3 < var2.length; var3 += var4) {
            var4 = var0.method1472(var2, var3, var2.length - var3);
            if(var4 == -1) {
