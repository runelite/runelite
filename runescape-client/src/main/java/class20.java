   ...
   static final void method211() {
      try {
         ...
         if(Client.loginState == 2) {
            ...
            Friend.rssocket.queueForWrite(Client.secretCipherBuffer1.payload, 0, 1);
         ...
         if(Client.loginState == 4) {
            if(Client.secretCipherBuffer2.offset < 8) {
               ...
               if(var0 > 0) {
                  Friend.rssocket.read(Client.secretCipherBuffer2.payload, Client.secretCipherBuffer2.offset, var0);
            ...
            if(Client.secretCipherBuffer2.offset == 8) {
               Client.secretCipherBuffer2.offset = 0;
               GameEngine.field1784 = Client.secretCipherBuffer2.readLong();
               Client.loginState = 5;
            }
         }
         ...
         if(Client.loginState == 5) {
            ...
            Client.secretCipherBuffer1.putByte(class41.field837.vmethod4163());
            ...
            case 0:
            case 2:
               Client.secretCipherBuffer1.put24bitInt(class122.authCodeForLogin);
               Client.secretCipherBuffer1.offset += 5;
               break;
            case 1:
               Client.secretCipherBuffer1.putInt(((Integer)Actor.field656.preferences.get(Integer.valueOf(class36.method755(class41.username)))).intValue());
            ...
            Client.secretCipherBuffer1.method2504(class41.password);
            Client.secretCipherBuffer1.method2483(class39.rsaKeyExponent, class39.rsaKeyModulus);
            ...
            Client.field326.putBytes(Client.secretCipherBuffer1.payload, 0, Client.secretCipherBuffer1.offset);
         ...
         if(Client.loginState == 8) {
            ...
            if(Client.loginState == 9 && Friend.rssocket.available() >= 13) {
               ...
               Friend.rssocket.read(Client.secretCipherBuffer2.payload, 0, 4);
               Client.secretCipherBuffer2.offset = 0;
               boolean var10 = false;
               if(var11) {
            ...
            if(Client.loginState == 10) {
               ...
               if(Client.loginState == 11 && Friend.rssocket.available() >= 2) {
                  ...
                  Friend.rssocket.read(Client.secretCipherBuffer2.payload, 0, 2);
                  Client.secretCipherBuffer2.offset = 0;
                  class10.field111 = Client.secretCipherBuffer2.readUnsignedShort();
                  Client.loginState = 12;
               }

               if(Client.loginState == 12 && Friend.rssocket.available() >= class10.field111) {
                  Client.secretCipherBuffer2.offset = 0;
                  Friend.rssocket.read(Client.secretCipherBuffer2.payload, 0, class10.field111);
                  Client.secretCipherBuffer2.offset = 0;
