...
public enum class4 implements RSEnum {
   @ObfuscatedName("p")
   field33(0, 0, Integer.class, new class2()),
   @ObfuscatedName("m")
   field28(2, 1, Long.class, new class3()),
   @ObfuscatedName("e")
   field30(1, 2, String.class, new class5());
   ...
   static final void method12(Player var0, int var1, int var2, int var3) {
      if(class20.localPlayer != var0 && Client.menuOptionCount < 400) {
         String var4;
