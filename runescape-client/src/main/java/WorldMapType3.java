...
public class WorldMapType3 implements WorldMapSectionBase {
   ...
   static int method199(Widget var0) {
      class198 var1 = (class198)Client.widgetFlags.method3530((long)var0.index + ((long)var0.id << 32));
      return var1 != null?var1.field2487:var0.field2694;
   }
   ...
   static final void method200(Actor var0, int var1, int var2, int var3, int var4, int var5) {
      if(var0 != null && var0.vmethod1695()) {
         ...
         if(!var0.combatInfoList.method3550()) {
            GraphicsObject.method1678(var0, var0.field1288 + 15);
            ...
            for(CombatInfoListHolder var9 = (CombatInfoListHolder)var0.combatInfoList.method3547(); var9 != null; var9 = (CombatInfoListHolder)var0.combatInfoList.method3558()) {
               ...
               if(var10 == null) {
                  ...
                  var20 = var2 + Client.field1031 - (var14 >> 1);
                  var21 = var3 + Client.field992 - var8;
                  if(var12 != null && var13 != null) {
                     var20 -= var15;
                     if(var88 == var14) {
                        var88 += var15 * 2;
                     ...
                     if(var16 >= 0 && var16 < 255) {
                        ...
                        Rasterizer2D.method4925(var20, var21, var88 + var20, var22 + var21);
                     ...
                     Rasterizer2D.method4999(var2, var3, var2 + var4, var3 + var5);
                     var8 += 2;
                  } else {
                     if(Client.field1031 > -1) {
         ...
         if(var1 < var74) {
            ...
            if(var85.skullIcon != -1 || var85.overheadIcon != -1) {
               ...
               if(Client.field1031 > -1) {
                  if(var85.skullIcon != -1) {
                     class182.field2442[var85.skullIcon].method5042(var2 + Client.field1031 - 12, var3 + Client.field992 - var8);
                     var8 += 25;
                  }

                  if(var85.overheadIcon != -1) {
                     Friend.field820[var85.overheadIcon].method5042(var2 + Client.field1031 - 12, var3 + Client.field992 - var8);
                     var8 += 25;
                  }
               }
            }
            ...
            if(var1 >= 0 && Client.field943 == 10 && var7[var1] == Client.field1183) {
               GraphicsObject.method1678(var0, var0.field1288 + 15);
               if(Client.field1031 > -1) {
                  class43.field601[1].method5042(var2 + Client.field1031 - 12, var3 + Client.field992 - var8);
               }
            }
         } else {
            NPCComposition var86 = ((NPC)var0).composition;
            if(var86.configs != null) {
               var86 = var86.method4646();
            }

            if(var86.field3583 >= 0 && var86.field3583 < Friend.field820.length) {
               GraphicsObject.method1678(var0, var0.field1288 + 15);
               if(Client.field1031 > -1) {
                  Friend.field820[var86.field3583].method5042(var2 + Client.field1031 - 12, var3 + Client.field992 - 30);
               }
            }
            ...
            if(Client.field943 == 1 && Client.npcIndices[var1 - var74] == Client.field944 && Client.gameCycle % 20 < 10) {
               GraphicsObject.method1678(var0, var0.field1288 + 15);
               if(Client.field1031 > -1) {
                  class43.field601[0].method5042(var2 + Client.field1031 - 12, var3 + Client.field992 - 28);
               }
            }
         }

         if(var0.overhead != null && (var1 >= var74 || !var0.inSequence && (Client.field1143 == 4 || !var0.field1284 && (Client.field1143 == 0 || Client.field1143 == 3 || Client.field1143 == 1 && class25.method167(((Player)var0).name, false))))) {
            GraphicsObject.method1678(var0, var0.field1288);
            if(Client.field1031 > -1 && Client.field1046 < Client.field1020) {
               Client.field1024[Client.field1046] = World.field1322.method4773(var0.overhead) / 2;
               Client.field1009[Client.field1046] = World.field1322.field3649;
               Client.field1021[Client.field1046] = Client.field1031;
               Client.field1022[Client.field1046] = Client.field992;
         ...
         for(int var75 = 0; var75 < 4; ++var75) {
            ...
            if(var76 - var78 <= Client.gameCycle) {
               if(var87 == null) {
                  ...
                  GraphicsObject.method1678(var0, var0.field1288 / 2);
                  if(Client.field1031 > -1) {
                     if(var75 == 1) {
                        Client.field992 -= 20;
                     }
                     ...
                     boolean var46 = false;
                     int var47 = 0;
                     var44 = var87.method4482(var0.field1259[var75]);
                     ...
                     int var62 = var87.field3433 - var87.field3433 * var61 / var87.field3428;
                     int var63 = var87.field3434 * var61 / var87.field3428 + -var87.field3434;
                     int var64 = var2 + Client.field1031 - (var50 >> 1) + var62;
                     int var65 = var3 + Client.field992 - 12 + var63;
                     int var66 = var65;
                     int var67 = var41 + var65;
                     int var68 = var87.field3440 + var65 + 15;
                     int var69 = var68 - var84.field3650;
                     int var70 = var84.field3651 + var68;
                     if(var69 < var65) {
                        var66 = var69;
                     }
                     ...
                     if(var79 != null) {
                        ...
                        var72 = var71 - var43.field3650;
                        var73 = var43.field3651 + var71;
                        if(var72 < var66) {
                           ;
                        }
                     ...
                     if(var72 >= 0 && var72 < 255) {
                        ...
                        if(var81 != null) {
                           for(var73 = 0; var73 < var48; ++var73) {
                              var81.method5057(var64 + var53 - var26 + var73 * var22, var65, var72);
                           }
                        }

                        if(var83 != null) {
                           var83.method5057(var64 + var55 - var28, var65, var72);
                        }
                        ...
                        if(var79 != null) {
                           ...
                           if(var31 != null) {
                              var31.method5057(var57 + var64 - var39, var65, var72);
                           }

                           if(var30 != null) {
                              for(var73 = 0; var73 < var49; ++var73) {
                                 var30.method5057(var64 + var58 - var38 + var73 * var34, var65, var72);
                              }
                           }
                        ...
                        if(var82 != null) {
                           var82.method5042(var52 + var64 - var27, var65);
                        }

                        if(var81 != null) {
                           for(var73 = 0; var73 < var48; ++var73) {
                              var81.method5042(var64 + var53 - var26 + var73 * var22, var65);
                           }
                        }

                        if(var83 != null) {
                           var83.method5042(var64 + var55 - var28, var65);
                        }

                        var84.method4790(var44, var54 + var64, var68, var87.field3438 | -16777216, 0);
                        if(var79 != null) {
                           if(var29 != null) {
                           ...
                           if(var30 != null) {
                              for(var73 = 0; var73 < var49; ++var73) {
                                 var30.method5042(var64 + var58 - var38 + var73 * var34, var65);
                              }
                           }
   ...
   static final void method202(int var0, int var1, int var2, boolean var3) {
      if(class66.method1121(var0)) {
         class69.method1131(class46.widgets[var0], -1, var1, var2, var3);
      }
   }
}
