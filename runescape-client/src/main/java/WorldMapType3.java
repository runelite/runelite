...
public class WorldMapType3 implements WorldMapSectionBase {
   ...
   public boolean vmethod678(int var1, int var2, int var3) {
      return var1 >= this.field394 && var1 < this.field389 + this.field394?var2 >= (this.field390 << 6) + (this.field400 << 3) && var2 <= (this.field390 << 6) + (this.field396 << 3) + 7 && var3 >= (this.field398 << 6) + (this.field395 << 3) && var3 <= (this.field398 << 6) + (this.field397 << 3) + 7:false;
   }
   ...
   public boolean vmethod679(int var1, int var2) {
      return var1 >= (this.field391 << 6) + (this.field388 << 3) && var1 <= (this.field391 << 6) + (this.field392 << 3) + 7 && var2 >= (this.field393 << 6) + (this.field399 << 3) && var2 <= (this.field393 << 6) + (this.field401 << 3) + 7;
   }
   ...
   public Coordinates vmethod685(int var1, int var2) {
      if(!this.vmethod679(var1, var2)) {
         ...
         int var3 = this.field400 * 8 - this.field388 * 8 + var1 + (this.field390 * 64 - this.field391 * 64);
   ...
   public int[] vmethod682(int var1, int var2, int var3) {
      if(!this.vmethod678(var1, var2, var3)) {
         ...
         int[] var4 = new int[]{this.field388 * 8 - this.field400 * 8 + this.field391 * 64 - this.field390 * 64 + var2, this.field399 * 8 - this.field395 * 8 + var3 + (this.field393 * 64 - this.field398 * 64)};
         return var4;
      }
   }
