...
public class class1 {
         ...
         if((client.field550 < 100 || client.field402 == 1) && client.field550 < 400) {
            ...
            if(null != var2) {
               ...
               for(var3 = 0; var3 < client.field550; ++var3) {
                  class7 var6 = client.field344[var3];
                  var4 = class32.method690(var6.field133, field24);
                  if(null != var4 && var4.equals(var2)) {
                     class125.method2783(31, "", var0 + " is already on your ignore list");
                     return;
                  }

                  if(var6.field135 != null) {
                     var5 = class32.method690(var6.field135, field24);
               ...
               for(var3 = 0; var3 < client.field499; ++var3) {
                  ...
                  var4 = class32.method690(var7.field247, field24);
                  ...
                  if(var7.field240 != null) {
                     var5 = class32.method690(var7.field240, field24);
   ...
   public static void method8(int var0) {
      if(var0 != -1 && class173.field2838[var0]) {
