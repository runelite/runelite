...
public class class101 extends RuntimeException {
   ...
   static int method2020(int var0, Script var1, boolean var2) {
      ...
      if(var0 == 3400) {
         ...
         var4 = class32.scriptIntStack[class103.scriptIntStackSize + 1];
         ...
         for(var6 = 0; var6 < var5.field2858; ++var6) {
            if(var5.field2862[var6] == var4) {
               class32.scriptStringStack[++class32.scriptStringStackSize - 1] = var5.field2860[var6];
               var5 = null;
               break;
            }
         }
         ...
         if(var5 != null) {
            class32.scriptStringStack[++class32.scriptStringStackSize - 1] = var5.field2861;
         }
         ...
         var3 = class32.scriptIntStack[class103.scriptIntStackSize];
         var4 = class32.scriptIntStack[class103.scriptIntStackSize + 1];
         int var9 = class32.scriptIntStack[2 + class103.scriptIntStackSize];
         var6 = class32.scriptIntStack[3 + class103.scriptIntStackSize];
         ...
         if(var7.field2856 == var3 && var7.field2857 == var4) {
            for(int var8 = 0; var8 < var7.field2858; ++var8) {
               if(var6 == var7.field2862[var8]) {
                  if(var4 == 115) {
                     class32.scriptStringStack[++class32.scriptStringStackSize - 1] = var7.field2860[var8];
                  } else {
                     class32.scriptIntStack[++class103.scriptIntStackSize - 1] = var7.field2865[var8];
                  }
            ...
            if(null != var7) {
               if(var4 == 115) {
                  class32.scriptStringStack[++class32.scriptStringStackSize - 1] = var7.field2861;
               } else {
                  class32.scriptIntStack[++class103.scriptIntStackSize - 1] = var7.field2863;
               }
            }
