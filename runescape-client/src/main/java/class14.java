...
public class class14 {
   ...
   public final GrandExchangeOffer field274;
   @ObfuscatedName("z")
   String field277;
   @ObfuscatedName("v")
   String field276;
   ...
   class14(Buffer var1, byte var2, int var3) {
      ...
      this.field276 = var1.readString();
      this.field280 = var1.readUnsignedShort();
      this.field273 = var1.readLong();
      int var4 = var1.readInt();
      int var5 = var1.readInt();
      this.field274 = new GrandExchangeOffer();
      this.field274.method111(2);
      this.field274.method112(var2);
      this.field274.price = var4;
      this.field274.totalQuantity = var5;
      this.field274.quantitySold = 0;
      this.field274.spent = 0;
      this.field274.itemId = var3;
   }
   ...
   public static void method89(String var0, String var1, int var2, int var3) throws IOException {
      ...
      while(var4 < 4) {
         ...
         class46.field567 = new File(Enum.userHome, "jagex_cl_" + var0 + "_" + var1 + var6 + ".dat");
         String var7 = null;
         String var8 = null;
         boolean var9 = false;
         Buffer var11;
         File var34;
         if(class46.field567.exists()) {
            try {
               FileOnDisk var10 = new FileOnDisk(class46.field567, "rw", 10000L);
         ...
         if(var9) {
            ...
            try {
               FileOnDisk var37 = new FileOnDisk(class46.field567, "rw", 10000L);
      ...
      if(!class158.field2163.exists()) {
         ...
         class8.method40();
         class156.field2157 = new CacheFile(new FileOnDisk(class1.method2("main_file_cache.dat2"), "rw", 1048576000L), 5200, 0);
         class156.field2154 = new CacheFile(new FileOnDisk(class1.method2("main_file_cache.idx255"), "rw", 1048576L), 6000, 0);
         ItemContainer.field751 = new CacheFile[class156.field2153];

         for(int var5 = 0; var5 < class156.field2153; ++var5) {
            ItemContainer.field751[var5] = new CacheFile(new FileOnDisk(class1.method2("main_file_cache.idx" + var5), "rw", 1048576L), 6000, 0);
         }
