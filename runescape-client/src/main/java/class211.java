...
public class class211 {
   ...
   static final void method3906(int var0, int var1, int var2, int var3, int var4, int var5, Region var6, CollisionData var7) {
      if(!Client.field930 || (class61.tileSettings[0][var1][var2] & 2) != 0 || (class61.tileSettings[var0][var1][var2] & 16) == 0) {
         ...
         if(var8.method4524()) {
            ...
            class82.field1349.method3603(var21);
         ...
         Object var30;
         if(var5 == 22) {
            if(!Client.field930 || var8.field3488 != 0 || var8.field3463 == 1 || var8.field3474) {
               if(var8.animationId == -1 && var8.impostorIds == null) {
                  var30 = var8.method4513(22, var4, var15, var17, var16, var18);
               } else {
               ...
               if(var8.field3463 == 1 && var7 != null) {
                  var7.method3019(var1, var2);
               }
            ...
            if(var5 >= 12) {
               if(var8.animationId == -1 && var8.impostorIds == null) {
                  var30 = var8.method4513(var5, var4, var15, var17, var16, var18);
               } else {
               ...
               if(var8.field3463 != 0 && var7 != null) {
                  var7.method3008(var1, var2, var9, var10, var8.field3456);
               }

            } else if(var5 == 0) {
               if(var8.animationId == -1 && var8.impostorIds == null) {
                  var30 = var8.method4513(0, var4, var15, var17, var16, var18);
               } else {
                  var30 = new DynamicObject(var3, 0, var4, var0, var1, var2, var8.animationId, true, (Renderable)null);
               }

               var6.method2675(var0, var1, var2, var16, (Renderable)var30, (Renderable)null, class61.field775[var4], 0, var19, var20);
               if(var4 == 0) {
                  if(var8.field3477) {
               ...
               if(var8.field3463 != 0 && var7 != null) {
                  var7.method3023(var1, var2, var5, var4, var8.field3456);
               }
               ...
               if(var8.animationId == -1 && var8.impostorIds == null) {
                  var30 = var8.method4513(1, var4, var15, var17, var16, var18);
               } else {
                  var30 = new DynamicObject(var3, 1, var4, var0, var1, var2, var8.animationId, true, (Renderable)null);
               }

               var6.method2675(var0, var1, var2, var16, (Renderable)var30, (Renderable)null, class61.field776[var4], 0, var19, var20);
               if(var8.field3477) {
                  if(var4 == 0) {
                     class61.field771[var0][var1][var2 + 1] = 50;
                  } else if(var4 == 1) {
               ...
               if(var5 == 2) {
                  ...
                  Object var27;
                  if(var8.animationId == -1 && var8.impostorIds == null) {
                     var27 = var8.method4513(2, var4 + 4, var15, var17, var16, var18);
                     var28 = var8.method4513(2, var26, var15, var17, var16, var18);
                  } else {
                  ...
                  var6.method2675(var0, var1, var2, var16, (Renderable)var27, (Renderable)var28, class61.field775[var4], class61.field775[var26], var19, var20);
                  if(var8.clipped) {
                     if(var4 == 0) {
                        class39.field555[var0][var1][var2] |= 585;
                        class39.field555[var0][var1][1 + var2] |= 1170;
                  ...
                  if(var8.animationId == -1 && var8.impostorIds == null) {
                     var30 = var8.method4513(3, var4, var15, var17, var16, var18);
                  } else {
                  ...
                  if(var8.animationId == -1 && var8.impostorIds == null) {
                     var30 = var8.method4513(4, var4, var15, var17, var16, var18);
                  } else {
                     var30 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                  }

                  var6.method2676(var0, var1, var2, var16, (Renderable)var30, (Renderable)null, class61.field775[var4], 0, 0, 0, var19, var20);
               } else if(var5 == 5) {
                  var26 = 16;
                  ...
                  if(var8.animationId == -1 && var8.impostorIds == null) {
                     var28 = var8.method4513(4, var4, var15, var17, var16, var18);
                  } else {
                     var28 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                  }

                  var6.method2676(var0, var1, var2, var16, (Renderable)var28, (Renderable)null, class61.field775[var4], 0, var26 * class61.field777[var4], var26 * class61.field778[var4], var19, var20);
               } else if(var5 == 6) {
                  var26 = 8;
                  var22 = var6.method2692(var0, var1, var2);
                  if(var22 != 0) {
                  ...
                  if(var8.animationId == -1 && var8.impostorIds == null) {
                     var28 = var8.method4513(4, var4 + 4, var15, var17, var16, var18);
                  } else {
                     var28 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                  }

                  var6.method2676(var0, var1, var2, var16, (Renderable)var28, (Renderable)null, 256, var4, var26 * class61.field772[var4], var26 * class61.field786[var4], var19, var20);
               } else if(var5 == 7) {
                  var22 = var4 + 2 & 3;
                  if(var8.animationId == -1 && var8.impostorIds == null) {
                     var30 = var8.method4513(4, var22 + 4, var15, var17, var16, var18);
                  } else {
                     var30 = new DynamicObject(var3, 4, var22 + 4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                  }

                  var6.method2676(var0, var1, var2, var16, (Renderable)var30, (Renderable)null, 256, var22, 0, 0, var19, var20);
               } else if(var5 == 8) {
                  var26 = 8;
                  var22 = var6.method2692(var0, var1, var2);
                  if(var22 != 0) {
                  ...
                  if(var8.animationId == -1 && var8.impostorIds == null) {
                     var28 = var8.method4513(4, var4 + 4, var15, var17, var16, var18);
                     var29 = var8.method4513(4, var25 + 4, var15, var17, var16, var18);
                  } else {
                     var28 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                     var29 = new DynamicObject(var3, 4, var25 + 4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                  }

                  var6.method2676(var0, var1, var2, var16, (Renderable)var28, (Renderable)var29, 256, var4, var26 * class61.field772[var4], var26 * class61.field786[var4], var19, var20);
               }
            }
         } else {
            if(var8.animationId == -1 && var8.impostorIds == null) {
               var30 = var8.method4513(10, var4, var15, var17, var16, var18);
            } else {
               var30 = new DynamicObject(var3, 10, var4, var0, var1, var2, var8.animationId, true, (Renderable)null);
            }

            if(var30 != null && var6.method2679(var0, var1, var2, var16, var9, var10, (Renderable)var30, var5 == 11?256:0, var19, var20) && var8.field3477) {
               var22 = 15;
   ...
   public static class240 method3908(int var0) {
      class240 var1 = (class240)class240.field3286.get((long)var0);
      if(var1 != null) {
         return var1;
      } else {
         byte[] var2 = class240.field3285.getConfigData(5, var0);
         var1 = new class240();
         if(var2 != null) {
            var1.method4271(new Buffer(var2));
         }

         class240.field3286.put(var1, (long)var0);
         return var1;
      }
   }
}
