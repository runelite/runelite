...
public final class ItemLayer {
   ...
   static int method2507(int var0, Script var1, boolean var2) {
      ...
      if(var0 == 6600) {
         ...
         if(var0 == 6601) {
            ...
            class82.intStack[++GrandExchangeEvents.intStackSize - 1] = ScriptState.method1094().method5415();
            return 1;
         } else if(var0 == 6604) {
            var3 = class82.intStack[--GrandExchangeEvents.intStackSize];
            ...
            class82.intStack[++GrandExchangeEvents.intStackSize - 1] = ScriptState.method1094().method5417()?1:0;
            return 1;
         } else {
            Coordinates var15;
            if(var0 == 6606) {
               var15 = new Coordinates(class82.intStack[--GrandExchangeEvents.intStackSize]);
               ...
               class82.intStack[++GrandExchangeEvents.intStackSize - 1] = ScriptState.method1094().method5470();
               class82.intStack[++GrandExchangeEvents.intStackSize - 1] = ScriptState.method1094().method5424();
               return 1;
            } else {
               WorldMapData var13;
               if(var0 == 6611) {
                  ...
                  if(var13 == null) {
                     ...
                     class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var13.method356().method4109();
                  }
                  ...
                  if(var13 == null) {
                     ...
                     class82.intStack[++GrandExchangeEvents.intStackSize - 1] = (var13.method288() - var13.method287() + 1) * 64;
                     class82.intStack[++GrandExchangeEvents.intStackSize - 1] = (var13.method290() - var13.method289() + 1) * 64;
                  }
                  ...
                  if(var13 == null) {
                     ...
                     class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var13.method287() * 64;
                     class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var13.method289() * 64;
                     class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var13.method288() * 64 + 64 - 1;
                     class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var13.method290() * 64 + 64 - 1;
                  }
                  ...
                  if(var13 == null) {
                     ...
                     class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var13.method286();
                  }
                  ...
                  if(var15 == null) {
                     ...
                     class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var15.worldX;
                     class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var15.worldY;
                  }

                  return 1;
               } else if(var0 == 6616) {
                  class82.intStack[++GrandExchangeEvents.intStackSize - 1] = ScriptState.method1094().method5555();
                  return 1;
               } else if(var0 == 6617) {
                  var15 = new Coordinates(class82.intStack[--GrandExchangeEvents.intStackSize]);
                  ...
                  if(var13 == null) {
                     ...
                     if(var14 == null) {
                        ...
                        class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var14[0];
                        class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var14[1];
                     }
                  ...
                  if(var0 == 6618) {
                     ...
                     if(var13 == null) {
                        ...
                        if(var7 == null) {
                           ...
                           class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var7.method4109();
                        }
                     ...
                     if(var0 == 6619) {
                        ...
                        var3 = class82.intStack[GrandExchangeEvents.intStackSize];
                        var12 = new Coordinates(class82.intStack[GrandExchangeEvents.intStackSize + 1]);
                        ...
                        if(var11 == null) {
                           ...
                           class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var11.method276(var12.plane, var12.worldX, var12.worldY)?1:0;
                           return 1;
                        }
                     } else if(var0 == 6622) {
                        class82.intStack[++GrandExchangeEvents.intStackSize - 1] = ScriptState.method1094().method5426();
                        class82.intStack[++GrandExchangeEvents.intStackSize - 1] = ScriptState.method1094().method5427();
                        return 1;
                     } else if(var0 == 6623) {
                        var15 = new Coordinates(class82.intStack[--GrandExchangeEvents.intStackSize]);
                        ...
                        if(var13 == null) {
                           ...
                           class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var13.method281();
                        }

                        return 1;
                     } else if(var0 == 6624) {
                        ScriptState.method1094().method5428(class82.intStack[--GrandExchangeEvents.intStackSize]);
                        return 1;
                     } else if(var0 == 6625) {
                        ScriptState.method1094().method5429();
                        return 1;
                     } else if(var0 == 6626) {
                        ScriptState.method1094().method5435(class82.intStack[--GrandExchangeEvents.intStackSize]);
                        return 1;
                     } else if(var0 == 6627) {
                        ...
                        if(var0 == 6628) {
                           ...
                           if(var0 == 6633) {
                              GrandExchangeEvents.intStackSize -= 2;
                              var3 = class82.intStack[GrandExchangeEvents.intStackSize];
                              var4 = class82.intStack[GrandExchangeEvents.intStackSize + 1] == 1;
                              ...
                              class82.intStack[++GrandExchangeEvents.intStackSize - 1] = ScriptState.method1094().method5439()?1:0;
                              return 1;
                           } else if(var0 == 6636) {
                              var3 = class82.intStack[--GrandExchangeEvents.intStackSize];
                              class82.intStack[++GrandExchangeEvents.intStackSize - 1] = ScriptState.method1094().method5518(var3)?1:0;
                              return 1;
                           } else if(var0 == 6637) {
                              var3 = class82.intStack[--GrandExchangeEvents.intStackSize];
                              class82.intStack[++GrandExchangeEvents.intStackSize - 1] = ScriptState.method1094().method5474(var3)?1:0;
                              return 1;
                           } else if(var0 == 6638) {
                              GrandExchangeEvents.intStackSize -= 2;
                              var3 = class82.intStack[GrandExchangeEvents.intStackSize];
                              ...
                              if(var0 == 6639) {
                                 ...
                                 if(var8 == null) {
                                    ...
                                    class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var8.field513;
                                    class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var8.field506.method4109();
                                 }
                                 ...
                                 if(var0 == 6693) {
                                    ...
                                    var3 = class82.intStack[--GrandExchangeEvents.intStackSize];
                                    var6 = Area.mapAreaType[var3];
                                    class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var6.field3371;
                                    return 1;
                                 } else if(var0 == 6695) {
                                    var3 = class82.intStack[--GrandExchangeEvents.intStackSize];
                                    var6 = Area.mapAreaType[var3];
                                    if(var6 == null) {
                                       ...
                                       class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var6.field3384;
                                    }
                                    ...
                                    if(var6 == null) {
                                       ...
                                       class82.intStack[++GrandExchangeEvents.intStackSize - 1] = var6.spriteId;
                                    }

                                    return 1;
                                 } else if(var0 == 6697) {
                                    class82.intStack[++GrandExchangeEvents.intStackSize - 1] = class28.field380.field572;
                                    return 1;
                                 } else if(var0 == 6698) {
                                    class82.intStack[++GrandExchangeEvents.intStackSize - 1] = class28.field380.field575.method4109();
                                    return 1;
                                 } else if(var0 == 6699) {
                                    class82.intStack[++GrandExchangeEvents.intStackSize - 1] = class28.field380.field574.method4109();
                                    return 1;
                                 } else {
                                    return 2;
                                 }
   ...
   static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
      ...
      if(var2 == 1) {
         ...
         var8.packetBuffer.writeIntME(class214.field2675);
         var8.packetBuffer.writeShortLE(Occluder.baseY + var1);
         ...
         var8.packetBuffer.writeIntLE(class37.field489);
         ...
         var8.packetBuffer.writeShortLE(var0 + IndexDataBase.baseX);
         ...
         if(var2 == 7) {
            ...
            if(var21 != null) {
               ...
               var16.packetBuffer.writeShortLE(class34.selectedItemIndex);
               var16.packetBuffer.method3307(KeyFocusListener.field606[82]?1:0);
               var16.packetBuffer.writeShortLE(class94.field1409);
               var16.packetBuffer.writeIntLE(class214.field2675);
            ...
            if(var21 != null) {
               ...
               var16.packetBuffer.writeIntLE16(class37.field489);
            ...
            if(var2 == 14) {
               ...
               if(var24 != null) {
                  ...
                  var16.packetBuffer.writeIntLE16(class214.field2675);
                  Client.field916.method1925(var16);
               }
            } else if(var2 == 15) {
               var24 = Client.cachedPlayers[var3];
               if(var24 != null) {
                  ...
                  var16.packetBuffer.writeShortLE(var3);
                  var16.packetBuffer.method3343(KeyFocusListener.field606[82]?1:0);
                  var16.packetBuffer.writeIntME(class37.field489);
                  Client.field916.method1925(var16);
               }
            } else if(var2 == 16) {
               Client.field1064 = var6;
               ...
               var8.packetBuffer.writeShortLE(Client.field917);
               var8.packetBuffer.writeShortLE(var0 + IndexDataBase.baseX);
               var8.packetBuffer.writeShortLE(Occluder.baseY + var1);
               Client.field916.method1925(var8);
            } else if(var2 == 18) {
               ...
               if(Client.isMenuOpen) {
                  GrandExchangeEvent.region.method2834();
               } else {
                  GrandExchangeEvent.region.method2970(class233.plane, var0, var1, true);
               }
            } else {
               PacketNode var10;
               Widget var26;
               if(var2 == 24) {
                  var26 = class87.getWidget(var1);
                  boolean var9 = true;
                  ...
                  if(var2 == 25) {
                     ...
                     if(var26 != null) {
                        ...
                        Client.lastSelectedSpellActionName = DecorativeObject.method3017(var26);
                        if(Client.lastSelectedSpellActionName == null) {
                           Client.lastSelectedSpellActionName = "Null";
                        }

                        if(var26.hasScript) {
                           Client.lastSelectedSpellName = var26.name + ISAACCipher.getColTags(16777215);
                        } else {
                           Client.lastSelectedSpellName = ISAACCipher.getColTags(65280) + var26.spellName + ISAACCipher.getColTags(16777215);
                        }
                     }
                  ...
                  if(var2 == 26) {
                     ...
                     if(var2 == 28) {
                        ...
                        if(Client.field1018 == null) {
                           ...
                           Client.field1018 = MilliTimer.getWidgetChild(var1, var0);
                        ...
                        SoundTaskDataProvider.field622 = class87.getWidget(var1);
                        ...
                        var8.packetBuffer.writeIntME(class37.field489);
                        var8.packetBuffer.putShortLE(var3);
                        Client.field916.method1925(var8);
                        Client.mouseCrosshair = 0;
                        SoundTaskDataProvider.field622 = class87.getWidget(var1);
                        ...
                        if(var2 == 38) {
                           ...
                           Client.lastSelectedItemName = ISAACCipher.getColTags(16748608) + WorldMapType2.getItemDefinition(var3).name + ISAACCipher.getColTags(16777215);
                        ...
                        if(var2 == 39) {
                           ...
                           if(var2 == 58) {
                              ...
                              SoundTaskDataProvider.field622 = class87.getWidget(var1);
                              Client.field966 = var0;
                           } else if(var2 == 1012 || var2 == 1008 || var2 == 1010 || var2 == 1009 || var2 == 1011) {
                           ...
                           if(var26 != null) {
                              var22 = var26.itemId;
                              Widget var23 = MilliTimer.getWidgetChild(var1, var0);
                              if(var23 != null) {
                                 if(var23.field2803 != null) {
                                    ...
                                    var18.field806 = var3;
                                    var18.string = var5;
                                    var18.objs = var23.field2803;
                                    GrandExchangeEvent.method95(var18);
                                 }
      ...
      if(Client.itemSelectionState != 0) {
         Client.itemSelectionState = 0;
         class40.method556(class87.getWidget(class214.field2675));
      }
      ...
      if(SoundTaskDataProvider.field622 != null && Client.mouseCrosshair == 0) {
