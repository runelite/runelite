...
public class Rasterizer3D extends Rasterizer2D {
	@ObfuscatedName("f")
	static boolean field1751;
	@ObfuscatedName("i")
	static boolean field1758;
	@ObfuscatedName("y")
	...
	@ObfuscatedName("w")
	public static final void method3086(int var0, int var1) {
	...
	public static void method3078(int var0, int var1, int var2) {
		field1751 = var0 < 0 || var0 > Rasterizer3D_clipWidth || var1 < 0 || var1 > Rasterizer3D_clipWidth || var2 < 0 || var2 > Rasterizer3D_clipWidth;
	}

	@ObfuscatedName("d")
	static final void method3000(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		int var9 = var4 - var3;
		int var10 = var1 - var0;
		int var11 = var5 - var3;
		int var12 = var2 - var0;
	...
	@ObfuscatedName("o")
	public static final void method3008(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		int var7 = 0;
		if (var0 != var1) {
	...
	@ObfuscatedName("t")
	static final void method3010(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
		int[] var19 = Rasterizer3D_textureLoader.getTexturePixels(var18);
		int var20;
		if (var19 == null) {
			var20 = Rasterizer3D_textureLoader.getAverageTextureRGB(var18);
			method3000(var0, var1, var2, var3, var4, var5, method3014(var20, var6), method3014(var20, var7), method3014(var20, var8));
		} else {
			Rasterizer3D_isLowDetailTexture = Rasterizer3D_textureLoader.isLowDetail(var18);
			field1758 = Rasterizer3D_textureLoader.vmethod3284(var18);
			var20 = var4 - var3;
			int var21 = var1 - var0;
			int var22 = var5 - var3;
			int var23 = var2 - var0;
	...
	@ObfuscatedName("z")
	static final int method3014(int var0, int var1) {
	...
	@ObfuscatedName("h")
	static final int method3015(int var0, int var1, int var2, int var3) {
		return var0 * var2 + var3 * var1 >> 16;
	}

	@ObfuscatedName("m")
	static final int method3016(int var0, int var1, int var2, int var3) {
		return var2 * var1 - var3 * var0 >> 16;
	}

	@ObfuscatedName("aa")
	static final int method3017(int var0, int var1, int var2, int var3) {
		return var0 * var2 - var3 * var1 >> 16;
	}

	@ObfuscatedName("av")
	static final int method3083(int var0, int var1, int var2, int var3) {
		return var3 * var0 + var2 * var1 >> 16;
	}

	@ObfuscatedName("aw")
	static final int method3019(int var0, int var1, int var2, int var3) {
		return var0 * var2 + var3 * var1 >> 16;
	}

	@ObfuscatedName("as")
	static final int method3020(int var0, int var1, int var2, int var3) {
		return var2 * var1 - var3 * var0 >> 16;
	}
}
