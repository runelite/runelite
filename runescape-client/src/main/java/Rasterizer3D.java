...
public class Rasterizer3D extends Rasterizer2D {
	...
	@ObfuscatedName("e")
	public static boolean field1762;
	@ObfuscatedName("i")
	...
	static {
		...
		field1777 = new int[512];
		field1778 = new int[2048];
		Rasterizer3D_sine = new int[2048];
		Rasterizer3D_cosine = new int[2048];

		int var0;
		for (var0 = 1; var0 < 512; ++var0) {
			field1777[var0] = 32768 / var0;
		}

		for (var0 = 1; var0 < 2048; ++var0) {
			field1778[var0] = 65536 / var0;
		}
	...
	static final void Rasterizer3D_setClip(int var0, int var1, int var2, int var3) {
		...
		if (Rasterizer3D_rowOffsets.length < Rasterizer3D_clipHeight) {
			Rasterizer3D_rowOffsets = new int[DynamicObject.method2293(Rasterizer3D_clipHeight)];
		}
	...
	@ObfuscatedName("e")
	public static final void method3101(int var0, int var1) {
	...
	@ObfuscatedName("j")
	public static void method3066(int var0, int var1, int var2) {
		field1761 = var0 < 0 || var0 > Rasterizer3D_clipWidth || var1 < 0 || var1 > Rasterizer3D_clipWidth || var2 < 0 || var2 > Rasterizer3D_clipWidth;
	}

	@ObfuscatedName("m")
	static final void method3116(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		int var9 = var4 - var3;
		int var10 = var1 - var0;
		int var11 = var5 - var3;
		int var12 = var2 - var0;
	...
	@ObfuscatedName("h")
	public static final void method3123(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		int var7 = 0;
		if (var0 != var1) {
	...
	@ObfuscatedName("n")
	static final void method3078(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
		int[] var19 = Rasterizer3D_textureLoader.getTexturePixels(var18);
		int var20;
		if (var19 == null) {
			var20 = Rasterizer3D_textureLoader.getAverageTextureRGB(var18);
			method3116(var0, var1, var2, var3, var4, var5, method3082(var20, var6), method3082(var20, var7), method3082(var20, var8));
		} else {
			Rasterizer3D_isLowDetailTexture = Rasterizer3D_textureLoader.isLowDetail(var18);
			field1755 = Rasterizer3D_textureLoader.vmethod3347(var18);
			var20 = var4 - var3;
			int var21 = var1 - var0;
			int var22 = var5 - var3;
			int var23 = var2 - var0;
	...
	@ObfuscatedName("z")
	static final int method3082(int var0, int var1) {
	...
	@ObfuscatedName("a")
	static final int method3112(int var0, int var1, int var2, int var3) {
		return var0 * var2 - var3 * var1 >> 16;
	}

	@ObfuscatedName("u")
	static final int method3086(int var0, int var1, int var2, int var3) {
		return var3 * var0 + var2 * var1 >> 16;
	}

	@ObfuscatedName("ae")
	static final int method3087(int var0, int var1, int var2, int var3) {
		return var0 * var2 + var3 * var1 >> 16;
	}
