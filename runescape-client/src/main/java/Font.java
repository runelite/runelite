...
public final class Font extends FontTypeFace {
   ...
   final void vmethod3896(byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      if(var3 + var5 > Rasterizer2D.field3189) {
         var5 -= var3 + var5 - Rasterizer2D.field3189;
      }

      if(var2 < Rasterizer2D.field3193) {
         var12 = Rasterizer2D.field3193 - var2;
         var4 -= var12;
   ...
   @ObfuscatedName("f")
   final void vmethod3915(byte[] var1, int var2, int var3, int var4, int var5, int var6) {
