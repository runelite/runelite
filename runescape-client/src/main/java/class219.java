...
public class class219 extends CacheableNode {
   ...
   public static void method3891() {
      field3175 = 0;
      field3171 = 0;
      field3176 = graphicsPixelsWidth;
      field3173 = graphicsPixelsHeight;
   }

   @ObfuscatedName("cs")
   public static void method3893(int var0, int var1, int var2, int var3) {
      if(var0 < 0) {
         var0 = 0;
      }
   ...
   @ObfuscatedName("cf")
   public static void method3894(int var0, int var1, int var2, int var3) {
      if(field3175 < var0) {
         field3175 = var0;
      }
   ...
   public static void setRasterBuffer(int[] var0, int var1, int var2) {
      ...
      method3893(0, 0, var1, var2);
   }

   @ObfuscatedName("cz")
   public static void method3898(int var0, int var1, int var2, int var3, int var4, int var5) {
      if(var0 < field3175) {
         var2 -= field3175 - var0;
         var0 = field3175;
      }
   ...
   @ObfuscatedName("dq")
   public static void method3899(int var0, int var1, int var2, int var3, int var4) {
      if(var0 < field3175) {
         var2 -= field3175 - var0;
         var0 = field3175;
      }
   ...
   @ObfuscatedName("dc")
   public static void method3900(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
   ...
   @ObfuscatedName("di")
   public static void method3903(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = 65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   @ObfuscatedName("dj")
   public static void method3905(int var0, int var1, int var2, int var3, int var4) {
      method3907(var0, var1, var2, var4);
      method3907(var0, var1 + var3 - 1, var2, var4);
      method3909(var0, var1, var3, var4);
      method3909(var0 + var2 - 1, var1, var3, var4);
   }

   @ObfuscatedName("dk")
   public static void method3906(int var0, int var1, int var2, int var3, int var4, int var5) {
      method3965(var0, var1, var2, var4, var5);
      method3965(var0, var1 + var3 - 1, var2, var4, var5);
      if(var3 >= 3) {
         method3923(var0, var1 + 1, var3 - 2, var4, var5);
         method3923(var0 + var2 - 1, var1 + 1, var3 - 2, var4, var5);
      }

   }

   @ObfuscatedName("de")
   public static void method3907(int var0, int var1, int var2, int var3) {
      if(var1 >= field3171 && var1 < field3173) {
         if(var0 < field3175) {
            var2 -= field3175 - var0;
            var0 = field3175;
         }
   ...
   @ObfuscatedName("da")
   public static void method3909(int var0, int var1, int var2, int var3) {
      if(var0 >= field3175 && var0 < field3176) {
         if(var1 < field3171) {
            var2 -= field3171 - var1;
            var1 = field3171;
         }
   ...
   public static void method3910(int var0, int var1, int var2, int var3, int var4, int var5) {
      int var6 = 0;
      int var7 = 65536 / var3;
      if(var0 < field3175) {
         var2 -= field3175 - var0;
   ...
   @ObfuscatedName("dz")
   public static void method3911(int var0, int var1, int var2, int var3, int var4) {
      var2 -= var0;
      var3 -= var1;
      if(var3 == 0) {
         if(var2 >= 0) {
            method3907(var0, var1, var2 + 1, var4);
         } else {
            method3907(var0 + var2, var1, -var2 + 1, var4);
         }

      } else if(var2 == 0) {
         if(var3 >= 0) {
            method3909(var0, var1, var3 + 1, var4);
         } else {
            method3909(var0, var1 + var3, -var3 + 1, var4);
         }
         ...
         if(var2 > var3) {
            ...
            while(var0 <= var2) {
               var6 = var1 >> 16;
               if(var6 >= field3171 && var6 < field3173) {
   ...
   @ObfuscatedName("dh")
   public static void method3921(int var0, int var1, int var2, int[] var3, int[] var4) {
   ...
   @ObfuscatedName("do")
   static void method3923(int var0, int var1, int var2, int var3, int var4) {
      if(var0 >= field3175 && var0 < field3176) {
         if(var1 < field3171) {
            var2 -= field3171 - var1;
            var1 = field3171;
   ...
   @ObfuscatedName("cj")
   public static void method3924(int[] var0) {
      field3175 = var0[0];
      field3171 = var0[1];
      field3176 = var0[2];
      field3173 = var0[3];
   ...
   @ObfuscatedName("dg")
   public static void method3925(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int var8 = 0;
      int var9 = var4 == var5 && var6 == var7?-1:65536 / var3;
      int var10 = var6;
      int var11 = 256 - var6;
   ...
   @ObfuscatedName("cd")
   public static void method3939(int[] var0) {
      var0[0] = field3175;
      var0[1] = field3171;
      var0[2] = field3176;
      var0[3] = field3173;
   ...
   @ObfuscatedName("du")
   static void method3965(int var0, int var1, int var2, int var3, int var4) {
      if(var1 >= field3171 && var1 < field3173) {
         if(var0 < field3175) {
            var2 -= field3175 - var0;
            var0 = field3175;
