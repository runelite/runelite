...
import net.runelite.deob.attributes.code.instructions.AAStore;
import net.runelite.deob.attributes.code.instructions.AConstNull;
import net.runelite.deob.attributes.code.instructions.ALoad;
import net.runelite.deob.attributes.code.instructions.ALoad_0;
import net.runelite.deob.attributes.code.instructions.ALoad_1;
import net.runelite.deob.attributes.code.instructions.ALoad_2;
import net.runelite.deob.attributes.code.instructions.ALoad_3;
import net.runelite.deob.attributes.code.instructions.ANewArray;
import net.runelite.deob.attributes.code.instructions.AStore;
import net.runelite.deob.attributes.code.instructions.AStore_0;
import net.runelite.deob.attributes.code.instructions.AStore_1;
import net.runelite.deob.attributes.code.instructions.AStore_2;
import net.runelite.deob.attributes.code.instructions.AStore_3;
import net.runelite.deob.attributes.code.instructions.AThrow;
import net.runelite.deob.attributes.code.instructions.ArrayLength;
import net.runelite.deob.attributes.code.instructions.BALoad;
import net.runelite.deob.attributes.code.instructions.BAStore;
import net.runelite.deob.attributes.code.instructions.BiPush;
import net.runelite.deob.attributes.code.instructions.CALoad;
import net.runelite.deob.attributes.code.instructions.CAStore;
import net.runelite.deob.attributes.code.instructions.CheckCast;
import net.runelite.deob.attributes.code.instructions.D2F;
import net.runelite.deob.attributes.code.instructions.D2I;
import net.runelite.deob.attributes.code.instructions.D2L;
import net.runelite.deob.attributes.code.instructions.DALoad;
import net.runelite.deob.attributes.code.instructions.DAStore;
import net.runelite.deob.attributes.code.instructions.DAdd;
import net.runelite.deob.attributes.code.instructions.DCmpG;
import net.runelite.deob.attributes.code.instructions.DCmpL;
import net.runelite.deob.attributes.code.instructions.DConst_0;
import net.runelite.deob.attributes.code.instructions.DConst_1;
import net.runelite.deob.attributes.code.instructions.DDiv;
import net.runelite.deob.attributes.code.instructions.DLoad;
import net.runelite.deob.attributes.code.instructions.DLoad_0;
import net.runelite.deob.attributes.code.instructions.DLoad_1;
import net.runelite.deob.attributes.code.instructions.DLoad_2;
import net.runelite.deob.attributes.code.instructions.DLoad_3;
import net.runelite.deob.attributes.code.instructions.DMul;
import net.runelite.deob.attributes.code.instructions.DNeg;
import net.runelite.deob.attributes.code.instructions.DRem;
import net.runelite.deob.attributes.code.instructions.DStore;
import net.runelite.deob.attributes.code.instructions.DStore_0;
import net.runelite.deob.attributes.code.instructions.DStore_1;
import net.runelite.deob.attributes.code.instructions.DStore_2;
import net.runelite.deob.attributes.code.instructions.DStore_3;
import net.runelite.deob.attributes.code.instructions.DSub;
import net.runelite.deob.attributes.code.instructions.Dup;
import net.runelite.deob.attributes.code.instructions.Dup2;
import net.runelite.deob.attributes.code.instructions.Dup2_X1;
import net.runelite.deob.attributes.code.instructions.Dup2_X2;
import net.runelite.deob.attributes.code.instructions.Dup_X1;
import net.runelite.deob.attributes.code.instructions.Dup_X2;
import net.runelite.deob.attributes.code.instructions.F2D;
import net.runelite.deob.attributes.code.instructions.F2I;
import net.runelite.deob.attributes.code.instructions.F2L;
import net.runelite.deob.attributes.code.instructions.FALoad;
import net.runelite.deob.attributes.code.instructions.FAStore;
import net.runelite.deob.attributes.code.instructions.FAdd;
import net.runelite.deob.attributes.code.instructions.FCmpG;
import net.runelite.deob.attributes.code.instructions.FCmpL;
import net.runelite.deob.attributes.code.instructions.FConst_0;
import net.runelite.deob.attributes.code.instructions.FConst_1;
import net.runelite.deob.attributes.code.instructions.FConst_2;
import net.runelite.deob.attributes.code.instructions.FDiv;
import net.runelite.deob.attributes.code.instructions.FLoad;
import net.runelite.deob.attributes.code.instructions.FLoad_0;
import net.runelite.deob.attributes.code.instructions.FLoad_1;
import net.runelite.deob.attributes.code.instructions.FLoad_2;
import net.runelite.deob.attributes.code.instructions.FLoad_3;
import net.runelite.deob.attributes.code.instructions.FMul;
import net.runelite.deob.attributes.code.instructions.FNeg;
import net.runelite.deob.attributes.code.instructions.FRem;
import net.runelite.deob.attributes.code.instructions.FStore;
import net.runelite.deob.attributes.code.instructions.FStore_0;
import net.runelite.deob.attributes.code.instructions.FStore_1;
import net.runelite.deob.attributes.code.instructions.FStore_2;
import net.runelite.deob.attributes.code.instructions.FStore_3;
import net.runelite.deob.attributes.code.instructions.FSub;
...
import net.runelite.deob.attributes.code.instructions.I2B;
import net.runelite.deob.attributes.code.instructions.I2C;
import net.runelite.deob.attributes.code.instructions.I2D;
import net.runelite.deob.attributes.code.instructions.I2F;
import net.runelite.deob.attributes.code.instructions.I2L;
import net.runelite.deob.attributes.code.instructions.I2S;
import net.runelite.deob.attributes.code.instructions.IALoad;
import net.runelite.deob.attributes.code.instructions.IAStore;
import net.runelite.deob.attributes.code.instructions.IAdd;
import net.runelite.deob.attributes.code.instructions.IAnd;
...
import net.runelite.deob.attributes.code.instructions.IConst_4;
import net.runelite.deob.attributes.code.instructions.IConst_5;
...
import net.runelite.deob.attributes.code.instructions.ILoad_0;
import net.runelite.deob.attributes.code.instructions.ILoad_1;
import net.runelite.deob.attributes.code.instructions.ILoad_2;
import net.runelite.deob.attributes.code.instructions.ILoad_3;
import net.runelite.deob.attributes.code.instructions.IMul;
import net.runelite.deob.attributes.code.instructions.INeg;
import net.runelite.deob.attributes.code.instructions.IOr;
import net.runelite.deob.attributes.code.instructions.IRem;
import net.runelite.deob.attributes.code.instructions.IShL;
import net.runelite.deob.attributes.code.instructions.IShR;
...
import net.runelite.deob.attributes.code.instructions.IStore_3;
...
import net.runelite.deob.attributes.code.instructions.L2D;
import net.runelite.deob.attributes.code.instructions.L2F;
import net.runelite.deob.attributes.code.instructions.L2I;
import net.runelite.deob.attributes.code.instructions.LALoad;
import net.runelite.deob.attributes.code.instructions.LAStore;
import net.runelite.deob.attributes.code.instructions.LAdd;
import net.runelite.deob.attributes.code.instructions.LAnd;
import net.runelite.deob.attributes.code.instructions.LCmp;
import net.runelite.deob.attributes.code.instructions.LConst_0;
...
import net.runelite.deob.attributes.code.instructions.LDiv;
import net.runelite.deob.attributes.code.instructions.LLoad;
import net.runelite.deob.attributes.code.instructions.LLoad_0;
import net.runelite.deob.attributes.code.instructions.LLoad_1;
import net.runelite.deob.attributes.code.instructions.LLoad_2;
import net.runelite.deob.attributes.code.instructions.LLoad_3;
import net.runelite.deob.attributes.code.instructions.LMul;
import net.runelite.deob.attributes.code.instructions.LNeg;
import net.runelite.deob.attributes.code.instructions.LOr;
import net.runelite.deob.attributes.code.instructions.LRem;
import net.runelite.deob.attributes.code.instructions.LShL;
import net.runelite.deob.attributes.code.instructions.LShR;
...
import net.runelite.deob.attributes.code.instructions.LStore_1;
import net.runelite.deob.attributes.code.instructions.LStore_2;
import net.runelite.deob.attributes.code.instructions.LStore_3;
import net.runelite.deob.attributes.code.instructions.LSub;
import net.runelite.deob.attributes.code.instructions.LUShR;
import net.runelite.deob.attributes.code.instructions.LXor;
import net.runelite.deob.attributes.code.instructions.LookupSwitch;
import net.runelite.deob.attributes.code.instructions.MonitorEnter;
import net.runelite.deob.attributes.code.instructions.MonitorExit;
import net.runelite.deob.attributes.code.instructions.MultiANewArray;
...
import net.runelite.deob.attributes.code.instructions.Pop2;
import net.runelite.deob.attributes.code.instructions.PutField;
...
import net.runelite.deob.attributes.code.instructions.SALoad;
import net.runelite.deob.attributes.code.instructions.SAStore;
import net.runelite.deob.attributes.code.instructions.SiPush;
import net.runelite.deob.attributes.code.instructions.Swap;
...
import net.runelite.deob.attributes.code.instructions.Wide;
